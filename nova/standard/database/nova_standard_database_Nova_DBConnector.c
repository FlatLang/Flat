...
{
	this->nova_standard_database_Nova_DBConnector_Nova_error = nova_standard_Nova_String_1_Nova_String(0, exceptionData, "");
}
...
{
	this->prv->nova_standard_database_Nova_DBConnector_Nova_mysql = nova_db_connect1((char*)(nova_standard_database_Nova_DBConnector_Nova_host->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)(nova_standard_database_Nova_DBConnector_Nova_user->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)(nova_standard_database_Nova_DBConnector_Nova_password->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data));
...
{
	this->prv->nova_standard_database_Nova_DBConnector_Nova_mysql = nova_db_connect2((char*)(nova_standard_database_Nova_DBConnector_Nova_host->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)(nova_standard_database_Nova_DBConnector_Nova_user->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)(nova_standard_database_Nova_DBConnector_Nova_password->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)(nova_standard_database_Nova_DBConnector_Nova_database->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data));
	nova_standard_database_Nova_DBConnector_Nova_updateError(this, exceptionData);
}
...
{
	this->prv->nova_standard_database_Nova_DBConnector_Nova_mysql = nova_db_connect3((char*)(nova_standard_database_Nova_DBConnector_Nova_host->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)(nova_standard_database_Nova_DBConnector_Nova_user->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)(nova_standard_database_Nova_DBConnector_Nova_password->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)(nova_standard_database_Nova_DBConnector_Nova_database->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), nova_standard_database_Nova_DBConnector_Nova_port, (char*)(nova_standard_database_Nova_DBConnector_Nova_unixSocket->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), nova_standard_database_Nova_DBConnector_Nova_clientFlag);
	nova_standard_database_Nova_DBConnector_Nova_updateError(this, exceptionData);
}
...
{
	this->nova_standard_database_Nova_DBConnector_Nova_error = nova_standard_Nova_String_1_Nova_String(0, exceptionData, nova_db_error(this->prv->nova_standard_database_Nova_DBConnector_Nova_mysql));
}
...
nova_standard_database_Nova_ResultSet* nova_standard_database_Nova_DBConnector_Nova_query(nova_standard_database_Nova_DBConnector* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_database_Nova_DBConnector_Nova_query)
{
	...
	this->prv->nova_standard_database_Nova_DBConnector_Nova_result = nova_exec_query(this->prv->nova_standard_database_Nova_DBConnector_Nova_mysql, (char*)(nova_standard_database_Nova_DBConnector_Nova_query->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data));
	...
	if (l1_Nova_arrays != 0)
	{
		...
		nova_standard_datastruct_list_Nova_Array* l2_Nova_rows = (nova_standard_datastruct_list_Nova_Array*)nova_null;
		...
		l2_Nova_rows = nova_standard_datastruct_list_Nova_Array_1_Nova_Array(0, exceptionData, l2_Nova_numRows);
		l4_Nova_i = (int)0;
		for (; l4_Nova_i < (int)l2_Nova_numRows; l4_Nova_i++)
		{
			int l6_Nova_j = 0;
			
			nova_standard_datastruct_list_Nova_Array_Nova_set(l2_Nova_rows, exceptionData, l4_Nova_i, (nova_standard_Nova_Object*)(nova_standard_datastruct_list_Nova_Array_1_Nova_Array(0, exceptionData, l2_Nova_numCols)));
			l6_Nova_j = (int)0;
			for (; l6_Nova_j < (int)l2_Nova_numCols; l6_Nova_j++)
			{
				nova_standard_datastruct_list_Nova_Array_Nova_set((nova_standard_datastruct_list_Nova_Array*)(nova_standard_datastruct_list_Nova_Array_virtual1_Nova_get((nova_standard_datastruct_list_Nova_Array*)(l2_Nova_rows), exceptionData, l4_Nova_i)), exceptionData, l6_Nova_j, (nova_standard_Nova_Object*)(nova_standard_Nova_String_1_Nova_String(0, exceptionData, l1_Nova_arrays[l4_Nova_i][l6_Nova_j])));
			}
		}
		l2_Nova_r = nova_standard_database_Nova_ResultSet_Nova_ResultSet(0, exceptionData, l2_Nova_rows, l2_Nova_numCols);
		nova_standard_database_Nova_DBConnector_Nova_updateError(this, exceptionData);
		return l2_Nova_r;
	}
	nova_standard_database_Nova_DBConnector_Nova_updateError(this, exceptionData);
