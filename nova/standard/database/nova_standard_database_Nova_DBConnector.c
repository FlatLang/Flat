...
{
	this->nova_standard_database_Nova_DBConnector_Nova_error = nova_standard_Nova_String_2_Nova_construct(0, exceptionData, nova_db_error(this->prv->nova_standard_database_Nova_DBConnector_Nova_mysql));
}
