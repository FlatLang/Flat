...
{
	nova_standard_datastruct_Nova_ArrayList_0_Nova_add(this->nova_standard_exception_Nova_ExceptionData_Nova_codes, exceptionData, (nova_standard_Nova_Object*)(nova_standard_primitive_number_Nova_Int_7_Nova_construct(0, exceptionData, l0_Nova_code)));
}
