...
{
	nova_standard_datastruct_list_Nova_Array_0_Nova_add(this->nova_standard_exception_Nova_ExceptionData_Nova_codes, exceptionData, (nova_standard_Nova_Object*)(nova_standard_primitive_number_Nova_Int_Nova_construct(0, exceptionData, nova_standard_exception_Nova_ExceptionData_Nova_code)));
}
