...
void nova_standard_exception_NovaExceptionData_Novathis(nova_standard_exception_NovaExceptionData* this, nova_standard_exception_NovaExceptionData* exceptionData, buffer* l0_Novabuf)
{
	...
	this->nova_standard_exception_NovaExceptionData_Novacodes = nova_standard_datastruct_NovaArrayList_Novaconstruct(0, exceptionData);
}
...
{
	nova_standard_datastruct_NovaArrayList_Novaadd(this->nova_standard_exception_NovaExceptionData_Novacodes, exceptionData, (nova_standard_NovaObject*)(nova_standard_NovaInt_Novaconstruct(0, exceptionData, l0_Novacode)));
}
...
nova_standard_exception_NovaExceptionData* nova_standard_exception_NovaExceptionData_NovagetCorrectData(nova_standard_exception_NovaExceptionData* this, nova_standard_exception_NovaExceptionData* exceptionData, int l0_Novacode)
{
	...
	while (l1_Novadata != (nova_standard_exception_NovaExceptionData*)nova_null)
	{
		...
		{
			if (((nova_standard_NovaInt*)nova_standard_datastruct_NovaArrayList_Novaget(l2_Novalist, exceptionData, l3_Novai))->nova_standard_NovaInt_Novavalue == l0_Novacode)
			{
				return l1_Novadata;
			}
		}
