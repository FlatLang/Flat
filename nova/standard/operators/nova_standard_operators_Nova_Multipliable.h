...
nova_standard_Nova_Object* nova_standard_operators_Nova_Multipliable_1_Nova_multiply(nova_standard_operators_Nova_Multipliable* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_value);void nova_standard_operators_Nova_Multipliable_8_Nova_this(nova_standard_operators_Nova_Multipliable* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
