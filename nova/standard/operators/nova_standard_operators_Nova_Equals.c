...
nova_standard_operators_Extension_VTable_Equals nova_standard_operators_Extension_VTable_Equals_val =
{
	{
		0,
		(char(*)(nova_standard_operators_Nova_Equals*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*))nova_standard_operators_Nova_Equals_1_Nova_equals,
		0,
		0,
		0,
		0,
