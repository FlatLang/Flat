...
{
	{
		...
		0,
		0,
		(nova_standard_Nova_Object*(*)(nova_standard_operators_Nova_Multiply*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*))nova_standard_operators_Nova_Multiply_0_Nova_multiply,
		0,
		0,
	},
...
nova_standard_Nova_Object* nova_standard_operators_Nova_Multiply_0_Nova_multiply(nova_standard_operators_Nova_Multiply* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_operators_Nova_Multiply_Nova_value){
	return this->vtable->itable.nova_standard_operators_Nova_Multiply_virtual0_Nova_multiply(this, exceptionData, nova_standard_operators_Nova_Multiply_Nova_value);
}
