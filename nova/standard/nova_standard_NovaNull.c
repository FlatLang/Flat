...
nova_VTable_nova_standard_NovaNull nova_VTable_nova_standard_NovaNull_val =
{
	nova_standard_NovaNull_Novanull0_toString,
	nova_standard_NovaString_Novanull0_equals,
	nova_standard_NovaNull_Novanull0_concat,
};
CCLASS_PRIVATE
(
...
{
	CCLASS_NEW(nova_standard_NovaNull, this);
	this->vtable = &nova_VTable_nova_standard_NovaNull_val;
	nova_standard_NovaObject_Novasuper((nova_standard_NovaObject*)this, 0);
	nova_standard_NovaString_Novasuper((nova_standard_NovaString*)this, 0);
	nova_standard_NovaObject_Novathis((nova_standard_NovaObject*)(this), exceptionData);
	nova_standard_NovaNull_Novasuper(this, 0);
	
	{
		nova_standard_NovaNull_Novathis(this, exceptionData);
	}
...
{
	return nova_standard_NovaString_Novanull0_concat(nova_standard_NovaString_Novaconstruct(0, exceptionData, "null"), exceptionData, l0_Novaother);
}
