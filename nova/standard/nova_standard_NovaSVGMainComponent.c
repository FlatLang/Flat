...
nova_VTable_nova_standard_NovaSVGMainComponent nova_VTable_nova_standard_NovaSVGMainComponent_val =
{
	nova_standard_NovaObject_Novanull0_toString,
	nova_standard_NovaObject_Novanull0_equals,
	nova_standard_NovaSVGMainComponent_Novanull0_generateOutput,
};
...
{
	CCLASS_NEW(nova_standard_NovaSVGMainComponent, this,);
	this->vtable = &nova_VTable_nova_standard_NovaSVGMainComponent_val;
	...
	nova_standard_NovaSVGMainComponent_Novasuper(this, 0);
	
	{
		nova_standard_NovaSVGMainComponent_Novathis(this, exceptionData);
	}
...
{
	nova_standard_NovaFile_Novawrite(l0_Novafile, exceptionData, nova_standard_NovaString_Novanull0_concat(nova_standard_NovaString_Novaconstruct(0, exceptionData, "<?xml version = '1.0' standalone = 'no'?>\n"), exceptionData, nova_standard_NovaString_Novanull0_concat(nova_standard_NovaString_Novaconstruct(0, exceptionData, "<!DOCTYPE svg PUBLIC\"-//W3C//DTD SVG1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\">"), exceptionData, nova_standard_NovaString_Novaconstruct(0, exceptionData, "<svg width=\"1400\"px height=\"950\"px version=\"1.1\" preserveAspectRatio=\"none\">\n"))));
	nova_standard_NovaSVGComponentList_NovagenerateOutput(this->nova_standard_NovaSVGComponent_Novachildren, exceptionData, l0_Novafile);
	nova_standard_NovaFile_Novawrite(l0_Novafile, exceptionData, nova_standard_NovaString_Novaconstruct(0, exceptionData, "</svg>\n"));
}
