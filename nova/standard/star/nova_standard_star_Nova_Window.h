#pragma once
#ifndef FILE_nova_standard_star_Nova_Window_NOVA
#define FILE_nova_standard_star_Nova_Window_NOVA
...
typedef struct nova_standard_star_Extension_VTable_Window nova_standard_star_Extension_VTable_Window;
struct nova_standard_star_Extension_VTable_Window
{
...
extern nova_standard_star_Extension_VTable_Window nova_standard_star_Extension_VTable_Window_val;
...
(
	...
	nova_standard_star_Extension_VTable_Window* vtable;
	...
	int nova_standard_star_Nova_Window_Nova_height;
	nova_standard_Nova_String* nova_standard_star_Nova_Window_Nova_title;
)

void nova_standard_star_Nova_Window_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
