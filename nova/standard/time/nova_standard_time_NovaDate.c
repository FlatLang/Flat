...
nova_standard_time_NovaDate* nova_standard_time_NovaDate_Nova0_construct(nova_standard_time_NovaDate* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	nova_standard_time_NovaDate_Novasuper(this, exceptionData);
...
{
	nova_updateTime();
	this->nova_standard_time_NovaDate_Novayear = (int)(nova_getYear());
	this->nova_standard_time_NovaDate_Novamonth = (int)(nova_getMonth());
	this->nova_standard_time_NovaDate_Novaday = (int)(nova_getDay());
	this->nova_standard_time_NovaDate_Novahour = (int)(nova_getHour());
	this->nova_standard_time_NovaDate_Novaminute = (int)(nova_getMinute());
	this->nova_standard_time_NovaDate_Novasecond = (int)(nova_getSecond());
}
...
nova_standard_NovaString* nova_standard_time_NovaDate_Nova1_formatDate(nova_standard_time_NovaDate* this, nova_standard_exception_NovaExceptionData* exceptionData, nova_standard_NovaString* l0_Novastr, int l0_Novafirst, int l0_Novasecond, int l0_Novathird, int l0_Novafourth, int l0_Novafifth, int l0_Novasixth)
{
	...
	l1_Novadata = (char*)(nova_formatDate((char*)(nova_standard_NovaString_NovatoCharArray(l0_Novastr, exceptionData)), (int)(l0_Novafirst), (int)(l0_Novasecond), (int)(l0_Novathird), (int)(l0_Novafourth), (int)(l0_Novafifth), (int)(l0_Novasixth)));
