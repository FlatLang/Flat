...
nova_VTable_nova_standard_time_Nova_Date nova_VTable_nova_standard_time_Nova_Date_val =
{
...
nova_standard_time_Nova_Date* nova_standard_time_Nova_Date_2_Nova_construct(nova_standard_time_Nova_Date* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_VTable_nova_standard_time_Nova_Date_val;
	...
	{
		nova_standard_time_Nova_Date_Nova_this(this, exceptionData);
	}
...
void nova_standard_time_Nova_Date_Nova_this(nova_standard_time_Nova_Date* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
