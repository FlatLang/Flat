...
typedef struct nova_standard_time_Extension_VTable_Time nova_standard_time_Extension_VTable_Time;
struct nova_standard_time_Extension_VTable_Time
{
...
extern nova_standard_time_Extension_VTable_Time nova_standard_time_Extension_VTable_Time_val;
...
(
	...
	nova_standard_time_Extension_VTable_Time* vtable;
)

void nova_standard_time_Nova_Time_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
nova_standard_time_Nova_Time* nova_standard_time_Nova_Time_Nova_Time(nova_standard_time_Nova_Time* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
