...
{
	nova_ArrayList_add(this->nova_ExceptionData_codes, exceptionData, (Object*)(nova_Int_construct(0, exceptionData, nova_0_code)));
}
...
ExceptionData* nova_ExceptionData_getCorrectData(ExceptionData* this, ExceptionData* exceptionData, int nova_0_code)
{
	...
	nova_1_data = this;
	while (nova_1_data != (ExceptionData*)nova_null)
	{
		...
		{
			if (((Int*)nova_ArrayList_get(nova_2_list, exceptionData, nova_3_i))->nova_Int_value == nova_0_code)
			{
				return nova_1_data;
			}
		}
		if (nova_ExceptionData_getParent(nova_1_data, exceptionData) == (ExceptionData*)nova_null)
		{
			return nova_1_data;
		}
...
buffer* nova_ExceptionData_getCorrectBuffer(ExceptionData* this, ExceptionData* exceptionData, int nova_0_code)
{
	...
	if (nova_1_data == (ExceptionData*)nova_null)
	{
		return 0;
	}
...
{
	this->nova_ExceptionData_codes = (ArrayList*)nova_null;
	this->prv->nova_ExceptionData_buf = (buffer*)nova_null;
	this->prv->nova_ExceptionData_parent = (ExceptionData*)nova_null;
}
