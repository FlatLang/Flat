#pragma once
#ifndef FILE_nova_standard_math_Nova_Diekstra_NOVA
#define FILE_nova_standard_math_Nova_Diekstra_NOVA

typedef struct nova_standard_math_Nova_Diekstra nova_standard_math_Nova_Diekstra;
...
typedef struct nova_standard_math_Extension_VTable_Diekstra nova_standard_math_Extension_VTable_Diekstra;
struct nova_standard_math_Extension_VTable_Diekstra
{
...
extern nova_standard_math_Extension_VTable_Diekstra nova_standard_math_Extension_VTable_Diekstra_val;


CCLASS_CLASS
(
	nova_standard_math_Nova_Diekstra, 
	
	nova_standard_math_Extension_VTable_Diekstra* vtable;
)

void nova_standard_math_Nova_Diekstra_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
nova_standard_math_Nova_Diekstra* nova_standard_math_Nova_Diekstra_Nova_Diekstra(nova_standard_math_Nova_Diekstra* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
