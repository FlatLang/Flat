#pragma once
#ifndef FILE_nova_standard_math_Nova_NumericOperand_NOVA
#define FILE_nova_standard_math_Nova_NumericOperand_NOVA
...
typedef struct nova_standard_math_Extension_VTable_NumericOperand nova_standard_math_Extension_VTable_NumericOperand;
struct nova_standard_math_Extension_VTable_NumericOperand
{
	...
	nova_standard_Nova_String* (*nova_standard_Nova_Object_virtual1_Nova_toString)(nova_standard_math_Nova_NumericOperand*, nova_standard_exception_Nova_ExceptionData*);
...
extern nova_standard_math_Extension_VTable_NumericOperand nova_standard_math_Extension_VTable_NumericOperand_val;
...
(
	...
	nova_standard_math_Extension_VTable_NumericOperand* vtable;
	struct Private* prv;
)

void nova_standard_math_Nova_NumericOperandNova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
nova_standard_math_Nova_NumericOperand* nova_standard_math_Nova_NumericOperand_Nova_NumericOperand(nova_standard_math_Nova_NumericOperand* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_math_Nova_NumericOperand_Nova_data);
...
void nova_standard_math_Nova_NumericOperand_2_Nova_this(nova_standard_math_Nova_NumericOperand* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_math_Nova_NumericOperand_Nova_data);
