...
struct nova_standard_math_Extension_VTable_NumericOperation
{
	...
	nova_standard_Nova_String* (*nova_standard_math_Nova_NumericOperation_virtual1_Nova_toString)(nova_standard_math_Nova_NumericOperation*, nova_standard_exception_Nova_ExceptionData*);
