...
typedef struct nova_standard_math_VTable_NumericOperation
{
...
} nova_standard_math_VTable_NumericOperation;

extern nova_standard_math_VTable_NumericOperation nova_standard_math_VTable_NumericOperation_val;

CCLASS_CLASS
(
	nova_standard_math_Nova_NumericOperation, 
	
	nova_standard_math_VTable_NumericOperation* vtable;
	struct Private* prv;
)
