...
void nova_standard_math_logic_Nova_StatementGroup_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_standard_math_logic_Nova_StatementGroup* nova_standard_math_logic_Nova_StatementGroup_Nova_StatementGroup(nova_standard_math_logic_Nova_StatementGroup* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_math_logic_Nova_StatementGroup_Nova_statement, nova_standard_datastruct_Nova_Bounds* nova_standard_math_logic_Nova_StatementGroup_Nova_bounds)
{
	...
	{
		nova_standard_math_logic_Nova_StatementGroup_Nova_this(this, exceptionData, nova_standard_math_logic_Nova_StatementGroup_Nova_statement, nova_standard_math_logic_Nova_StatementGroup_Nova_bounds);
	}
...
void nova_standard_math_logic_Nova_StatementGroup_Nova_this(nova_standard_math_logic_Nova_StatementGroup* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_math_logic_Nova_StatementGroup_Nova_statement, nova_standard_datastruct_Nova_Bounds* nova_standard_math_logic_Nova_StatementGroup_Nova_bounds)
{
	this->nova_standard_math_logic_Nova_StatementGroup_Nova_statement = nova_standard_math_logic_Nova_StatementGroup_Nova_statement;
	this->nova_standard_math_logic_Nova_StatementGroup_Nova_bounds = nova_standard_math_logic_Nova_StatementGroup_Nova_bounds;
}
