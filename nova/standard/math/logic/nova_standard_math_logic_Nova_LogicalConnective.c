...
nova_standard_math_logic_Nova_LogicalConnective* nova_standard_math_logic_Nova_LogicalConnective_Nova_LogicalConnective(nova_standard_math_logic_Nova_LogicalConnective* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_standard_math_logic_Nova_LogicalConnective_0_Nova_super(this, exceptionData);
	
	{
		nova_standard_math_logic_Nova_LogicalConnective_2_Nova_this(this, exceptionData);
	}
...
void nova_standard_math_logic_Nova_LogicalConnective_2_Nova_this(nova_standard_math_logic_Nova_LogicalConnective* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}

void nova_standard_math_logic_Nova_LogicalConnective_0_Nova_super(nova_standard_math_logic_Nova_LogicalConnective* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
