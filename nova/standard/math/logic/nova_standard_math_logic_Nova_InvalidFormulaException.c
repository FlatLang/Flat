...
nova_standard_math_logic_Nova_InvalidFormulaException* nova_standard_math_logic_Nova_InvalidFormulaException_1_Nova_construct(nova_standard_math_logic_Nova_InvalidFormulaException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_logic_Nova_InvalidFormulaException_Nova_message)
{
	...
	{
		nova_standard_math_logic_Nova_InvalidFormulaException_1_Nova_this(this, exceptionData, nova_standard_math_logic_Nova_InvalidFormulaException_Nova_message);
	}
...
void nova_standard_math_logic_Nova_InvalidFormulaException_1_Nova_this(nova_standard_math_logic_Nova_InvalidFormulaException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_logic_Nova_InvalidFormulaException_Nova_message)
{
