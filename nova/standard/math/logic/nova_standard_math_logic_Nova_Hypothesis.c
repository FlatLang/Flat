...
nova_VTable_nova_standard_math_logic_Nova_Hypothesis nova_VTable_nova_standard_math_logic_Nova_Hypothesis_val =
{
...
nova_standard_math_logic_Nova_Hypothesis* nova_standard_math_logic_Nova_Hypothesis_0_Nova_construct(nova_standard_math_logic_Nova_Hypothesis* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_statement)
{
	CCLASS_NEW(nova_standard_math_logic_Nova_Hypothesis, this);
	this->vtable = &nova_VTable_nova_standard_math_logic_Nova_Hypothesis_val;
	...
	nova_standard_math_logic_Nova_Hypothesis_Nova_super(this, exceptionData);
	
	{
		nova_standard_math_logic_Nova_Hypothesis_Nova_this(this, exceptionData, l0_Nova_statement);
	}
...
void nova_standard_math_logic_Nova_Hypothesis_Nova_this(nova_standard_math_logic_Nova_Hypothesis* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_statement)
{
	nova_standard_math_logic_Nova_LogicalStatement_Nova_this((nova_standard_math_logic_Nova_LogicalStatement*)(this), exceptionData, l0_Nova_statement);
}

void nova_standard_math_logic_Nova_Hypothesis_Nova_super(nova_standard_math_logic_Nova_Hypothesis* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
