...
nova_standard_math_logic_Nova_Hypothesis* nova_standard_math_logic_Nova_Hypothesis_Nova_Hypothesis(nova_standard_math_logic_Nova_Hypothesis* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_logic_Nova_Hypothesis_Nova_statement)
{
	...
	{
		nova_standard_math_logic_Nova_Hypothesis_1_Nova_this(this, exceptionData, nova_standard_math_logic_Nova_Hypothesis_Nova_statement);
	}
...
void nova_standard_math_logic_Nova_Hypothesis_1_Nova_this(nova_standard_math_logic_Nova_Hypothesis* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_logic_Nova_Hypothesis_Nova_statement)
{
	nova_standard_math_logic_Nova_LogicalStatement_1_Nova_this((nova_standard_math_logic_Nova_LogicalStatement*)(this), exceptionData, nova_standard_math_logic_Nova_Hypothesis_Nova_statement);
}
