...
struct nova_standard_math_logic_Extension_VTable_Hypothesis
{
	...
	nova_standard_Nova_String* (*nova_standard_math_logic_Nova_LogicalStatement_virtual1_Nova_toString)(nova_standard_math_logic_Nova_LogicalStatement*, nova_standard_exception_Nova_ExceptionData*);
