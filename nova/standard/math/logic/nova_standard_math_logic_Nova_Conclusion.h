...
typedef struct nova_VTable_nova_standard_math_logic_Nova_Conclusion
{
...
} nova_VTable_nova_standard_math_logic_Nova_Conclusion;

extern nova_VTable_nova_standard_math_logic_Nova_Conclusion nova_VTable_nova_standard_math_logic_Nova_Conclusion_val;

CCLASS_CLASS
(
	nova_standard_math_logic_Nova_Conclusion, 
	
	nova_VTable_nova_standard_math_logic_Nova_Conclusion* vtable;
	struct Private* prv;
)

void nova_standard_math_logic_Nova_ConclusionNova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
nova_standard_math_logic_Nova_Conclusion* nova_standard_math_logic_Nova_Conclusion_Nova_construct(nova_standard_math_logic_Nova_Conclusion* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_statement);
