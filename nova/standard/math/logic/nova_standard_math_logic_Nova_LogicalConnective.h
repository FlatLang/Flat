...
typedef struct nova_VTable_nova_standard_math_logic_Nova_LogicalConnective
{
...
} nova_VTable_nova_standard_math_logic_Nova_LogicalConnective;

extern nova_VTable_nova_standard_math_logic_Nova_LogicalConnective nova_VTable_nova_standard_math_logic_Nova_LogicalConnective_val;

CCLASS_CLASS
(
	nova_standard_math_logic_Nova_LogicalConnective, 
	
	nova_VTable_nova_standard_math_logic_Nova_LogicalConnective* vtable;
)
