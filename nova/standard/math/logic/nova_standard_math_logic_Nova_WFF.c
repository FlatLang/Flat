...
nova_VTable_nova_standard_math_logic_Nova_WFF nova_VTable_nova_standard_math_logic_Nova_WFF_val =
{
...
nova_standard_math_logic_Nova_WFF* nova_standard_math_logic_Nova_WFF_Nova_construct(nova_standard_math_logic_Nova_WFF* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_wellFormedFormula, nova_standard_math_logic_Nova_StatementLetter** l0_Nova_letters)
{
	...
	this->vtable = &nova_VTable_nova_standard_math_logic_Nova_WFF_val;
...
void nova_standard_math_logic_Nova_WFF_Nova_decodeFormula(nova_standard_math_logic_Nova_WFF* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	l4_Nova_i = 0;
	for (; l4_Nova_i < l1_Nova_statements->nova_standard_datastruct_Nova_ArrayList_Nova_size; l4_Nova_i++)
	{
		nova_standard_math_logic_Nova_StatementGroup* l4_Nova_group;
		
		l4_Nova_group = (nova_standard_math_logic_Nova_StatementGroup*)(((nova_standard_math_logic_Nova_StatementGroup*)nova_standard_datastruct_Nova_ArrayList_Nova_get(l1_Nova_statements, exceptionData, l4_Nova_i)));
		nova_standard_datastruct_Nova_ArrayList_0_Nova_add(this->prv->nova_standard_math_logic_Nova_WFF_Nova_hypotheses, exceptionData, l4_Nova_group->nova_standard_math_logic_Nova_StatementGroup_Nova_statement);
	}
	l5_Nova_n = 0;
	for (; l5_Nova_n < this->prv->nova_standard_math_logic_Nova_WFF_Nova_hypotheses->nova_standard_datastruct_Nova_ArrayList_Nova_size; l5_Nova_n++)
	{
		nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, (nova_standard_Nova_Object*)(((nova_standard_math_logic_Nova_Hypothesis*)nova_standard_datastruct_Nova_ArrayList_Nova_get(this->prv->nova_standard_math_logic_Nova_WFF_Nova_hypotheses, exceptionData, l5_Nova_n))));
	}
}
	...
	if (nova_standard_Nova_String_Nova_lastChar(l0_Nova_wff, exceptionData) == ')')
{
	...
	l3_Nova_first = nova_standard_math_logic_Nova_WFF_Nova_findEndingMatch(this, exceptionData, l0_Nova_wff, '(', ')', l0_Nova_wff->nova_standard_Nova_String_Nova_length - 1, -1);
}
...
nova_standard_datastruct_Nova_ArrayList* nova_standard_math_logic_Nova_WFF_Nova_decodeHypotheses(nova_standard_math_logic_Nova_WFF* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_wff)
{
	...
	l1_Nova_next = 0;
	l1_Nova_prev = 0;
	l2_Nova_index = nova_standard_Nova_String_1_Nova_indexOf(l0_Nova_wff, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "&"));
	for (; l2_Nova_index >= 0; l2_Nova_index = nova_standard_Nova_String_2_Nova_indexOf(l0_Nova_wff, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "&"), l1_Nova_prev + 1))
	{
		l1_Nova_next = nova_standard_math_logic_Nova_WFF_Nova_nextNonWhitespaceIndex(this, exceptionData, l0_Nova_wff, l2_Nova_index - 1, -1);
		...
		l1_Nova_prev = nova_standard_math_logic_Nova_WFF_Nova_nextNonWhitespaceIndex(this, exceptionData, l0_Nova_wff, l2_Nova_index + 1, 1);
	}
...
int nova_standard_math_logic_Nova_WFF_1_Nova_nextWhitespaceIndex(nova_standard_math_logic_Nova_WFF* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_wff, int l0_Nova_index, int l0_Nova_direction, char l0_Nova_opposite)
{
	...
	for (; l2_Nova_i < l0_Nova_wff->nova_standard_Nova_String_Nova_length && l2_Nova_i >= 0; l2_Nova_i = l2_Nova_i + l0_Nova_direction)
	{
		...
		if (nova_standard_math_logic_Nova_WFF_Nova_containsChar((nova_standard_math_logic_Nova_WFF*)nova_null, exceptionData, l2_Nova_c, nova_standard_math_logic_Nova_WFF_Nova_whitespace, 4) != l0_Nova_opposite)
		{
			return l2_Nova_i;
		}
	}
...
int nova_standard_math_logic_Nova_WFF_Nova_findEndingMatch(nova_standard_math_logic_Nova_WFF* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_wff, char l0_Nova_start, char l0_Nova_end, int l0_Nova_index, int l0_Nova_direction)
{
	...
	if (l0_Nova_direction < 0)
	{
		...
		l2_Nova_temp = l0_Nova_start;
		l0_Nova_start = l0_Nova_end;
		l0_Nova_end = l2_Nova_temp;
	}
	l1_Nova_scope = 0;
	l3_Nova_i = l0_Nova_index;
	for (; l3_Nova_i < l0_Nova_wff->nova_standard_Nova_String_Nova_length && l3_Nova_i >= 0; l3_Nova_i = l3_Nova_i + l0_Nova_direction)
	{
		char l3_Nova_c;
		
		l3_Nova_c = nova_standard_Nova_String_Nova_charAt(l0_Nova_wff, exceptionData, l3_Nova_i);
		if (l3_Nova_c == l0_Nova_start)
		{
			l1_Nova_scope++;
		}
		else if (l3_Nova_c == l0_Nova_end)
		{
			l1_Nova_scope--;
		}
		if (l1_Nova_scope == 0)
