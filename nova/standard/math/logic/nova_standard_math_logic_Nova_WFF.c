...
void nova_standard_math_logic_Nova_WFF_Nova_decodeFormula(nova_standard_math_logic_Nova_WFF* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		THROW(6, nova_standard_math_logic_Nova_InvalidFormulaException_4_Nova_construct(0, exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "No valid conclusion found")));
	}
	...
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Conclusion: "), exceptionData, nova_standard_math_logic_Nova_LogicalStatement_1_Nova_toString((nova_standard_math_logic_Nova_LogicalStatement*)(l1_Nova_conclusion), exceptionData)));
...
nova_standard_datastruct_list_Nova_Array* nova_standard_math_logic_Nova_WFF_Nova_decodeHypotheses(nova_standard_math_logic_Nova_WFF* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_logic_Nova_WFF_Nova_wff)
{
	...
	for (; l2_Nova_index >= 0; l2_Nova_index = nova_standard_Nova_String_2_Nova_indexOf(nova_standard_math_logic_Nova_WFF_Nova_wff, exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "&"), l1_Nova_prev + 1))
	{
		...
		l1_Nova_prev = nova_standard_math_logic_Nova_WFF_Nova_nextNonWhitespaceIndex(this, exceptionData, nova_standard_math_logic_Nova_WFF_Nova_wff, l2_Nova_index + 1, 1);
	}
...
int nova_standard_math_logic_Nova_WFF_1_Nova_nextWhitespaceIndex(nova_standard_math_logic_Nova_WFF* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_logic_Nova_WFF_Nova_wff, int nova_standard_math_logic_Nova_WFF_Nova_index, int nova_standard_math_logic_Nova_WFF_Nova_direction, char nova_standard_math_logic_Nova_WFF_Nova_opposite)
{
	...
	for (; l2_Nova_i < nova_standard_math_logic_Nova_WFF_Nova_wff->nova_standard_Nova_String_Nova_size && l2_Nova_i >= 0; l2_Nova_i = l2_Nova_i + nova_standard_math_logic_Nova_WFF_Nova_direction)
	{
		...
		if (nova_standard_math_logic_Nova_WFF_Nova_containsChar((nova_standard_math_logic_Nova_WFF*)nova_null, exceptionData, l2_Nova_c, nova_standard_math_logic_Nova_WFF_Nova_whitespace, 4) != nova_standard_math_logic_Nova_WFF_Nova_opposite)
		{
			return l2_Nova_i;
		}
	}
