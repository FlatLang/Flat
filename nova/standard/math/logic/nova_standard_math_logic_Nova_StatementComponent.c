...
nova_standard_math_logic_VTable_StatementComponent nova_standard_math_logic_VTable_StatementComponent_val =
{
...
nova_standard_math_logic_Nova_StatementComponent* nova_standard_math_logic_Nova_StatementComponent_0_Nova_construct(nova_standard_math_logic_Nova_StatementComponent* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_standard_math_logic_VTable_StatementComponent_val;
