#pragma once
#ifndef FILE_nova_standard_math_logic_Nova_StatementLetter_NOVA
#define FILE_nova_standard_math_logic_Nova_StatementLetter_NOVA

typedef struct nova_standard_math_logic_Nova_StatementLetter nova_standard_math_logic_Nova_StatementLetter;
