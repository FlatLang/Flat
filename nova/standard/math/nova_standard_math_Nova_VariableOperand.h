#pragma once
#ifndef FILE_nova_standard_math_Nova_VariableOperand_NOVA
#define FILE_nova_standard_math_Nova_VariableOperand_NOVA

typedef struct nova_standard_math_Nova_VariableOperand nova_standard_math_Nova_VariableOperand;
...
typedef struct nova_standard_math_Extension_VTable_VariableOperand nova_standard_math_Extension_VTable_VariableOperand;
struct nova_standard_math_Extension_VTable_VariableOperand
{
...
extern nova_standard_math_Extension_VTable_VariableOperand nova_standard_math_Extension_VTable_VariableOperand_val;


CCLASS_CLASS
(
	nova_standard_math_Nova_VariableOperand, 
	
	nova_standard_math_Extension_VTable_VariableOperand* vtable;
)

void nova_standard_math_Nova_VariableOperandNova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
nova_standard_math_Nova_VariableOperand* nova_standard_math_Nova_VariableOperand_0_Nova_construct(nova_standard_math_Nova_VariableOperand* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
