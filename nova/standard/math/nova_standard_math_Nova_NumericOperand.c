...
nova_standard_math_Nova_NumericOperand* nova_standard_math_Nova_NumericOperand_2_Nova_construct(nova_standard_math_Nova_NumericOperand* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_math_Nova_NumericOperand_Nova_data)
{
	CCLASS_NEW(nova_standard_math_Nova_NumericOperand, this);
	this->vtable = &nova_standard_math_Extension_VTable_NumericOperand_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
	nova_standard_math_Nova_NumericOperand_Nova_super(this, exceptionData);
	
	{
		nova_standard_math_Nova_NumericOperand_2_Nova_this(this, exceptionData, nova_standard_math_Nova_NumericOperand_Nova_data);
	}
...
{
	return ((nova_standard_Nova_Object*)this->prv->nova_standard_math_Nova_NumericOperand_Nova_data)->vtable->nova_standard_Nova_Object_virtual1_Nova_toString((nova_standard_Nova_Object*)(this->prv->nova_standard_math_Nova_NumericOperand_Nova_data), exceptionData);
}
