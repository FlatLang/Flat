...
nova_standard_math_Nova_NumericOperand* nova_standard_math_Nova_NumericOperand_3_Nova_construct(nova_standard_math_Nova_NumericOperand* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_math_Nova_NumericOperand_Nova_data)
{
	...
	{
		nova_standard_math_Nova_NumericOperand_3_Nova_this(this, exceptionData, nova_standard_math_Nova_NumericOperand_Nova_data);
	}
...
void nova_standard_math_Nova_NumericOperand_3_Nova_this(nova_standard_math_Nova_NumericOperand* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_math_Nova_NumericOperand_Nova_data)
{
...
{
	return ((nova_standard_Nova_Object*)this->prv->nova_standard_math_Nova_NumericOperand_Nova_data)->vtable->nova_standard_Nova_Object_virtual0_Nova_toString(this->prv->nova_standard_math_Nova_NumericOperand_Nova_data, exceptionData);
}
