...
{
	return this->prv->nova_standard_math_Nova_NumericOperand_Nova_data->vtable->nova_standard_Nova_Object_virtual0_Nova_toString(this->prv->nova_standard_math_Nova_NumericOperand_Nova_data, exceptionData);
}
