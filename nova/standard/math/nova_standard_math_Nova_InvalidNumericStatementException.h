...
typedef struct nova_standard_math_VTable_InvalidNumericStatementException
{
	long (*nova_standard_Nova_Object_virtual1_Nova_getHashCodeLong)(nova_standard_Nova_Object*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_String* (*nova_standard_Nova_Object_virtual0_Nova_toString)(nova_standard_Nova_Object*, nova_standard_exception_Nova_ExceptionData*);
	char (*nova_standard_Nova_Object_virtual0_Nova_equals)(nova_standard_Nova_Object*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
} nova_standard_math_VTable_InvalidNumericStatementException;

extern nova_standard_math_VTable_InvalidNumericStatementException nova_standard_math_VTable_InvalidNumericStatementException_val;

CCLASS_CLASS
(
	nova_standard_math_Nova_InvalidNumericStatementException, 
	
	nova_standard_math_VTable_InvalidNumericStatementException* vtable;
