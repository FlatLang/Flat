...
{
	CCLASS_NEW(nova_standard_math_Nova_Graph, this,);
	this->vtable = &nova_standard_math_Extension_VTable_Graph_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
	nova_standard_math_Nova_Graph_Nova_super(this, exceptionData);
	
	{
		nova_standard_math_Nova_Graph_0_Nova_this(this, exceptionData);
	}
