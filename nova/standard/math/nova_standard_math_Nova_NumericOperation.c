...
void nova_standard_math_Nova_NumericOperation_Nova_this(nova_standard_math_Nova_NumericOperation* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_Nova_NumericOperation_Nova_operation)
{
	...
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_Nova_Object_virtual1_Nova_toString((nova_standard_Nova_Object*)(l2_Nova_bounds1), exceptionData)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, ", "), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_Nova_Object_virtual1_Nova_toString((nova_standard_Nova_Object*)(l2_Nova_bounds2), exceptionData)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, " and "), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, l2_Nova_index1)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, ", "), exceptionData, nova_standard_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, l2_Nova_index2))))))));
	...
	if (l2_Nova_type2 != nova_standard_math_Nova_NumericOperation_Nova_OPERATOR)
	{
		...
		{
			THROW(5, nova_standard_math_Nova_InvalidNumericStatementException_4_Nova_construct(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Missing left hand operand in operation '"), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_math_Nova_NumericOperation_Nova_operation), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "'")))));
		}
...
void nova_standard_math_Nova_NumericOperation_0_Nova_this(nova_standard_math_Nova_NumericOperation* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_Nova_NumericOperation_Nova_left, nova_standard_Nova_String* nova_standard_math_Nova_NumericOperation_Nova_operator, nova_standard_Nova_String* nova_standard_math_Nova_NumericOperation_Nova_right)
{
	...
	{
		THROW(1, nova_standard_exception_Nova_Exception_4_Nova_construct(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Left operand '"), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_math_Nova_NumericOperation_Nova_left), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "' is invalid")))));
	}
	else if (nova_standard_math_Nova_NumericOperation_Nova_right == (nova_standard_Nova_String*)nova_null)
	{
		THROW(1, nova_standard_exception_Nova_Exception_4_Nova_construct(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Right operand '"), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_math_Nova_NumericOperation_Nova_right), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "' is invalid")))));
	}
...
int nova_standard_math_Nova_NumericOperation_Nova_getOperatorRank(nova_standard_math_Nova_NumericOperation* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_math_Nova_NumericOperation_Nova_operator)
{
	...
	char nova_standard_math_Nova_NumericOperation_Nova_isNumeric(nova_standard_math_Nova_NumericOperation* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_math_Nova_NumericOperation_Nova_c)
	{
		return nova_standard_math_Nova_NumericOperation_Nova_contains(0, exceptionData, nova_standard_math_Nova_NumericOperation_Nova_NUMERIC_CHARS, nova_standard_math_Nova_NumericOperation_Nova_c, nova_standard_math_Nova_NumericOperation_Nova_numbersLength);
	}
	
	char nova_standard_math_Nova_NumericOperation_Nova_isOperator(nova_standard_math_Nova_NumericOperation* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_math_Nova_NumericOperation_Nova_c)
	{
		return nova_standard_math_Nova_NumericOperation_Nova_contains(0, exceptionData, nova_standard_math_Nova_NumericOperation_Nova_VALID_OPERATORS, nova_standard_math_Nova_NumericOperation_Nova_c, nova_standard_math_Nova_NumericOperation_Nova_operatorsLength);
	}
	
	char nova_standard_math_Nova_NumericOperation_Nova_isWhitespace(nova_standard_math_Nova_NumericOperation* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_math_Nova_NumericOperation_Nova_c)
	{
		return nova_standard_math_Nova_NumericOperation_Nova_contains(0, exceptionData, nova_standard_math_Nova_NumericOperation_Nova_WHITESPACE_CHARS, nova_standard_math_Nova_NumericOperation_Nova_c, nova_standard_math_Nova_NumericOperation_Nova_whitespaceLength);
	}
	...
	{
		return nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_Nova_Object_virtual1_Nova_toString((nova_standard_Nova_Object*)(this->prv->nova_standard_math_Nova_NumericOperation_Nova_leftOperand), exceptionData)), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(this->prv->nova_standard_math_Nova_NumericOperation_Nova_operator), exceptionData, nova_standard_Nova_Object_virtual1_Nova_toString((nova_standard_Nova_Object*)(this->prv->nova_standard_math_Nova_NumericOperation_Nova_rightOperand), exceptionData)));
	}
