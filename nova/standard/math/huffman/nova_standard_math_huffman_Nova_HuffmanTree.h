#pragma once
#ifndef FILE_nova_standard_math_huffman_Nova_HuffmanTree_NOVA
#define FILE_nova_standard_math_huffman_Nova_HuffmanTree_NOVA

typedef struct nova_standard_math_huffman_Nova_HuffmanTree nova_standard_math_huffman_Nova_HuffmanTree;
...
typedef struct nova_standard_math_huffman_Extension_VTable_HuffmanTree nova_standard_math_huffman_Extension_VTable_HuffmanTree;
struct nova_standard_math_huffman_Extension_VTable_HuffmanTree
{
...
extern nova_standard_math_huffman_Extension_VTable_HuffmanTree nova_standard_math_huffman_Extension_VTable_HuffmanTree_val;


CCLASS_CLASS
(
	nova_standard_math_huffman_Nova_HuffmanTree, 
	
	nova_standard_math_huffman_Extension_VTable_HuffmanTree* vtable;
