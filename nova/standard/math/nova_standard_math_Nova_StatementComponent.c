...
{
	return (nova_standard_Nova_String*)(nova_standard_Nova_Object_virtual1_Nova_toString((nova_standard_Nova_Object*)(this->nova_standard_math_Nova_StatementComponent_Nova_data), exceptionData));
}
