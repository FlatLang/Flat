...
{
	return this->nova_standard_math_Nova_StatementComponent_Nova_data->vtable->nova_standard_Nova_Object_virtual0_Nova_toString((nova_standard_Nova_Object*)(this->nova_standard_math_Nova_StatementComponent_Nova_data), exceptionData);
}
