...
nova_standard_math_Extension_VTable_StatementComponent nova_standard_math_Extension_VTable_StatementComponent_val =
{
	...
	nova_standard_math_Nova_StatementComponent_2_Nova_toString,
...
nova_standard_math_Nova_StatementComponent* nova_standard_math_Nova_StatementComponent_Nova_StatementComponent(nova_standard_math_Nova_StatementComponent* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_math_Nova_StatementComponent_Nova_data)
{
...
nova_standard_Nova_String* nova_standard_math_Nova_StatementComponent_2_Nova_toString(nova_standard_math_Nova_StatementComponent* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	return (nova_standard_Nova_String*)(nova_standard_Nova_Object_virtual2_Nova_toString((nova_standard_Nova_Object*)(this->nova_standard_math_Nova_StatementComponent_Nova_data), exceptionData));
}
