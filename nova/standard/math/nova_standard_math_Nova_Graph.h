#pragma once
#ifndef FILE_nova_standard_math_Nova_Graph_NOVA
#define FILE_nova_standard_math_Nova_Graph_NOVA

typedef struct nova_standard_math_Nova_Graph nova_standard_math_Nova_Graph;
...
typedef struct nova_standard_math_Extension_VTable_Graph nova_standard_math_Extension_VTable_Graph;
struct nova_standard_math_Extension_VTable_Graph
{
...
extern nova_standard_math_Extension_VTable_Graph nova_standard_math_Extension_VTable_Graph_val;


CCLASS_CLASS
(
	nova_standard_math_Nova_Graph, 
...
nova_standard_math_Nova_Graph* nova_standard_math_Nova_Graph_0_Nova_construct(nova_standard_math_Nova_Graph* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
...
void nova_standard_math_Nova_Graph_Nova_super(nova_standard_math_Nova_Graph* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
