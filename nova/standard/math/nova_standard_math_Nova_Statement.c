...
nova_VTable_nova_standard_math_Nova_Statement nova_VTable_nova_standard_math_Nova_Statement_val =
{
...
nova_standard_math_Nova_Statement* nova_standard_math_Nova_Statement_2_Nova_construct(nova_standard_math_Nova_Statement* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_VTable_nova_standard_math_Nova_Statement_val;
	...
	{
		nova_standard_math_Nova_Statement_Nova_this(this, exceptionData);
	}
