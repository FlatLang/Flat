...
nova_standard_math_Nova_InvalidNumericStatementException* nova_standard_math_Nova_InvalidNumericStatementException_Nova_InvalidNumericStatementException(nova_standard_math_Nova_InvalidNumericStatementException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_Nova_InvalidNumericStatementException_Nova_message)
{
	...
	{
		nova_standard_math_Nova_InvalidNumericStatementException_1_Nova_this(this, exceptionData, nova_standard_math_Nova_InvalidNumericStatementException_Nova_message);
	}
...
void nova_standard_math_Nova_InvalidNumericStatementException_1_Nova_this(nova_standard_math_Nova_InvalidNumericStatementException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_math_Nova_InvalidNumericStatementException_Nova_message)
{
