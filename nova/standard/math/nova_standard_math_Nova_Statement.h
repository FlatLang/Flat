#pragma once
#ifndef FILE_nova_standard_math_Nova_Statement_NOVA
#define FILE_nova_standard_math_Nova_Statement_NOVA

typedef struct nova_standard_math_Nova_Statement nova_standard_math_Nova_Statement;
...
typedef struct nova_standard_math_Extension_VTable_Statement nova_standard_math_Extension_VTable_Statement;
struct nova_standard_math_Extension_VTable_Statement
{
...
extern nova_standard_math_Extension_VTable_Statement nova_standard_math_Extension_VTable_Statement_val;


CCLASS_CLASS
(
	nova_standard_math_Nova_Statement, 
	
	nova_standard_math_Extension_VTable_Statement* vtable;
)

void nova_standard_math_Nova_Statement_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
