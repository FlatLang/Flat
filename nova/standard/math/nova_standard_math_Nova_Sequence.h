#pragma once
#ifndef FILE_nova_standard_math_Nova_Sequence_NOVA
#define FILE_nova_standard_math_Nova_Sequence_NOVA

typedef struct nova_standard_math_Nova_Sequence nova_standard_math_Nova_Sequence;
...
typedef struct nova_standard_math_Extension_VTable_Sequence nova_standard_math_Extension_VTable_Sequence;
struct nova_standard_math_Extension_VTable_Sequence
{
...
extern nova_standard_math_Extension_VTable_Sequence nova_standard_math_Extension_VTable_Sequence_val;
...
nova_standard_math_Nova_Sequence* nova_standard_math_Nova_Sequence_2_Nova_construct(nova_standard_math_Nova_Sequence* this, nova_standard_exception_Nova_ExceptionData* exceptionData, double* nova_standard_math_Nova_Sequence_Nova_values);
...
void nova_standard_math_Nova_Sequence_2_Nova_this(nova_standard_math_Nova_Sequence* this, nova_standard_exception_Nova_ExceptionData* exceptionData, double* nova_standard_math_Nova_Sequence_Nova_values);
