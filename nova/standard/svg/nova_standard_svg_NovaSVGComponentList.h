...
typedef struct nova_standard_svg_NovaSVGComponentList nova_standard_svg_NovaSVGComponentList;
...
typedef struct nova_VTable_nova_standard_svg_NovaSVGComponentList
{
...
} nova_VTable_nova_standard_svg_NovaSVGComponentList;

CCLASS_CLASS
(
	nova_standard_svg_NovaSVGComponentList, 
	
	nova_VTable_nova_standard_svg_NovaSVGComponentList* vtable;
	nova_standard_svg_NovaSVGComponentNode* nova_standard_svg_NovaSVGComponentList_Novastart;
)
