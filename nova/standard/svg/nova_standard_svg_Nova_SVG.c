...
nova_standard_svg_Nova_SVG* nova_standard_svg_Nova_SVG_Nova_SVG(nova_standard_svg_Nova_SVG* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
{
	this->nova_standard_svg_Nova_SVG_Nova_root = nova_standard_svg_Nova_SVGMainComponent_Nova_SVGMainComponent(0, exceptionData);
}
...
{
	nova_standard_io_Nova_File_Nova_write(nova_standard_svg_Nova_SVG_Nova_file, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "<html>\n"));
