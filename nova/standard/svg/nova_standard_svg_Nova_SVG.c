...
nova_standard_svg_Nova_SVG* nova_standard_svg_Nova_SVG_0_Nova_construct(nova_standard_svg_Nova_SVG* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_standard_svg_Nova_SVG_0_Nova_this(this, exceptionData);
	}
...
void nova_standard_svg_Nova_SVG_0_Nova_this(nova_standard_svg_Nova_SVG* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
{
	this->nova_standard_svg_Nova_SVG_Nova_root->vtable->nova_standard_svg_Nova_SVGMainComponent_virtual0_Nova_generateOutput(this->nova_standard_svg_Nova_SVG_Nova_root, exceptionData, nova_standard_svg_Nova_SVG_Nova_file);
}
...
{
	nova_standard_io_Nova_File_Nova_write(nova_standard_svg_Nova_SVG_Nova_file, exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "<html>\n"));
