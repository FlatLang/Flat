...
nova_VTable_nova_standard_svg_Nova_SVGComponent nova_VTable_nova_standard_svg_Nova_SVGComponent_val =
{
...
nova_standard_svg_Nova_SVGComponent* nova_standard_svg_Nova_SVGComponent_2_Nova_construct(nova_standard_svg_Nova_SVGComponent* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_VTable_nova_standard_svg_Nova_SVGComponent_val;
	...
	{
		nova_standard_svg_Nova_SVGComponent_Nova_this(this, exceptionData);
	}
