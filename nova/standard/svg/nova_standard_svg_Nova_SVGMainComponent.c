...
void nova_standard_svg_Nova_SVGMainComponent_Nova_generateOutput(nova_standard_svg_Nova_SVGMainComponent* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_io_Nova_File* nova_standard_svg_Nova_SVGMainComponent_Nova_file)
{
	nova_standard_io_Nova_File_Nova_write(nova_standard_svg_Nova_SVGMainComponent_Nova_file, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "<?xml version = '1.0' standalone = 'no'?>\n"), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "<!DOCTYPE svg PUBLIC\"-//W3C//DTD SVG1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\">"), exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "<svg width=\"1400\"px height=\"950\"px version=\"1.1\" preserveAspectRatio=\"none\">\n"))));
	...
	nova_standard_io_Nova_File_Nova_write(nova_standard_svg_Nova_SVGMainComponent_Nova_file, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "</svg>\n"));
}
