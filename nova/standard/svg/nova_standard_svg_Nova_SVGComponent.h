...
typedef struct nova_VTable_nova_standard_svg_Nova_SVGComponent
{
...
} nova_VTable_nova_standard_svg_Nova_SVGComponent;

extern nova_VTable_nova_standard_svg_Nova_SVGComponent nova_VTable_nova_standard_svg_Nova_SVGComponent_val;

CCLASS_CLASS
(
	nova_standard_svg_Nova_SVGComponent, 
	
	nova_VTable_nova_standard_svg_Nova_SVGComponent* vtable;
...
void nova_standard_svg_Nova_SVGComponent_Nova_this(nova_standard_svg_Nova_SVGComponent* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
