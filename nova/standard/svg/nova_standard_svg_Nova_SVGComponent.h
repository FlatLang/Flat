...
typedef struct nova_standard_svg_VTable_SVGComponent
{
...
} nova_standard_svg_VTable_SVGComponent;

extern nova_standard_svg_VTable_SVGComponent nova_standard_svg_VTable_SVGComponent_val;

CCLASS_CLASS
(
	nova_standard_svg_Nova_SVGComponent, 
	
	nova_standard_svg_VTable_SVGComponent* vtable;
