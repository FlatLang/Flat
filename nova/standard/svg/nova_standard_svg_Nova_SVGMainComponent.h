...
struct nova_standard_svg_Extension_VTable_SVGMainComponent
{
	...
	void (*nova_standard_svg_Nova_SVGMainComponent_virtual0_Nova_generateOutput)(nova_standard_svg_Nova_SVGMainComponent*, nova_standard_exception_Nova_ExceptionData*, nova_standard_io_Nova_File*);
};
