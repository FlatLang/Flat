...
typedef struct nova_standard_svg_VTable_SVGCircle
{
...
} nova_standard_svg_VTable_SVGCircle;

extern nova_standard_svg_VTable_SVGCircle nova_standard_svg_VTable_SVGCircle_val;

CCLASS_CLASS
(
	nova_standard_svg_Nova_SVGCircle, 
	
	nova_standard_svg_VTable_SVGCircle* vtable;
