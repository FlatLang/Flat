...
} nova_VTable_nova_standard_svg_Nova_SVGCircle;

extern nova_VTable_nova_standard_svg_Nova_SVGCircle nova_VTable_nova_standard_svg_Nova_SVGCircle_val;

CCLASS_CLASS
(
	nova_standard_svg_Nova_SVGCircle, 
	
	nova_VTable_nova_standard_svg_Nova_SVGCircle* vtable;
