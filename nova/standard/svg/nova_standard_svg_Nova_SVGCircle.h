...
struct nova_standard_svg_Extension_VTable_SVGCircle
{
	...
	nova_standard_Nova_String* (*nova_standard_Nova_Object_virtual2_Nova_toString)(nova_standard_svg_Nova_SVGCircle*, nova_standard_exception_Nova_ExceptionData*);
