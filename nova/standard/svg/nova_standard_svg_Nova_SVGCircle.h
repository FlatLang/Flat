...
struct nova_standard_svg_Extension_VTable_SVGCircle
{
	...
	nova_standard_Nova_String* (*nova_standard_Nova_Object_virtual1_Nova_toString)(nova_standard_svg_Nova_SVGCircle*, nova_standard_exception_Nova_ExceptionData*);
	...
	void (*nova_standard_svg_Nova_SVGComponent_virtual0_Nova_generateOutput)(nova_standard_svg_Nova_SVGCircle*, nova_standard_exception_Nova_ExceptionData*, nova_standard_io_Nova_File*);
};
