...
void nova_standard_svg_Nova_SVGComponentList_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
nova_standard_svg_Nova_SVGComponentList* nova_standard_svg_Nova_SVGComponentList_Nova_SVGComponentList(nova_standard_svg_Nova_SVGComponentList* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_standard_svg_Nova_SVGComponentList_0_Nova_this(this, exceptionData);
	}
...
void nova_standard_svg_Nova_SVGComponentList_0_Nova_this(nova_standard_svg_Nova_SVGComponentList* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
