...
nova_standard_svg_Extension_VTable_SVGCircle nova_standard_svg_Extension_VTable_SVGCircle_val =
{
	...
	nova_standard_svg_Nova_SVGCircle_2_Nova_toString,
...
{
	nova_standard_io_Nova_File_Nova_write(nova_standard_svg_Nova_SVGCircle_Nova_file, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "<circle cx=\""), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Double_3_Nova_toString(0, exceptionData, this->nova_standard_svg_Nova_SVGCircle_Nova_x)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "\" cy=\""), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Double_3_Nova_toString(0, exceptionData, this->nova_standard_svg_Nova_SVGCircle_Nova_y)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "\" r=\""), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Int_3_Nova_toString(0, exceptionData, this->nova_standard_svg_Nova_SVGCircle_Nova_r)), exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "\" stroke=\"false\" fill=\"black\"/>\n"))))))));
}

nova_standard_Nova_String* nova_standard_svg_Nova_SVGCircle_2_Nova_toString(nova_standard_svg_Nova_SVGCircle* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	return nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "[Circle at ("), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Double_3_Nova_toString(0, exceptionData, this->nova_standard_svg_Nova_SVGCircle_Nova_x)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, ", "), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Double_3_Nova_toString(0, exceptionData, this->nova_standard_svg_Nova_SVGCircle_Nova_y)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, ") with a radius of "), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Int_3_Nova_toString(0, exceptionData, this->nova_standard_svg_Nova_SVGCircle_Nova_r)), exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "]")))))));
}
