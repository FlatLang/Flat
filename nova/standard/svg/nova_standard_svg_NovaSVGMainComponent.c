...
nova_VTable_nova_standard_svg_NovaSVGMainComponent nova_VTable_nova_standard_svg_NovaSVGMainComponent_val =
{
	...
	nova_standard_svg_NovaSVGMainComponent_NovagenerateOutput,
};
...
{
	nova_standard_io_NovaFile_Novawrite(l0_Novafile, exceptionData, nova_standard_NovaString_Nova0_concat(nova_standard_NovaString_Nova1_construct(0, exceptionData, "<?xml version = '1.0' standalone = 'no'?>\n"), exceptionData, nova_standard_NovaString_Nova0_concat(nova_standard_NovaString_Nova1_construct(0, exceptionData, "<!DOCTYPE svg PUBLIC\"-//W3C//DTD SVG1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\">"), exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "<svg width=\"1400\"px height=\"950\"px version=\"1.1\" preserveAspectRatio=\"none\">\n"))));
	...
	nova_standard_io_NovaFile_Novawrite(l0_Novafile, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "</svg>\n"));
}
