...
nova_standard_svg_Nova_SVGComponentNode* nova_standard_svg_Nova_SVGComponentNode_0_Nova_construct(nova_standard_svg_Nova_SVGComponentNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	CCLASS_NEW(nova_standard_svg_Nova_SVGComponentNode, this,);
	this->vtable = &nova_standard_svg_Extension_VTable_SVGComponentNode_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
	nova_standard_svg_Nova_SVGComponentNode_Nova_super(this, exceptionData);
	
	{
		nova_standard_svg_Nova_SVGComponentNode_0_Nova_this(this, exceptionData);
	}
