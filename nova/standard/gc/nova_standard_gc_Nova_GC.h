...
typedef struct nova_standard_gc_Extension_VTable_GC nova_standard_gc_Extension_VTable_GC;
struct nova_standard_gc_Extension_VTable_GC
{
...
extern nova_standard_gc_Extension_VTable_GC nova_standard_gc_Extension_VTable_GC_val;
...
(
	...
	nova_standard_gc_Extension_VTable_GC* vtable;
)

void nova_standard_gc_Nova_GC_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
nova_standard_gc_Nova_GC* nova_standard_gc_Nova_GC_Nova_GC(nova_standard_gc_Nova_GC* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
