#pragma once
#ifndef FILE_StatementGroup_NOVA
#define FILE_StatementGroup_NOVA

typedef struct nova_standard_logic_NovaStatementGroup nova_standard_logic_NovaStatementGroup;
...
typedef struct nova_VTable_nova_standard_logic_NovaStatementGroup
{
	nova_standard_NovaString* (*nova_standard_NovaObject_Novavirtual0_toString)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*);
	char (*nova_standard_NovaObject_Novavirtual0_equals)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*, nova_standard_NovaObject*);
} nova_VTable_nova_standard_logic_NovaStatementGroup;

CCLASS_CLASS
(
	nova_standard_logic_NovaStatementGroup, 
	
	nova_VTable_nova_standard_logic_NovaStatementGroup* vtable;
	nova_standard_NovaObject* nova_standard_logic_NovaStatementGroup_Novastatement;
	nova_standard_datastruct_NovaBounds* nova_standard_logic_NovaStatementGroup_Novabounds;
)
