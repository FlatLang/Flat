#pragma once
#ifndef FILE_StatementComponent_NOVA
#define FILE_StatementComponent_NOVA

typedef struct nova_standard_logic_NovaStatementComponent nova_standard_logic_NovaStatementComponent;
...
typedef struct nova_VTable_nova_standard_logic_NovaStatementComponent
{
	nova_standard_NovaString* (*nova_standard_NovaObject_Novavirtual0_toString)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*);
	char (*nova_standard_NovaObject_Novavirtual0_equals)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*, nova_standard_NovaObject*);
} nova_VTable_nova_standard_logic_NovaStatementComponent;

CCLASS_CLASS
(
	nova_standard_logic_NovaStatementComponent, 
	
	nova_VTable_nova_standard_logic_NovaStatementComponent* vtable;
)
