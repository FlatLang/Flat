...
nova_VTable_nova_standard_datastruct_Nova_BinaryTree nova_VTable_nova_standard_datastruct_Nova_BinaryTree_val =
{
...
nova_standard_datastruct_Nova_BinaryTree* nova_standard_datastruct_Nova_BinaryTree_2_Nova_construct(nova_standard_datastruct_Nova_BinaryTree* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_VTable_nova_standard_datastruct_Nova_BinaryTree_val;
	...
	nova_standard_datastruct_Nova_Tree_Nova_this((nova_standard_datastruct_Nova_Tree*)(this), exceptionData);
	nova_standard_datastruct_Nova_BinaryTree_Nova_super(this, exceptionData);
	
	{
		nova_standard_datastruct_Nova_BinaryTree_Nova_this(this, exceptionData);
	}
...
void nova_standard_datastruct_Nova_BinaryTree_Nova_addNode(nova_standard_datastruct_Nova_BinaryTree* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_data)
{
	...
	{
		nova_standard_datastruct_Nova_BinaryTree_Mutator_Nova_root(this, exceptionData, nova_standard_datastruct_Nova_BinaryNode_3_Nova_construct(0, exceptionData, (nova_standard_Nova_Object*)(l0_Nova_data)));
	}
	else
	{
		nova_standard_datastruct_Nova_BinaryTree_Accessor_Nova_root(this, exceptionData);
	}
}
...
void nova_standard_datastruct_Nova_BinaryTree_Nova_super(nova_standard_datastruct_Nova_BinaryTree* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
