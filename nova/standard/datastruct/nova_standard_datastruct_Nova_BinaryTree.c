...
void nova_standard_datastruct_Nova_BinaryTree_Mutator_Nova_root(nova_standard_datastruct_Nova_BinaryTree* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_Nova_BinaryNode* nova_standard_datastruct_Nova_BinaryTree_Nova_node);
