...
{
	{
		...
		0,
		0,
		(nova_standard_Nova_Object**(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*))nova_standard_datastruct_list_Nova_Array_0_Nova_toArray,
	...
	nova_standard_datastruct_list_Nova_Array_0_Nova_toArray,
	nova_standard_datastruct_list_Nova_IntArray_Nova_map,
...
nova_standard_datastruct_list_Nova_IntArray* nova_standard_datastruct_list_Nova_IntArray_0_Nova_IntArray(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_standard_datastruct_list_Nova_IntArray_Nova_this(this, exceptionData);
	}
...
nova_standard_datastruct_list_Nova_IntArray* nova_standard_datastruct_list_Nova_IntArray_1_Nova_IntArray(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_datastruct_list_Nova_IntArray_Nova_size)
{
	...
	{
		nova_standard_datastruct_list_Nova_IntArray_0_Nova_this(this, exceptionData, nova_standard_datastruct_list_Nova_IntArray_Nova_size);
	}
...
nova_standard_datastruct_list_Nova_IntArray* nova_standard_datastruct_list_Nova_IntArray_2_Nova_IntArray(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int* nova_standard_datastruct_list_Nova_IntArray_Nova_data, int nova_standard_datastruct_list_Nova_IntArray_Nova_size)
{
	...
	{
		nova_standard_datastruct_list_Nova_IntArray_1_Nova_this(this, exceptionData, nova_standard_datastruct_list_Nova_IntArray_Nova_data, nova_standard_datastruct_list_Nova_IntArray_Nova_size);
	}
...
void nova_standard_datastruct_list_Nova_IntArray_Nova_this(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	nova_standard_datastruct_list_Nova_Array_2_Nova_this((nova_standard_datastruct_list_Nova_Array*)(this), exceptionData);
}

void nova_standard_datastruct_list_Nova_IntArray_0_Nova_this(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_datastruct_list_Nova_IntArray_Nova_size)
{
	nova_standard_datastruct_list_Nova_Array_3_Nova_this((nova_standard_datastruct_list_Nova_Array*)(this), exceptionData, nova_standard_datastruct_list_Nova_IntArray_Nova_size);
}

void nova_standard_datastruct_list_Nova_IntArray_1_Nova_this(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int* nova_standard_datastruct_list_Nova_IntArray_Nova_data, int nova_standard_datastruct_list_Nova_IntArray_Nova_size)
{
	nova_standard_datastruct_list_Nova_Array_4_Nova_this((nova_standard_datastruct_list_Nova_Array*)(this), exceptionData, (nova_standard_Nova_Object**)&(nova_standard_datastruct_list_Nova_IntArray_Nova_data), nova_standard_datastruct_list_Nova_IntArray_Nova_size);
}
...
nova_standard_datastruct_list_Nova_Array* nova_standard_datastruct_list_Nova_IntArray_Nova_map(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_list_Nova_IntArray_closure3_Nova_mapFunc nova_standard_datastruct_list_Nova_IntArray_Nova_mapFunc, void* nova_standard_datastruct_list_Nova_IntArray_ref_Nova_mapFunc)
{
	...
	int l1_Nova_i;
	nova_standard_datastruct_list_Nova_IntArrayIterator* nova_local_0;
	int l1_Nova_element;
...
{
	nova_standard_datastruct_list_Nova_IntArray* l1_Nova_filtered;
	nova_standard_datastruct_list_Nova_IntArrayIterator* nova_local_0;
	int l1_Nova_element;
	...
	{
		l1_Nova_element = (int)(nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData));
		if (nova_standard_datastruct_list_Nova_IntArray_Nova_filterFunc(nova_standard_datastruct_list_Nova_IntArray_ref_Nova_filterFunc, exceptionData, l1_Nova_element))
		{
...
nova_standard_datastruct_list_Nova_IntArray* nova_standard_datastruct_list_Nova_IntArray_Nova_take(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_datastruct_list_Nova_IntArray_Nova_howMany)
{
	...
	if (nova_standard_datastruct_list_Nova_IntArray_Nova_howMany > this->nova_standard_datastruct_list_Nova_Array_Nova_size)
	{
		nova_standard_datastruct_list_Nova_IntArray_Nova_howMany = this->nova_standard_datastruct_list_Nova_Array_Nova_size;
	}
	l1_Nova_list = nova_standard_datastruct_list_Nova_IntArray_0_Nova_IntArray(0, exceptionData);
	l3_Nova_i = (int)(0);
	for (; l3_Nova_i < nova_standard_datastruct_list_Nova_IntArray_Nova_howMany; l3_Nova_i++)
	{
...
nova_standard_datastruct_list_Nova_IntArray* nova_standard_datastruct_list_Nova_IntArray_Nova_skip(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_datastruct_list_Nova_IntArray_Nova_howMany)
{
	...
	l1_Nova_list = nova_standard_datastruct_list_Nova_IntArray_0_Nova_IntArray(0, exceptionData);
	l2_Nova_i = nova_standard_datastruct_list_Nova_IntArray_Nova_howMany;
	for (; l2_Nova_i < this->nova_standard_datastruct_list_Nova_Array_Nova_size; l2_Nova_i++)
	{
...
{
	nova_standard_datastruct_list_Nova_IntArray* l1_Nova_array;
	int l1_Nova_i;
	nova_standard_datastruct_list_Nova_IntArrayIterator* nova_local_0;
	int l1_Nova_element;
	
	l1_Nova_array = nova_standard_datastruct_list_Nova_IntArray_1_Nova_IntArray(0, exceptionData, this->nova_standard_datastruct_list_Nova_Array_Nova_size);
	...
	{
		l1_Nova_element = (int)(nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData));
		nova_standard_datastruct_list_Nova_Array_Nova_set((nova_standard_datastruct_list_Nova_Array*)(l1_Nova_array), exceptionData, this->nova_standard_datastruct_list_Nova_Array_Nova_size - ++l1_Nova_i, (nova_standard_Nova_Object*)(nova_standard_primitive_number_Nova_Int_Nova_Int(0, exceptionData, l1_Nova_element)));
	}
	return l1_Nova_array;
}
...
nova_standard_Nova_String* nova_standard_datastruct_list_Nova_IntArray_Nova_join(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_datastruct_list_Nova_IntArray_Nova_delimiter)
{
	...
	while (nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_hasNext((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData))
	{
		...
		if (l1_Nova_passed)
		{
			l1_Nova_str = (nova_standard_Nova_String*)(nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(l1_Nova_str), exceptionData, nova_standard_datastruct_list_Nova_IntArray_Nova_delimiter));
		}
		else
		{
			l1_Nova_passed = 1;
		}
		l1_Nova_str = (nova_standard_Nova_String*)(nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(l1_Nova_str), exceptionData, nova_standard_primitive_number_Nova_Int_3_Nova_toString(0, exceptionData, l1_Nova_element)));
	}
	return l1_Nova_str;
}
...
int nova_standard_datastruct_list_Nova_IntArray_Accessor_Nova_last(nova_standard_datastruct_list_Nova_IntArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	if (this->nova_standard_datastruct_list_Nova_Array_Nova_size > 0)
	{
		return (int)this->prv->nova_standard_datastruct_list_Nova_Array_Nova_data[this->nova_standard_datastruct_list_Nova_Array_Nova_size - 1];
	}
	return (int)nova_null;
}
