...
void nova_standard_datastruct_list_Nova_IntArrayIterator_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
int nova_standard_datastruct_list_Nova_IntArrayIterator_Accessor_Nova_next(nova_standard_datastruct_list_Nova_IntArrayIterator* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		return (int)(intptr_t)nova_standard_datastruct_list_Nova_Array_virtual1_Nova_get((nova_standard_datastruct_list_Nova_Array*)(this->prv->nova_standard_datastruct_list_Nova_IntArrayIterator_Nova_array), exceptionData, this->nova_standard_datastruct_list_Nova_IntArrayIterator_Nova_position++);
	}
