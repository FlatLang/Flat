...
{
	return (char)this->prv->nova_standard_datastruct_list_Nova_IntArrayIterator_Nova_array->nova_standard_datastruct_list_Nova_Array_Nova_size > this->nova_standard_datastruct_list_Nova_IntArrayIterator_Nova_position;
}
