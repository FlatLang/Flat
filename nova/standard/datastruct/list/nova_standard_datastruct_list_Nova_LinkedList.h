...
struct nova_standard_datastruct_list_Extension_VTable_LinkedList
{
	...
	nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_List_virtual1_Nova_take)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, int);
	nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_List_virtual1_Nova_skip)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, int);
	...
	nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_List_virtual1_Nova_reverse)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_List_virtual1_Nova_join)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
