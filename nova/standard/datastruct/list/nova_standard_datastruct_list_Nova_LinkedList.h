...
typedef nova_standard_Nova_Object* (*nova_standard_datastruct_list_Nova_LinkedList_closure1_Nova_mapFunc)(void*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
typedef nova_standard_Nova_Object* (*nova_standard_datastruct_list_Nova_LinkedList_closure2_Nova_mapFunc)(void*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
typedef nova_standard_Nova_Object* (*nova_standard_datastruct_list_Nova_LinkedList_closure3_Nova_mapFunc)(void*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
...
struct nova_standard_datastruct_list_Extension_VTable_LinkedList
{
	...
	nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_map)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_LinkedList_closure3_Nova_mapFunc nova_standard_datastruct_list_Nova_LinkedList_Nova_mapFunc, void* nova_standard_datastruct_list_Nova_LinkedList_ref_Nova_mapFunc);
	void (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_forEach)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_LinkedList_closure6_Nova_func nova_standard_datastruct_list_Nova_LinkedList_Nova_func, void* nova_standard_datastruct_list_Nova_LinkedList_ref_Nova_func);
	char (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_any)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_LinkedList_closure9_Nova_anyFunc nova_standard_datastruct_list_Nova_LinkedList_Nova_anyFunc, void* nova_standard_datastruct_list_Nova_LinkedList_ref_Nova_anyFunc);
	char (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_all)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_LinkedList_closure12_Nova_allFunc nova_standard_datastruct_list_Nova_LinkedList_Nova_allFunc, void* nova_standard_datastruct_list_Nova_LinkedList_ref_Nova_allFunc);
	nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_filter)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_LinkedList_closure15_Nova_filterFunc nova_standard_datastruct_list_Nova_LinkedList_Nova_filterFunc, void* nova_standard_datastruct_list_Nova_LinkedList_ref_Nova_filterFunc);
	nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_take)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, int);
	nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_skip)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, int);
	nova_standard_datastruct_list_Nova_ListNode* (*nova_standard_datastruct_list_Nova_LinkedList_Accessor0_Nova_first)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_Object* (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_last)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_Object* (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_firstWhere)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_LinkedList_closure18_Nova_func nova_standard_datastruct_list_Nova_LinkedList_Nova_func, void* nova_standard_datastruct_list_Nova_LinkedList_ref_Nova_func);
	nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_reverse)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_LinkedList_virtual0_Nova_join)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
};
