...
struct nova_standard_datastruct_list_Extension_VTable_LinkedList
{
	...
	nova_standard_Nova_Object** (*nova_standard_datastruct_list_Nova_List_virtual0_Nova_toArray)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*);
