...
nova_standard_datastruct_list_Nova_Queue* nova_standard_datastruct_list_Nova_Queue_2_Nova_construct(nova_standard_datastruct_list_Nova_Queue* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_standard_datastruct_list_Nova_Queue_2_Nova_this(this, exceptionData);
	}
...
void nova_standard_datastruct_list_Nova_Queue_2_Nova_this(nova_standard_datastruct_list_Nova_Queue* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	this->prv->nova_standard_datastruct_list_Nova_Queue_Nova_data = nova_standard_datastruct_list_Nova_Array_2_Nova_construct(0, exceptionData);
}
