...
{
	this->nova_standard_datastruct_list_Nova_IntRangeIterator_Nova_position = this->prv->nova_standard_datastruct_list_Nova_IntRangeIterator_Nova_range->nova_standard_datastruct_list_Nova_IntRange_Nova_start;
...
{
	return (char)this->nova_standard_datastruct_list_Nova_IntRangeIterator_Nova_position < this->prv->nova_standard_datastruct_list_Nova_IntRangeIterator_Nova_range->nova_standard_datastruct_list_Nova_IntRange_Nova_end;
}
...
int nova_standard_datastruct_list_Nova_IntRangeIterator_Accessor_Nova_next(nova_standard_datastruct_list_Nova_IntRangeIterator* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		return this->nova_standard_datastruct_list_Nova_IntRangeIterator_Nova_position++;
	}
