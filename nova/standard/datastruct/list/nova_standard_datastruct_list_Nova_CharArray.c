...
nova_standard_datastruct_list_Extension_VTable_CharArray nova_standard_datastruct_list_Extension_VTable_CharArray_val =
{
	{
		0,
		(nova_standard_datastruct_list_Nova_Iterator*(*)(nova_standard_datastruct_list_Nova_Iterable*, nova_standard_exception_Nova_ExceptionData*))nova_standard_datastruct_list_Nova_CharArray_Accessor_Nova_iterator,
		0,
		0,
		0,
		...
		(char(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_List_closure12_Nova_allFunc nova_standard_datastruct_list_Nova_List_Nova_allFunc, void* nova_standard_datastruct_list_Nova_List_ref_Nova_allFunc, void* allFunc_context))nova_standard_datastruct_list_Nova_CharArray_Nova_all,
		(nova_standard_datastruct_list_Nova_List*(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_List_closure15_Nova_filterFunc nova_standard_datastruct_list_Nova_List_Nova_filterFunc, void* nova_standard_datastruct_list_Nova_List_ref_Nova_filterFunc, void* filterFunc_context))nova_standard_datastruct_list_Nova_CharArray_Nova_filter,
		(nova_standard_datastruct_list_Nova_List*(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*, int))nova_standard_datastruct_list_Nova_CharArray_Nova_take,
		(nova_standard_datastruct_list_Nova_List*(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*, int))nova_standard_datastruct_list_Nova_CharArray_Nova_skip,
		(nova_standard_Nova_Object*(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_List_closure18_Nova_func nova_standard_datastruct_list_Nova_List_Nova_func, void* nova_standard_datastruct_list_Nova_List_ref_Nova_func, void* func_context))nova_standard_datastruct_list_Nova_CharArray_Nova_firstWhere,
		(nova_standard_datastruct_list_Nova_List*(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*))nova_standard_datastruct_list_Nova_CharArray_Nova_reverse,
		(nova_standard_Nova_String*(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*))nova_standard_datastruct_list_Nova_CharArray_Nova_join,
		0,
		0,
	...
	nova_standard_datastruct_list_Nova_CharArray_Accessor_Nova_iterator,
	nova_standard_datastruct_list_Nova_CharArray_Accessor_Nova_first,
	nova_standard_datastruct_list_Nova_CharArray_Accessor_Nova_last,
};
...
{
	CCLASS_NEW(nova_standard_datastruct_list_Nova_CharArray, this,);
	this->vtable = &nova_standard_datastruct_list_Extension_VTable_CharArray_val;
	...
	nova_standard_datastruct_list_Nova_CharArray_0_Nova_super(this, exceptionData);
	
	{
		nova_standard_datastruct_list_Nova_CharArray_0_Nova_this(this, exceptionData);
	}
...
nova_standard_datastruct_list_Nova_CharArray* nova_standard_datastruct_list_Nova_CharArray_1_Nova_CharArray(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_datastruct_list_Nova_CharArray_Nova_count)
{
	...
	{
		nova_standard_datastruct_list_Nova_CharArray_1_Nova_this(this, exceptionData, nova_standard_datastruct_list_Nova_CharArray_Nova_count);
	}
...
nova_standard_datastruct_list_Nova_CharArray* nova_standard_datastruct_list_Nova_CharArray_2_Nova_CharArray(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char* nova_standard_datastruct_list_Nova_CharArray_Nova_data, int nova_standard_datastruct_list_Nova_CharArray_Nova_count)
{
	...
	{
		nova_standard_datastruct_list_Nova_CharArray_2_Nova_this(this, exceptionData, nova_standard_datastruct_list_Nova_CharArray_Nova_data, nova_standard_datastruct_list_Nova_CharArray_Nova_count);
	}
...
{
	nova_standard_datastruct_list_Nova_Array_1_Nova_this((nova_standard_datastruct_list_Nova_Array*)(this), exceptionData, nova_standard_datastruct_list_Nova_CharArray_Nova_count);
}
...
{
	return ((char*)this->nova_standard_datastruct_list_Nova_Array_Nova_data)[nova_standard_datastruct_list_Nova_CharArray_Nova_index];
}
...
{
	nova_standard_datastruct_list_Nova_Array_2_Nova_this((nova_standard_datastruct_list_Nova_Array*)(this), exceptionData, (nova_standard_Nova_Object**)(nova_standard_datastruct_list_Nova_CharArray_Nova_data), nova_standard_datastruct_list_Nova_CharArray_Nova_count);
}
...
nova_standard_datastruct_list_Nova_Array* nova_standard_datastruct_list_Nova_CharArray_Nova_map(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_list_Nova_CharArray_closure3_Nova_mapFunc nova_standard_datastruct_list_Nova_CharArray_Nova_mapFunc, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_mapFunc, void* mapFunc_context)
{
	...
	int l1_Nova_i = 0;
	nova_standard_datastruct_list_Nova_CharArrayIterator* nova_local_0 = (nova_standard_datastruct_list_Nova_CharArrayIterator*)nova_null;
	char l1_Nova_element = 0;
	
	l1_Nova_array = nova_standard_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
	l1_Nova_i = (int)(0);
	nova_local_0 = (nova_standard_datastruct_list_Nova_CharArrayIterator*)(nova_standard_datastruct_list_Nova_Iterable_virtual_Accessor1_Nova_iterator((nova_standard_datastruct_list_Nova_Iterable*)((this)), exceptionData));
	...
	{
		l1_Nova_element = (char)(intptr_t)(nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData));
		nova_standard_datastruct_list_Nova_Array_0_Nova_add(l1_Nova_array, exceptionData, (nova_standard_Nova_Object*)(intptr_t)(nova_standard_datastruct_list_Nova_CharArray_Nova_mapFunc(nova_standard_datastruct_list_Nova_CharArray_ref_Nova_mapFunc, exceptionData, l1_Nova_element, l1_Nova_i++, this, mapFunc_context)));
	}
...
void nova_standard_datastruct_list_Nova_CharArray_Nova_forEach(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_list_Nova_CharArray_closure6_Nova_func nova_standard_datastruct_list_Nova_CharArray_Nova_func, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_func, void* func_context)
{
	...
	{
		nova_standard_datastruct_list_Nova_CharArray_Nova_func(nova_standard_datastruct_list_Nova_CharArray_ref_Nova_func, exceptionData, (char)(intptr_t)nova_standard_datastruct_list_Nova_Array_virtual1_Nova_get((nova_standard_datastruct_list_Nova_Array*)(this), exceptionData, l2_Nova_i), l2_Nova_i, this, func_context);
	}
}
...
char nova_standard_datastruct_list_Nova_CharArray_Nova_any(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_list_Nova_CharArray_closure9_Nova_anyFunc nova_standard_datastruct_list_Nova_CharArray_Nova_anyFunc, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_anyFunc, void* anyFunc_context)
{
	...
	{
		l1_Nova_element = (char)(intptr_t)(nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData));
		if (nova_standard_datastruct_list_Nova_CharArray_Nova_anyFunc(nova_standard_datastruct_list_Nova_CharArray_ref_Nova_anyFunc, exceptionData, l1_Nova_element, anyFunc_context))
		{
			return 1;
		}
	}
...
char nova_standard_datastruct_list_Nova_CharArray_Nova_all(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_list_Nova_CharArray_closure12_Nova_allFunc nova_standard_datastruct_list_Nova_CharArray_Nova_allFunc, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_allFunc, void* allFunc_context)
{
	...
	{
		l1_Nova_element = (char)(intptr_t)(nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData));
		if (!nova_standard_datastruct_list_Nova_CharArray_Nova_allFunc(nova_standard_datastruct_list_Nova_CharArray_ref_Nova_allFunc, exceptionData, l1_Nova_element, allFunc_context))
		{
			return 0;
		}
	}
...
{
	nova_standard_datastruct_list_Nova_CharArray* l1_Nova_filtered = (nova_standard_datastruct_list_Nova_CharArray*)nova_null;
	int l1_Nova_i = 0;
	nova_standard_datastruct_list_Nova_CharArrayIterator* nova_local_0 = (nova_standard_datastruct_list_Nova_CharArrayIterator*)nova_null;
	char l1_Nova_element = 0;
	
	l1_Nova_filtered = nova_standard_datastruct_list_Nova_CharArray_0_Nova_CharArray(0, exceptionData);
	l1_Nova_i = (int)(0);
	nova_local_0 = (nova_standard_datastruct_list_Nova_CharArrayIterator*)(nova_standard_datastruct_list_Nova_Iterable_virtual_Accessor1_Nova_iterator((nova_standard_datastruct_list_Nova_Iterable*)((this)), exceptionData));
	while (nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_hasNext((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData))
	{
		l1_Nova_element = (char)(intptr_t)(nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData));
		if (nova_standard_datastruct_list_Nova_CharArray_Nova_filterFunc(nova_standard_datastruct_list_Nova_CharArray_ref_Nova_filterFunc, exceptionData, l1_Nova_element, l1_Nova_i++, this, filterFunc_context))
		{
...
{
	nova_standard_datastruct_list_Nova_CharArray* l1_Nova_list = (nova_standard_datastruct_list_Nova_CharArray*)nova_null;
	int l3_Nova_i = 0;
	
	if (nova_standard_datastruct_list_Nova_CharArray_Nova_howMany > this->nova_standard_datastruct_list_Nova_Array_Nova_count)
	{
		nova_standard_datastruct_list_Nova_CharArray_Nova_howMany = this->nova_standard_datastruct_list_Nova_Array_Nova_count;
	}
	l1_Nova_list = nova_standard_datastruct_list_Nova_CharArray_0_Nova_CharArray(0, exceptionData);
	l3_Nova_i = (int)0;
	for (; l3_Nova_i < (int)nova_standard_datastruct_list_Nova_CharArray_Nova_howMany; l3_Nova_i++)
	{
...
nova_standard_datastruct_list_Nova_CharArray* nova_standard_datastruct_list_Nova_CharArray_Nova_skip(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_datastruct_list_Nova_CharArray_Nova_howMany)
{
	...
	l1_Nova_list = nova_standard_datastruct_list_Nova_CharArray_0_Nova_CharArray(0, exceptionData);
	l2_Nova_i = (int)nova_standard_datastruct_list_Nova_CharArray_Nova_howMany;
	for (; l2_Nova_i < (int)this->nova_standard_datastruct_list_Nova_Array_Nova_count; l2_Nova_i++)
	{
...
char nova_standard_datastruct_list_Nova_CharArray_Nova_firstWhere(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_list_Nova_CharArray_closure18_Nova_func nova_standard_datastruct_list_Nova_CharArray_Nova_func, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_func, void* func_context)
{
	...
	{
		l1_Nova_element = (char)(intptr_t)(nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData));
		if (nova_standard_datastruct_list_Nova_CharArray_Nova_func(nova_standard_datastruct_list_Nova_CharArray_ref_Nova_func, exceptionData, l1_Nova_element, func_context))
		{
...
{
	nova_standard_datastruct_list_Nova_CharArray* l1_Nova_array = (nova_standard_datastruct_list_Nova_CharArray*)nova_null;
	int l1_Nova_i = 0;
	nova_standard_datastruct_list_Nova_CharArrayIterator* nova_local_0 = (nova_standard_datastruct_list_Nova_CharArrayIterator*)nova_null;
	char l1_Nova_element = 0;
	
	l1_Nova_array = nova_standard_datastruct_list_Nova_CharArray_1_Nova_CharArray(0, exceptionData, this->nova_standard_datastruct_list_Nova_Array_Nova_count);
...
nova_standard_Nova_String* nova_standard_datastruct_list_Nova_CharArray_Nova_join(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_datastruct_list_Nova_CharArray_Nova_delimiter)
{
	...
	while (nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_hasNext((nova_standard_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData))
	{
		...
		if (l1_Nova_passed)
		{
			l1_Nova_str = (nova_standard_Nova_String*)(nova_standard_Nova_String_virtual1_Nova_concat((nova_standard_Nova_String*)(l1_Nova_str), exceptionData, nova_standard_datastruct_list_Nova_CharArray_Nova_delimiter));
		}
		else
		{
			l1_Nova_passed = 1;
		}
		l1_Nova_str = (nova_standard_Nova_String*)(nova_standard_Nova_String_virtual1_Nova_concat((nova_standard_Nova_String*)(l1_Nova_str), exceptionData, nova_standard_primitive_number_Nova_Char_2_Nova_toString(0, exceptionData, l1_Nova_element)));
	}
	return l1_Nova_str;
}
...
{
	return nova_standard_datastruct_list_Nova_CharArrayIterator_Nova_CharArrayIterator(0, exceptionData, this);
}
...
char nova_standard_datastruct_list_Nova_CharArray_Accessor_Nova_first(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		return (char)(intptr_t)this->nova_standard_datastruct_list_Nova_Array_Nova_data[0];
	}
	return (char)0;
}
...
char nova_standard_datastruct_list_Nova_CharArray_Accessor_Nova_last(nova_standard_datastruct_list_Nova_CharArray* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	if (this->nova_standard_datastruct_list_Nova_Array_Nova_count > 0)
	{
		return (char)(intptr_t)this->nova_standard_datastruct_list_Nova_Array_Nova_data[this->nova_standard_datastruct_list_Nova_Array_Nova_count - 1];
	}
	return (char)0;
}
