#pragma once
#ifndef FILE_nova_standard_datastruct_list_Nova_IntRangeIterator_NOVA
#define FILE_nova_standard_datastruct_list_Nova_IntRangeIterator_NOVA

typedef struct nova_standard_datastruct_list_Nova_IntRangeIterator nova_standard_datastruct_list_Nova_IntRangeIterator;
...
typedef struct nova_standard_datastruct_list_Extension_VTable_IntRangeIterator nova_standard_datastruct_list_Extension_VTable_IntRangeIterator;
struct nova_standard_datastruct_list_Extension_VTable_IntRangeIterator
{
	...
	nova_standard_datastruct_list_Nova_Iterator* (*nova_standard_datastruct_list_Nova_Iterator_virtual0_Nova_reset)(nova_standard_datastruct_list_Nova_IntRangeIterator*, nova_standard_exception_Nova_ExceptionData*);
	char (*nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_hasNext)(nova_standard_datastruct_list_Nova_IntRangeIterator*, nova_standard_exception_Nova_ExceptionData*);
	int (*nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next)(nova_standard_datastruct_list_Nova_IntRangeIterator*, nova_standard_exception_Nova_ExceptionData*);
};

extern nova_standard_datastruct_list_Extension_VTable_IntRangeIterator nova_standard_datastruct_list_Extension_VTable_IntRangeIterator_val;
...
(
	...
	nova_standard_datastruct_list_Extension_VTable_IntRangeIterator* vtable;
	int nova_standard_datastruct_list_Nova_IntRangeIterator_Nova_position;
	struct Private* prv;
)
