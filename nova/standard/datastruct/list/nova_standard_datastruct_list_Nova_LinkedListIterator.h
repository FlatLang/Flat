...
struct nova_standard_datastruct_list_Extension_VTable_LinkedListIterator
{
	...
	nova_standard_datastruct_list_Nova_Iterator* (*nova_standard_datastruct_list_Nova_LinkedListIterator_virtual0_Nova_reset)(nova_standard_datastruct_list_Nova_LinkedListIterator*, nova_standard_exception_Nova_ExceptionData*);
	char (*nova_standard_datastruct_list_Nova_LinkedListIterator_Accessor_Nova_hasNext)(nova_standard_datastruct_list_Nova_LinkedListIterator*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_Object* (*nova_standard_datastruct_list_Nova_LinkedListIterator_Accessor_Nova_next)(nova_standard_datastruct_list_Nova_LinkedListIterator*, nova_standard_exception_Nova_ExceptionData*);
};
