...
void nova_standard_datastruct_list_Nova_ArrayIterator_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
{
	return (char)this->prv->nova_standard_datastruct_list_Nova_ArrayIterator_Nova_array->nova_standard_datastruct_list_Nova_Array_Nova_count > this->nova_standard_datastruct_list_Nova_ArrayIterator_Nova_position;
}
