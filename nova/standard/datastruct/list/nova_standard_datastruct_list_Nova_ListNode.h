#pragma once
#ifndef FILE_nova_standard_datastruct_list_Nova_ListNode_NOVA
#define FILE_nova_standard_datastruct_list_Nova_ListNode_NOVA

typedef struct nova_standard_datastruct_list_Nova_ListNode nova_standard_datastruct_list_Nova_ListNode;
...
typedef struct nova_standard_datastruct_list_Extension_VTable_ListNode nova_standard_datastruct_list_Extension_VTable_ListNode;
struct nova_standard_datastruct_list_Extension_VTable_ListNode
{
...
extern nova_standard_datastruct_list_Extension_VTable_ListNode nova_standard_datastruct_list_Extension_VTable_ListNode_val;


CCLASS_CLASS
(
	nova_standard_datastruct_list_Nova_ListNode, 
	
	nova_standard_datastruct_list_Extension_VTable_ListNode* vtable;
	nova_standard_Nova_Object* nova_standard_datastruct_list_Nova_ListNode_Nova_data;
	nova_standard_datastruct_list_Nova_ListNode* nova_standard_datastruct_list_Nova_ListNode_Nova_next;
)
