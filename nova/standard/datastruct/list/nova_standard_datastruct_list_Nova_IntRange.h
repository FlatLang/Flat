...
struct nova_standard_datastruct_list_Extension_VTable_IntRange
{
	...
	int* (*nova_standard_datastruct_list_Nova_List_virtual0_Nova_toArray)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*);
