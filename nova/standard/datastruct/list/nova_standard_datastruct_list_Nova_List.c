...
nova_standard_datastruct_list_Extension_VTable_List nova_standard_datastruct_list_Extension_VTable_List_val =
{
	...
	nova_standard_datastruct_list_Nova_List_virtual0_Nova_first,
	nova_standard_datastruct_list_Nova_List_virtual0_Nova_last,
...
{
	return this->vtable->itable.nova_standard_datastruct_list_Nova_List_virtual0_Nova_first((nova_standard_datastruct_list_Nova_List*)(this), exceptionData);
}
...
{
	return this->vtable->itable.nova_standard_datastruct_list_Nova_List_virtual0_Nova_last((nova_standard_datastruct_list_Nova_List*)(this), exceptionData);
}
