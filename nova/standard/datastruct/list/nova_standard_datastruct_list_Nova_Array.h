...
struct nova_standard_datastruct_list_Extension_VTable_Array
{
	...
	nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_Array_virtual_Nova_reverse)(nova_standard_datastruct_list_Nova_Array*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_Array_virtual_Nova_join)(nova_standard_datastruct_list_Nova_Array*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
};
