...
nova_standard_datastruct_list_Nova_EmptyStackException* nova_standard_datastruct_list_Nova_EmptyStackException_0_Nova_construct(nova_standard_datastruct_list_Nova_EmptyStackException* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_standard_datastruct_list_Nova_NoSuchElementException_2_Nova_super((nova_standard_datastruct_list_Nova_NoSuchElementException*)this, exceptionData);
...
{
	nova_standard_datastruct_list_Nova_EmptyStackException_1_Nova_this(this, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, ""));
}
