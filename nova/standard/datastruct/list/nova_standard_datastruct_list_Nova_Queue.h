...
struct nova_standard_datastruct_list_Extension_VTable_Queue
{
	...
	nova_standard_Nova_String* (*nova_standard_Nova_Object_virtual1_Nova_toString)(nova_standard_datastruct_list_Nova_Queue*, nova_standard_exception_Nova_ExceptionData*);
