#pragma once
#ifndef FILE_nova_standard_datastruct_list_Nova_DoubleArrayIterator_NOVA
#define FILE_nova_standard_datastruct_list_Nova_DoubleArrayIterator_NOVA

typedef struct nova_standard_datastruct_list_Nova_DoubleArrayIterator nova_standard_datastruct_list_Nova_DoubleArrayIterator;
...
typedef struct nova_standard_datastruct_list_Extension_VTable_DoubleArrayIterator nova_standard_datastruct_list_Extension_VTable_DoubleArrayIterator;
struct nova_standard_datastruct_list_Extension_VTable_DoubleArrayIterator
{
	...
	nova_standard_datastruct_list_Nova_Iterator* (*nova_standard_datastruct_list_Nova_Iterator_virtual0_Nova_reset)(nova_standard_datastruct_list_Nova_DoubleArrayIterator*, nova_standard_exception_Nova_ExceptionData*);
	char (*nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_hasNext)(nova_standard_datastruct_list_Nova_DoubleArrayIterator*, nova_standard_exception_Nova_ExceptionData*);
	double (*nova_standard_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_next)(nova_standard_datastruct_list_Nova_DoubleArrayIterator*, nova_standard_exception_Nova_ExceptionData*);
};

extern nova_standard_datastruct_list_Extension_VTable_DoubleArrayIterator nova_standard_datastruct_list_Extension_VTable_DoubleArrayIterator_val;
...
(
	...
	nova_standard_datastruct_list_Extension_VTable_DoubleArrayIterator* vtable;
	int nova_standard_datastruct_list_Nova_DoubleArrayIterator_Nova_position;
	struct Private* prv;
)
