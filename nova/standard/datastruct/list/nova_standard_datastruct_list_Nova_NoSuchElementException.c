...
{
	nova_standard_datastruct_list_Nova_NoSuchElementException_1_Nova_this(this, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "No such element"));
}
