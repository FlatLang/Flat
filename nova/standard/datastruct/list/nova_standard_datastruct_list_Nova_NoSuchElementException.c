...
nova_standard_datastruct_list_Nova_NoSuchElementException* nova_standard_datastruct_list_Nova_NoSuchElementException_1_Nova_construct(nova_standard_datastruct_list_Nova_NoSuchElementException* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
nova_standard_datastruct_list_Nova_NoSuchElementException* nova_standard_datastruct_list_Nova_NoSuchElementException_2_Nova_construct(nova_standard_datastruct_list_Nova_NoSuchElementException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_datastruct_list_Nova_NoSuchElementException_Nova_message)
{
	CCLASS_NEW(nova_standard_datastruct_list_Nova_NoSuchElementException, this,);
	this->vtable = &nova_standard_datastruct_list_Extension_VTable_NoSuchElementException_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
...
{
	nova_standard_datastruct_list_Nova_NoSuchElementException_2_Nova_this(this, exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "No such element"));
}
