...
struct nova_standard_datastruct_list_Extension_VTable_ArrayIterator
{
	...
	nova_standard_datastruct_list_Nova_Iterator* (*nova_standard_datastruct_list_Nova_ArrayIterator_virtual_Nova_reset)(nova_standard_datastruct_list_Nova_ArrayIterator*, nova_standard_exception_Nova_ExceptionData*);
	char (*nova_standard_datastruct_list_Nova_ArrayIterator_Accessor_Nova_hasNext)(nova_standard_datastruct_list_Nova_ArrayIterator*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_Object* (*nova_standard_datastruct_list_Nova_ArrayIterator_Accessor_Nova_next)(nova_standard_datastruct_list_Nova_ArrayIterator*, nova_standard_exception_Nova_ExceptionData*);
};
