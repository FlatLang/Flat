...
long nova_standard_datastruct_list_Nova_Array_Nova_sum(nova_standard_datastruct_list_Nova_Array* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	long l1_Nova_sum;
