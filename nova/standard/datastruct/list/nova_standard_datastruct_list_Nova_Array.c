...
{
	{
		...
		(nova_standard_Nova_Object*(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*))nova_standard_datastruct_list_Nova_Array_0_Nova_first,
		(nova_standard_Nova_Object*(*)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*))nova_standard_datastruct_list_Nova_Array_0_Nova_last,
	...
	nova_standard_datastruct_list_Nova_Array_0_Nova_first,
	nova_standard_datastruct_list_Nova_Array_0_Nova_last,
...
nova_standard_Nova_Object* nova_standard_datastruct_list_Nova_Array_0_Nova_first(nova_standard_datastruct_list_Nova_Array* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
nova_standard_Nova_Object* nova_standard_datastruct_list_Nova_Array_0_Nova_last(nova_standard_datastruct_list_Nova_Array* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	if (this->nova_standard_datastruct_list_Nova_Array_Nova_size > 0)
	{
