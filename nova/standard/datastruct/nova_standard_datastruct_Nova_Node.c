...
nova_VTable_nova_standard_datastruct_Nova_Node nova_VTable_nova_standard_datastruct_Nova_Node_val =
{
...
nova_standard_datastruct_Nova_Node* nova_standard_datastruct_Nova_Node_2_Nova_construct(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_VTable_nova_standard_datastruct_Nova_Node_val;
	...
	{
		nova_standard_datastruct_Nova_Node_Nova_this(this, exceptionData);
	}
...
nova_standard_datastruct_Nova_Node* nova_standard_datastruct_Nova_Node_3_Nova_construct(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_data)
{
	...
	{
		nova_standard_datastruct_Nova_Node_0_Nova_this(this, exceptionData, l0_Nova_data);
	}
...
nova_standard_datastruct_Nova_Node* nova_standard_datastruct_Nova_Node_4_Nova_construct(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int l0_Nova_numChildren)
{
	...
	{
		nova_standard_datastruct_Nova_Node_0_Nova_this(this, exceptionData, (nova_standard_Nova_Object*)(nova_standard_primitive_number_Nova_Int_7_Nova_construct(0, exceptionData, l0_Nova_numChildren)));
	}
...
nova_standard_datastruct_Nova_Node* nova_standard_datastruct_Nova_Node_5_Nova_construct(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_data, int l0_Nova_numChildren)
{
	...
	{
		nova_standard_datastruct_Nova_Node_2_Nova_this(this, exceptionData, l0_Nova_data, l0_Nova_numChildren);
	}
...
void nova_standard_datastruct_Nova_Node_Nova_this(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	nova_standard_datastruct_Nova_Node_0_Nova_this(this, exceptionData, (nova_standard_Nova_Object*)((nova_standard_Nova_Object*)nova_null));
}

void nova_standard_datastruct_Nova_Node_0_Nova_this(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_data)
{
...
void nova_standard_datastruct_Nova_Node_1_Nova_this(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int l0_Nova_numChildren)
{
	nova_standard_datastruct_Nova_Node_2_Nova_this(this, exceptionData, (nova_standard_Nova_Object*)((nova_standard_Nova_Object*)nova_null), l0_Nova_numChildren);
}

void nova_standard_datastruct_Nova_Node_2_Nova_this(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_data, int l0_Nova_numChildren)
{
...
nova_standard_Nova_String* nova_standard_datastruct_Nova_Node_Nova_preorder(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	nova_standard_Nova_String* l1_Nova_str;
	int l3_Nova_i;
	
	l1_Nova_str = nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "");
	l1_Nova_str = l1_Nova_str->vtable->nova_standard_Nova_String_virtual0_Nova_concat(l1_Nova_str, exceptionData, this->nova_standard_datastruct_Nova_Node_Nova_data->vtable->nova_standard_Nova_Object_virtual0_Nova_toString((nova_standard_Nova_Object*)(this->nova_standard_datastruct_Nova_Node_Nova_data), exceptionData));
	if (this->nova_standard_datastruct_Nova_Node_Nova_children->nova_standard_datastruct_Nova_ArrayList_Nova_size > 0)
	{
	...
	l3_Nova_i = 0;
	for (; l3_Nova_i < this->nova_standard_datastruct_Nova_Node_Nova_children->nova_standard_datastruct_Nova_ArrayList_Nova_size; l3_Nova_i++)
	{
		nova_standard_datastruct_Nova_Node* l3_Nova_child;
		nova_standard_Nova_String* nova_local_0;
		
		l3_Nova_child = (nova_standard_datastruct_Nova_Node*)(((nova_standard_datastruct_Nova_Node*)nova_standard_datastruct_Nova_ArrayList_Nova_get(this->nova_standard_datastruct_Nova_Node_Nova_children, exceptionData, l3_Nova_i)));
		nova_local_0 = nova_standard_datastruct_Nova_Node_Nova_preorder(l3_Nova_child, exceptionData);
