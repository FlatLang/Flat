...
void nova_standard_datastruct_Nova_Node_Nova_destroy(nova_standard_datastruct_Nova_Node** this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_standard_datastruct_Nova_Array_Nova_destroy(&(*this)->nova_standard_datastruct_Nova_Node_Nova_children, exceptionData);
...
{
	this->nova_standard_datastruct_Nova_Node_Nova_children = nova_standard_datastruct_Nova_Array_2_Nova_construct(0, exceptionData);
...
{
	this->nova_standard_datastruct_Nova_Node_Nova_children = nova_standard_datastruct_Nova_Array_3_Nova_construct(0, exceptionData, nova_standard_datastruct_Nova_Node_Nova_numChildren);
	this->nova_standard_datastruct_Nova_Node_Nova_data = nova_standard_datastruct_Nova_Node_Nova_data;
}
...
nova_standard_Nova_String* nova_standard_datastruct_Nova_Node_0_Nova_inorder(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_str = nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "");
	l1_Nova_i = 0;
	for (; l1_Nova_i < this->nova_standard_datastruct_Nova_Node_Nova_children->nova_standard_datastruct_Nova_Array_Nova_size / 2; l1_Nova_i++)
	{
		nova_standard_datastruct_Nova_Node* l1_Nova_child;
	...
	l1_Nova_str = l1_Nova_str->vtable->nova_standard_Nova_String_virtual0_Nova_concat(l1_Nova_str, exceptionData, ((nova_standard_Nova_Object*)this->nova_standard_datastruct_Nova_Node_Nova_data)->vtable->nova_standard_Nova_Object_virtual0_Nova_toString(this->nova_standard_datastruct_Nova_Node_Nova_data, exceptionData));
	l2_Nova_i = this->nova_standard_datastruct_Nova_Node_Nova_children->nova_standard_datastruct_Nova_Array_Nova_size / 2;
	for (; l2_Nova_i < this->nova_standard_datastruct_Nova_Node_Nova_children->nova_standard_datastruct_Nova_Array_Nova_size; l2_Nova_i++)
	{
		nova_standard_datastruct_Nova_Node* l2_Nova_child;
		
		l2_Nova_child = (nova_standard_datastruct_Nova_Node*)(nova_standard_datastruct_Nova_Array_Nova_get(this->nova_standard_datastruct_Nova_Node_Nova_children, exceptionData, l2_Nova_i));
...
nova_standard_Nova_String* nova_standard_datastruct_Nova_Node_Nova_levelorder(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	while (!nova_standard_datastruct_Nova_Queue_Nova_isEmpty(l1_Nova_queue, exceptionData))
	{
		...
		l3_Nova_i = 0;
		for (; l3_Nova_i < l1_Nova_current->nova_standard_datastruct_Nova_Node_Nova_children->nova_standard_datastruct_Nova_Array_Nova_size; l3_Nova_i++)
		{
			nova_standard_datastruct_Nova_Node* l3_Nova_node;
			
			l3_Nova_node = (nova_standard_datastruct_Nova_Node*)(nova_standard_datastruct_Nova_Array_Nova_get(l1_Nova_current->nova_standard_datastruct_Nova_Node_Nova_children, exceptionData, l3_Nova_i));
...
void nova_standard_datastruct_Nova_Node_Nova_super(nova_standard_datastruct_Nova_Node* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->nova_standard_datastruct_Nova_Node_Nova_children = (nova_standard_datastruct_Nova_Array*)nova_null;
}
