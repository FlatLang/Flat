...
typedef struct nova_VTable_nova_standard_datastruct_Nova_ListNode
{
...
} nova_VTable_nova_standard_datastruct_Nova_ListNode;

extern nova_VTable_nova_standard_datastruct_Nova_ListNode nova_VTable_nova_standard_datastruct_Nova_ListNode_val;

CCLASS_CLASS
(
	nova_standard_datastruct_Nova_ListNode, 
	
	nova_VTable_nova_standard_datastruct_Nova_ListNode* vtable;
