#pragma once
#ifndef FILE_nova_standard_datastruct_Nova_Queue_NOVA
#define FILE_nova_standard_datastruct_Nova_Queue_NOVA

typedef struct nova_standard_datastruct_Nova_Queue nova_standard_datastruct_Nova_Queue;
...
typedef struct nova_standard_datastruct_Extension_VTable_Queue nova_standard_datastruct_Extension_VTable_Queue;
struct nova_standard_datastruct_Extension_VTable_Queue
{
	...
	nova_standard_Nova_String* (*nova_standard_datastruct_Nova_Queue_virtual0_Nova_toString)(nova_standard_datastruct_Nova_Queue*, nova_standard_exception_Nova_ExceptionData*);
	char (*nova_standard_Nova_Object_virtual0_Nova_equals)(nova_standard_Nova_Object*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
};

extern nova_standard_datastruct_Extension_VTable_Queue nova_standard_datastruct_Extension_VTable_Queue_val;


CCLASS_CLASS
(
	nova_standard_datastruct_Nova_Queue, 
	
	nova_standard_datastruct_Extension_VTable_Queue* vtable;
	struct Private* prv;
)
