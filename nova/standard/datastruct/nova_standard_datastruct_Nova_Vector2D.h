...
(
	...
	nova_standard_primitive_number_Nova_Number* nova_standard_datastruct_Nova_Vector2D_Nova_x;
	nova_standard_primitive_number_Nova_Number* nova_standard_datastruct_Nova_Vector2D_Nova_y;
)
