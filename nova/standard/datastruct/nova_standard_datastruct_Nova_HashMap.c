...
void nova_standard_datastruct_Nova_HashMap_Nova_put(nova_standard_datastruct_Nova_HashMap* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_key, nova_standard_Nova_Object* l0_Nova_value)
{
	...
	hashmapInsert(this->prv->nova_standard_datastruct_Nova_HashMap_Nova_map, l0_Nova_value, (long_long)(l0_Nova_key->vtable->nova_standard_Nova_Object_virtual1_Nova_getHashCodeLong(l0_Nova_key, exceptionData)));
}
...
{
	return ((nova_standard_Nova_Object*)hashmapGet(this->prv->nova_standard_datastruct_Nova_HashMap_Nova_map, (long_long)(l0_Nova_key->vtable->nova_standard_Nova_Object_virtual1_Nova_getHashCodeLong(l0_Nova_key, exceptionData))));
}
...
nova_standard_Nova_Object* nova_standard_datastruct_Nova_HashMap_Nova_remove(nova_standard_datastruct_Nova_HashMap* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_key)
{
	...
	l1_Nova_val = (nova_standard_Nova_Object*)(((nova_standard_Nova_Object*)nova_standard_datastruct_Nova_HashMap_Nova_get(this, exceptionData, l0_Nova_key)));
	hashmapRemove(this->prv->nova_standard_datastruct_Nova_HashMap_Nova_map, (long_long)(l0_Nova_key->vtable->nova_standard_Nova_Object_virtual1_Nova_getHashCodeLong(l0_Nova_key, exceptionData)));
...
{
	return hashmapContains(this->prv->nova_standard_datastruct_Nova_HashMap_Nova_map, (long_long)(l0_Nova_key->vtable->nova_standard_Nova_Object_virtual1_Nova_getHashCodeLong(l0_Nova_key, exceptionData)));
}
