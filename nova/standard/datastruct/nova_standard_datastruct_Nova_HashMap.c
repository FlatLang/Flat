...
nova_VTable_nova_standard_datastruct_Nova_HashMap nova_VTable_nova_standard_datastruct_Nova_HashMap_val =
{
...
nova_standard_datastruct_Nova_HashMap* nova_standard_datastruct_Nova_HashMap_2_Nova_construct(nova_standard_datastruct_Nova_HashMap* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_VTable_nova_standard_datastruct_Nova_HashMap_val;
	...
	{
		nova_standard_datastruct_Nova_HashMap_Nova_this(this, exceptionData);
	}
...
void nova_standard_datastruct_Nova_HashMap_Nova_this(nova_standard_datastruct_Nova_HashMap* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
{
	if (nova_standard_datastruct_Nova_HashMap_Nova_containsKey(this, exceptionData, l0_Nova_key))
	{
		return;
	}
	hashmapInsert(this->prv->nova_standard_datastruct_Nova_HashMap_Nova_map, l0_Nova_value, (long_long)(l0_Nova_key->vtable->nova_standard_Nova_Object_virtual0_Nova_getHashCodeLong((nova_standard_Nova_Object*)(l0_Nova_key), exceptionData)));
}
...
{
	return ((nova_standard_Nova_Object*)hashmapGet(this->prv->nova_standard_datastruct_Nova_HashMap_Nova_map, (long_long)(l0_Nova_key->vtable->nova_standard_Nova_Object_virtual0_Nova_getHashCodeLong((nova_standard_Nova_Object*)(l0_Nova_key), exceptionData))));
}
...
nova_standard_Nova_Object* nova_standard_datastruct_Nova_HashMap_Nova_remove(nova_standard_datastruct_Nova_HashMap* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_key)
{
	...
	hashmapRemove(this->prv->nova_standard_datastruct_Nova_HashMap_Nova_map, (long_long)(l0_Nova_key->vtable->nova_standard_Nova_Object_virtual0_Nova_getHashCodeLong((nova_standard_Nova_Object*)(l0_Nova_key), exceptionData)));
	return l1_Nova_val;
}
...
{
	return hashmapContains(this->prv->nova_standard_datastruct_Nova_HashMap_Nova_map, (long_long)(l0_Nova_key->vtable->nova_standard_Nova_Object_virtual0_Nova_getHashCodeLong((nova_standard_Nova_Object*)(l0_Nova_key), exceptionData)));
}
