...
nova_standard_datastruct_Nova_ArrayList* nova_standard_datastruct_Nova_ArrayList_2_Nova_construct(nova_standard_datastruct_Nova_ArrayList* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_standard_datastruct_Nova_ArrayList_Nova_this(this, exceptionData);
	}
...
nova_standard_datastruct_Nova_ArrayList* nova_standard_datastruct_Nova_ArrayList_3_Nova_construct(nova_standard_datastruct_Nova_ArrayList* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int l0_Nova_size)
{
	...
	{
		nova_standard_datastruct_Nova_ArrayList_0_Nova_this(this, exceptionData, l0_Nova_size);
	}
...
void nova_standard_datastruct_Nova_ArrayList_Nova_this(nova_standard_datastruct_Nova_ArrayList* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	nova_standard_datastruct_Nova_ArrayList_0_Nova_this(this, exceptionData, 10);
}

void nova_standard_datastruct_Nova_ArrayList_0_Nova_this(nova_standard_datastruct_Nova_ArrayList* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int l0_Nova_size)
{
...
{
	nova_standard_datastruct_Nova_ArrayList_0_Nova_add(this, exceptionData, l0_Nova_element);
...
void nova_standard_datastruct_Nova_ArrayList_Nova_shiftRight(nova_standard_datastruct_Nova_ArrayList* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int l0_Nova_left, int l0_Nova_right)
{
	...
	l2_Nova_i = l0_Nova_right - 1;
	for (; l2_Nova_i > l0_Nova_left; l2_Nova_i--)
	{
		this->prv->nova_standard_datastruct_Nova_ArrayList_Nova_data[l2_Nova_i] = this->prv->nova_standard_datastruct_Nova_ArrayList_Nova_data[l2_Nova_i - 1];
	}
...
void nova_standard_datastruct_Nova_ArrayList_Nova_shiftLeft(nova_standard_datastruct_Nova_ArrayList* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int l0_Nova_left, int l0_Nova_right)
{
	...
	l2_Nova_i = l0_Nova_left - 1;
	for (; l2_Nova_i < l0_Nova_right - 1; l2_Nova_i++)
	{
		this->prv->nova_standard_datastruct_Nova_ArrayList_Nova_data[l2_Nova_i] = this->prv->nova_standard_datastruct_Nova_ArrayList_Nova_data[l2_Nova_i + 1];
	}
...
nova_standard_Nova_Object** nova_standard_datastruct_Nova_ArrayList_Nova_toArray(nova_standard_datastruct_Nova_ArrayList* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	l2_Nova_i = 0;
	for (; l2_Nova_i < this->nova_standard_datastruct_Nova_ArrayList_Nova_size; l2_Nova_i++)
	{
		l1_Nova_array[l2_Nova_i] = this->prv->nova_standard_datastruct_Nova_ArrayList_Nova_data[l2_Nova_i];
	}
}
