#pragma once
#ifndef FILE_Queue_NOVA
#define FILE_Queue_NOVA

typedef struct nova_standard_datastruct_NovaQueue nova_standard_datastruct_NovaQueue;
...
typedef struct nova_VTable_nova_standard_datastruct_NovaQueue
{
	...
	nova_standard_NovaString* (*nova_standard_datastruct_NovaQueue_Novavirtual0_toString)(nova_standard_datastruct_NovaQueue*, nova_standard_exception_NovaExceptionData*);
	char (*nova_standard_NovaObject_Novavirtual0_equals)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*, nova_standard_NovaObject*);
} nova_VTable_nova_standard_datastruct_NovaQueue;

CCLASS_CLASS
(
	nova_standard_datastruct_NovaQueue, 
	
	nova_VTable_nova_standard_datastruct_NovaQueue* vtable;
	int nova_standard_datastruct_NovaQueue_Novasize;
	struct Private* prv;
)
