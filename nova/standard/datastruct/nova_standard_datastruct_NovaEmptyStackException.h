...
typedef struct nova_standard_datastruct_NovaEmptyStackException nova_standard_datastruct_NovaEmptyStackException;
...
typedef struct nova_VTable_nova_standard_datastruct_NovaEmptyStackException
{
	nova_standard_NovaString* (*nova_standard_NovaObject_Novavirtual0_toString)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*);
	char (*nova_standard_NovaObject_Novavirtual0_equals)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*, nova_standard_NovaObject*);
} nova_VTable_nova_standard_datastruct_NovaEmptyStackException;

CCLASS_CLASS
(
	nova_standard_datastruct_NovaEmptyStackException, 
	
	nova_VTable_nova_standard_datastruct_NovaEmptyStackException* vtable;
)

nova_standard_datastruct_NovaEmptyStackException* nova_standard_datastruct_NovaEmptyStackException_Novaconstruct(nova_standard_datastruct_NovaEmptyStackException* this, nova_standard_exception_NovaExceptionData* exceptionData);
