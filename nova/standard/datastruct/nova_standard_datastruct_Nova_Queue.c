...
nova_VTable_nova_standard_datastruct_Nova_Queue nova_VTable_nova_standard_datastruct_Nova_Queue_val =
{
...
nova_standard_datastruct_Nova_Queue* nova_standard_datastruct_Nova_Queue_2_Nova_construct(nova_standard_datastruct_Nova_Queue* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_VTable_nova_standard_datastruct_Nova_Queue_val;
	...
	{
		nova_standard_datastruct_Nova_Queue_Nova_this(this, exceptionData);
	}
...
void nova_standard_datastruct_Nova_Queue_Nova_this(nova_standard_datastruct_Nova_Queue* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
{
	return ((nova_standard_Nova_Object*)nova_standard_datastruct_Nova_ArrayList_Nova_remove(this->prv->nova_standard_datastruct_Nova_Queue_Nova_data, exceptionData, 0));
}
...
nova_standard_Nova_String* nova_standard_datastruct_Nova_Queue_0_Nova_toString(nova_standard_datastruct_Nova_Queue* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	l2_Nova_i = nova_standard_datastruct_Nova_Queue_Accessor_Nova_size(this, exceptionData) - 1;
	for (; l2_Nova_i >= 0; l2_Nova_i--)
	{
		if (l2_Nova_i < nova_standard_datastruct_Nova_Queue_Accessor_Nova_size(this, exceptionData) - 1)
		{
		...
		l1_Nova_s = l1_Nova_s->vtable->nova_standard_Nova_String_virtual0_Nova_concat(l1_Nova_s, exceptionData, ((nova_standard_Nova_Object*)nova_standard_datastruct_Nova_ArrayList_Nova_get(this->prv->nova_standard_datastruct_Nova_Queue_Nova_data, exceptionData, l2_Nova_i))->vtable->nova_standard_Nova_Object_virtual0_Nova_toString((nova_standard_Nova_Object*)(((nova_standard_Nova_Object*)nova_standard_datastruct_Nova_ArrayList_Nova_get(this->prv->nova_standard_datastruct_Nova_Queue_Nova_data, exceptionData, l2_Nova_i))), exceptionData));
	}
	return l1_Nova_s;
}
