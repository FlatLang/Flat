...
nova_standard_datastruct_Nova_BinaryNode* nova_standard_datastruct_Nova_BinaryNode_0_Nova_construct(nova_standard_datastruct_Nova_BinaryNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_Nova_Comparable* nova_standard_datastruct_Nova_BinaryNode_Nova_data)
{
	CCLASS_NEW(nova_standard_datastruct_Nova_BinaryNode, this,);
	this->vtable = &nova_standard_datastruct_Extension_VTable_BinaryNode_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
...
nova_standard_datastruct_Nova_BinaryNode* nova_standard_datastruct_Nova_BinaryNode_1_Nova_construct(nova_standard_datastruct_Nova_BinaryNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_datastruct_Nova_Comparable* nova_standard_datastruct_Nova_BinaryNode_Nova_data, int nova_standard_datastruct_Nova_BinaryNode_Nova_size)
{
	CCLASS_NEW(nova_standard_datastruct_Nova_BinaryNode, this,);
	this->vtable = &nova_standard_datastruct_Extension_VTable_BinaryNode_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
