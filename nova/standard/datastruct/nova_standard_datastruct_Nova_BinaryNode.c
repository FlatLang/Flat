...
nova_standard_datastruct_Nova_BinaryNode* nova_standard_datastruct_Nova_BinaryNode_Nova_construct(nova_standard_datastruct_Nova_BinaryNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
nova_standard_datastruct_Nova_BinaryNode* nova_standard_datastruct_Nova_BinaryNode_0_Nova_construct(nova_standard_datastruct_Nova_BinaryNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_datastruct_Nova_BinaryNode_Nova_data)
{
	CCLASS_NEW(nova_standard_datastruct_Nova_BinaryNode, this,);
	this->vtable = &nova_standard_datastruct_Extension_VTable_BinaryNode_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
...
void nova_standard_datastruct_Nova_BinaryNode_0_Nova_this(nova_standard_datastruct_Nova_BinaryNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_datastruct_Nova_BinaryNode_Nova_data)
{
...
void nova_standard_datastruct_Nova_BinaryNode_1_Nova_this(nova_standard_datastruct_Nova_BinaryNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_datastruct_Nova_BinaryNode_Nova_data, int nova_standard_datastruct_Nova_BinaryNode_Nova_size)
{
...
void nova_standard_datastruct_Nova_BinaryNode_Nova_addChild(nova_standard_datastruct_Nova_BinaryNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_datastruct_Nova_BinaryNode_Nova_data)
{
	...
	if (l1_Nova_temp->vtable->itable.nova_standard_datastruct_Nova_Comparable_virtual0_Nova_compareTo(l1_Nova_temp, exceptionData, nova_standard_datastruct_Nova_BinaryNode_Nova_data) >= 0)
	{
		...
		{
			nova_standard_datastruct_Nova_BinaryNode_Mutator_Nova_left(this, exceptionData, nova_standard_datastruct_Nova_BinaryNode_0_Nova_construct(0, exceptionData, nova_standard_datastruct_Nova_BinaryNode_Nova_data));
		}
		else
		{
	...
	else
	{
		...
		{
			nova_standard_datastruct_Nova_BinaryNode_Mutator_Nova_right(this, exceptionData, nova_standard_datastruct_Nova_BinaryNode_0_Nova_construct(0, exceptionData, nova_standard_datastruct_Nova_BinaryNode_Nova_data));
		}
		else
		{
