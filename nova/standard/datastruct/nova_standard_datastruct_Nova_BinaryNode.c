...
void nova_standard_datastruct_Nova_BinaryNode_Nova_addChild(nova_standard_datastruct_Nova_BinaryNode* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_data)
{
	...
	if (l1_Nova_temp->vtable->nova_standard_datastruct_Nova_Comparable_virtual0_Nova_compareTo(l1_Nova_temp, exceptionData, (nova_standard_Nova_Object*)(nova_standard_primitive_number_Nova_Int_7_Nova_construct(0, exceptionData, (int)l0_Nova_data))) < 0)
	{
