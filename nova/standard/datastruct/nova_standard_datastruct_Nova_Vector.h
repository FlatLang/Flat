#pragma once
#ifndef FILE_nova_standard_datastruct_Nova_Vector_NOVA
#define FILE_nova_standard_datastruct_Nova_Vector_NOVA

typedef struct nova_standard_datastruct_Nova_Vector nova_standard_datastruct_Nova_Vector;
...
typedef struct nova_standard_datastruct_Extension_VTable_Vector nova_standard_datastruct_Extension_VTable_Vector;
struct nova_standard_datastruct_Extension_VTable_Vector
{
...
extern nova_standard_datastruct_Extension_VTable_Vector nova_standard_datastruct_Extension_VTable_Vector_val;


CCLASS_CLASS
(
	nova_standard_datastruct_Nova_Vector, 
	
	nova_standard_datastruct_Extension_VTable_Vector* vtable;
)

void nova_standard_datastruct_Nova_Vector_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
nova_standard_datastruct_Nova_Vector* nova_standard_datastruct_Nova_Vector_Nova_Vector(nova_standard_datastruct_Nova_Vector* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
