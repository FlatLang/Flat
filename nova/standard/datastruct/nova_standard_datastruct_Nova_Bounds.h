...
struct nova_standard_datastruct_Extension_VTable_Bounds
{
	...
	nova_standard_Nova_String* (*nova_standard_datastruct_Nova_Bounds_virtual1_Nova_toString)(nova_standard_datastruct_Nova_Bounds*, nova_standard_exception_Nova_ExceptionData*);
