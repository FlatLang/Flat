...
struct nova_standard_datastruct_Extension_VTable_ReversibleHashMap
{
	...
	void (*nova_standard_datastruct_Nova_HashMap_virtual0_Nova_put)(nova_standard_datastruct_Nova_ReversibleHashMap*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*, nova_standard_Nova_Object*);
};
