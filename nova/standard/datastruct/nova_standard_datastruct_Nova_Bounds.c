...
nova_standard_datastruct_Nova_Bounds* nova_standard_datastruct_Nova_Bounds_3_Nova_construct(nova_standard_datastruct_Nova_Bounds* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_datastruct_Nova_Bounds_Nova_start, int nova_standard_datastruct_Nova_Bounds_Nova_end)
{
	CCLASS_NEW(nova_standard_datastruct_Nova_Bounds, this,);
	this->vtable = &nova_standard_datastruct_Extension_VTable_Bounds_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
	...
	{
		nova_standard_datastruct_Nova_Bounds_3_Nova_this(this, exceptionData, nova_standard_datastruct_Nova_Bounds_Nova_start, nova_standard_datastruct_Nova_Bounds_Nova_end);
	}
...
void nova_standard_datastruct_Nova_Bounds_3_Nova_this(nova_standard_datastruct_Nova_Bounds* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_datastruct_Nova_Bounds_Nova_start, int nova_standard_datastruct_Nova_Bounds_Nova_end)
{
...
nova_standard_Nova_String* nova_standard_datastruct_Nova_Bounds_Nova_trimString(nova_standard_datastruct_Nova_Bounds* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_datastruct_Nova_Bounds_Nova_source)
{
	...
	nova_local_0 = nova_standard_datastruct_Nova_Bounds_Nova_extractPreString(this, exceptionData, nova_standard_datastruct_Nova_Bounds_Nova_source);
