...
nova_VTable_nova_standard_NovaFile nova_VTable_nova_standard_NovaFile_val =
{
...
CCLASS_PRIVATE
(
	FILE* nova_standard_NovaFile_Novafp;
	nova_standard_NovaString* nova_standard_NovaFile_Novalocation;
...
{
	CCLASS_NEW(nova_standard_NovaFile, this);
	this->vtable = &nova_VTable_nova_standard_NovaFile_val;
	nova_standard_NovaObject_Novasuper((nova_standard_NovaObject*)this, 0);
	nova_standard_NovaObject_Novathis((nova_standard_NovaObject*)(this), exceptionData);
	nova_standard_NovaFile_Novasuper(this, 0);
	
	{
		nova_standard_NovaFile_Novanull0_this(this, exceptionData, l0_Novalocation);
	}
...
nova_standard_NovaFile* nova_standard_NovaFile_Novanull2_construct(nova_standard_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData, FILE* l0_Novafp)
{
	...
	{
		nova_standard_NovaFile_Novanull1_this(this, exceptionData, l0_Novafp);
	}
...
void nova_del_File(nova_standard_NovaFile** this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	nova_del_String(&(*this)->prv->nova_standard_NovaFile_Novalocation, exceptionData);
	NOVA_FREE((*this)->prv);
...
{
	this->prv->nova_standard_NovaFile_Novalocation = l0_Novalocation;
	this->prv->nova_standard_NovaFile_Novafp = fopen(nova_standard_NovaString_NovatoCharArray(l0_Novalocation, exceptionData), "r+");
}
...
{
	this->prv->nova_standard_NovaFile_Novafp = l0_Novafp;
}
...
{
	nova_standard_NovaFile_Novaclose(this, exceptionData);
	return remove(nova_standard_NovaString_NovatoCharArray(this->prv->nova_standard_NovaFile_Novalocation, exceptionData)) == 0;
}
...
{
	nova_standard_NovaFile_Novaclose(this, exceptionData);
	this->prv->nova_standard_NovaFile_Novafp = fopen(nova_standard_NovaString_NovatoCharArray(this->prv->nova_standard_NovaFile_Novalocation, exceptionData), "r+");
}
...
{
	rewind(this->prv->nova_standard_NovaFile_Novafp);
}
...
{
	return this->prv->nova_standard_NovaFile_Novafp != 0;
}
...
{
	if (nova_standard_NovaFile_Novaexists(this, exceptionData))
	{
		this->prv->nova_standard_NovaFile_Novafp = fopen(nova_standard_NovaString_NovatoCharArray(this->prv->nova_standard_NovaFile_Novalocation, exceptionData), "w");
	}
}
...
char nova_standard_NovaFile_Novacreate(nova_standard_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	if (!nova_standard_NovaFile_Novaexists(this, exceptionData))
	{
		...
		nova_standard_NovaFile_Novareopen(this, exceptionData);
		if (!nova_standard_NovaFile_Novaexists(this, exceptionData))
		{
			perror("fopen");
			return 0;
...
nova_standard_NovaString* nova_standard_NovaFile_NovareadAllContents(nova_standard_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	l1_Novaline = nova_standard_NovaFile_NovareadLine(this, exceptionData);
...
nova_standard_NovaString* nova_standard_NovaFile_NovareadLine(nova_standard_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	l1_Novac = getc(this->prv->nova_standard_NovaFile_Novafp);
	if (l1_Novac == EOF)
	{
...
{
	nova_standard_NovaFile_Novawrite(this, exceptionData, l0_Novaline->vtable->nova_standard_NovaString_Novavirtual0_concat(l0_Novaline, exceptionData, nova_standard_NovaString_Novaconstruct(0, exceptionData, "\n")));
}
...
{
	fputs(nova_standard_NovaString_NovatoCharArray(l0_Novadata, exceptionData), this->prv->nova_standard_NovaFile_Novafp);
	nova_standard_NovaFile_Novaflush(this, exceptionData);
}
...
{
	fflush(this->prv->nova_standard_NovaFile_Novafp);
}
...
void nova_standard_NovaFile_Novaclose(nova_standard_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	if (nova_standard_NovaFile_Novaexists(this, exceptionData))
	{
		fclose(this->prv->nova_standard_NovaFile_Novafp);
	}
}
...
void nova_standard_NovaFile_static_NovasetMaxOpenFiles(nova_standard_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData, int l0_Novanum)
{
	...
	if (l0_Novanum > l1_Novamax || l0_Novanum < l1_Novamin)
	{
		...
		nova_local_0 = nova_standard_NovaInt_Novanull2_toString(nova_standard_NovaInt_Novaconstruct(0, exceptionData, l0_Novanum), exceptionData);
		nova_local_1 = nova_standard_NovaShort_Novanull2_toString(nova_standard_NovaShort_Novaconstruct(0, exceptionData, l1_Novamin), exceptionData);
		nova_standard_NovaConsole_static_Novanull0_writeLine(0, exceptionData, nova_standard_NovaString_Novanull0_concat(nova_standard_NovaString_Novaconstruct(0, exceptionData, "Invalid max number of open files: "), exceptionData, nova_local_0->vtable->nova_standard_NovaString_Novavirtual0_concat(nova_local_0, exceptionData, nova_standard_NovaString_Novanull0_concat(nova_standard_NovaString_Novaconstruct(0, exceptionData, "\nValid values include "), exceptionData, nova_local_1->vtable->nova_standard_NovaString_Novavirtual0_concat(nova_local_1, exceptionData, nova_standard_NovaString_Novanull0_concat(nova_standard_NovaString_Novaconstruct(0, exceptionData, "-"), exceptionData, nova_standard_NovaShort_Novanull2_toString(nova_standard_NovaShort_Novaconstruct(0, exceptionData, l1_Novamax), exceptionData)))))));
	}
	else
	{
...
{
	this->prv->nova_standard_NovaFile_Novafp = (FILE*)nova_null;
	this->prv->nova_standard_NovaFile_Novalocation = (nova_standard_NovaString*)nova_null;
}
