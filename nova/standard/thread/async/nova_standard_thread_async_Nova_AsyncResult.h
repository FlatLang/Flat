#pragma once
#ifndef FILE_nova_standard_thread_async_Nova_AsyncResult_NOVA
#define FILE_nova_standard_thread_async_Nova_AsyncResult_NOVA

typedef struct nova_standard_thread_async_Nova_AsyncResult nova_standard_thread_async_Nova_AsyncResult;
...
typedef struct nova_standard_thread_async_Extension_VTable_AsyncResult nova_standard_thread_async_Extension_VTable_AsyncResult;
struct nova_standard_thread_async_Extension_VTable_AsyncResult
{
...
extern nova_standard_thread_async_Extension_VTable_AsyncResult nova_standard_thread_async_Extension_VTable_AsyncResult_val;


CCLASS_CLASS
(
	nova_standard_thread_async_Nova_AsyncResult, 
	
	nova_standard_thread_async_Extension_VTable_AsyncResult* vtable;
)
