...
typedef struct nova_VTable_nova_standard_thread_Nova_UncaughtExceptionHandler
{
	...
	void (*nova_standard_thread_Nova_UncaughtExceptionHandler_virtual0_Nova_uncaughtException)(nova_standard_thread_Nova_UncaughtExceptionHandler*, nova_standard_exception_Nova_ExceptionData*, nova_standard_thread_Nova_Thread*, nova_standard_exception_Nova_Exception*);
} nova_VTable_nova_standard_thread_Nova_UncaughtExceptionHandler;

extern nova_VTable_nova_standard_thread_Nova_UncaughtExceptionHandler nova_VTable_nova_standard_thread_Nova_UncaughtExceptionHandler_val;

CCLASS_CLASS
(
	nova_standard_thread_Nova_UncaughtExceptionHandler, 
	
	nova_VTable_nova_standard_thread_Nova_UncaughtExceptionHandler* vtable;
)
