...
struct nova_standard_thread_Extension_VTable_Thread
{
	...
	void (*nova_standard_thread_Nova_Thread_virtual1_Nova_run)(nova_standard_thread_Nova_Thread*, nova_standard_exception_Nova_ExceptionData*);
};
...
nova_standard_thread_Nova_Thread* nova_standard_thread_Nova_Thread_Nova_Thread(nova_standard_thread_Nova_Thread* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
