...
typedef struct nova_VTable_nova_standard_thread_Nova_Thread
{
...
} nova_VTable_nova_standard_thread_Nova_Thread;

extern nova_VTable_nova_standard_thread_Nova_Thread nova_VTable_nova_standard_thread_Nova_Thread_val;

CCLASS_CLASS
(
	nova_standard_thread_Nova_Thread, 
	
	nova_VTable_nova_standard_thread_Nova_Thread* vtable;
	struct Private* prv;
)
