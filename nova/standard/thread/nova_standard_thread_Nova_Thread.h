...
typedef struct nova_standard_thread_VTable_Thread
{
...
} nova_standard_thread_VTable_Thread;

extern nova_standard_thread_VTable_Thread nova_standard_thread_VTable_Thread_val;

CCLASS_CLASS
(
	nova_standard_thread_Nova_Thread, 
	
	nova_standard_thread_VTable_Thread* vtable;
	struct Private* prv;
)
