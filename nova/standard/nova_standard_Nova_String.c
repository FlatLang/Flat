...
char nova_standard_Nova_String_Nova_equals(nova_standard_Nova_String* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_other)
{
	...
	{
		if (this->nova_standard_Nova_String_Nova_chars[l2_Nova_i] != l0_Nova_other->nova_standard_Nova_String_Nova_chars[l2_Nova_i])
		{
			return 0;
		}
	}
...
int nova_standard_Nova_String_0_Nova_indexOf(nova_standard_Nova_String* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_search, int l0_Nova_start, int l0_Nova_direction)
{
	...
	for (; l1_Nova_i < this->nova_standard_Nova_String_Nova_length && l1_Nova_i >= 0; l1_Nova_i = l1_Nova_i + l0_Nova_direction)
	{
		char l1_Nova_found;
		int l2_Nova_j;
		...
		l1_Nova_found = 1;
		l2_Nova_j = 0;
		for (; l2_Nova_j < l0_Nova_search->nova_standard_Nova_String_Nova_length && l1_Nova_i + l2_Nova_j < this->nova_standard_Nova_String_Nova_length && l1_Nova_found; l2_Nova_j++)
		{
			if (l0_Nova_search->nova_standard_Nova_String_Nova_chars[l2_Nova_j] != this->nova_standard_Nova_String_Nova_chars[l1_Nova_i + l2_Nova_j])
			{
				l1_Nova_found = 0;
			}
		}
...
nova_standard_Nova_String* nova_standard_Nova_String_Nova_changeCase(nova_standard_Nova_String* this, nova_standard_exception_Nova_ExceptionData* exceptionData, l0_3_Nova_transform l0_Nova_transform, void* l0_ref_Nova_transform)
{
	...
	l1_Nova_i = 0;
	for (; l1_Nova_i < this->nova_standard_Nova_String_Nova_length; l1_Nova_i++)
	{
		l1_Nova_newData[l1_Nova_i] = l0_Nova_transform(l0_ref_Nova_transform, exceptionData, this->nova_standard_Nova_String_Nova_chars[l1_Nova_i]);
	}
