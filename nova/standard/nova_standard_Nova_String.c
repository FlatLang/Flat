...
nova_standard_Nova_String* nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_Nova_String_Nova_str)
{
	...
	nova_standard_Nova_String_Nova_str = nova_standard_Nova_String_0_Nova_toString(nova_standard_Nova_String_Nova_str, exceptionData);
	...
	l1_Nova_newStr = nova_standard_Nova_String_2_Nova_construct(0, exceptionData, l1_Nova_newData);
...
{
	return nova_standard_Nova_String_Nova_compareTo(this, exceptionData, nova_standard_Nova_String_Nova_other) == 0;
}
...
nova_standard_Nova_String* nova_standard_Nova_String_0_Nova_substring(nova_standard_Nova_String* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_Nova_String_Nova_start, int nova_standard_Nova_String_Nova_end)
{
	...
	{
		return nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "");
	}
	else if (nova_standard_Nova_String_Nova_end - nova_standard_Nova_String_Nova_start < 0)
	{
		THROW(1, nova_standard_exception_Nova_Exception_4_Nova_construct(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Substring bounds of ["), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, nova_standard_Nova_String_Nova_start), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, ", "), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, nova_standard_Nova_String_Nova_end), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "] are invalid")))))));
	}
	...
	return nova_standard_Nova_String_2_Nova_construct(0, exceptionData, l1_Nova_buf);
}
...
nova_standard_Nova_String* nova_standard_Nova_String_Nova_transform(nova_standard_Nova_String* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String_closure3_Nova_transform nova_standard_Nova_String_Nova_transform, void* nova_standard_Nova_String_ref_Nova_transform)
{
	...
	return nova_standard_Nova_String_2_Nova_construct(0, exceptionData, l1_Nova_newData);
}
