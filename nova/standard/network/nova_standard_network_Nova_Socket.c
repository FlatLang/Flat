...
void nova_standard_network_Nova_Socket_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

nova_standard_network_Nova_Socket* nova_standard_network_Nova_Socket_Nova_Socket(nova_standard_network_Nova_Socket* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_standard_network_Nova_Socket_0_Nova_this(this, exceptionData);
	}
...
void nova_standard_network_Nova_Socket_0_Nova_this(nova_standard_network_Nova_Socket* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
