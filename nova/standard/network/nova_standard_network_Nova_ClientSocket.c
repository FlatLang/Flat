...
void nova_standard_network_Nova_ClientSocket_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
{
	this->prv->nova_standard_network_Nova_ClientSocket_Nova_socket = nova_clientsocket_connect((char*)(nova_standard_network_Nova_ClientSocket_Nova_ipAddress->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), nova_standard_network_Nova_ClientSocket_Nova_port);
