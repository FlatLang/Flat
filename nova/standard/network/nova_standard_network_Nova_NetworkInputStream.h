...
struct nova_standard_network_Extension_VTable_NetworkInputStream
{
	...
	nova_standard_Nova_String* (*nova_standard_network_Nova_NetworkInputStream_virtual0_Nova_readString)(nova_standard_network_Nova_NetworkInputStream*, nova_standard_exception_Nova_ExceptionData*);
	char* (*nova_standard_network_Nova_NetworkInputStream_virtual0_Nova_readBytes)(nova_standard_network_Nova_NetworkInputStream*, nova_standard_exception_Nova_ExceptionData*);
};
