...
struct nova_standard_network_Extension_VTable_NetworkInputStream
{
	...
	char* (*nova_standard_io_Nova_InputStream_virtual1_Nova_readBytes)(nova_standard_network_Nova_NetworkInputStream*, nova_standard_exception_Nova_ExceptionData*);
};
