...
struct nova_standard_network_Extension_VTable_NetworkOutputStream
{
	...
	char (*nova_standard_network_Nova_NetworkOutputStream_virtual0_Nova_write)(nova_standard_network_Nova_NetworkOutputStream*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
	char (*nova_standard_network_Nova_NetworkOutputStream_virtual1_Nova_write)(nova_standard_network_Nova_NetworkOutputStream*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
};
