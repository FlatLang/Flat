...
nova_VTable_nova_standard_network_Nova_ConnectionSocket nova_VTable_nova_standard_network_Nova_ConnectionSocket_val =
{
...
nova_standard_Nova_String* nova_standard_network_Nova_ConnectionSocket_1_Nova_readString(nova_standard_network_Nova_ConnectionSocket* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char l0_Nova_checkBuffer);
...
nova_standard_network_Nova_ConnectionSocket* nova_standard_network_Nova_ConnectionSocket_Nova_construct(nova_standard_network_Nova_ConnectionSocket* this, nova_standard_exception_Nova_ExceptionData* exceptionData, SOCKET_ID_TYPE l0_Nova_socket)
{
	...
	this->vtable = &nova_VTable_nova_standard_network_Nova_ConnectionSocket_val;
	...
	nova_standard_network_Nova_Socket_Nova_this((nova_standard_network_Nova_Socket*)(this), exceptionData);
	nova_standard_network_Nova_ConnectionSocket_Nova_super(this, exceptionData);
	
	{
		nova_standard_network_Nova_ConnectionSocket_Nova_this(this, exceptionData, l0_Nova_socket);
	}
...
void nova_standard_network_Nova_ConnectionSocket_Nova_destroy(nova_standard_network_Nova_ConnectionSocket** this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_standard_datastruct_Nova_Queue_Nova_destroy(&(*this)->prv->nova_standard_network_Nova_ConnectionSocket_Nova_inputBuffer, exceptionData);
	
	NOVA_FREE((*this)->prv);
	
	nova_standard_io_Nova_InputStream_Nova_destroy(&(*this)->nova_standard_network_Nova_ConnectionSocket_Nova_in, exceptionData);
...
{
	this->prv->nova_standard_network_Nova_ConnectionSocket_Nova_socket = l0_Nova_socket;
	this->nova_standard_network_Nova_ConnectionSocket_Nova_in = (nova_standard_io_Nova_InputStream*)(nova_standard_network_Nova_NetworkInputStream_3_Nova_construct(0, exceptionData, this));
	this->nova_standard_network_Nova_ConnectionSocket_Nova_out = (nova_standard_io_Nova_OutputStream*)(nova_standard_network_Nova_NetworkOutputStream_3_Nova_construct(0, exceptionData, this));
...
char nova_standard_network_Nova_ConnectionSocket_Nova_validateConnection(nova_standard_network_Nova_ConnectionSocket* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	if (this->nova_standard_network_Nova_ConnectionSocket_Nova_connected)
	{
		nova_standard_datastruct_Nova_Queue_Nova_enqueue(this->prv->nova_standard_network_Nova_ConnectionSocket_Nova_inputBuffer, exceptionData, (nova_standard_Nova_Object*)(l1_Nova_message));
	}
	return this->nova_standard_network_Nova_ConnectionSocket_Nova_connected;
}
...
nova_standard_Nova_String* nova_standard_network_Nova_ConnectionSocket_1_Nova_readString(nova_standard_network_Nova_ConnectionSocket* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char l0_Nova_checkBuffer)
{
	if (!l0_Nova_checkBuffer || nova_standard_datastruct_Nova_Queue_Nova_isEmpty(this->prv->nova_standard_network_Nova_ConnectionSocket_Nova_inputBuffer, exceptionData))
	{
		char* l2_Nova_data;
		
		l2_Nova_data = (char*)(nova_socket_receive(this->prv->nova_standard_network_Nova_ConnectionSocket_Nova_socket));
		if (l2_Nova_data == 0)
		{
			this->nova_standard_network_Nova_ConnectionSocket_Nova_connected = 0;
			return (nova_standard_Nova_String*)nova_null;
		}
		return nova_standard_Nova_String_1_Nova_construct(0, exceptionData, l2_Nova_data);
	}
...
char nova_standard_network_Nova_ConnectionSocket_Nova_write(nova_standard_network_Nova_ConnectionSocket* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* l0_Nova_data)
{
	...
	l1_Nova_success = nova_socket_send(this->prv->nova_standard_network_Nova_ConnectionSocket_Nova_socket, (char*)(l0_Nova_data->nova_standard_Nova_String_Nova_chars)) == 1;
	return l1_Nova_success;
}

void nova_standard_network_Nova_ConnectionSocket_Nova_super(nova_standard_network_Nova_ConnectionSocket* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	this->nova_standard_network_Nova_ConnectionSocket_Nova_connected = 0;
	...
	this->prv->nova_standard_network_Nova_ConnectionSocket_Nova_inputBuffer = (nova_standard_datastruct_Nova_Queue*)nova_null;
	this->prv->nova_standard_network_Nova_ConnectionSocket_Nova_socket = 0;
	this->prv->nova_standard_network_Nova_ConnectionSocket_Nova_inputBuffer = nova_standard_datastruct_Nova_Queue_2_Nova_construct(0, exceptionData);
}
