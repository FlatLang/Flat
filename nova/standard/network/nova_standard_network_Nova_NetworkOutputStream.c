...
nova_standard_network_Nova_NetworkOutputStream* nova_standard_network_Nova_NetworkOutputStream_3_Nova_construct(nova_standard_network_Nova_NetworkOutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_network_Nova_ConnectionSocket* l0_Nova_socket)
{
	...
	nova_standard_io_Nova_OutputStream_Nova_this((nova_standard_io_Nova_OutputStream*)(this), exceptionData);
	nova_standard_network_Nova_NetworkOutputStream_Nova_super(this, exceptionData);
	
	{
		nova_standard_network_Nova_NetworkOutputStream_Nova_this(this, exceptionData, l0_Nova_socket);
	}
...
void nova_standard_network_Nova_NetworkOutputStream_Nova_this(nova_standard_network_Nova_NetworkOutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_network_Nova_ConnectionSocket* l0_Nova_socket)
{
	this->prv->nova_standard_network_Nova_NetworkOutputStream_Nova_socket = l0_Nova_socket;
}
...
{
	return nova_standard_network_Nova_ConnectionSocket_Nova_write(this->prv->nova_standard_network_Nova_NetworkOutputStream_Nova_socket, exceptionData, l0_Nova_data);
}
...
void nova_standard_network_Nova_NetworkOutputStream_Nova_super(nova_standard_network_Nova_NetworkOutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
