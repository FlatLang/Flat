...
typedef struct nova_VTable_nova_standard_network_Nova_Socket
{
...
} nova_VTable_nova_standard_network_Nova_Socket;

extern nova_VTable_nova_standard_network_Nova_Socket nova_VTable_nova_standard_network_Nova_Socket_val;

CCLASS_CLASS
(
	nova_standard_network_Nova_Socket, 
	
	nova_VTable_nova_standard_network_Nova_Socket* vtable;
...
void nova_standard_network_Nova_Socket_Nova_this(nova_standard_network_Nova_Socket* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
