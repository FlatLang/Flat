...
nova_standard_primitive_Nova_Null* nova_standard_primitive_Nova_Null_1_Nova_construct(nova_standard_primitive_Nova_Null* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_primitive_Nova_Null_Nova_c)
{
	CCLASS_NEW(nova_standard_primitive_Nova_Null, this,);
	this->vtable = &nova_standard_primitive_Extension_VTable_Null_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
	...
	{
		nova_standard_primitive_Nova_Null_1_Nova_this(this, exceptionData, nova_standard_primitive_Nova_Null_Nova_c);
	}
	
	return this;
}

nova_standard_primitive_Nova_Null* nova_standard_primitive_Nova_Null_2_Nova_construct(nova_standard_primitive_Nova_Null* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char* nova_standard_primitive_Nova_Null_Nova_chars)
{
	CCLASS_NEW(nova_standard_primitive_Nova_Null, this,);
	this->vtable = &nova_standard_primitive_Extension_VTable_Null_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
	...
	{
		nova_standard_primitive_Nova_Null_2_Nova_this(this, exceptionData, nova_standard_primitive_Nova_Null_Nova_chars);
	}
...
void nova_standard_primitive_Nova_Null_1_Nova_this(nova_standard_primitive_Nova_Null* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_primitive_Nova_Null_Nova_c)
{
}

void nova_standard_primitive_Nova_Null_2_Nova_this(nova_standard_primitive_Nova_Null* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char* nova_standard_primitive_Nova_Null_Nova_chars)
{
}
