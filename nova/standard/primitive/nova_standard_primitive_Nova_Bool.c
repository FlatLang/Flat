...
nova_standard_primitive_Nova_Bool* nova_standard_primitive_Nova_Bool_3_Nova_construct(nova_standard_primitive_Nova_Bool* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_primitive_Nova_Bool_Nova_value)
{
	...
	{
		nova_standard_primitive_Nova_Bool_3_Nova_this(this, exceptionData, nova_standard_primitive_Nova_Bool_Nova_value);
	}
...
void nova_standard_primitive_Nova_Bool_3_Nova_this(nova_standard_primitive_Nova_Bool* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_primitive_Nova_Bool_Nova_value)
{
	this->nova_standard_primitive_Nova_Bool_Nova_value = nova_standard_primitive_Nova_Bool_Nova_value;
}

nova_standard_Nova_String* nova_standard_primitive_Nova_Bool_1_Nova_toString(nova_standard_primitive_Nova_Bool* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_primitive_Nova_Bool_Nova_value)
{
	if (nova_standard_primitive_Nova_Bool_Nova_value)
	{
		return nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "true");
	}
	return nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "false");
}
...
{
	return nova_standard_primitive_Nova_Bool_1_Nova_toString(this, exceptionData, this->nova_standard_primitive_Nova_Bool_Nova_value);
}

char nova_standard_primitive_Nova_Bool_Nova_compareTo(nova_standard_primitive_Nova_Bool* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_primitive_Nova_Bool* nova_standard_primitive_Nova_Bool_Nova_prim)
{
	char l1_Nova_other;
