...
{
	return nova_standard_primitive_number_Nova_Double_0_Nova_numDigits(0, exceptionData, (double)(nova_standard_primitive_number_Nova_Float_Nova_number));
}

nova_standard_Nova_String* nova_standard_primitive_number_Nova_Float_1_Nova_toString(nova_standard_primitive_number_Nova_Float* this, nova_standard_exception_Nova_ExceptionData* exceptionData, float nova_standard_primitive_number_Nova_Float_Nova_value)
{
	return nova_standard_primitive_number_Nova_Double_1_Nova_toString(0, exceptionData, (double)(nova_standard_primitive_number_Nova_Float_Nova_value));
}
...
float nova_standard_primitive_number_Nova_Float_0_Nova_compareTo(nova_standard_primitive_number_Nova_Float* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_primitive_number_Nova_Float* nova_standard_primitive_number_Nova_Float_Nova_prim)
{
	...
	l1_Nova_other = nova_standard_primitive_number_Nova_Float_Nova_prim->nova_standard_primitive_number_Nova_Float_Nova_value;
	return this->nova_standard_primitive_number_Nova_Float_Nova_value - l1_Nova_other;
}

float nova_standard_primitive_number_Nova_Float_1_Nova_multiply(nova_standard_primitive_number_Nova_Float* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_primitive_number_Nova_Float* nova_standard_primitive_number_Nova_Float_Nova_prim)
{
	float l1_Nova_value;
	
	l1_Nova_value = nova_standard_primitive_number_Nova_Float_Nova_prim->nova_standard_primitive_number_Nova_Float_Nova_value;
