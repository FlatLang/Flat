...
nova_standard_primitive_number_Extension_VTable_Long nova_standard_primitive_number_Extension_VTable_Long_val =
{
	...
	nova_standard_primitive_number_Nova_Long_4_Nova_toString,
...
{
	{
		...
		nova_standard_primitive_number_Nova_Long_Nova_MIN_VALUE = (-9223372036854775807LL - 1);
	}
}
...
nova_standard_primitive_number_Nova_Long* nova_standard_primitive_number_Nova_Long_Nova_Long(nova_standard_primitive_number_Nova_Long* this, nova_standard_exception_Nova_ExceptionData* exceptionData, long_long nova_standard_primitive_number_Nova_Long_Nova_value)
{
	...
	nova_standard_primitive_number_Nova_Long_2_Nova_super(this, exceptionData);
...
int nova_standard_primitive_number_Nova_Long_0_Nova_numDigits(nova_standard_primitive_number_Nova_Long* this, nova_standard_exception_Nova_ExceptionData* exceptionData, long_long nova_standard_primitive_number_Nova_Long_Nova_number)
{
	...
	while (nova_standard_primitive_number_Nova_Long_Nova_number != 0)
	{
		nova_standard_primitive_number_Nova_Long_Nova_number = nova_standard_primitive_number_Nova_Long_Nova_number / 10;
		l1_Nova_size++;
	}
...
nova_standard_Nova_String* nova_standard_primitive_number_Nova_Long_3_Nova_toString(nova_standard_primitive_number_Nova_Long* this, nova_standard_exception_Nova_ExceptionData* exceptionData, long_long nova_standard_primitive_number_Nova_Long_Nova_value)
{
...
nova_standard_Nova_String* nova_standard_primitive_number_Nova_Long_4_Nova_toString(nova_standard_primitive_number_Nova_Long* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	return nova_standard_primitive_number_Nova_Long_3_Nova_toString(0, exceptionData, this->nova_standard_primitive_number_Nova_Long_Nova_value);
}
...
{
	return this->nova_standard_primitive_number_Nova_Long_Nova_value - nova_standard_primitive_number_Nova_Long_Nova_other;
}
...
{
	return this->nova_standard_primitive_number_Nova_Long_Nova_value * nova_standard_primitive_number_Nova_Long_Nova_value;
}
