...
nova_standard_Nova_String* nova_standard_primitive_number_Nova_Double_Nova_genString(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char* nova_standard_primitive_number_Nova_Double_Nova_buffer, int nova_standard_primitive_number_Nova_Double_Nova_lastIndex)
{
	...
	return nova_standard_Nova_String_1_Nova_construct(0, exceptionData, nova_standard_primitive_number_Nova_Double_Nova_buffer);
}
...
nova_standard_Nova_String* nova_standard_primitive_number_Nova_Double_1_Nova_toString(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, double nova_standard_primitive_number_Nova_Double_Nova_value)
{
	char* l1_Nova_buffer;
	int l1_Nova_size;
...
double nova_standard_primitive_number_Nova_Double_1_Nova_multiply(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_primitive_number_Nova_Double* nova_standard_primitive_number_Nova_Double_Nova_prim)
{
