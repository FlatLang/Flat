...
{
	{
		(int(*)(nova_standard_datastruct_Nova_Comparable*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*))nova_standard_primitive_number_Nova_Double_0_Nova_compareTo,
		0,
		0,
		0,
		0,
...
nova_standard_primitive_number_Nova_Double* nova_standard_primitive_number_Nova_Double_Nova_construct(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, double nova_standard_primitive_number_Nova_Double_Nova_value)
{
	...
	nova_standard_primitive_number_Nova_Double_2_Nova_super(this, exceptionData);
	
	{
		nova_standard_primitive_number_Nova_Double_Nova_this(this, exceptionData, nova_standard_primitive_number_Nova_Double_Nova_value);
	}
...
{
	this->nova_standard_primitive_number_Nova_Double_Nova_value = nova_standard_primitive_number_Nova_Double_Nova_value;
}
...
int nova_standard_primitive_number_Nova_Double_0_Nova_numDigits(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, double nova_standard_primitive_number_Nova_Double_Nova_number)
{
	...
	if (nova_standard_primitive_number_Nova_Double_Nova_number < 0)
	{
		return nova_standard_primitive_number_Nova_Double_0_Nova_numDigits((nova_standard_primitive_number_Nova_Double*)nova_null, exceptionData, -nova_standard_primitive_number_Nova_Double_Nova_number) + 1;
	}
...
{
	nova_standard_primitive_number_Nova_Double_Nova_buffer = (char*)(realloc((char*)(nova_standard_primitive_number_Nova_Double_Nova_buffer), (int)(++nova_standard_primitive_number_Nova_Double_Nova_lastIndex + 1)));
...
char* nova_standard_primitive_number_Nova_Double_Nova_genBuffer(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, double nova_standard_primitive_number_Nova_Double_Nova_value)
{
	...
	sprintf((char*)(l1_Nova_buffer), (char*)("%.15f"), (double)(nova_standard_primitive_number_Nova_Double_Nova_value));
...
int nova_standard_primitive_number_Nova_Double_Nova_repetition(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char* nova_standard_primitive_number_Nova_Double_Nova_buffer, int nova_standard_primitive_number_Nova_Double_Nova_start)
{
	...
	l1_Nova_index = nova_standard_primitive_number_Nova_Double_Nova_start;
	l1_Nova_c = nova_standard_primitive_number_Nova_Double_Nova_buffer[l1_Nova_index];
	while (nova_standard_primitive_number_Nova_Double_Nova_buffer[--l1_Nova_index] == l1_Nova_c);
	return nova_standard_primitive_number_Nova_Double_Nova_start - l1_Nova_index - 1;
}
...
{
	while (nova_standard_primitive_number_Nova_Double_Nova_buffer[nova_standard_primitive_number_Nova_Double_Nova_start--] == '0');
	return nova_standard_primitive_number_Nova_Double_Nova_start + 1;
}
...
nova_standard_Nova_String* nova_standard_primitive_number_Nova_Double_2_Nova_toString(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, double nova_standard_primitive_number_Nova_Double_Nova_value)
{
	...
	l1_Nova_buffer = nova_standard_primitive_number_Nova_Double_Nova_genBuffer((nova_standard_primitive_number_Nova_Double*)nova_null, exceptionData, nova_standard_primitive_number_Nova_Double_Nova_value);
...
{
	return nova_standard_primitive_number_Nova_Double_2_Nova_toString(this, exceptionData, this->nova_standard_primitive_number_Nova_Double_Nova_value);
}
...
double nova_standard_primitive_number_Nova_Double_Nova_parseDouble(nova_standard_primitive_number_Nova_Double* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_primitive_number_Nova_Double_Nova_str)
{
	...
	return (double)strtod((char*)(nova_standard_primitive_number_Nova_Double_Nova_str->nova_standard_Nova_String_Nova_chars), (char**)&(l1_Nova_pEnd));
}
