...
struct nova_standard_primitive_number_Extension_VTable_Float
{
	...
	float (*nova_standard_primitive_number_Nova_Float_virtual0_Nova_multiply)(nova_standard_primitive_number_Nova_Float*, nova_standard_exception_Nova_ExceptionData*, nova_standard_primitive_number_Nova_Float*);
};
