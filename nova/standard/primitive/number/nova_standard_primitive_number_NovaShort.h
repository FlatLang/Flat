...
{
	nova_standard_NovaString* (*nova_standard_primitive_number_NovaShort_Novavirtual2_toString)(nova_standard_primitive_number_NovaShort*, nova_standard_exception_NovaExceptionData*);
	...
	nova_standard_NovaString* (*nova_standard_primitive_number_NovaShort_static_Novavirtual1_toString)(nova_standard_primitive_number_NovaShort*, nova_standard_exception_NovaExceptionData*, short);
