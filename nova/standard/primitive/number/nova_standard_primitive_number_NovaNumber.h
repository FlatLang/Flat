...
typedef struct nova_VTable_nova_standard_primitive_number_NovaNumber
{
	...
	nova_standard_NovaString* (*nova_standard_primitive_number_NovaNumber_static_Novavirtual0_toString)(nova_standard_primitive_number_NovaNumber*, nova_standard_exception_NovaExceptionData*, nova_standard_primitive_number_NovaNumber*);
