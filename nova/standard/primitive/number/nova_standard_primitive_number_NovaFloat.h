...
typedef struct nova_VTable_nova_standard_primitive_number_NovaFloat
{
	...
	nova_standard_NovaString* (*nova_standard_primitive_number_NovaFloat_static_Novavirtual0_toString)(nova_standard_primitive_number_NovaFloat*, nova_standard_exception_NovaExceptionData*, float);
...
nova_standard_NovaString* nova_standard_primitive_number_NovaFloat_static_Nova0_toString(nova_standard_primitive_number_NovaFloat* this, nova_standard_exception_NovaExceptionData* exceptionData, float l0_Novavalue);
