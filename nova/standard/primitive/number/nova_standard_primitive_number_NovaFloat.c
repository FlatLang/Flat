...
nova_VTable_nova_standard_primitive_number_NovaFloat nova_VTable_nova_standard_primitive_number_NovaFloat_val =
{
	...
	nova_standard_primitive_number_NovaFloat_static_Nova0_toString,
};
...
{
	return nova_standard_primitive_number_NovaDouble_static_Nova0_toString(0, exceptionData, (double)(l0_Novavalue));
}
