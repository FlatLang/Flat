...
{
	nova_standard_primitive_number_NovaFloat_Nova3_toString,
...
int nova_standard_primitive_number_NovaFloat_static_NovanumDigits(nova_standard_primitive_number_NovaFloat* this, nova_standard_exception_NovaExceptionData* exceptionData, float l0_Novanumber)
{
	return nova_standard_primitive_number_NovaDouble_static_NovanumDigits(0, exceptionData, (double)(l0_Novanumber));
}

nova_standard_NovaString* nova_standard_primitive_number_NovaFloat_static_Nova2_toString(nova_standard_primitive_number_NovaFloat* this, nova_standard_exception_NovaExceptionData* exceptionData, float l0_Novavalue)
{
	return nova_standard_primitive_number_NovaDouble_static_Nova2_toString(0, exceptionData, (double)(l0_Novavalue));
}

nova_standard_NovaString* nova_standard_primitive_number_NovaFloat_Nova3_toString(nova_standard_primitive_number_NovaFloat* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	return nova_standard_primitive_number_NovaFloat_static_Nova2_toString(this, exceptionData, this->nova_standard_primitive_number_NovaFloat_Novavalue);
}
