...
typedef struct nova_VTable_nova_standard_primitive_number_Nova_Short
{
...
} nova_VTable_nova_standard_primitive_number_Nova_Short;

extern nova_VTable_nova_standard_primitive_number_Nova_Short nova_VTable_nova_standard_primitive_number_Nova_Short_val;

CCLASS_CLASS
(
	nova_standard_primitive_number_Nova_Short, 
	
	nova_VTable_nova_standard_primitive_number_Nova_Short* vtable;
