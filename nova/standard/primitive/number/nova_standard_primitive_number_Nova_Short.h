...
struct nova_standard_primitive_number_Extension_VTable_Short
{
	...
	nova_standard_Nova_String* (*nova_standard_primitive_number_Nova_Short_virtual3_Nova_toString)(nova_standard_primitive_number_Nova_Short*, nova_standard_exception_Nova_ExceptionData*);
