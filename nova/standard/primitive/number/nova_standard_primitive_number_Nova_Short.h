...
typedef struct nova_standard_primitive_number_VTable_Short
{
...
} nova_standard_primitive_number_VTable_Short;

extern nova_standard_primitive_number_VTable_Short nova_standard_primitive_number_VTable_Short_val;

CCLASS_CLASS
(
	nova_standard_primitive_number_Nova_Short, 
	
	nova_standard_primitive_number_VTable_Short* vtable;
