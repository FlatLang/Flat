...
nova_standard_primitive_number_Extension_VTable_Int nova_standard_primitive_number_Extension_VTable_Int_val =
{
	...
	nova_standard_primitive_number_Nova_Int_4_Nova_toString,
...
nova_standard_Nova_String* nova_standard_primitive_number_Nova_Int_3_Nova_toString(nova_standard_primitive_number_Nova_Int* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_primitive_number_Nova_Int_Nova_value)
{
	return nova_standard_primitive_number_Nova_Long_3_Nova_toString(0, exceptionData, nova_standard_primitive_number_Nova_Int_Nova_value);
}

nova_standard_Nova_String* nova_standard_primitive_number_Nova_Int_4_Nova_toString(nova_standard_primitive_number_Nova_Int* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	return nova_standard_primitive_number_Nova_Int_3_Nova_toString(0, exceptionData, this->nova_standard_primitive_number_Nova_Int_Nova_value);
}
