...
nova_VTable_nova_standard_primitive_number_Nova_Int nova_VTable_nova_standard_primitive_number_Nova_Int_val =
{
	...
	nova_standard_primitive_number_Nova_Int_Nova_compareTo,
};
...
nova_standard_primitive_number_Nova_Int* nova_standard_primitive_number_Nova_Int_7_Nova_construct(nova_standard_primitive_number_Nova_Int* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int l0_Nova_value)
{
...
int nova_standard_primitive_number_Nova_Int_Nova_compareTo(nova_standard_primitive_number_Nova_Int* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* l0_Nova_other)
{
	return this->nova_standard_primitive_number_Nova_Int_Nova_value - ((int)l0_Nova_other)->nova_standard_primitive_number_Nova_Int_Nova_value;
}
