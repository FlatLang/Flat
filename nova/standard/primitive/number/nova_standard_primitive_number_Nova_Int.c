...
int nova_standard_primitive_number_Nova_Int_1_Nova_multiply(nova_standard_primitive_number_Nova_Int* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_primitive_number_Nova_Int* nova_standard_primitive_number_Nova_Int_Nova_prim)
{
	int l1_Nova_value;
