...
{
	nova_standard_primitive_number_NovaByte_Nova0_toString,
...
nova_standard_primitive_number_NovaByte* nova_standard_primitive_number_NovaByte_Novaconstruct(nova_standard_primitive_number_NovaByte* this, nova_standard_exception_NovaExceptionData* exceptionData, char l0_Novavalue)
{
	...
	nova_standard_primitive_number_NovaByte_Novasuper(this, 0);
...
{
	return this->vtable->nova_standard_primitive_number_NovaByte_static_Novavirtual1_toString(this, exceptionData, this->nova_standard_primitive_number_NovaByte_Novavalue);
}
