...
struct nova_standard_primitive_number_Extension_VTable_Double
{
	...
	nova_standard_Nova_String* (*nova_standard_primitive_number_Nova_Double_virtual3_Nova_toString)(nova_standard_primitive_number_Nova_Double*, nova_standard_exception_Nova_ExceptionData*);
	...
	double (*nova_standard_primitive_number_Nova_Double_virtual0_Nova_multiply)(nova_standard_primitive_number_Nova_Double*, nova_standard_exception_Nova_ExceptionData*, nova_standard_primitive_number_Nova_Double*);
};
