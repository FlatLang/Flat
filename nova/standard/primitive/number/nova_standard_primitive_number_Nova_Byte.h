...
typedef struct nova_standard_primitive_number_VTable_Byte
{
...
} nova_standard_primitive_number_VTable_Byte;

extern nova_standard_primitive_number_VTable_Byte nova_standard_primitive_number_VTable_Byte_val;

CCLASS_CLASS
(
	nova_standard_primitive_number_Nova_Byte, 
	
	nova_standard_primitive_number_VTable_Byte* vtable;
