...
nova_standard_primitive_number_VTable_Char nova_standard_primitive_number_VTable_Char_val =
{
...
nova_standard_primitive_number_Nova_Char* nova_standard_primitive_number_Nova_Char_5_Nova_construct(nova_standard_primitive_number_Nova_Char* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char l0_Nova_value)
{
	...
	this->vtable = &nova_standard_primitive_number_VTable_Char_val;
	...
	{
		nova_standard_primitive_number_Nova_Char_5_Nova_this(this, exceptionData, l0_Nova_value);
	}
...
void nova_standard_primitive_number_Nova_Char_5_Nova_this(nova_standard_primitive_number_Nova_Char* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char l0_Nova_value)
{
...
int nova_standard_primitive_number_Nova_Char_Nova_compareTo(nova_standard_primitive_number_Nova_Char* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_primitive_number_Nova_Char* l0_Nova_prim)
{
	...
	nova_local_0 = nova_standard_primitive_number_Nova_Char_1_Nova_toString(0, exceptionData, this->nova_standard_primitive_number_Nova_Char_Nova_value);
	nova_local_1 = nova_standard_primitive_number_Nova_Char_1_Nova_toString(0, exceptionData, l1_Nova_other);
