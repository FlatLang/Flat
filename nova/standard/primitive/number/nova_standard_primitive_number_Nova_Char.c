...
nova_standard_primitive_number_Nova_Char* nova_standard_primitive_number_Nova_Char_5_Nova_construct(nova_standard_primitive_number_Nova_Char* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_primitive_number_Nova_Char_Nova_value)
{
	...
	{
		nova_standard_primitive_number_Nova_Char_5_Nova_this(this, exceptionData, nova_standard_primitive_number_Nova_Char_Nova_value);
	}
...
{
	return nova_standard_Nova_String_0_Nova_construct(0, exceptionData, nova_standard_primitive_number_Nova_Char_Nova_c);
}
