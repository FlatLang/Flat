...
{
	return nova_standard_primitive_number_Nova_Long_0_Nova_numDigits(0, exceptionData, (long)(nova_standard_primitive_number_Nova_Short_Nova_number));
}
...
{
	return nova_standard_primitive_number_Nova_Long_2_Nova_toString(0, exceptionData, (long)(nova_standard_primitive_number_Nova_Short_Nova_value));
}
...
{
	return nova_standard_primitive_number_Nova_Short_2_Nova_toString(this, exceptionData, this->nova_standard_primitive_number_Nova_Short_Nova_value);
}
...
short nova_standard_primitive_number_Nova_Short_0_Nova_compareTo(nova_standard_primitive_number_Nova_Short* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_primitive_number_Nova_Short* nova_standard_primitive_number_Nova_Short_Nova_prim)
{
	...
	l1_Nova_other = nova_standard_primitive_number_Nova_Short_Nova_prim->nova_standard_primitive_number_Nova_Short_Nova_value;
...
short nova_standard_primitive_number_Nova_Short_0_Nova_multiply(nova_standard_primitive_number_Nova_Short* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_primitive_number_Nova_Short* nova_standard_primitive_number_Nova_Short_Nova_prim)
{
	...
	l1_Nova_value = nova_standard_primitive_number_Nova_Short_Nova_prim->nova_standard_primitive_number_Nova_Short_Nova_value;
