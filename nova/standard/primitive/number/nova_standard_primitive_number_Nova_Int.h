...
typedef struct nova_VTable_nova_standard_primitive_number_Nova_Int
{
	...
	int (*nova_standard_primitive_number_Nova_Int_virtual_Nova_compareTo)(nova_standard_primitive_number_Nova_Int*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
} nova_VTable_nova_standard_primitive_number_Nova_Int;

extern nova_VTable_nova_standard_primitive_number_Nova_Int nova_VTable_nova_standard_primitive_number_Nova_Int_val;

CCLASS_CLASS
(
	nova_standard_primitive_number_Nova_Int, 
	
	nova_VTable_nova_standard_primitive_number_Nova_Int* vtable;
