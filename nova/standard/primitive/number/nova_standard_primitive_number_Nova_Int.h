...
typedef struct nova_VTable_nova_standard_primitive_number_Nova_Int
{
	...
	int (*nova_standard_primitive_number_Nova_Int_virtual0_Nova_compareTo)(nova_standard_primitive_number_Nova_Int*, nova_standard_exception_Nova_ExceptionData*, int);
