...
struct nova_standard_primitive_number_Extension_VTable_Int
{
	...
	int (*nova_standard_primitive_number_Nova_Int_virtual0_Nova_multiply)(nova_standard_primitive_number_Nova_Int*, nova_standard_exception_Nova_ExceptionData*, nova_standard_primitive_number_Nova_Int*);
};
