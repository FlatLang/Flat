...
typedef struct nova_standard_primitive_number_VTable_Int
{
...
} nova_standard_primitive_number_VTable_Int;

extern nova_standard_primitive_number_VTable_Int nova_standard_primitive_number_VTable_Int_val;

CCLASS_CLASS
(
	nova_standard_primitive_number_Nova_Int, 
	
	nova_standard_primitive_number_VTable_Int* vtable;
