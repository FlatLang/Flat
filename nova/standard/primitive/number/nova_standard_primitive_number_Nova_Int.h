...
struct nova_standard_primitive_number_Extension_VTable_Int
{
	...
	long (*nova_standard_Nova_Object_virtual1_Nova_getHashCodeLong)(nova_standard_primitive_number_Nova_Int*, nova_standard_exception_Nova_ExceptionData*);
	...
	int (*nova_standard_datastruct_Nova_Comparable_virtual0_Nova_compareTo)(nova_standard_primitive_number_Nova_Int*, nova_standard_exception_Nova_ExceptionData*, nova_standard_primitive_number_Nova_Int*);
	int (*nova_standard_operators_Nova_Multiply_virtual1_Nova_multiply)(nova_standard_primitive_number_Nova_Int*, nova_standard_exception_Nova_ExceptionData*, nova_standard_primitive_number_Nova_Int*);
};
