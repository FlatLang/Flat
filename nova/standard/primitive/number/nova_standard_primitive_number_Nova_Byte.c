...
nova_standard_primitive_number_Nova_Byte* nova_standard_primitive_number_Nova_Byte_Nova_construct(nova_standard_primitive_number_Nova_Byte* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char l0_Nova_value)
{
	...
	nova_standard_primitive_number_Nova_Byte_Nova_super(this, exceptionData);
...
void nova_standard_primitive_number_Nova_Byte_Nova_super(nova_standard_primitive_number_Nova_Byte* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
