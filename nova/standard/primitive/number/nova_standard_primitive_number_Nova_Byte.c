...
nova_standard_primitive_number_Extension_VTable_Byte nova_standard_primitive_number_Extension_VTable_Byte_val =
{
	...
	nova_standard_primitive_number_Nova_Byte_4_Nova_toString,
...
{
	return nova_standard_primitive_number_Nova_Long_3_Nova_toString(0, exceptionData, nova_standard_primitive_number_Nova_Byte_Nova_value);
}
...
{
	return nova_standard_primitive_number_Nova_Byte_3_Nova_toString(0, exceptionData, this->nova_standard_primitive_number_Nova_Byte_Nova_value);
}
