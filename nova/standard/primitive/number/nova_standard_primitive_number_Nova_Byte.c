...
void nova_standard_primitive_number_Nova_Byte_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
{
	return nova_standard_primitive_number_Nova_Long_0_Nova_numDigits(0, exceptionData, nova_standard_primitive_number_Nova_Byte_Nova_number);
}
...
{
	return nova_standard_primitive_number_Nova_Long_2_Nova_toString(0, exceptionData, nova_standard_primitive_number_Nova_Byte_Nova_value);
}
...
{
	return nova_standard_primitive_number_Nova_Byte_2_Nova_toString(0, exceptionData, this->nova_standard_primitive_number_Nova_Byte_Nova_value);
}
...
{
	return this->nova_standard_primitive_number_Nova_Byte_Nova_value - nova_standard_primitive_number_Nova_Byte_Nova_other;
}
...
{
	return this->nova_standard_primitive_number_Nova_Byte_Nova_value * nova_standard_primitive_number_Nova_Byte_Nova_value;
}
