...
nova_standard_primitive_number_Nova_Byte* nova_standard_primitive_number_Nova_Byte_Nova_construct(nova_standard_primitive_number_Nova_Byte* this, nova_standard_exception_Nova_ExceptionData* exceptionData, char nova_standard_primitive_number_Nova_Byte_Nova_value)
{
	...
	{
		nova_standard_primitive_number_Nova_Byte_Nova_this(this, exceptionData, nova_standard_primitive_number_Nova_Byte_Nova_value);
	}
...
{
	return nova_standard_primitive_number_Nova_Long_1_Nova_toString(0, exceptionData, (long)(nova_standard_primitive_number_Nova_Byte_Nova_value));
}
