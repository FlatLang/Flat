...
{
	{
		...
		0,
		0,
		(nova_standard_Nova_Object*(*)(nova_standard_datastruct_Nova_Comparable*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*))nova_standard_primitive_number_Nova_Byte_0_Nova_compareTo,
		0,
		0,
		0,
		0,
