...
typedef struct nova_VTable_nova_standard_primitive_number_Nova_Char
{
	...
	int (*nova_standard_primitive_number_Nova_Char_virtual_Nova_compareTo)(nova_standard_primitive_number_Nova_Char*, nova_standard_exception_Nova_ExceptionData*, char);
