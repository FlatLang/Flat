...
struct nova_standard_primitive_number_Extension_VTable_Char
{
	...
	char (*nova_standard_primitive_number_Nova_Char_virtual0_Nova_compareTo)(nova_standard_primitive_number_Nova_Char*, nova_standard_exception_Nova_ExceptionData*, nova_standard_primitive_number_Nova_Char*);
};
