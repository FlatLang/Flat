...
{
	nova_standard_NovaString* (*nova_standard_primitive_number_NovaByte_Novavirtual0_toString)(nova_standard_primitive_number_NovaByte*, nova_standard_exception_NovaExceptionData*);
	char (*nova_standard_NovaObject_Novavirtual0_equals)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*, nova_standard_NovaObject*);
	int (*nova_standard_primitive_number_NovaByte_static_Novavirtual0_numDigits)(nova_standard_primitive_number_NovaByte*, nova_standard_exception_NovaExceptionData*, char);
	nova_standard_NovaString* (*nova_standard_primitive_number_NovaByte_static_Novavirtual1_toString)(nova_standard_primitive_number_NovaByte*, nova_standard_exception_NovaExceptionData*, char);
...
int nova_standard_primitive_number_NovaByte_static_Nova0_numDigits(nova_standard_primitive_number_NovaByte* this, nova_standard_exception_NovaExceptionData* exceptionData, char l0_Novanumber);
...
nova_standard_NovaString* nova_standard_primitive_number_NovaByte_Nova0_toString(nova_standard_primitive_number_NovaByte* this, nova_standard_exception_NovaExceptionData* exceptionData);
