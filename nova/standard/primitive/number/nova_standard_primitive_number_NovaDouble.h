...
typedef struct nova_VTable_nova_standard_primitive_number_NovaDouble
{
	...
	nova_standard_NovaString* (*nova_standard_primitive_number_NovaDouble_Novavirtual2_toString)(nova_standard_primitive_number_NovaDouble*, nova_standard_exception_NovaExceptionData*);
