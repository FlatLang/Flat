...
struct nova_standard_primitive_Extension_VTable_Null
{
	...
	nova_standard_Nova_String* (*nova_standard_primitive_Nova_Null_virtual0_Nova_toString)(nova_standard_primitive_Nova_Null*, nova_standard_exception_Nova_ExceptionData*);
	...
	nova_standard_Nova_String* (*nova_standard_primitive_Nova_Null_virtual0_Nova_concat)(nova_standard_primitive_Nova_Null*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
