...
typedef struct nova_standard_primitive_VTable_Null
{
...
} nova_standard_primitive_VTable_Null;

extern nova_standard_primitive_VTable_Null nova_standard_primitive_VTable_Null_val;

CCLASS_CLASS
(
	nova_standard_primitive_Nova_Null, 
	
	nova_standard_primitive_VTable_Null* vtable;
