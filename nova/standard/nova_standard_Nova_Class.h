#pragma once
#ifndef FILE_nova_standard_Nova_Class_NOVA
#define FILE_nova_standard_Nova_Class_NOVA

typedef struct nova_standard_Nova_Class nova_standard_Nova_Class;
...
typedef struct nova_standard_Extension_VTable_Class nova_standard_Extension_VTable_Class;
struct nova_standard_Extension_VTable_Class
{
...
extern nova_standard_Extension_VTable_Class nova_standard_Extension_VTable_Class_val;


CCLASS_CLASS
(
	nova_standard_Nova_Class, 
	
	nova_standard_Extension_VTable_Class* vtable;
	struct Private* prv;
)
