...
nova_standard_io_Nova_File* nova_standard_io_Nova_File_0_Nova_File(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_io_Nova_File_Nova_location)
{
...
nova_standard_io_Nova_File* nova_standard_io_Nova_File_1_Nova_File(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData, FILE* nova_standard_io_Nova_File_Nova_fp)
{
	CCLASS_NEW(nova_standard_io_Nova_File, this);
	this->vtable = &nova_standard_io_Extension_VTable_File_val;
	nova_standard_Nova_Object_Nova_super((nova_standard_Nova_Object*)this, exceptionData);
...
void nova_standard_io_Nova_File_1_Nova_this(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_io_Nova_File_Nova_location)
{
	...
	this->prv->nova_standard_io_Nova_File_Nova_fp = fopen((char*)(nova_standard_io_Nova_File_Nova_location->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)("r+"));
}
...
char nova_standard_io_Nova_File_Nova_delete(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	return remove((char*)(this->nova_standard_io_Nova_File_Nova_location->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data)) == 0;
}
...
{
	nova_standard_io_Nova_File_Nova_close(this, exceptionData);
	this->prv->nova_standard_io_Nova_File_Nova_fp = fopen((char*)(this->nova_standard_io_Nova_File_Nova_location->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)("r+"));
}
...
void nova_standard_io_Nova_File_Nova_clearContents(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		this->prv->nova_standard_io_Nova_File_Nova_fp = fopen((char*)(this->nova_standard_io_Nova_File_Nova_location->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), (char*)("w"));
	}
}
...
char nova_standard_io_Nova_File_Nova_create(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	if (!nova_standard_io_Nova_File_Accessor_Nova_exists(this, exceptionData))
	{
		...
		if (!nova_standard_io_Nova_File_Accessor_Nova_exists(this, exceptionData))
		{
			THROW(4, nova_standard_io_Nova_FileNotFoundException_Nova_FileNotFoundException(0, exceptionData, this));
			return 0;
		}
...
nova_standard_Nova_String* nova_standard_io_Nova_File_Nova_readAllContents(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	while (l1_Nova_line != (nova_standard_Nova_String*)nova_null)
	{
		...
		l1_Nova_data = (nova_standard_Nova_String*)(nova_standard_Nova_String_virtual1_Nova_concat((nova_standard_Nova_String*)(l1_Nova_data), exceptionData, l1_Nova_line));
		l1_Nova_line = nova_standard_io_Nova_File_Nova_readLine(this, exceptionData);
	}
	return l1_Nova_data;
}
...
nova_standard_Nova_String* nova_standard_io_Nova_File_Nova_readLine(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	return nova_standard_Nova_String_1_Nova_String(0, exceptionData, l1_Nova_line);
}
...
{
	nova_standard_io_Nova_File_Nova_write(this, exceptionData, nova_standard_Nova_String_virtual1_Nova_concat((nova_standard_Nova_String*)(nova_standard_io_Nova_File_Nova_line), exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "\n")));
}
...
{
	fputs((char*)(nova_standard_io_Nova_File_Nova_data->nova_standard_Nova_String_Nova_chars->nova_standard_datastruct_list_Nova_Array_Nova_data), this->prv->nova_standard_io_Nova_File_Nova_fp);
...
int nova_standard_io_Nova_File_Mutator_Nova_maxOpenFiles(nova_standard_io_Nova_File* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int nova_standard_io_Nova_File_Nova_value)
{
	...
	{
		nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Invalid max number of open files: "), exceptionData, nova_standard_Nova_String_virtual1_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, nova_standard_io_Nova_File_Nova_value)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "\nValid values include "), exceptionData, nova_standard_Nova_String_virtual1_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Short_2_Nova_toString(0, exceptionData, l1_Nova_min)), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "-"), exceptionData, nova_standard_primitive_number_Nova_Short_2_Nova_toString(0, exceptionData, l1_Nova_max)))))));
	}
	else
	{
		setMaxOpenFiles(nova_standard_io_Nova_File_Nova_value);
	}
	return nova_standard_io_Nova_File_Nova_value;
}
