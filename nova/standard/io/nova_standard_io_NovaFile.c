...
void nova_standard_io_NovaFile_Nova0_this(nova_standard_io_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData, nova_standard_NovaString* l0_Novalocation)
{
	...
	this->prv->nova_standard_io_NovaFile_Novafp = fopen((char*)(nova_standard_NovaString_NovatoCharArray(l0_Novalocation, exceptionData)), (char*)("r+"));
}
...
char nova_standard_io_NovaFile_Novadelete(nova_standard_io_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	return remove((char*)(nova_standard_NovaString_NovatoCharArray(this->prv->nova_standard_io_NovaFile_Novalocation, exceptionData))) == 0;
}
...
{
	nova_standard_io_NovaFile_Novaclose(this, exceptionData);
	this->prv->nova_standard_io_NovaFile_Novafp = fopen((char*)(nova_standard_NovaString_NovatoCharArray(this->prv->nova_standard_io_NovaFile_Novalocation, exceptionData)), (char*)("r+"));
}
...
void nova_standard_io_NovaFile_NovaclearContents(nova_standard_io_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	{
		this->prv->nova_standard_io_NovaFile_Novafp = fopen((char*)(nova_standard_NovaString_NovatoCharArray(this->prv->nova_standard_io_NovaFile_Novalocation, exceptionData)), (char*)("w"));
	}
}
...
nova_standard_NovaString* nova_standard_io_NovaFile_NovareadAllContents(nova_standard_io_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	l1_Novadata = nova_standard_NovaString_Nova1_construct(0, exceptionData, "");
	...
	while (l1_Novaline != (nova_standard_NovaString*)nova_null)
	{
		...
		{
			l1_Novadata = l1_Novadata->vtable->nova_standard_NovaString_Novavirtual0_concat(l1_Novadata, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "\n"));
		}
...
nova_standard_NovaString* nova_standard_io_NovaFile_NovareadLine(nova_standard_io_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	l1_Novaline = (char*)NOVA_MALLOC(sizeof(nova_standard_primitive_number_NovaChar[l1_Novasize]));
	l1_Novac = (char)(getc(this->prv->nova_standard_io_NovaFile_Novafp));
	if (l1_Novac == EOF)
	{
	...
	while (l1_Novac != '\n' && l1_Novac != EOF)
	{
		if (l1_Novaindex >= l1_Novasize)
		{
			...
			l1_Novaline = (char*)(realloc((char*)(l1_Novaline), (int)(l1_Novasize)));
		}
	...
	l1_Novaline = (char*)(realloc((char*)(l1_Novaline), (int)(l1_Novaindex)));
	return nova_standard_NovaString_Nova1_construct(0, exceptionData, l1_Novaline);
}
...
{
	nova_standard_io_NovaFile_Novawrite(this, exceptionData, l0_Novaline->vtable->nova_standard_NovaString_Novavirtual0_concat(l0_Novaline, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "\n")));
}
...
{
	fputs((char*)(nova_standard_NovaString_NovatoCharArray(l0_Novadata, exceptionData)), this->prv->nova_standard_io_NovaFile_Novafp);
...
void nova_standard_io_NovaFile_static_NovasetMaxOpenFiles(nova_standard_io_NovaFile* this, nova_standard_exception_NovaExceptionData* exceptionData, int l0_Novanum)
{
	...
	if (l0_Novanum > l1_Novamax || l0_Novanum < l1_Novamin)
	{
		...
		nova_local_0 = nova_standard_primitive_number_NovaInt_static_Nova0_toString(0, exceptionData, l0_Novanum);
		nova_local_1 = nova_standard_primitive_number_NovaShort_static_Nova0_toString(0, exceptionData, l1_Novamin);
		nova_standard_io_NovaConsole_static_Nova0_writeLine(0, exceptionData, nova_standard_NovaString_Nova0_concat(nova_standard_NovaString_Nova1_construct(0, exceptionData, "Invalid max number of open files: "), exceptionData, nova_local_0->vtable->nova_standard_NovaString_Novavirtual0_concat(nova_local_0, exceptionData, nova_standard_NovaString_Nova0_concat(nova_standard_NovaString_Nova1_construct(0, exceptionData, "\nValid values include "), exceptionData, nova_local_1->vtable->nova_standard_NovaString_Novavirtual0_concat(nova_local_1, exceptionData, nova_standard_NovaString_Nova0_concat(nova_standard_NovaString_Nova1_construct(0, exceptionData, "-"), exceptionData, nova_standard_primitive_number_NovaShort_static_Nova0_toString(0, exceptionData, l1_Novamax)))))));
	}
	else
	{
		setMaxOpenFiles((int)(l0_Novanum));
	}
}
