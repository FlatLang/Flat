...
{
	nova_standard_exception_Nova_Exception_1_Nova_this((nova_standard_exception_Nova_Exception*)(this), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "File at location '"), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_io_Nova_FileNotFoundException_Nova_file->nova_standard_io_Nova_File_Nova_location), exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "' does not exist"))));
}
