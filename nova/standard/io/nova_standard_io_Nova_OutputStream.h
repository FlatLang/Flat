...
struct nova_standard_io_Extension_VTable_OutputStream
{
	...
	char (*nova_standard_io_Nova_OutputStream_virtual0_Nova_write)(nova_standard_io_Nova_OutputStream*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
	char (*nova_standard_io_Nova_OutputStream_virtual1_Nova_write)(nova_standard_io_Nova_OutputStream*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
};
...
char nova_standard_io_Nova_OutputStream_0_Nova_write(nova_standard_io_Nova_OutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_io_Nova_OutputStream_Nova_data);char nova_standard_io_Nova_OutputStream_1_Nova_write(nova_standard_io_Nova_OutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_io_Nova_OutputStream_Nova_data);void nova_standard_io_Nova_OutputStream_0_Nova_this(nova_standard_io_Nova_OutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
