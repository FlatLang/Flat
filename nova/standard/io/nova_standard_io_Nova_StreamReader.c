...
nova_standard_io_VTable_StreamReader nova_standard_io_VTable_StreamReader_val =
{
...
nova_standard_io_Nova_StreamReader* nova_standard_io_Nova_StreamReader_Nova_construct(nova_standard_io_Nova_StreamReader* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_io_Nova_File* l0_Nova_file)
{
	...
	this->vtable = &nova_standard_io_VTable_StreamReader_val;
	...
	nova_standard_io_Nova_StreamReader_2_Nova_super(this, exceptionData);
...
void nova_standard_io_Nova_StreamReader_2_Nova_super(nova_standard_io_Nova_StreamReader* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
