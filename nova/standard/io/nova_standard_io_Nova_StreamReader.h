...
struct nova_standard_io_Extension_VTable_StreamReader
{
	...
	nova_standard_datastruct_list_Nova_Array* (*nova_standard_io_Nova_InputStream_virtual1_Nova_readBytes)(nova_standard_io_Nova_StreamReader*, nova_standard_exception_Nova_ExceptionData*);
};
