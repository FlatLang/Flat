...
{
	nova_standard_io_Nova_Console_1_Nova_writeLine((nova_standard_io_Nova_Console*)nova_null, exceptionData, nova_standard_io_Nova_Console_Nova_obj->vtable->nova_standard_Nova_Object_virtual1_Nova_toString(nova_standard_io_Nova_Console_Nova_obj, exceptionData));
}
