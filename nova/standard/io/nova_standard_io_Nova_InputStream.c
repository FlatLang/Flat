...
nova_standard_io_Nova_InputStream* nova_standard_io_Nova_InputStream_4_Nova_construct(nova_standard_io_Nova_InputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_standard_io_Nova_InputStream_Nova_this(this, exceptionData);
	}
...
void nova_standard_io_Nova_InputStream_Nova_this(nova_standard_io_Nova_InputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
