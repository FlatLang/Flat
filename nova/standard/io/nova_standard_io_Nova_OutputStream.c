...
nova_standard_io_Extension_VTable_OutputStream nova_standard_io_Extension_VTable_OutputStream_val =
{
	...
	nova_standard_io_Nova_OutputStream_virtual2_Nova_write,
};
...
nova_standard_io_Nova_OutputStream* nova_standard_io_Nova_OutputStream_Nova_OutputStream(nova_standard_io_Nova_OutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		nova_standard_io_Nova_OutputStream_2_Nova_this(this, exceptionData);
	}
...
void nova_standard_io_Nova_OutputStream_2_Nova_this(nova_standard_io_Nova_OutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
...
char nova_standard_io_Nova_OutputStream_virtual1_Nova_write(nova_standard_io_Nova_OutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* nova_standard_io_Nova_OutputStream_Nova_data)
{
...
char nova_standard_io_Nova_OutputStream_virtual2_Nova_write(nova_standard_io_Nova_OutputStream* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* nova_standard_io_Nova_OutputStream_Nova_data)
{
	return this->vtable->nova_standard_io_Nova_OutputStream_virtual2_Nova_write((nova_standard_io_Nova_OutputStream*)(this), exceptionData, nova_standard_io_Nova_OutputStream_Nova_data);
}
