#pragma once
#ifndef FILE_MD5_NOVA
#define FILE_MD5_NOVA

typedef struct nova_standard_security_NovaMD5 nova_standard_security_NovaMD5;
...
typedef struct nova_VTable_nova_standard_security_NovaMD5
{
...
} nova_VTable_nova_standard_security_NovaMD5;

CCLASS_CLASS
(
	nova_standard_security_NovaMD5, 
	
	nova_VTable_nova_standard_security_NovaMD5* vtable;
)
