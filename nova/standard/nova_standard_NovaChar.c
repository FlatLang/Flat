...
nova_VTable_nova_standard_NovaChar nova_VTable_nova_standard_NovaChar_val =
{
	nova_standard_NovaChar_Novanull0_toString,
	nova_standard_NovaObject_Novanull0_equals,
	nova_standard_NovaNumber_static_Novanull0_numDigits,
	nova_standard_NovaChar_Novanull1_toString,
};
...
{
	CCLASS_NEW(nova_standard_NovaChar, this,);
	this->vtable = &nova_VTable_nova_standard_NovaChar_val;
	...
	nova_standard_NovaChar_Novasuper(this, 0);
	
	{
		nova_standard_NovaChar_Novathis(this, exceptionData, l0_Novavalue);
	}
...
{
	this->nova_standard_NovaChar_Novavalue = l0_Novavalue;
}
...
{
	return this->vtable->nova_standard_NovaChar_Novavirtual1_toString(this, exceptionData, this->nova_standard_NovaChar_Novavalue);
}
...
{
	this->nova_standard_NovaChar_Novavalue = 0;
}
