...
{
	return nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, (char*)("[Circle at (")), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_x)), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, (char*)(", ")), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_y)), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, (char*)(") with a radius of ")), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_r)), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, (char*)("]"))))))));
}
