...
nova_svg_Nova_SvgCircle* nova_svg_Nova_SvgCircle_Nova_SvgCircle(nova_svg_Nova_SvgCircle* this, nova_exception_Nova_ExceptionData* exceptionData, double nova_svg_Nova_SvgCircle_Nova_x, double nova_svg_Nova_SvgCircle_Nova_y, int nova_svg_Nova_SvgCircle_Nova_r)
{
...
{
	nova_io_Nova_File_Nova_write(nova_svg_Nova_SvgCircle_Nova_file, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "<circle cx=\""), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_x)), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "\" cy=\""), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_y)), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "\" r=\""), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_r)), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "\" stroke=\"false\" fill=\"black\"/>\n"))))))));
}
...
{
	return nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "[Circle at ("), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_x)), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, ", "), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Double_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_y)), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, ") with a radius of "), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, this->nova_svg_Nova_SvgCircle_Nova_r)), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "]")))))));
}
