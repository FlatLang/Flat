...
nova_Nova_String* nova_Nova_Object_Nova_getHashCode(nova_Nova_Object* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return nova_Nova_String_1_Nova_String(0, exceptionData, hashCode(this));
}

long_long nova_Nova_Object_0_Nova_getHashCodeLong(nova_Nova_Object* this, nova_exception_Nova_ExceptionData* exceptionData)
{
...
{
	return nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "[Object @"), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_Nova_Object_Nova_getHashCode(this, exceptionData)), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "]")));
}
...
long_long nova_Nova_Object_virtual1_Nova_getHashCodeLong(nova_Nova_Object* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	return this->vtable->nova_Nova_Object_virtual1_Nova_getHashCodeLong((nova_Nova_Object*)(this), exceptionData);
}
