...
typedef struct nova_datastruct_list_Extension_VTable_ListNode nova_datastruct_list_Extension_VTable_ListNode;
struct nova_datastruct_list_Extension_VTable_ListNode
{
...
extern nova_datastruct_list_Extension_VTable_ListNode nova_datastruct_list_Extension_VTable_ListNode_val;
...
(
	...
	nova_datastruct_list_Extension_VTable_ListNode* vtable;
...
nova_datastruct_list_Nova_ListNode* nova_datastruct_list_Nova_ListNode_Nova_ListNode(nova_datastruct_list_Nova_ListNode* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* nova_datastruct_list_Nova_ListNode_Nova_data);
