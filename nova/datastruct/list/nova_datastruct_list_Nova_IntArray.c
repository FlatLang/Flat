...
nova_datastruct_list_Extension_VTable_IntArray nova_datastruct_list_Extension_VTable_IntArray_val =
{
	{
		0,
		(nova_datastruct_list_Nova_Iterator*(*)(nova_datastruct_list_Nova_Iterable*, nova_exception_Nova_ExceptionData*))nova_datastruct_list_Nova_IntArray_Accessor_Nova_iterator,
		0,
		0,
		0,
		...
		(char(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*))nova_datastruct_list_Nova_Array_Nova_contains,
		(void(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List_closure3_Nova_func nova_datastruct_list_Nova_List_Nova_func, void* nova_datastruct_list_Nova_List_ref_Nova_func, void* func_context))nova_datastruct_list_Nova_IntArray_0_Nova_forEach,
		(nova_datastruct_list_Nova_List*(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List_closure6_Nova_mapFunc nova_datastruct_list_Nova_List_Nova_mapFunc, void* nova_datastruct_list_Nova_List_ref_Nova_mapFunc, void* mapFunc_context))nova_datastruct_list_Nova_IntArray_0_Nova_map,
		(char(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List_closure9_Nova_anyFunc nova_datastruct_list_Nova_List_Nova_anyFunc, void* nova_datastruct_list_Nova_List_ref_Nova_anyFunc, void* anyFunc_context))nova_datastruct_list_Nova_IntArray_0_Nova_any,
		(char(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List_closure12_Nova_allFunc nova_datastruct_list_Nova_List_Nova_allFunc, void* nova_datastruct_list_Nova_List_ref_Nova_allFunc, void* allFunc_context))nova_datastruct_list_Nova_IntArray_0_Nova_all,
		(nova_datastruct_list_Nova_List*(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List_closure15_Nova_filterFunc nova_datastruct_list_Nova_List_Nova_filterFunc, void* nova_datastruct_list_Nova_List_ref_Nova_filterFunc, void* filterFunc_context))nova_datastruct_list_Nova_IntArray_0_Nova_filter,
		(nova_datastruct_list_Nova_List*(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, int))nova_datastruct_list_Nova_IntArray_0_Nova_take,
		(nova_datastruct_list_Nova_List*(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, int))nova_datastruct_list_Nova_IntArray_0_Nova_skip,
		(nova_Nova_Object*(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_List_closure18_Nova_func nova_datastruct_list_Nova_List_Nova_func, void* nova_datastruct_list_Nova_List_ref_Nova_func, void* func_context))nova_datastruct_list_Nova_IntArray_0_Nova_firstWhere,
		(nova_datastruct_list_Nova_List*(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*))nova_datastruct_list_Nova_IntArray_0_Nova_reverse,
		(nova_Nova_String*(*)(nova_datastruct_list_Nova_List*, nova_exception_Nova_ExceptionData*, nova_Nova_String*))nova_datastruct_list_Nova_IntArray_0_Nova_join,
		0,
		0,
	...
	nova_datastruct_list_Nova_Array_Nova_contains,
	...
	nova_datastruct_list_Nova_IntArray_Accessor_Nova_iterator,
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_0_Nova_IntArray(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	this->vtable = &nova_datastruct_list_Extension_VTable_IntArray_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	nova_datastruct_list_Nova_Array_Nova_super((nova_datastruct_list_Nova_Array*)this, exceptionData);
	nova_datastruct_list_Nova_IntArray_0_Nova_super(this, exceptionData);
	
	{
		nova_datastruct_list_Nova_IntArray_0_Nova_this(this, exceptionData);
	}
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_1_Nova_IntArray(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_count)
{
	...
	{
		nova_datastruct_list_Nova_IntArray_1_Nova_this(this, exceptionData, nova_datastruct_list_Nova_IntArray_Nova_count);
	}
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_2_Nova_IntArray(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int* nova_datastruct_list_Nova_IntArray_Nova_data, int nova_datastruct_list_Nova_IntArray_Nova_count)
{
	...
	{
		nova_datastruct_list_Nova_IntArray_2_Nova_this(this, exceptionData, nova_datastruct_list_Nova_IntArray_Nova_data, nova_datastruct_list_Nova_IntArray_Nova_count);
	}
...
{
	nova_datastruct_list_Nova_Array_1_Nova_this((nova_datastruct_list_Nova_Array*)(this), exceptionData, nova_datastruct_list_Nova_IntArray_Nova_count);
}
...
{
	nova_datastruct_list_Nova_Array_2_Nova_this((nova_datastruct_list_Nova_Array*)(this), exceptionData, (nova_Nova_Object**)(nova_datastruct_list_Nova_IntArray_Nova_data), nova_datastruct_list_Nova_IntArray_Nova_count);
}
...
nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_IntArray_0_Nova_map(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_IntArray_closure3_Nova_mapFunc nova_datastruct_list_Nova_IntArray_Nova_mapFunc, void* nova_datastruct_list_Nova_IntArray_ref_Nova_mapFunc, void* mapFunc_context)
{
	...
	l1_Nova_i = (int)(0);
	nova_local_0 = (nova_datastruct_list_Nova_IntArrayIterator*)(nova_datastruct_list_Nova_Iterable_virtual_Accessor1_Nova_iterator((nova_datastruct_list_Nova_Iterable*)((this)), exceptionData));
...
void nova_datastruct_list_Nova_IntArray_0_Nova_forEach(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_IntArray_closure6_Nova_func nova_datastruct_list_Nova_IntArray_Nova_func, void* nova_datastruct_list_Nova_IntArray_ref_Nova_func, void* func_context)
{
	...
	{
		nova_datastruct_list_Nova_IntArray_Nova_func(nova_datastruct_list_Nova_IntArray_ref_Nova_func, exceptionData, (int)(intptr_t)nova_datastruct_list_Nova_Array_virtual1_Nova_get((nova_datastruct_list_Nova_Array*)(this), exceptionData, l2_Nova_i), l2_Nova_i, this, func_context);
	}
}
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_0_Nova_filter(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_IntArray_closure15_Nova_filterFunc nova_datastruct_list_Nova_IntArray_Nova_filterFunc, void* nova_datastruct_list_Nova_IntArray_ref_Nova_filterFunc, void* filterFunc_context)
{
	...
	l1_Nova_filtered = nova_datastruct_list_Nova_IntArray_0_Nova_IntArray(0, exceptionData);
	l1_Nova_i = (int)(0);
	nova_local_0 = (nova_datastruct_list_Nova_IntArrayIterator*)(nova_datastruct_list_Nova_Iterable_virtual_Accessor1_Nova_iterator((nova_datastruct_list_Nova_Iterable*)((this)), exceptionData));
	while (nova_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_hasNext((nova_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData))
	{
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_0_Nova_take(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_howMany)
{
	...
	if (nova_datastruct_list_Nova_IntArray_Nova_howMany > this->nova_datastruct_list_Nova_Array_Nova_count)
	{
		nova_datastruct_list_Nova_IntArray_Nova_howMany = this->nova_datastruct_list_Nova_Array_Nova_count;
	}
	l1_Nova_list = nova_datastruct_list_Nova_IntArray_0_Nova_IntArray(0, exceptionData);
	l3_Nova_i = (int)0;
	for (; l3_Nova_i < (int)nova_datastruct_list_Nova_IntArray_Nova_howMany; l3_Nova_i++)
	{
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_0_Nova_skip(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_IntArray_Nova_howMany)
{
	...
	l1_Nova_list = nova_datastruct_list_Nova_IntArray_0_Nova_IntArray(0, exceptionData);
	l2_Nova_i = (int)nova_datastruct_list_Nova_IntArray_Nova_howMany;
	for (; l2_Nova_i < (int)this->nova_datastruct_list_Nova_Array_Nova_count; l2_Nova_i++)
	{
...
nova_datastruct_list_Nova_IntArray* nova_datastruct_list_Nova_IntArray_0_Nova_reverse(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_array = nova_datastruct_list_Nova_IntArray_1_Nova_IntArray(0, exceptionData, this->nova_datastruct_list_Nova_Array_Nova_count);
...
nova_Nova_String* nova_datastruct_list_Nova_IntArray_0_Nova_join(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_datastruct_list_Nova_IntArray_Nova_delimiter)
{
	...
	while (nova_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_hasNext((nova_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData))
	{
		...
		if (l1_Nova_passed)
		{
			l1_Nova_str = (nova_Nova_String*)(nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(l1_Nova_str), exceptionData, nova_datastruct_list_Nova_IntArray_Nova_delimiter));
		}
		else
		{
			l1_Nova_passed = 1;
...
{
	return nova_datastruct_list_Nova_IntArrayIterator_Nova_IntArrayIterator(0, exceptionData, this);
}
...
int nova_datastruct_list_Nova_IntArray_Accessor_Nova_first(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		return (int)(intptr_t)this->nova_datastruct_list_Nova_Array_Nova_data[0];
	}
	return (int)nova_null;
}
...
int nova_datastruct_list_Nova_IntArray_Accessor_Nova_last(nova_datastruct_list_Nova_IntArray* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (this->nova_datastruct_list_Nova_Array_Nova_count > 0)
	{
		return (int)(intptr_t)this->nova_datastruct_list_Nova_Array_Nova_data[this->nova_datastruct_list_Nova_Array_Nova_count - 1];
	}
	return (int)nova_null;
}
