...
char nova_datastruct_list_Nova_Array_Nova_testLambda25(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* nova_datastruct_list_Nova_Array_Nova__1, Context1* context);
...
nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_Array_0_Nova_Array(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData)
{
...
nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_Array_1_Nova_Array(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_list_Nova_Array_Nova_count)
{
	CCLASS_NEW(nova_datastruct_list_Nova_Array, this,);
	this->vtable = &nova_datastruct_list_Extension_VTable_Array_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
...
nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_Array_2_Nova_Array(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object** nova_datastruct_list_Nova_Array_Nova_data, int nova_datastruct_list_Nova_Array_Nova_count)
{
	CCLASS_NEW(nova_datastruct_list_Nova_Array, this,);
	this->vtable = &nova_datastruct_list_Extension_VTable_Array_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
...
{
	nova_datastruct_list_Nova_Array_1_Nova_this(this, exceptionData, 10);
}
...
{
	this->nova_datastruct_list_Nova_Array_Nova_count = (int)(0);
...
{
	return this->nova_datastruct_list_Nova_Array_Nova_data[nova_datastruct_list_Nova_Array_Nova_index];
}
...
char nova_datastruct_list_Nova_Array_Nova_contains(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* nova_datastruct_list_Nova_Array_Nova_value)
{
	...
	return nova_datastruct_list_Nova_List_virtual0_Nova_any((nova_datastruct_list_Nova_List*)(this), exceptionData, (nova_datastruct_list_Nova_List_closure9_Nova_anyFunc)&nova_datastruct_list_Nova_Array_Nova_testLambda25, this, &contextArg28);
}
...
nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_Array_Nova_toArray(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_array = nova_datastruct_list_Nova_Array_1_Nova_Array(0, exceptionData, this->nova_datastruct_list_Nova_Array_Nova_count);
	l2_Nova_i = (int)0;
...
nova_datastruct_list_Nova_Array* nova_datastruct_list_Nova_Array_0_Nova_filter(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array_closure15_Nova_filterFunc nova_datastruct_list_Nova_Array_Nova_filterFunc, void* nova_datastruct_list_Nova_Array_ref_Nova_filterFunc, void* filterFunc_context)
{
	...
	l1_Nova_filtered = nova_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
	l1_Nova_i = (int)(0);
	nova_local_0 = (nova_datastruct_list_Nova_ArrayIterator*)(nova_datastruct_list_Nova_Iterable_virtual_Accessor1_Nova_iterator((nova_datastruct_list_Nova_Iterable*)((this)), exceptionData));
	while (nova_datastruct_list_Nova_Iterator_virtual_Accessor_Nova_hasNext((nova_datastruct_list_Nova_Iterator*)(nova_local_0), exceptionData))
	{
...
nova_Nova_Object* nova_datastruct_list_Nova_Array_Accessor_Nova_first(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		return this->nova_datastruct_list_Nova_Array_Nova_data[0];
	}
	return (nova_Nova_Object*)nova_null;
}
...
nova_Nova_Object* nova_datastruct_list_Nova_Array_Accessor_Nova_last(nova_datastruct_list_Nova_Array* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	if (this->nova_datastruct_list_Nova_Array_Nova_count > 0)
	{
		return this->nova_datastruct_list_Nova_Array_Nova_data[this->nova_datastruct_list_Nova_Array_Nova_count - 1];
	}
	return (nova_Nova_Object*)nova_null;
}
