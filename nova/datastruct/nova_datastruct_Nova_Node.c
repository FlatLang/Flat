...
typedef struct
{
	/* Queue<Node<Object>, Node<Object>> queue */ nova_datastruct_list_Nova_Queue** nova_datastruct_Nova_Node_Nova_queue;
} Context5;
...
void nova_datastruct_Nova_Node_Nova_testLambda39(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_Nova__1, int nova_datastruct_Nova_Node_Nova__2, nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_Nova__3, Context1* context);
void nova_datastruct_Nova_Node_Nova_testLambda40(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_Nova__1, int nova_datastruct_Nova_Node_Nova__2, nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_Nova__3, Context2* context);
void nova_datastruct_Nova_Node_Nova_testLambda41(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_Nova__1, int nova_datastruct_Nova_Node_Nova__2, nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_Nova__3, Context3* context);
void nova_datastruct_Nova_Node_Nova_testLambda42(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_Nova__1, int nova_datastruct_Nova_Node_Nova__2, nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_Nova__3, Context4* context);
...
void nova_datastruct_Nova_Node_Nova_testLambda43(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_Nova__1, int nova_datastruct_Nova_Node_Nova__2, nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_Nova__3, Context5* context);
...
nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_0_Nova_Node(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData)
{
...
nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_1_Nova_Node(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* nova_datastruct_Nova_Node_Nova_data)
{
	CCLASS_NEW(nova_datastruct_Nova_Node, this,);
	this->vtable = &nova_datastruct_Extension_VTable_Node_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
...
nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_2_Nova_Node(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_datastruct_Nova_Node_Nova_numChildren)
{
	CCLASS_NEW(nova_datastruct_Nova_Node, this,);
	this->vtable = &nova_datastruct_Extension_VTable_Node_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
	...
	{
		nova_datastruct_Nova_Node_3_Nova_this(this, exceptionData, (nova_Nova_Object*)(nova_primitive_number_Nova_Int_Nova_Int(0, exceptionData, nova_datastruct_Nova_Node_Nova_numChildren)));
	}
	
	return this;
}

nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_3_Nova_Node(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_Object* nova_datastruct_Nova_Node_Nova_data, int nova_datastruct_Nova_Node_Nova_numChildren)
{
	CCLASS_NEW(nova_datastruct_Nova_Node, this,);
	this->vtable = &nova_datastruct_Extension_VTable_Node_val;
	nova_Nova_Object_Nova_super((nova_Nova_Object*)this, exceptionData);
...
{
	this->nova_datastruct_Nova_Node_Nova_children = nova_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
...
{
	this->nova_datastruct_Nova_Node_Nova_children = nova_datastruct_list_Nova_Array_1_Nova_Array(0, exceptionData, nova_datastruct_Nova_Node_Nova_numChildren);
	this->nova_datastruct_Nova_Node_Nova_data = nova_datastruct_Nova_Node_Nova_data;
}
...
nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_0_Nova_inorder(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_array = nova_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
	return nova_datastruct_Nova_Node_1_Nova_inorder(this, exceptionData, l1_Nova_array);
}
...
nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_0_Nova_postorder(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_array = nova_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
	return nova_datastruct_Nova_Node_1_Nova_postorder(this, exceptionData, l1_Nova_array);
}

nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_1_Nova_postorder(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_Nova_array)
{
	Context4 contextArg46 = 
	{
		&nova_datastruct_Nova_Node_Nova_array,
	};
	
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_filter((nova_datastruct_list_Nova_List*)(this->nova_datastruct_Nova_Node_Nova_children), exceptionData, (nova_datastruct_list_Nova_List_closure15_Nova_filterFunc)&nova_datastruct_Nova_Node_Nova_notNull, this, nova_null)), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&nova_datastruct_Nova_Node_Nova_testLambda42, this, &contextArg46);
	nova_datastruct_list_Nova_Array_0_Nova_add(nova_datastruct_Nova_Node_Nova_array, exceptionData, this->nova_datastruct_Nova_Node_Nova_data);
	return nova_datastruct_Nova_Node_Nova_array;
}
...
nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_0_Nova_levelorder(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_array = nova_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
	return nova_datastruct_Nova_Node_1_Nova_levelorder(this, exceptionData, l1_Nova_array);
}
...
nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_1_Nova_levelorder(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_Nova_array)
{
	...
	l1_Nova_queue = nova_datastruct_list_Nova_Queue_1_Nova_Queue(0, exceptionData, generated9(this, exceptionData));
	while (!nova_datastruct_list_Nova_Queue_Accessor_Nova_empty(l1_Nova_queue, exceptionData))
	{
		nova_datastruct_Nova_Node* l1_Nova_current = (nova_datastruct_Nova_Node*)nova_null;
		Context5 contextArg47 = 
		{
			&l1_Nova_queue,
		};
		
		l1_Nova_current = (nova_datastruct_Nova_Node*)(nova_datastruct_list_Nova_Queue_Nova_dequeue(l1_Nova_queue, exceptionData));
...
nova_datastruct_list_Nova_Array* generated9(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	l1_Nova_temp[0] = this;
	return nova_datastruct_list_Nova_Array_2_Nova_Array(0, exceptionData, (nova_Nova_Object**)(l1_Nova_temp), 1);
}

void nova_datastruct_Nova_Node_Nova_testLambda43(nova_datastruct_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Node* nova_datastruct_Nova_Node_Nova__1, int nova_datastruct_Nova_Node_Nova__2, nova_datastruct_list_Nova_Array* nova_datastruct_Nova_Node_Nova__3, Context5* context)
{
	nova_datastruct_list_Nova_Queue_Nova_enqueue((*context->nova_datastruct_Nova_Node_Nova_queue), exceptionData, (nova_Nova_Object*)(nova_datastruct_Nova_Node_Nova__1));
}
