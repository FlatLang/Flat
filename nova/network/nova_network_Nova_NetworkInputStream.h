...
nova_network_Nova_NetworkInputStream* nova_network_Nova_NetworkInputStream_Nova_NetworkInputStream(nova_network_Nova_NetworkInputStream* this, nova_exception_Nova_ExceptionData* exceptionData, nova_network_Nova_ConnectionSocket* nova_network_Nova_NetworkInputStream_Nova_socket);
