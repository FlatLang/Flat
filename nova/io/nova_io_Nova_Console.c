...
{
	nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_io_Nova_Console_Nova_text), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "\n")));
}
...
nova_Nova_String* nova_io_Nova_Console_Nova_readPassword(nova_io_Nova_Console* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "\n"));
	return l1_Nova_pass;
}
