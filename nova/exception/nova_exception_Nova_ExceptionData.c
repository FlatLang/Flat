...
char nova_exception_Nova_ExceptionData_Nova_testLambda46(nova_exception_Nova_ExceptionData* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_exception_Nova_ExceptionData_Nova__1, Context1* context);
...
nova_exception_Nova_ExceptionData* nova_exception_Nova_ExceptionData_Nova_ExceptionData(nova_exception_Nova_ExceptionData* this, nova_exception_Nova_ExceptionData* exceptionData, buffer* nova_exception_Nova_ExceptionData_Nova_buf)
{
...
void nova_exception_Nova_ExceptionData_Nova_this(nova_exception_Nova_ExceptionData* this, nova_exception_Nova_ExceptionData* exceptionData, buffer* nova_exception_Nova_ExceptionData_Nova_buf)
{
	...
	this->nova_exception_Nova_ExceptionData_Nova_codes = nova_datastruct_list_Nova_IntArray_0_Nova_IntArray(0, exceptionData);
}
...
void nova_exception_Nova_ExceptionData_Nova_jumpToBuffer(nova_exception_Nova_ExceptionData* this, nova_exception_Nova_ExceptionData* exceptionData, int nova_exception_Nova_ExceptionData_Nova_code)
{
	...
	{
		nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, (char*)("Could not get exception buffer!")));
		return;
	}
