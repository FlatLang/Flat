...
nova_math_logic_Nova_WFF* nova_math_logic_Nova_WFF_Nova_WFF(nova_math_logic_Nova_WFF* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_math_logic_Nova_WFF_Nova_wellFormedFormula, nova_datastruct_list_Nova_Array* nova_math_logic_Nova_WFF_Nova_letters)
{
...
void nova_math_logic_Nova_WFF_Nova_this(nova_math_logic_Nova_WFF* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_math_logic_Nova_WFF_Nova_wellFormedFormula, nova_datastruct_list_Nova_Array* nova_math_logic_Nova_WFF_Nova_letters)
{
	...
	this->prv->nova_math_logic_Nova_WFF_Nova_hypotheses = nova_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
...
void nova_math_logic_Nova_WFF_Nova_decodeFormula(nova_math_logic_Nova_WFF* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		THROW(6, nova_math_logic_Nova_InvalidFormulaException_Nova_InvalidFormulaException(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "No valid conclusion found")));
	}
	...
	nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "Conclusion: "), exceptionData, nova_Nova_Object_virtual1_Nova_toString((nova_Nova_Object*)(l1_Nova_conclusion), exceptionData)));
	...
	for (; l4_Nova_i < (int)l1_Nova_statements->nova_datastruct_list_Nova_Array_Nova_count; l4_Nova_i++)
	{
		...
		nova_datastruct_list_Nova_Array_0_Nova_add(this->prv->nova_math_logic_Nova_WFF_Nova_hypotheses, exceptionData, (nova_Nova_Object*)(l4_Nova_group->nova_math_logic_Nova_StatementGroup_Nova_statement));
	}
	l6_Nova_n = (int)0;
...
nova_math_logic_Nova_StatementGroup* nova_math_logic_Nova_WFF_Nova_searchForConclusion(nova_math_logic_Nova_WFF* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_math_logic_Nova_WFF_Nova_wff)
{
	...
	l1_Nova_index = nova_Nova_String_Nova_lastIndexOf(nova_math_logic_Nova_WFF_Nova_wff, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "->"));
	if (l1_Nova_index < 0)
	{
		return (nova_math_logic_Nova_StatementGroup*)nova_null;
	}
...
l1_Nova_bounds = nova_datastruct_Nova_Bounds_1_Nova_Bounds(0, exceptionData, l1_Nova_conclusionStart, nova_math_logic_Nova_WFF_Nova_wff->nova_Nova_String_Nova_count);
l1_Nova_conclusion = nova_math_logic_Nova_Conclusion_Nova_Conclusion(0, exceptionData, nova_datastruct_Nova_Bounds_Nova_extractString(l1_Nova_bounds, exceptionData, nova_math_logic_Nova_WFF_Nova_wff));
...
l1_Nova_group = nova_math_logic_Nova_StatementGroup_Nova_StatementGroup(0, exceptionData, (nova_Nova_Object*)(l1_Nova_conclusion), l1_Nova_bounds);
...
nova_datastruct_list_Nova_Array* nova_math_logic_Nova_WFF_Nova_decodeHypotheses(nova_math_logic_Nova_WFF* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_math_logic_Nova_WFF_Nova_wff)
{
	...
	l1_Nova_next = (int)(0);
	l1_Nova_prev = (int)(0);
	l1_Nova_index = nova_Nova_String_1_Nova_indexOf(nova_math_logic_Nova_WFF_Nova_wff, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "&"));
	while (l1_Nova_index >= 0)
	{
		...
		nova_datastruct_list_Nova_Array_0_Nova_add(l1_Nova_list, exceptionData, (nova_Nova_Object*)(nova_math_logic_Nova_WFF_Nova_generateHypothesis(this, exceptionData, nova_math_logic_Nova_WFF_Nova_wff, l1_Nova_prev, l1_Nova_next + 1)));
		...
		l1_Nova_index = nova_Nova_String_2_Nova_indexOf(nova_math_logic_Nova_WFF_Nova_wff, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "&"), l1_Nova_prev + 1);
	}
	nova_datastruct_list_Nova_Array_0_Nova_add(l1_Nova_list, exceptionData, (nova_Nova_Object*)(nova_math_logic_Nova_WFF_Nova_generateHypothesis(this, exceptionData, nova_math_logic_Nova_WFF_Nova_wff, l1_Nova_prev, nova_math_logic_Nova_WFF_Nova_wff->nova_Nova_String_Nova_count)));
	return l1_Nova_list;
}
...
nova_math_logic_Nova_StatementGroup* nova_math_logic_Nova_WFF_Nova_generateHypothesis(nova_math_logic_Nova_WFF* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_math_logic_Nova_WFF_Nova_wff, int nova_math_logic_Nova_WFF_Nova_start, int nova_math_logic_Nova_WFF_Nova_end)
{
	...
	l1_Nova_bounds = nova_datastruct_Nova_Bounds_1_Nova_Bounds(0, exceptionData, nova_math_logic_Nova_WFF_Nova_start, nova_math_logic_Nova_WFF_Nova_end);
	l1_Nova_h = nova_math_logic_Nova_Hypothesis_Nova_Hypothesis(0, exceptionData, nova_datastruct_Nova_Bounds_Nova_extractString(l1_Nova_bounds, exceptionData, nova_math_logic_Nova_WFF_Nova_wff));
	l1_Nova_group = nova_math_logic_Nova_StatementGroup_Nova_StatementGroup(0, exceptionData, (nova_Nova_Object*)(l1_Nova_h), l1_Nova_bounds);
	return l1_Nova_group;
}
