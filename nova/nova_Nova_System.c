...
nova_process_Nova_Process* nova_Nova_System_Nova_execute(nova_Nova_System* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_Nova_System_Nova_command)
{
	...
	l1_Nova_pipe = getPipe((char*)(nova_Nova_System_Nova_command->nova_Nova_String_Nova_chars->nova_datastruct_list_Nova_Array_Nova_data), (nova_Nova_System_closure1_Nova_exit)&nova_Nova_System_2_Nova_exit, nova_Nova_System_Nova_System, nova_null);
