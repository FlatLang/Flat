...
nova_svg_no3_Nova_No3Select* nova_svg_no3_Nova_No3_Nova_select(nova_svg_no3_Nova_No3* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_svg_no3_Nova_No3_Nova_selection)
{
	return nova_svg_no3_Nova_No3Select_Nova_No3Select(0, exceptionData, nova_svg_no3_Nova_No3_Nova_selection);
}

nova_svg_no3_Nova_No3SelectAll* nova_svg_no3_Nova_No3_Nova_selectAll(nova_svg_no3_Nova_No3* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_svg_no3_Nova_No3_Nova_selection)
{
	return nova_svg_no3_Nova_No3SelectAll_Nova_No3SelectAll(0, exceptionData, nova_svg_no3_Nova_No3_Nova_selection);
}
