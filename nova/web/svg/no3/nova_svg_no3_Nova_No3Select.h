#pragma once
#ifndef FILE_nova_svg_no3_Nova_No3Select_NOVA
#define FILE_nova_svg_no3_Nova_No3Select_NOVA

typedef struct nova_svg_no3_Nova_No3Select nova_svg_no3_Nova_No3Select;
...
typedef struct nova_svg_no3_Extension_VTable_No3Select nova_svg_no3_Extension_VTable_No3Select;
struct nova_svg_no3_Extension_VTable_No3Select
{
	...
	nova_Nova_String* (*nova_svg_no3_Nova_No3Node_virtual1_Nova_toJs)(nova_svg_no3_Nova_No3Select*, nova_exception_Nova_ExceptionData*);
};

extern nova_svg_no3_Extension_VTable_No3Select nova_svg_no3_Extension_VTable_No3Select_val;


CCLASS_CLASS
(
	nova_svg_no3_Nova_No3Select, 
	
	nova_svg_no3_Extension_VTable_No3Select* vtable;
	nova_Nova_String* nova_svg_no3_Nova_No3Select_Nova_selection;
)
