...
nova_web_svg_no3_Extension_VTable_No3Select nova_web_svg_no3_Extension_VTable_No3Select_val =
{
	{
		0,
		0,
...
nova_web_svg_no3_Nova_No3Select* nova_web_svg_no3_Nova_No3Select_Nova_No3Select(nova_web_svg_no3_Nova_No3Select* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* nova_web_svg_no3_Nova_No3Select_Nova_selection)
{
	...
	nova_web_svg_no3_Nova_No3Select_0_Nova_super(this, exceptionData);
...
{
	return nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "d3.select('"), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)((this->nova_web_svg_no3_Nova_No3Select_Nova_selection)), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "')")));
}
