...
nova_web_svg_Nova_SvgMainComponent* nova_web_svg_Nova_SvgMainComponent_Nova_SvgMainComponent(nova_web_svg_Nova_SvgMainComponent* this, nova_exception_Nova_ExceptionData* exceptionData)
{
...
{
	this->nova_web_svg_Nova_SvgComponent_Nova_children = nova_web_svg_Nova_SvgComponentList_Nova_SvgComponentList(0, exceptionData);
}
...
{
	nova_io_Nova_File_Nova_write(nova_web_svg_Nova_SvgMainComponent_Nova_file, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "<?xml version = '1.0' standalone = 'no'?>\n"), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "<!DOCTYPE svg PUBLIC\"-//W3C//DTD Svg1.1//EN\" \"http://www.w3.org/Graphics/Svg/1.1/DTD/svg11.dtd\">"), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "<svg width=\"1400px\" height=\"950px\" version=\"1.1\" preserveAspectRatio=\"none\">\n"))));
	...
	nova_io_Nova_File_Nova_write(nova_web_svg_Nova_SvgMainComponent_Nova_file, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "</svg>\n"));
}
