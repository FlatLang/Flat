...
/**
 * Class that contains methods used for finding data about a String.
 *
...
public class StringUtils {
     ...
     *
     * // Scenario 2
     * findGroupedSymbols("number = ++num2", 8);
     * </pre>
     * 
     * </blockquote> Scenario 1 returns the "++" String and scenario 2 returns "" because the index
     * that it starts at is whitespace, not a symbol.
     *
     * @param str The String to search through for the symbols.
     * @param start The index to start the search at.
     * @return A String containing the grouped chars. If there were no grouped chars, then an empty
     *         String is returned.
     */
     ...
     *
     * // Scenario 2
     * findGroupedSymbols("number = ++num2", 10, -1);
     * </pre>
     * 
     * </blockquote> Scenario 1 and 2 both return the "++" String because they are searching the
     * same symbols at opposite ends and directions.
     *
     * @param str The String to search through for the symbols.
     * @param start The index to start the search at.
    ...
    /**
     * Get the next sequence of characters, if they are contained within the given chars array.<br>
     * For example: <blockquote>
     * 
     * <pre>
     * // Scenario 1
     ...
     *
     * // Scenario 2
     * findGroupedChars("number = ++num2", StringUtils.SYMBOLS_CHARS, 10, -1);
     * </pre>
     * 
     * </blockquote> Scenario 1 and 2 both return the "++" String because they are searching the
     * same symbols at opposite ends and directions.
     ...
     *         String is returned.
     */
    public static String findGroupedChars(CharSequence str, char chars[], int start,
        int direction) {
        int index = start;

        while (index < str.length() && index >= 0
            && StringUtils.containsChar(chars, str.charAt(index))) {
            index += direction;
        }
    ...
    /**
     * Get the Bounds of the next sequence of characters, if they are contained within the given
     * chars array.<br>
     * For example: <blockquote>
     * 
     * <pre>
     ...
     *
     * // Scenario 2
     * findGroupedCharsBounds("number = ++num2", StringUtils.SYMBOLS_CHARS, 2);
     * </pre>
     * 
     * </blockquote> Scenario 1 returns a Bounds containing [9, 11].<br>
     * Scenario 2 returns a Bounds containing [-1, -1], In other words Bounds.EMPTY.
     *
     * @param source The String to search through for the characters to find the Bounds from.
     * @param start The index to start the search at.
     * @param types Character arrays containing valid characters to search for.
     * @return The Bounds of the location that the characters were found at in the given source
     *         String.
     */
     ...
     *
     * // Scenario 2
     * findGroupedCharsBounds("number = ++num2", 0, 1, true, StringUtils.SYMBOLS_CHARS);
     * </pre>
     * 
     * </blockquote> Scenario 1 returns a Bounds containing [9, 11].<br>
     ...
     * @param opposite Whether to search for or against the data in the types array.
     * @param types Character arrays containing valid characters to search for.
     * @return The Bounds of the location that the characters were found at in the given source
     *         String.
     */
    public static Bounds findGroupedCharsBounds(String source, int start, int direction,
        boolean opposite, char[]... types) {
        int index = start;
    ...
    /**
     * Find the index of the next word in the given source String starting at the start of the
     * source String.
     *
     * @param source The source String to search for the next word in.
     * @param word The word to search for.
     * @return The index of the word. If the word was not found, -1 is returned.
     */
    ...
    /**
     * Find the index of the next word in the given source String starting at the given start index.
     *
     * @param source The source String to search for the next word in.
     * @param word The word to search for.
     * @param start The index to start the search at.
    ...
    /**
     * Find the index of the last instance of the given word in the given source String.
     *
     * @param source The source String to search for the next word in.
     * @param word The word to search for.
     * @return The index of the word. If the word was not found, -1 is returned.
     ...
     * @param start The index to start the search at.
     * @param direction The direction to search for the word in.
     * @return The index of the found word. If the word is not found, -1 is returned.
     */
    ...
    public static boolean startsWithWord(CharSequence source, String word) {
        ...
        return bounds.isValid() && bounds.getStart() == 0
            && bounds.extractString(source.toString()).equals(word);
    }
    ...
    /**
     * Find the next word in the given source starting at the beginning of the String. If there are
     * no words available, an empty String is returned.<br>
     * For example: <blockquote>
     * 
     * <pre>
     * // Scenario 1
     ...
     *
     * // Scenario 2
     * findNextWord("asdf = ++num2");
     * </pre>
     * 
     * </blockquote> Scenario 1 returns "number"<br>
     * Scenario 2 returns "asdf"
     *
     * @param source The source to search within.
     * @return The next available word if available, else it returns an empty String.
     */
    ...
    /**
     * Find the next word in the given source starting at the given index. If there are no words
     * available, an empty String is returned.<br>
     * For example: <blockquote>
     * 
     * <pre>
     * // Scenario 1
     ...
     *
     * // Scenario 2
     * findNextWord("number = ++num2", 8, -1);
     * </pre>
     * 
     * </blockquote> Scenario 1 and 2 both return "number"
     *
     * @param source The source to search within.
     * @param start The index to start the search.
     * @param direction The direction to search for the word in.
    ...
    public static Bounds findNextWordBounds(CharSequence source, int start, int direction) {
        ...
        int index =
            StringUtils.findNextLetterIndex(source, start + direction, direction, true, true);
    ...
    /**
     * Find the next index in which a letter resides, starting at the given index. If there are no
     * letters available, -1 is returned.<br>
     * <br>
     ...
     * </pre>
     * 
     * </blockquote> Scenario 1 returns 0<br>
     * Scenario 2 returns 5
     *
     * @param source The source to search within.
     * @param start The index to start the search.
     * @param direction The direction to search for the word in.
     * @return The next index in which a letter resides. If no letters are found, -1 is returned.
     */
    ...
    /**
     * Find the next index in which a letter resides, starting at the given index. If there are no
     * letters available, -1 is returned. However, if the <u>opposite</u> param is true, then the
     * opposite of what was stated above is done.<br>
     * <br>
     * A letter is anything besides whitespace and symbols.<br>
     * <br>
     * For example: <blockquote>
     ...
     *
     * // Scenario 2
     * findNextWord("number = ++num2", 8, -1, true);
     * </pre>
     * 
     * </blockquote> Scenario 1 returns 6<br>
     * Scenario 2 returns 8
     *
     * @param source The source to search within.
     * @param start The index to start the search.
     * @param direction The direction to search for the word in.
     * @param opposite Whether or not to search for anything that is NOT a letter (instead of
     ...
     * Find the next index in which a letter resides, starting at the given index. If there are no
     * letters available, -1 is returned. However, if the <u>opposite</u> param is true, then the
     * opposite of what was stated above is done. Passing true for the <u>bound</u> parameter makes
     * sure that -1 is never returned (It will return the end-point of whichever direction that the
     * method was searching in).<br>
     * <br>
     * A letter is anything besides whitespace and symbols.<br>
     * <br>
     * For example: <blockquote>
     ...
     *
     * // Scenario 2
     * findNextWord("number = ++num2", 4, -1, true, true);
     * </pre>
     * 
     * </blockquote> Scenario 1 returns 15<br>
     ...
     * @param opposite Whether or not to search for anything that is NOT a letter (instead of
     *        searching for a letter).
     * @param bound Whether or not to bound the result returned if the a result was not found.
     * @return The next index in which a letter resides.
     */
    public static int findNextLetterIndex(CharSequence source, int start, int direction,
        boolean opposite, boolean bound) {
    ...
    /**
     * Find the index of the ending char for the match. For instance, to search for an ending
     * parenthesis, starting from the opening parenthesis, you would pass findEndingMatch(str, 0,
     * '(', ')'); The method call would return the index of the ending parenthesis that is paired
     * with the index of 0.
     *
     ...
     * @return The index of the pair to the starting char, if no pair is found then -1 is returned.
     */
     ...
     * Find the index of the ending char for the match. For instance, to search for an ending
     * parenthesis, starting from the opening parenthesis, you would pass findEndingMatch(str, 0,
     * '(', ')', '\\'); <i>(The backslash would act to escape any parentheses. eg: \\( would not be
     * counted.)</i> The method call would return the index of the ending parenthesis that is paired
     * with the index of 0.
     *
     * @param str The String to search for the pair to the start char.
     * @param index The index of the start char in the pair.
     * @param startChar The char that starts off the pair. eg. '('
     * @param endChar The char that ends the pair. eg: ')'
     * @param escapeChar The char that escapes a start or end char, of there is no escape char, pass
     *        '(char)0'.
     * @return The index of the pair to the starting char, if no pair is found then -1 is returned.
     */
    public static int findEndingMatch(CharSequence str, int index, char startChar, char endChar,
     ...
     */
    public static int findEndingMatch(CharSequence str, int index, char startChar, char endChar,
        char escapeChar, int direction) {
        return findEndingMatch(str, index, Character.toString(startChar),
            Character.toString(endChar), escapeChar, direction);
    }

    /**
     * Find the index of the ending String for the match. For instance, to search for an ending
     * parenthesis, starting from the opening parenthesis, you would pass findEndingMatch(str, 0,
     * "(", ")", '\\'); <i>(The backslash would act to escape any parentheses. eg: \\( would not be
     * counted.)</i> The method call would return the index of the ending parenthesis that is paired
     * with the index of 0.
     ...
     * @return The index of the pair to the starting String, if no pair is found then -1 is
     *         returned.
     */
        ...
        while (index >= 0 && index < str.length()) {
            ...
            if (c == escapeChar && direction > 0) {
                if (index < str.length() - 1) {
                    if (StringUtils.containsString(str, end, index + 1)
                        || StringUtils.containsString(str, end, index + 1)) {
                        index += end.length();
                    }
                }
            } else if (StringUtils.containsString(str, start, index)
                && (direction > 0 || index > 0 && str.charAt(index - 1) != escapeChar)
                && (!start.equals(end) || scope == 0)) {
                scope++;
            } else if (StringUtils.containsString(str, end, index)
                && (direction > 0 || index > 0 && str.charAt(index - 1) != escapeChar)
                && (!end.equals(">") || str.charAt(index - 1) != '-')) {
                scope--;
    ...
    /**
     * Find the index of the ending quote, given the index of the start quote.
     *
     * @param value The String to search within.
     * @param start The index of the starting quote.
     * @return The index of the ending quote. If an end is not found, -1 is returned instead.
     */
    ...
    public static int findEndingQuote(CharSequence value, int start, int direction) {
        QuadFunction<CharSequence, Character, Integer, Integer, Integer> condition =
            (str, c, i, dir) -> {
                i += dir;

                if (dir > 0 && i < str.length() - 3 && str.charAt(i) == '#'
                    && !isCharacterEscaped(str, i) && str.charAt(i + 1) == '{') {
    ...
    /**
     * Find the index of the ending char that matches the given 'c' param, given the index of the
     * start char.
     *
     * @param value The String to search within.
     ...
     * @param start The index of the starting quote.
     * @param direction The direction in which to search the given String.
     * @return The index of the matching char. If an end is not found, -1 is returned instead.
     */
    public static int findEndingChar(CharSequence value, char c, int start, int direction,
        QuadFunction<CharSequence, Character, Integer, Integer, Integer> advance) {
    ...
    public static String removeContentsWithin(String source, String start, String end, int index) {
        ...
        return source.substring(0, bounds.getStart() - start.length())
            + source.substring(bounds.getEnd() + end.length());
    }

    public static Bounds findContentBoundsWithin(String source, String start, String end,
        int index) {
    ...
    /**
     * Search through the given value for any match within the strings array.
     *
     * @param value The String to search through.
     * @param strings The array to search through.
     * @return A Bounds instance with the end points of the found String. If a String is not found,
     *         [-1, -1] is returned.
     */
    ...
    public static Bounds findStrings(CharSequence value, String strings[], int start, int direction,
        boolean checkBaseScope) {
        return findStrings(value, strings, start, direction,
            checkBaseScope ? SCOPE_CHECKS_ALL : null);
    }
        ...
        while (start >= 0 && start < value.length()) {
            ...
            if (scopeChecks != null) {
                if (containsChar(scopeChecks, '"') && c == '"') {
                    start = findEndingQuote(value, start, direction);// findEndingQuote(value,
                                                                     // start, direction) +
                                                                     // direction;
                    ...
                    start = findEndingChar(value, c, start, direction);// findEndingQuote(value,
                                                                       // start, direction) +
                                                                       // direction;
                    ...
                    continue;
                } else if (containsChar(scopeChecks, '(')
    ...
    /**
     * Search the given haystack String for any match within the strings array starting at the given
     * char start index. If a match is encountered, the String that makes the match is returned. If
     * not match is made, null is returned.
     *
     ...
     * @return The String in the strings array that made the match. If no match was found, null is
     *         returned.
     */
    ...
    /**
     * Search the given haystack String for any match within the strings array at the given char
     * offset index. If a match is encountered, the String that makes the match is returned. If not
     ...
     * @param strings The array to search through to try and match.
     * @param index The index to search the value at.
     * @return Whether or not there is a match within the strings array at the given index in the
     *         haystack String.
     */
    ...
    /**
     * Check to see if the character is a new-line character. If so, increment the line-number
     * variable.
     *
     * @param start The index to start the search at.
     * @param statementStart The index to end the search at.
     * @param source The source String to search in.
     * @return The number of lines that the iterator encountered within the given bounds.
     */
    ...
    /**
     * Get the next possible index in the String that is not a whitespace character.
     *
     * @param str The String to search through.
     * @param index The index to start the search at.
     * @return The next possible index in the String that is not whitespace.
     */
    ...
    /**
     * Get the next possible index in the String that is not a whitespace character, while moving in
    ...
    /**
     * Get the next possible index in the String that is a whitespace character.
     *
     * @param str The String to search through.
     * @param index The index to start the search at.
     * @return The next possible index in the String that is whitespace.
     */
    ...
    /**
     * Get the next possible index in the String that contains a char in the given character array,
     * while moving in the specified direction. If none exists, -1 is returned.
     *
     * @param str The String to search through.
     * @param chars The array of valid characters to search for.
     * @param index The index to start the search at.
     * @param direction The direction in which to increment the index.
     * @return The next possible index in the String that is a character in the given array.
     */
     ...
     * @param index The index to start the search at.
     * @param direction The direction in which to increment the index.
     * @param opposite Whether or not to search for or against what is within the character array.
     * @return The next possible index in the String that is a character in the given array.
     */
    public static int findNextCharacter(CharSequence str, char chars[], int index, int direction,
        boolean opposite) {
     ...
     * <br>
     * For example: An input of "this is a test" would return "this\ is\ a\ test"
     *
    ...
    /**
     * Split the src by the commas. Makes sure not to split commas that are within parentheses and
     * quotes.
     *
    ...
    public static String[] splitCommas(String src, int searchGenerics, boolean allowTrailing) {
        ...
        while ((index = SyntaxUtils.findCharInBaseScope(src, ',', index + 1, searchGenerics)) >= 0)// (index
                                                                                                   // =
                                                                                                   // Regex.indexOf(src,
                                                                                                   // index
                                                                                                   // +
    ...
    public static String[] splitWhitespace(String src, int searchGenerics, boolean allowTrailing) {
        ...
        while ((index = SyntaxUtils.findCharInBaseScope(src, SyntaxUtils.WHITESPACE, index + 1,
            searchGenerics)) >= 0)// (index = Regex.indexOf(src, index + 1, ',', new char[] { '(' },
                                  // new char[] { ')' }, new char[] { '"' }, new boolean[] { false
                                  // }, new boolean[] { false }, new boolean[] { true })) > 0)
        {
            builder = new StringBuilder(src.substring(oldIndex, index));
     ...
     * <br>
     * For example: A call of "<code>trimToIdentifier("**identifer322&amp;+")</code>" would return
     * "<code>identifier322</code>"
     *
    ...
    /**
     * Get whether the given String only contains chars of the type in the given needles array.
     *
    ...
    /**
     * Search for the char at the given index in the given source String in the given array.
     *
    ...
    /**
     * Search for the given char 'c' in the given array, if it is found, return the index at which
     * it was found.
     *
     * @param array The array to search for 'c' in.
     * @param c The char to search for.
     * @return The index in the array of the occurrence of char 'c', if it was found in the array.
     */
    ...
    /**
     * Search for the given Element 'element' in the given array, if it is found, return the index
     * at which it was found.
     *
     * @param element The Element to search for.
     * @param array The array to search for 'element' in.
     * @return The index in the array of the occurrence of String 'element', if it was found in the
     *         array.
     */
    ...
    /**
     * Search for the given String 's' in the given list, if it is found, return the index at which
     * it was found.
     *
     * @param array The list to search for 's' in.
     * @param s The String to search for.
     * @return The index in the array of the occurrence of String 's', if it was found in the array.
     */
    ...
    /**
     * Find the String value of the data that is in between the last two words in the array.<br>
     * <br>
    ...
    /**
     * Search backwards for the index of the next available match of the needle within the haystack
     * String, if a match exists. The search starts at the given index.
     *
    ...
    /**
     * Get whether or not the needle matches the haystack at the given index.<br>
     * <br>
    ...
    /**
     * Generate a modified version of the given String in which for every character after the
     * "after" char type that is the same type as the given "removeType" char type will be removed
     * from the String.<br>
     * <br>
     * For example: Calling "<code>removeTypeAfterChar("this is an example", 's', ' ')</code>" would
     * return a String "thisisan example"
     *
     * @param str The String to generate a modified version of.
     * @param after The char type to search for the remove type directly after.
    ...
    /**
     * Increase the given String array size by one and insert the given String into the newly added
     * index.
     *
    ...
    /**
     * Increase the given Element array size by one and insert the given Element into the newly
     * added index.
     *
     * @param array The array to expand.
     ...
     * String out = removeSurroundingQuotes(s);
     * </pre>
     * 
     * </blockquote> The out String would contain the data "C:/myfile/test" without the surrounding
     * quotes.
     *
