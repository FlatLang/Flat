...
public class Writer
{
	public static NodeWriter getWriter(final Node node)
	{
		...
		else if (node instanceof MethodGenericTypeParameter)
		{
			return new MethodGenericTypeParameterWriter()
			{
				@Override
				public MethodGenericTypeParameter node()
				{
					return (MethodGenericTypeParameter)node;
				}
			};
		}
