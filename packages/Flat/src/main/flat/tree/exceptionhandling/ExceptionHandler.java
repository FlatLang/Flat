...
/**
 * Node extension that represents the declaration of an exception handling node type. See
...
public class ExceptionHandler extends Node {
    ...
    /**
     * Decode the given statement into a ExceptionHandler instance, if possible. If it is not
     ...
     * @param statement The statement to try to decode into a ExceptionHandler instance.
     * @param location The location of the statement in the source code.
     * @param require Whether or not to throw an error if anything goes wrong.
     * @return The generated node, if it was possible to translated it into a ExceptionHandler.
     */
    public static ExceptionHandler decodeStatement(Node parent, String statement, Location location,
        boolean require) {
    ...
    /**
     * Fill the given {@link ExceptionHandler} with the data that is in the specified node.
     *
    ...
    /**
     * Test the ExceptionHandler class type to make sure everything is working properly.
     *
