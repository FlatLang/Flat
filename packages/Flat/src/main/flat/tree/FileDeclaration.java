...
public class FileDeclaration extends Node {
    ...
    public ValidationResult validate(int phase) {
        ...
        switch (phase) {
            case SyntaxTree.PHASE_CLASS_DECLARATION:
                phaseLabel = "one";
                break;
            case SyntaxTree.PHASE_INSTANCE_DECLARATIONS:
                phaseLabel = "two";
                break;
            case SyntaxTree.PHASE_METHOD_CONTENTS:
                phaseLabel = "three";
                break;
            case SyntaxTree.PHASE_PRE_GENERATION:
                phaseLabel = "four";
                break;
        }
