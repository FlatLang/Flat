...
public class SyntaxUtils
{
	...
	{
		int index = StringUtils.findCharInBaseScope(statement, '=');
...
//		}
	...
	{
		int start = StringUtils.findCharInBaseScope(statement, '(');
...
//		}
	...
	public static String strictStripGenerics(String type)
	{
		if (type != null)
		{
			int start = StringUtils.findCharInBaseScope(type, '<');
	...
	public static LiteralNameData getFirstLiteralNameData(String statement, int startIndex) {
		int startTick = StringUtils.findCharInBaseScope(statement, '`', startIndex);
		String literalName;
		String validName;

		if (startTick >= 0) {
			int endTick = StringUtils.findCharInBaseScope(statement, '`', startTick + 1);
