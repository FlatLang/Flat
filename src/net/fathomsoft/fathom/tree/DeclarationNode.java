...
/**
 * VariableNode extension that represents the declaration of a variable
 * or method. Contains the modifiers for visibility and whether or not
 * the variable/method is static. 
 * 
...
public class DeclarationNode extends VariableNode
{
	...
	/**
	 * Instantiate a new DeclarationNode and initialize the default
	 * values.
	 */
	...
	/**
	 * Get whether or not the specified DeclarationNode is static. Static
	 * variables/methods are shared among each of its containing class's
	 * instances.
	 * 
	 * @return Whether or not the specified DeclarationNode is static.
	 */
	...
	/**
	 * Set whether or not the specified DeclarationNode is static. Static
	 * variables/methods are shared among each of its containing class's
	 * instances.
	 * 
	 ...
	 * <ul>
	 * 	<li>DeclarationNode.PRIVATE</li>
	 * 	<li>DeclarationNode.PROTECTED</li>
	 * 	<li>DeclarationNode.PUBLIC</li>
	 * </ul>
	 * 
	 ...
	 * specified DeclarationNode.<br>
	 * <br>
	 * For example: DeclarationNode.PRIVATE would return a String with
	...
	/**
	 * @see net.fathomsoft.fathom.tree.variables.VariableNode#setAttribute(java.lang.String)
	 */
...
//	}
	...
	/**
	 * Fill the given DeclarationNode with the data that is in the
	 * specified node.
	 * 
