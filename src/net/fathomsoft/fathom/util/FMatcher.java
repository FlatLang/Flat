...
import net.fathomsoft.fathom.util.FPattern.Bounds;

/**
 * Class used to traverse a Pattern linearly.
 * 
 * @author	Braden Steffaniak
 * @since	Mar 10, 2014 at 8:19:50 PM
 * @since	v0.1
 * @version	Mar 10, 2014 at 8:19:50 PM
 * @version	v0.1
 */
public class FMatcher
{
	private int			index, end;
	
	private String		data, group;
	
	private FPattern	pattern;
	 ...
	 */
	public FMatcher(String data, FPattern pattern)
	{
		this.data    = data;
