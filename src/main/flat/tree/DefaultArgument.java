...
public class DefaultArgument extends IValue {
    ...
    /**
     * Decode the given statement into a {@link DefaultArgument} instance, if possible. If it is not
     ...
     * @param statement The statement to try to decode into a {@link DefaultArgument} instance.
     * @param location The location of the statement in the source code.
     * @param require Whether or not to throw an error if anything goes wrong.
     * @return The generated node, if it was possible to translated it into a
     *         {@link DefaultArgument}.
     */
    public static DefaultArgument decodeStatement(Node parent, String statement, Location location,
        boolean require) {
    ...
    /**
     * Fill the given {@link DefaultArgument} with the data that is in the specified node.
     *
    ...
    /**
     * Test the {@link DefaultArgument} class type to make sure everything is working properly.
     *
