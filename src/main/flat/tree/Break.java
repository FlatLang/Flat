...
public class Break extends Node {
    ...
    /**
     * Decode the given statement into a {@link Break} instance, if possible. If it is not possible,
     ...
     * @param statement The statement to try to decode into a {@link Break} instance.
     * @param location The location of the statement in the source code.
     * @param require Whether or not to throw an error if anything goes wrong.
     * @return The generated node, if it was possible to translated it into a {@link Break}.
     */
    public static Break decodeStatement(Node parent, String statement, Location location,
        boolean require) {
    ...
    /**
     * Fill the given {@link Break} with the data that is in the specified node.
     *
    ...
    /**
     * Test the {@link Break} class type to make sure everything is working properly.
     *
