...
public class PassingAnnotation extends Annotation implements ModifierAnnotation {
    ...
    public static PassingAnnotation decodeStatement(Node parent, String name, String parameters, Location location, boolean require) {
...
//			((VariableDeclaration)next).isFinal = true;
    ...
    @Override
    public PassingAnnotation clone(Node temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations) {
    ...
    public PassingAnnotation cloneTo(PassingAnnotation node, boolean cloneChildren, boolean cloneAnnotations) {
