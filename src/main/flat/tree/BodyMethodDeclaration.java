...
public class BodyMethodDeclaration extends FlatMethodDeclaration {
    ...
    public boolean isInstance() {
        return super.isInstance() || getName().equals(Constructor.IDENTIFIER)
     ...
     */
    public static BodyMethodDeclaration decodeStatement(Node parent, String statement,
    ...
    /**
     * Generate a Method with the given parent and location for temporary use.
     *
    ...
    public static BodyMethodDeclaration generateTemporaryMethod(Node parent, Location locationIn) {
        ...
        BodyMethodDeclaration methodDeclaration =
            decodeStatement(parent, name + "()", locationIn, true);
    ...
    public boolean convertFunctionContents() {
        ...
        if (!parsedConvertedContext && doesConvertToPrimitive()
            && getConversionTargetContext().isInTree()
            && getConversionTarget().getScope() != null) {
            SyntaxUtils.parseConvertedContentsTo(getConversionTarget().getScope(),
                getConversionTargetContext(), this, this);
     ...
     */
    @Override
    public BodyMethodDeclaration clone(Node temporaryParent, Location locationIn,
    ...
    public BodyMethodDeclaration cloneTo(BodyMethodDeclaration node, boolean cloneChildren,
        ...
        for (DefaultParameterInitialization param : node.getScope()
            .getDefaultParameterInitializations()) {
