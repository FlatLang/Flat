...
/**
 * {@link FieldList} extensions that contains all of the private Field instances of a
 * ClassDeclaration.
 *
...
public class StaticFieldList extends List {
    ...
    /**
     * Fill the given {@link StaticFieldList} with the data that is in the specified node.
     *
    ...
    /**
     * Test the StaticFieldList class type to make sure everything is working properly.
     *
