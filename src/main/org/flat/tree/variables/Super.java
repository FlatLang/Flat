...
import org.flat.tree.ParameterList;
import org.flat.tree.Priority;
import org.flat.tree.StaticClassReference;
...
public class Super extends Priority
{
	...
	/**
	 * @see org.flat.tree.Variable#clone(Node, Location, boolean)
	 */
	@Override
