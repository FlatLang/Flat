...
import org.flat.tree.FlatParameterList.ReturnParameterList;
import org.flat.tree.annotations.NativeAnnotation;
import org.flat.tree.annotations.RequireGenericTypeAnnotation;
import org.flat.tree.generics.GenericTypeArgument;
import org.flat.tree.generics.GenericTypeArgumentList;
...
//							SyntaxUtils.performWalk(context, context.getParentClass(), param.getParentClass(), param, true);
	...
	/*/**
	 * @see org.flat.tree.Node#generateFlatInput(StringBuilder, boolean)
	 *
	@Override
