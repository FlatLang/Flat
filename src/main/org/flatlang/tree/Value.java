...
import org.flatlang.tree.annotations.NativeAnnotation;
import org.flatlang.tree.annotations.RequireGenericTypeAnnotation;
...
//			if ("flatlang/primitive/number/Int".equals(getTypeClassLocation()))
//			{
//				type += "IntArray";
//			}
//			else if ("flatlang/primitive/number/Char".equals(getTypeClassLocation()))
//			{
//				type += "CharArray";
//			}
//			else if ("flatlang/primitive/number/Double".equals(getTypeClassLocation()))
//			{
//				type += "DoubleArray";
//			}
//			else
...
//		if (c != null)
//		{
//			return c.isOfType("flatlang/datastruct/list/CharArray") || c.isOfType("flatlang/datastruct/list/IntArray") || c.isOfType("flatlang/datastruct/list/DoubleArray") ||
//				c.isOfType("flatlang/datastruct/list/CharArrayIterator") || c.isOfType("flatlang/datastruct/list/IntArrayIterator") || c.isOfType("flatlang/datastruct/list/DoubleArrayIterator");
//		}
	...
	public Value getArrayTypeValue()
	{
		...
		if ("flatlang/datastruct/list/Array".equals(getTypeClassLocation()))
		{
...
//							SyntaxUtils.performWalk(context, context.getParentClass(), param.getParentClass(), param, true);
	...
	/*/**
	 * @see org.flatlang.tree.Node#generateFlatInput(StringBuilder, boolean)
	 *
	@Override
...
//		}
	...
	public Literal generateDefaultValue(Node parent, Location location)
	{
		...
		else if (getTypeClass().isOfType(getProgram().getClassDeclaration("flatlang/primitive/number/Char")))
		{
			return (Literal)Literal.decodeStatement(parent, "'\\0'", location, true, true);
		}
		else if (getTypeClass().isOfType(getProgram().getClassDeclaration("flatlang/primitive/number/Number")))
		{
			return (Literal)Literal.decodeStatement(parent, "0", location, true, true);
		}
		else if (getTypeClass().isOfType(getProgram().getClassDeclaration("flatlang/primitive/Bool")))
		{
