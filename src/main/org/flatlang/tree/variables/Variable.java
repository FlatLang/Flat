package org.flatlang.tree.variables;
...
import org.flatlang.tree.annotations.FinalAnnotation;
import org.flatlang.tree.annotations.ImmutableAnnotation;
import org.flatlang.tree.annotations.VarAnnotation;
...
import org.flatlang.tree.AbstractValue;
			...
			if (current != null)
			{
				...
				while (current != null)
				{
					...
					for (Node n : children)
					{
						...
						if (m.getName().equals("isOfType") && m.getDeclaringClass().getClassLocation().endsWith("flatlang/meta/Class"))
						{
