...
public class Operator extends IValue
{
	...
	public Trait getOperatorOverload()
	{
		switch (operator)
		{
			case "==": return (Trait)getProgram().getClassDeclaration("flatlang/operators/EqualsOperator");
			case "!=": return (Trait)getProgram().getClassDeclaration("flatlang/operators/NotEqualToOperator");
			case "*": return (Trait)getProgram().getClassDeclaration("flatlang/operators/MultiplyOperator");
			case "*=": return (Trait)getProgram().getClassDeclaration("flatlang/operators/MultiplyEqualsOperator");
			case "+": return (Trait)getProgram().getClassDeclaration("flatlang/operators/PlusOperator");
			case "+=": return (Trait)getProgram().getClassDeclaration("flatlang/operators/PlusEqualsOperator");
			case "-": return (Trait)getProgram().getClassDeclaration("flatlang/operators/MinusOperator");
			case "-=": return (Trait)getProgram().getClassDeclaration("flatlang/operators/MinusEqualsOperator");
			case "<": return (Trait)getProgram().getClassDeclaration("flatlang/operators/LessThanOperator");
			case "<=": return (Trait)getProgram().getClassDeclaration("flatlang/operators/LessThanOrEqualToOperator");
			case ">": return (Trait)getProgram().getClassDeclaration("flatlang/operators/GreaterThanOperator");
			case ">=": return (Trait)getProgram().getClassDeclaration("flatlang/operators/GreaterThanOrEqualToOperator");
			default: return null;
		}
	}
