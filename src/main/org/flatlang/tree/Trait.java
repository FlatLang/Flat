...
public class Trait extends ClassDeclaration
{
	...
	public String getExtendedClassLocation()
	{
		...
		return extended != null ? (!extended.equals("flatlang/Object") ? extended : null) : null;
	}
	...
	public MethodDeclaration[] getMethods(String methodName, MethodList.SearchFilter filter)
	{
		...
		{
			ClassDeclaration obj = getExtendedClass().getTypeClass();//getProgram().getClassDeclaration("flatlang/Object");
			
			boolean before = filter.checkInterfaces;
			
			if (obj.getClassLocation().equals("flatlang/Object") && obj.implementsInterface(this, false))
			{
