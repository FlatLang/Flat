...
//		variables.addChild(decl);
	...
	{
		ClassDeclaration iterator = getProgram().getClassDeclaration("flatlang/datastruct/list/Iterator");
		...
		{
			ClassDeclaration iterable = getProgram().getClassDeclaration("flatlang/datastruct/list/Iterable");
