...
import static org.flatlang.tree.Value.POINTER;
...
//		}
		...
		if (call != null)
		{
			...
			if (ref instanceof Variable)
			{
				...
				return arg.getFlatTypeClass();//d.getGenericTypeParameter(index).getFlatTypeClass();
			}
...
//			if (!required[i].isGenericType())
	...
	public static boolean isTypeCompatible(GenericCompatible context, Value required, Value given, boolean searchGeneric, int arrayDifference)
	{
		...
		else if (given != null && given.isFunctionType() && required.getTypeClass() != null && required.getTypeClass().getClassLocation().equals("flatlang/Object"))
		{
			return true;
		}
...
//		}
		...
		{
			if (required.isExternalType() || (required.getTypeClassLocation().equals("flatlang/primitive/number/Char") && required.getArrayDimensions() == 1 && given.getTypeClassLocation() != null && given.getTypeClassLocation().equals("flatlang/String")))
			{
				return true;
			}
