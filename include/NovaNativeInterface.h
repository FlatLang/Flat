...
typedef void (*nova_standard_io_Nova_Console_native5_Nova_writeLine)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, long);
...
typedef long (*nova_standard_math_Nova_Math_native_Nova_max)(nova_standard_math_Nova_Math*, nova_standard_exception_Nova_ExceptionData*, long, long);
...
typedef int (*nova_standard_primitive_number_Nova_Number_native0_Nova_numDigits)(nova_standard_primitive_number_Nova_Number*, nova_standard_exception_Nova_ExceptionData*, long_long);
...
typedef stabilitytest_Nova_UnstableException* (*stabilitytest_Nova_UnstableException_native3_Nova_construct)(stabilitytest_Nova_UnstableException*, nova_standard_exception_Nova_ExceptionData*);

typedef struct stabilitytest_native_UnstableException
{
stabilitytest_Nova_UnstableException_native3_Nova_construct construct;
