...
typedef nova_standard_Nova_String* (*nova_standard_Nova_String_native_Nova_capitalize)(nova_standard_Nova_String*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_Nova_String* (*nova_standard_Nova_String_native_Nova_transform)(nova_standard_Nova_String*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String_closure3_Nova_transform nova_standard_Nova_String_Nova_transform, void* nova_standard_Nova_String_ref_Nova_transform, void* transform_context);
typedef nova_standard_Nova_String* (*nova_standard_Nova_String_native0_Nova_getStringBetween)(nova_standard_Nova_String*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*, nova_standard_Nova_String*);
typedef nova_standard_Nova_String* (*nova_standard_Nova_String_native1_Nova_getStringBetween)(nova_standard_Nova_String*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*, nova_standard_Nova_String*, int);
...
nova_standard_Nova_String_native_Nova_capitalize capitalize;
nova_standard_Nova_String_native_Nova_transform transform;
nova_standard_Nova_String_native0_Nova_getStringBetween getStringBetween__nova_standard_String__nova_standard_String;
nova_standard_Nova_String_native1_Nova_getStringBetween getStringBetween__nova_standard_String__nova_standard_String__nova_standard_primitive_number_Int;
...
typedef nova_standard_Nova_System* (*nova_standard_Nova_System_native_Nova_System)(nova_standard_Nova_System*, nova_standard_exception_Nova_ExceptionData*);
...
typedef nova_standard_database_Nova_DBConnector* (*nova_standard_database_Nova_DBConnector_native_Nova_DBConnector)(nova_standard_database_Nova_DBConnector*, nova_standard_exception_Nova_ExceptionData*);
...
typedef nova_standard_database_Nova_ResultSet* (*nova_standard_database_Nova_ResultSet_native_Nova_ResultSet)(nova_standard_database_Nova_ResultSet*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*, int);
...
nova_standard_datastruct_Nova_BinaryNode_native0_Nova_BinaryNode BinaryNode;
...
typedef nova_standard_datastruct_Nova_BinaryTree* (*nova_standard_datastruct_Nova_BinaryTree_native_Nova_addNodes)(nova_standard_datastruct_Nova_BinaryTree*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef nova_standard_datastruct_Nova_BinaryTree* (*nova_standard_datastruct_Nova_BinaryTree_native_Nova_BinaryTree)(nova_standard_datastruct_Nova_BinaryTree*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
nova_standard_datastruct_Nova_BinaryTree_native_Nova_addNodes addNodes;
...
typedef nova_standard_datastruct_Nova_Tree* (*nova_standard_datastruct_Nova_Tree_native_Nova_Tree)(nova_standard_datastruct_Nova_Tree*, nova_standard_exception_Nova_ExceptionData*);
...
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_Array_native_Nova_addAll)(nova_standard_datastruct_list_Nova_Array*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_Array_native0_Nova_add)(nova_standard_datastruct_list_Nova_Array*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
...
typedef nova_standard_Nova_Object* (*nova_standard_datastruct_list_Nova_Array_native0_Nova_get)(nova_standard_datastruct_list_Nova_Array*, nova_standard_exception_Nova_ExceptionData*, int);
...
typedef char (*nova_standard_datastruct_list_Nova_Array_native_Nova_contains)(nova_standard_datastruct_list_Nova_Array*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_Array_native_Nova_toArray)(nova_standard_datastruct_list_Nova_Array*, nova_standard_exception_Nova_ExceptionData*);
...
typedef nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_Array_native0_Nova_toString)(nova_standard_datastruct_list_Nova_Array*, nova_standard_exception_Nova_ExceptionData*);
...
{
nova_standard_datastruct_list_Nova_Array_native_Nova_addAll addAll;
...
nova_standard_datastruct_list_Nova_Array_native0_Nova_get get__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_Array_native_Nova_set set;
nova_standard_datastruct_list_Nova_Array_native_Nova_contains contains;
...
nova_standard_datastruct_list_Nova_Array_native0_Nova_toString toString;
...
typedef char (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_get)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_map)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_CharArray_closure3_Nova_mapFunc nova_standard_datastruct_list_Nova_CharArray_Nova_mapFunc, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_mapFunc, void* mapFunc_context);
typedef void (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_forEach)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_CharArray_closure6_Nova_func nova_standard_datastruct_list_Nova_CharArray_Nova_func, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_func, void* func_context);
typedef char (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_any)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_CharArray_closure9_Nova_anyFunc nova_standard_datastruct_list_Nova_CharArray_Nova_anyFunc, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_anyFunc, void* anyFunc_context);
typedef char (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_all)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_CharArray_closure12_Nova_allFunc nova_standard_datastruct_list_Nova_CharArray_Nova_allFunc, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_allFunc, void* allFunc_context);
typedef nova_standard_datastruct_list_Nova_CharArray* (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_filter)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_CharArray_closure15_Nova_filterFunc nova_standard_datastruct_list_Nova_CharArray_Nova_filterFunc, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_filterFunc, void* filterFunc_context);
typedef nova_standard_datastruct_list_Nova_CharArray* (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_take)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef nova_standard_datastruct_list_Nova_CharArray* (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_skip)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef char (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_firstWhere)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_CharArray_closure18_Nova_func nova_standard_datastruct_list_Nova_CharArray_Nova_func, void* nova_standard_datastruct_list_Nova_CharArray_ref_Nova_func, void* func_context);
typedef nova_standard_datastruct_list_Nova_CharArray* (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_reverse)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_CharArray_native_Nova_join)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
typedef nova_standard_datastruct_list_Nova_CharArray* (*nova_standard_datastruct_list_Nova_CharArray_native0_Nova_CharArray)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_datastruct_list_Nova_CharArray* (*nova_standard_datastruct_list_Nova_CharArray_native1_Nova_CharArray)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef nova_standard_datastruct_list_Nova_CharArray* (*nova_standard_datastruct_list_Nova_CharArray_native2_Nova_CharArray)(nova_standard_datastruct_list_Nova_CharArray*, nova_standard_exception_Nova_ExceptionData*, char*, int);

typedef struct nova_standard_datastruct_list_native_CharArray
{
nova_standard_datastruct_list_Nova_CharArray_native_Nova_get get;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_map map;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_forEach forEach;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_any any;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_all all;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_filter filter;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_take take;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_skip skip;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_firstWhere firstWhere;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_reverse reverse;
nova_standard_datastruct_list_Nova_CharArray_native_Nova_join join;
nova_standard_datastruct_list_Nova_CharArray_native0_Nova_CharArray CharArray;
nova_standard_datastruct_list_Nova_CharArray_native1_Nova_CharArray CharArray__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_CharArray_native2_Nova_CharArray CharArray__Array1d_nova_standard_primitive_number_Char__nova_standard_primitive_number_Int;
} nova_standard_datastruct_list_native_CharArray;

typedef nova_standard_datastruct_list_Nova_Iterator* (*nova_standard_datastruct_list_Nova_CharArrayIterator_native0_Nova_reset)(nova_standard_datastruct_list_Nova_CharArrayIterator*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_datastruct_list_Nova_CharArrayIterator* (*nova_standard_datastruct_list_Nova_CharArrayIterator_native_Nova_CharArrayIterator)(nova_standard_datastruct_list_Nova_CharArrayIterator*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_CharArray*);

typedef struct nova_standard_datastruct_list_native_CharArrayIterator
{
nova_standard_datastruct_list_Nova_CharArrayIterator_native0_Nova_reset reset;
nova_standard_datastruct_list_Nova_CharArrayIterator_native_Nova_CharArrayIterator CharArrayIterator;
} nova_standard_datastruct_list_native_CharArrayIterator;
...
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_map)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray_closure3_Nova_mapFunc nova_standard_datastruct_list_Nova_DoubleArray_Nova_mapFunc, void* nova_standard_datastruct_list_Nova_DoubleArray_ref_Nova_mapFunc, void* mapFunc_context);
typedef void (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_forEach)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray_closure6_Nova_func nova_standard_datastruct_list_Nova_DoubleArray_Nova_func, void* nova_standard_datastruct_list_Nova_DoubleArray_ref_Nova_func, void* func_context);
typedef char (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_any)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray_closure9_Nova_anyFunc nova_standard_datastruct_list_Nova_DoubleArray_Nova_anyFunc, void* nova_standard_datastruct_list_Nova_DoubleArray_ref_Nova_anyFunc, void* anyFunc_context);
typedef char (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_all)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray_closure12_Nova_allFunc nova_standard_datastruct_list_Nova_DoubleArray_Nova_allFunc, void* nova_standard_datastruct_list_Nova_DoubleArray_ref_Nova_allFunc, void* allFunc_context);
typedef nova_standard_datastruct_list_Nova_DoubleArray* (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_filter)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray_closure15_Nova_filterFunc nova_standard_datastruct_list_Nova_DoubleArray_Nova_filterFunc, void* nova_standard_datastruct_list_Nova_DoubleArray_ref_Nova_filterFunc, void* filterFunc_context);
typedef nova_standard_datastruct_list_Nova_DoubleArray* (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_take)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef nova_standard_datastruct_list_Nova_DoubleArray* (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_skip)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef double (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_firstWhere)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray_closure18_Nova_func nova_standard_datastruct_list_Nova_DoubleArray_Nova_func, void* nova_standard_datastruct_list_Nova_DoubleArray_ref_Nova_func, void* func_context);
typedef nova_standard_datastruct_list_Nova_DoubleArray* (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_reverse)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_join)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
typedef nova_standard_datastruct_list_Nova_DoubleArray* (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_DoubleArray)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_datastruct_list_Nova_DoubleArray* (*nova_standard_datastruct_list_Nova_DoubleArray_native1_Nova_DoubleArray)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef nova_standard_datastruct_list_Nova_DoubleArray* (*nova_standard_datastruct_list_Nova_DoubleArray_native2_Nova_DoubleArray)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, double*, int);

typedef struct nova_standard_datastruct_list_native_DoubleArray
{
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_map map__nova_standard_Object;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_forEach forEach__void;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_any any__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_all all__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_filter filter__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_take take__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_skip skip__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_firstWhere firstWhere__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_reverse reverse;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_join join__nova_standard_String;
nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_DoubleArray DoubleArray;
nova_standard_datastruct_list_Nova_DoubleArray_native1_Nova_DoubleArray DoubleArray__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_DoubleArray_native2_Nova_DoubleArray DoubleArray__Array1d_nova_standard_primitive_number_Double__nova_standard_primitive_number_Int;
} nova_standard_datastruct_list_native_DoubleArray;

typedef nova_standard_datastruct_list_Nova_Iterator* (*nova_standard_datastruct_list_Nova_DoubleArrayIterator_native0_Nova_reset)(nova_standard_datastruct_list_Nova_DoubleArrayIterator*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_datastruct_list_Nova_DoubleArrayIterator* (*nova_standard_datastruct_list_Nova_DoubleArrayIterator_native_Nova_DoubleArrayIterator)(nova_standard_datastruct_list_Nova_DoubleArrayIterator*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray*);

typedef struct nova_standard_datastruct_list_native_DoubleArrayIterator
{
nova_standard_datastruct_list_Nova_DoubleArrayIterator_native0_Nova_reset reset;
nova_standard_datastruct_list_Nova_DoubleArrayIterator_native_Nova_DoubleArrayIterator DoubleArrayIterator;
} nova_standard_datastruct_list_native_DoubleArrayIterator;
...
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_map)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntArray_closure3_Nova_mapFunc nova_standard_datastruct_list_Nova_IntArray_Nova_mapFunc, void* nova_standard_datastruct_list_Nova_IntArray_ref_Nova_mapFunc, void* mapFunc_context);
typedef void (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_forEach)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntArray_closure6_Nova_func nova_standard_datastruct_list_Nova_IntArray_Nova_func, void* nova_standard_datastruct_list_Nova_IntArray_ref_Nova_func, void* func_context);
typedef char (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_any)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntArray_closure9_Nova_anyFunc nova_standard_datastruct_list_Nova_IntArray_Nova_anyFunc, void* nova_standard_datastruct_list_Nova_IntArray_ref_Nova_anyFunc, void* anyFunc_context);
typedef char (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_all)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntArray_closure12_Nova_allFunc nova_standard_datastruct_list_Nova_IntArray_Nova_allFunc, void* nova_standard_datastruct_list_Nova_IntArray_ref_Nova_allFunc, void* allFunc_context);
typedef nova_standard_datastruct_list_Nova_IntArray* (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_filter)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntArray_closure15_Nova_filterFunc nova_standard_datastruct_list_Nova_IntArray_Nova_filterFunc, void* nova_standard_datastruct_list_Nova_IntArray_ref_Nova_filterFunc, void* filterFunc_context);
typedef nova_standard_datastruct_list_Nova_IntArray* (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_take)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef nova_standard_datastruct_list_Nova_IntArray* (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_skip)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, int);
typedef int (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_firstWhere)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntArray_closure18_Nova_func nova_standard_datastruct_list_Nova_IntArray_Nova_func, void* nova_standard_datastruct_list_Nova_IntArray_ref_Nova_func, void* func_context);
typedef nova_standard_datastruct_list_Nova_IntArray* (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_reverse)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_IntArray_native0_Nova_join)(nova_standard_datastruct_list_Nova_IntArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
...
{
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_map map__nova_standard_Object;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_forEach forEach__void;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_any any__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_all all__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_filter filter__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_take take__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_skip skip__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_firstWhere firstWhere__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_reverse reverse;
nova_standard_datastruct_list_Nova_IntArray_native0_Nova_join join__nova_standard_String;
...
typedef char (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_contains)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, int);
typedef nova_standard_datastruct_list_Nova_IntArray* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_toArray)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*);
typedef void (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_forEach)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntRange_closure3_Nova_func nova_standard_datastruct_list_Nova_IntRange_Nova_func, void* nova_standard_datastruct_list_Nova_IntRange_ref_Nova_func, void* func_context);
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_map)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntRange_closure6_Nova_mapFunc nova_standard_datastruct_list_Nova_IntRange_Nova_mapFunc, void* nova_standard_datastruct_list_Nova_IntRange_ref_Nova_mapFunc, void* mapFunc_context);
typedef char (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_any)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntRange_closure9_Nova_anyFunc nova_standard_datastruct_list_Nova_IntRange_Nova_anyFunc, void* nova_standard_datastruct_list_Nova_IntRange_ref_Nova_anyFunc, void* anyFunc_context);
typedef char (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_all)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntRange_closure12_Nova_allFunc nova_standard_datastruct_list_Nova_IntRange_Nova_allFunc, void* nova_standard_datastruct_list_Nova_IntRange_ref_Nova_allFunc, void* allFunc_context);
typedef nova_standard_datastruct_list_Nova_IntArray* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_filter)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntRange_closure15_Nova_filterFunc nova_standard_datastruct_list_Nova_IntRange_Nova_filterFunc, void* nova_standard_datastruct_list_Nova_IntRange_ref_Nova_filterFunc, void* filterFunc_context);
typedef nova_standard_datastruct_list_Nova_IntRange* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_take)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, int);
typedef nova_standard_datastruct_list_Nova_IntRange* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_skip)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, int);
typedef int (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_firstWhere)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntRange_closure18_Nova_func nova_standard_datastruct_list_Nova_IntRange_Nova_func, void* nova_standard_datastruct_list_Nova_IntRange_ref_Nova_func, void* func_context);
typedef nova_standard_datastruct_list_Nova_IntRange* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_reverse)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_join)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
typedef nova_standard_Nova_String* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_toString)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_datastruct_list_Nova_IntRange* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_IntRange)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_datastruct_list_Nova_IntRange* (*nova_standard_datastruct_list_Nova_IntRange_native1_Nova_IntRange)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*, int, int);

typedef struct nova_standard_datastruct_list_native_IntRange
{
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_contains contains__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_toArray toArray;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_forEach forEach__void;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_map map__nova_standard_Object;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_any any__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_all all__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_filter filter__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_take take__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_skip skip__nova_standard_primitive_number_Int;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_firstWhere firstWhere__nova_standard_primitive_Bool;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_reverse reverse;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_join join__nova_standard_String;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_toString toString;
nova_standard_datastruct_list_Nova_IntRange_native0_Nova_IntRange IntRange;
nova_standard_datastruct_list_Nova_IntRange_native1_Nova_IntRange IntRange__nova_standard_primitive_number_Int__nova_standard_primitive_number_Int;
} nova_standard_datastruct_list_native_IntRange;

typedef nova_standard_datastruct_list_Nova_Iterator* (*nova_standard_datastruct_list_Nova_IntRangeIterator_native0_Nova_reset)(nova_standard_datastruct_list_Nova_IntRangeIterator*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_datastruct_list_Nova_IntRangeIterator* (*nova_standard_datastruct_list_Nova_IntRangeIterator_native_Nova_IntRangeIterator)(nova_standard_datastruct_list_Nova_IntRangeIterator*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_IntRange*);

typedef struct nova_standard_datastruct_list_native_IntRangeIterator
{
nova_standard_datastruct_list_Nova_IntRangeIterator_native0_Nova_reset reset;
nova_standard_datastruct_list_Nova_IntRangeIterator_native_Nova_IntRangeIterator IntRangeIterator;
} nova_standard_datastruct_list_native_IntRangeIterator;
...
typedef nova_standard_datastruct_list_Nova_LinkedList* (*nova_standard_datastruct_list_Nova_LinkedList_native_Nova_addAll)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef char (*nova_standard_datastruct_list_Nova_LinkedList_native0_Nova_contains)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_LinkedList_native0_Nova_toArray)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*nova_standard_datastruct_list_Nova_LinkedList_native0_Nova_forEach)(nova_standard_datastruct_list_Nova_LinkedList*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_LinkedList_closure6_Nova_func nova_standard_datastruct_list_Nova_LinkedList_Nova_func, void* nova_standard_datastruct_list_Nova_LinkedList_ref_Nova_func, void* func_context);
...
{
nova_standard_datastruct_list_Nova_LinkedList_native_Nova_addAll addAll;
...
nova_standard_datastruct_list_Nova_LinkedList_native0_Nova_contains contains__nova_standard_Object;
...
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_datastruct_list_Nova_List_native0_Nova_toArray)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*);
typedef char (*nova_standard_datastruct_list_Nova_List_native0_Nova_contains)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
...
typedef nova_standard_datastruct_list_Nova_List* (*nova_standard_datastruct_list_Nova_List_native0_Nova_filter)(nova_standard_datastruct_list_Nova_List*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_List_closure15_Nova_filterFunc nova_standard_datastruct_list_Nova_List_Nova_filterFunc, void* nova_standard_datastruct_list_Nova_List_ref_Nova_filterFunc, void* filterFunc_context);
...
nova_standard_datastruct_list_Nova_List_native0_Nova_contains contains__nova_standard_Object;
...
typedef nova_standard_datastruct_list_Nova_Queue* (*nova_standard_datastruct_list_Nova_Queue_native0_Nova_Queue)(nova_standard_datastruct_list_Nova_Queue*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_datastruct_list_Nova_Queue* (*nova_standard_datastruct_list_Nova_Queue_native1_Nova_Queue)(nova_standard_datastruct_list_Nova_Queue*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
nova_standard_datastruct_list_Nova_Queue_native0_Nova_Queue Queue;
nova_standard_datastruct_list_Nova_Queue_native1_Nova_Queue Queue__nova_standard_datastruct_list_Array;
...
typedef void (*nova_standard_io_Nova_Console_native2_Nova_writeLine)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_Object*);
typedef void (*nova_standard_io_Nova_Console_native3_Nova_writeLine)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, double);
typedef void (*nova_standard_io_Nova_Console_native4_Nova_writeLine)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, float);
typedef void (*nova_standard_io_Nova_Console_native5_Nova_writeLine)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, long_long);
typedef void (*nova_standard_io_Nova_Console_native6_Nova_writeLine)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, int);
typedef void (*nova_standard_io_Nova_Console_native7_Nova_writeLine)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, short);
...
typedef void (*nova_standard_io_Nova_Console_native9_Nova_writeLine)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, char);
...
typedef void (*nova_standard_io_Nova_Console_native4_Nova_write)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*, long_long);
...
typedef nova_standard_io_Nova_Console* (*nova_standard_io_Nova_Console_native_Nova_Console)(nova_standard_io_Nova_Console*, nova_standard_exception_Nova_ExceptionData*);

typedef struct nova_standard_io_native_Console
{
nova_standard_io_Nova_Console_native0_Nova_writeLine writeLine;
nova_standard_io_Nova_Console_native1_Nova_writeLine writeLine__nova_standard_String;
nova_standard_io_Nova_Console_native2_Nova_writeLine writeLine__nova_standard_Object;
nova_standard_io_Nova_Console_native3_Nova_writeLine writeLine__nova_standard_primitive_number_Double;
nova_standard_io_Nova_Console_native4_Nova_writeLine writeLine__nova_standard_primitive_number_Float;
nova_standard_io_Nova_Console_native5_Nova_writeLine writeLine__nova_standard_primitive_number_Long;
nova_standard_io_Nova_Console_native6_Nova_writeLine writeLine__nova_standard_primitive_number_Int;
nova_standard_io_Nova_Console_native7_Nova_writeLine writeLine__nova_standard_primitive_number_Short;
nova_standard_io_Nova_Console_native8_Nova_writeLine writeLine__nova_standard_primitive_number_Byte;
nova_standard_io_Nova_Console_native9_Nova_writeLine writeLine__nova_standard_primitive_number_Char;
...
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_io_Nova_InputStream_native0_Nova_readBytes)(nova_standard_io_Nova_InputStream*, nova_standard_exception_Nova_ExceptionData*);
...
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_io_Nova_StreamReader_native_Nova_readBytes)(nova_standard_io_Nova_StreamReader*, nova_standard_exception_Nova_ExceptionData*);
...
typedef long_long (*nova_standard_math_Nova_Math_native_Nova_min)(nova_standard_math_Nova_Math*, nova_standard_exception_Nova_ExceptionData*, long_long, long_long);
...
nova_standard_math_Nova_Math_native_Nova_min min;
...
typedef nova_standard_math_Nova_Sequence* (*nova_standard_math_Nova_Sequence_native_Nova_Sequence)(nova_standard_math_Nova_Sequence*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray*);
...
typedef nova_standard_math_logic_Nova_WFF* (*nova_standard_math_logic_Nova_WFF_native_Nova_WFF)(nova_standard_math_logic_Nova_WFF*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*, nova_standard_datastruct_list_Nova_Array*);
...
typedef nova_standard_datastruct_list_Nova_Array* (*nova_standard_network_Nova_NetworkInputStream_native0_Nova_readBytes)(nova_standard_network_Nova_NetworkInputStream*, nova_standard_exception_Nova_ExceptionData*);
...
typedef char (*nova_standard_primitive_number_Nova_Char_native0_Nova_toUpperCase)(nova_standard_primitive_number_Nova_Char*, nova_standard_exception_Nova_ExceptionData*);
...
typedef char (*nova_standard_primitive_number_Nova_Char_native1_Nova_toUpperCase)(nova_standard_primitive_number_Nova_Char*, nova_standard_exception_Nova_ExceptionData*, char);
...
nova_standard_primitive_number_Nova_Char_native0_Nova_toUpperCase toUpperCase;
nova_standard_primitive_number_Nova_Char_native1_Nova_toLowerCase toLowerCase__nova_standard_primitive_number_Char;
nova_standard_primitive_number_Nova_Char_native1_Nova_toUpperCase toUpperCase__nova_standard_primitive_number_Char;
...
typedef nova_standard_time_Nova_Date* (*nova_standard_time_Nova_Date_native_Nova_Date)(nova_standard_time_Nova_Date*, nova_standard_exception_Nova_ExceptionData*);
...
nova_standard_time_Nova_Timer_native_Nova_Timer Timer;
...
typedef void (*example_Nova_ArrayDemo_native_Nova_main)(example_Nova_ArrayDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_ArrayDemo* (*example_Nova_ArrayDemo_native_Nova_ArrayDemo)(example_Nova_ArrayDemo*, nova_standard_exception_Nova_ExceptionData*);
...
typedef example_Nova_BodyBuilder* (*example_Nova_BodyBuilder_native_Nova_BodyBuilder)(example_Nova_BodyBuilder*, nova_standard_exception_Nova_ExceptionData*, int, nova_standard_Nova_String*);
...
typedef void (*example_Nova_ClosureDemo_native_Nova_main)(example_Nova_ClosureDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_ClosureDemo* (*example_Nova_ClosureDemo_native_Nova_ClosureDemo)(example_Nova_ClosureDemo*, nova_standard_exception_Nova_ExceptionData*);
...
typedef example_Nova_Dog* (*example_Nova_Dog_native_Nova_Dog)(example_Nova_Dog*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*example_Nova_ExceptionHandlingDemo_native_Nova_main)(example_Nova_ExceptionHandlingDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef void (*example_Nova_FileTest_native_Nova_main)(example_Nova_FileTest*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef void (*example_Nova_GenericDemo_native_Nova_main)(example_Nova_GenericDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_GenericDemo* (*example_Nova_GenericDemo_native_Nova_GenericDemo)(example_Nova_GenericDemo*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*example_Nova_HashMapDemo_native_Nova_main)(example_Nova_HashMapDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_HashMapDemo* (*example_Nova_HashMapDemo_native_Nova_HashMapDemo)(example_Nova_HashMapDemo*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*example_Nova_IntegerTest_native_Nova_main)(example_Nova_IntegerTest*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_IntegerTest* (*example_Nova_IntegerTest_native_Nova_IntegerTest)(example_Nova_IntegerTest*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*example_Nova_Lab_native_Nova_main)(example_Nova_Lab*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_Lab* (*example_Nova_Lab_native_Nova_Lab)(example_Nova_Lab*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*example_Nova_MathDemo_native_Nova_main)(example_Nova_MathDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef void (*example_Nova_PolymorphismDemo_native_Nova_main)(example_Nova_PolymorphismDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_PolymorphismDemo* (*example_Nova_PolymorphismDemo_native_Nova_PolymorphismDemo)(example_Nova_PolymorphismDemo*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*example_Nova_QueueDemo_native_Nova_main)(example_Nova_QueueDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_QueueDemo* (*example_Nova_QueueDemo_native_Nova_QueueDemo)(example_Nova_QueueDemo*, nova_standard_exception_Nova_ExceptionData*);
...
typedef example_Nova_Spider* (*example_Nova_Spider_native_Nova_Spider)(example_Nova_Spider*, nova_standard_exception_Nova_ExceptionData*);
...
typedef example_Nova_Square* (*example_Nova_Square_native_Nova_Square)(example_Nova_Square*, nova_standard_exception_Nova_ExceptionData*, int);
...
typedef void (*example_Nova_SVGTest_native_Nova_main)(example_Nova_SVGTest*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_SVGTest* (*example_Nova_SVGTest_native_Nova_SVGTest)(example_Nova_SVGTest*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*example_Nova_Test_native_Nova_main)(example_Nova_Test*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef void (*example_Nova_ThreadDemo_native_Nova_main)(example_Nova_ThreadDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef example_Nova_ThreadDemo* (*example_Nova_ThreadDemo_native_Nova_ThreadDemo)(example_Nova_ThreadDemo*, nova_standard_exception_Nova_ExceptionData*);
...
typedef example_Nova_ThreadDemoImplementation* (*example_Nova_ThreadDemoImplementation_native_Nova_ThreadDemoImplementation)(example_Nova_ThreadDemoImplementation*, nova_standard_exception_Nova_ExceptionData*, long_long, nova_standard_Nova_String*);
...
typedef void (*example_ackermann_Nova_Ackermann_native_Nova_main)(example_ackermann_Nova_Ackermann*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef example_ackermann_Nova_Ackermann* (*example_ackermann_Nova_Ackermann_native_Nova_Ackermann)(example_ackermann_Nova_Ackermann*, nova_standard_exception_Nova_ExceptionData*);
...
typedef example_copy_Nova_Dog* (*example_copy_Nova_Dog_native_Nova_Dog)(example_copy_Nova_Dog*, nova_standard_exception_Nova_ExceptionData*, int, int);
...
typedef void (*example_database_Nova_DatabaseDemo_native_Nova_main)(example_database_Nova_DatabaseDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef void (*example_network_Nova_ClientDemo_native_Nova_main)(example_network_Nova_ClientDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef void (*example_network_Nova_ServerDemo_native_Nova_main)(example_network_Nova_ServerDemo*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
...
typedef void (*stabilitytest_Nova_AssignmentStability_native_Nova_test)(stabilitytest_Nova_AssignmentStability*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_AssignmentStability* (*stabilitytest_Nova_AssignmentStability_native_Nova_AssignmentStability)(stabilitytest_Nova_AssignmentStability*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef stabilitytest_Nova_ClassWithProperties* (*stabilitytest_Nova_ClassWithProperties_native_Nova_ClassWithProperties)(stabilitytest_Nova_ClassWithProperties*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_ClosureStability_native0_Nova_test)(stabilitytest_Nova_ClosureStability*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_ClosureStability* (*stabilitytest_Nova_ClosureStability_native_Nova_ClosureStability)(stabilitytest_Nova_ClosureStability*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef void (*stabilitytest_Nova_ExceptionStability_native0_Nova_test)(stabilitytest_Nova_ExceptionStability*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_ExceptionStability* (*stabilitytest_Nova_ExceptionStability_native_Nova_ExceptionStability)(stabilitytest_Nova_ExceptionStability*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef void (*stabilitytest_Nova_FileStability_native0_Nova_test)(stabilitytest_Nova_FileStability*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_FileStability* (*stabilitytest_Nova_FileStability_native_Nova_FileStability)(stabilitytest_Nova_FileStability*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef void (*stabilitytest_Nova_LambdaStability_native0_Nova_test)(stabilitytest_Nova_LambdaStability*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_LambdaStability* (*stabilitytest_Nova_LambdaStability_native_Nova_LambdaStability)(stabilitytest_Nova_LambdaStability*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef void (*stabilitytest_Nova_NetworkStability_native0_Nova_test)(stabilitytest_Nova_NetworkStability*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_NetworkStability* (*stabilitytest_Nova_NetworkStability_native_Nova_NetworkStability)(stabilitytest_Nova_NetworkStability*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef nova_standard_Nova_String* (*stabilitytest_Nova_PolymorphicSubClass_native_Nova_toString)(stabilitytest_Nova_PolymorphicSubClass*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_PolymorphicSubClass* (*stabilitytest_Nova_PolymorphicSubClass_native_Nova_PolymorphicSubClass)(stabilitytest_Nova_PolymorphicSubClass*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_PolymorphicSuperClass_native_Nova_giveBirth)(stabilitytest_Nova_PolymorphicSuperClass*, nova_standard_exception_Nova_ExceptionData*);
typedef nova_standard_Nova_String* (*stabilitytest_Nova_PolymorphicSuperClass_native0_Nova_toString)(stabilitytest_Nova_PolymorphicSuperClass*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_PolymorphicSuperClass* (*stabilitytest_Nova_PolymorphicSuperClass_native_Nova_PolymorphicSuperClass)(stabilitytest_Nova_PolymorphicSuperClass*, nova_standard_exception_Nova_ExceptionData*);
...
typedef void (*stabilitytest_Nova_PolymorphismStability_native0_Nova_test)(stabilitytest_Nova_PolymorphismStability*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_PolymorphismStability* (*stabilitytest_Nova_PolymorphismStability_native_Nova_PolymorphismStability)(stabilitytest_Nova_PolymorphismStability*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef void (*stabilitytest_Nova_StabilityExceptionHandler_native_Nova_uncaughtException)(stabilitytest_Nova_StabilityExceptionHandler*, nova_standard_exception_Nova_ExceptionData*, nova_standard_thread_Nova_Thread*, nova_standard_exception_Nova_Exception*);
typedef stabilitytest_Nova_StabilityExceptionHandler* (*stabilitytest_Nova_StabilityExceptionHandler_native_Nova_StabilityExceptionHandler)(stabilitytest_Nova_StabilityExceptionHandler*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef void (*stabilitytest_Nova_StabilityTest_native_Nova_main)(stabilitytest_Nova_StabilityTest*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_Array*);
typedef void (*stabilitytest_Nova_StabilityTest_native0_Nova_test)(stabilitytest_Nova_StabilityTest*, nova_standard_exception_Nova_ExceptionData*);
typedef void (*stabilitytest_Nova_StabilityTest_native0_Nova_fail)(stabilitytest_Nova_StabilityTest*, nova_standard_exception_Nova_ExceptionData*);
typedef void (*stabilitytest_Nova_StabilityTest_native1_Nova_fail)(stabilitytest_Nova_StabilityTest*, nova_standard_exception_Nova_ExceptionData*, nova_standard_Nova_String*);
typedef stabilitytest_Nova_StabilityTest* (*stabilitytest_Nova_StabilityTest_native_Nova_StabilityTest)(stabilitytest_Nova_StabilityTest*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
stabilitytest_Nova_StabilityTest_native1_Nova_fail fail__nova_standard_String;
stabilitytest_Nova_StabilityTest_native_Nova_StabilityTest StabilityTest;
} stabilitytest_native_StabilityTest;

typedef void (*stabilitytest_Nova_StabilityTestCase_native0_Nova_test)(stabilitytest_Nova_StabilityTestCase*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_StabilityTestCase* (*stabilitytest_Nova_StabilityTestCase_native_Nova_StabilityTestCase)(stabilitytest_Nova_StabilityTestCase*, nova_standard_exception_Nova_ExceptionData*, stabilitytest_Nova_StabilityTest*);
...
typedef void (*stabilitytest_Nova_ThreadImplementation_native0_Nova_run)(stabilitytest_Nova_ThreadImplementation*, nova_standard_exception_Nova_ExceptionData*);
typedef stabilitytest_Nova_ThreadImplementation* (*stabilitytest_Nova_ThreadImplementation_native_Nova_ThreadImplementation)(stabilitytest_Nova_ThreadImplementation*, nova_standard_exception_Nova_ExceptionData*, int, int);
...
nova_standard_datastruct_list_native_CharArray nova_standard_datastruct_list_CharArray;
nova_standard_datastruct_list_native_CharArrayIterator nova_standard_datastruct_list_CharArrayIterator;
nova_standard_datastruct_list_native_CompiledList nova_standard_datastruct_list_CompiledList;
nova_standard_datastruct_list_native_DoubleArray nova_standard_datastruct_list_DoubleArray;
nova_standard_datastruct_list_native_DoubleArrayIterator nova_standard_datastruct_list_DoubleArrayIterator;
...
nova_standard_datastruct_list_native_IntRange nova_standard_datastruct_list_IntRange;
nova_standard_datastruct_list_native_IntRangeIterator nova_standard_datastruct_list_IntRangeIterator;
