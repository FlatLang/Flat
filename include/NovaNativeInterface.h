...
typedef char (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_all)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray_closure12_Nova_allFunc nova_standard_datastruct_list_Nova_DoubleArray_Nova_allFunc, void* nova_standard_datastruct_list_Nova_DoubleArray_ref_Nova_allFunc);
typedef nova_standard_datastruct_list_Nova_DoubleArray* (*nova_standard_datastruct_list_Nova_DoubleArray_native0_Nova_filter)(nova_standard_datastruct_list_Nova_DoubleArray*, nova_standard_exception_Nova_ExceptionData*, nova_standard_datastruct_list_Nova_DoubleArray_closure15_Nova_filterFunc nova_standard_datastruct_list_Nova_DoubleArray_Nova_filterFunc, void* nova_standard_datastruct_list_Nova_DoubleArray_ref_Nova_filterFunc);
