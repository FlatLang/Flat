...
typedef nova_datastruct_Nova_BinaryNode* (*nova_datastruct_Nova_BinaryNode_native0_Nova_construct)(nova_datastruct_Nova_BinaryNode*, nova_exception_Nova_ExceptionData*);
typedef nova_datastruct_Nova_BinaryNode* (*nova_datastruct_Nova_BinaryNode_native1_Nova_construct)(nova_datastruct_Nova_BinaryNode*, nova_exception_Nova_ExceptionData*, nova_datastruct_Nova_Comparable*);

typedef struct nova_datastruct_native_BinaryNode
{
nova_datastruct_Nova_BinaryNode_native_Nova_addChild addChild;
nova_datastruct_Nova_BinaryNode_native0_Nova_construct BinaryNode;
nova_datastruct_Nova_BinaryNode_native1_Nova_construct BinaryNode__nova_datastruct_Comparable;
...
typedef nova_datastruct_list_Nova_Array* (*nova_datastruct_Nova_HashSet_native0_Nova_toArray)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*);
...
typedef nova_Nova_String* (*nova_datastruct_Nova_HashSet_native0_Nova_join)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef nova_Nova_Object* (*nova_datastruct_Nova_HashSet_native0_Nova_skip)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*, int);
typedef nova_Nova_Object* (*nova_datastruct_Nova_HashSet_native0_Nova_take)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*, int);
typedef nova_datastruct_list_Nova_Array* (*nova_datastruct_Nova_HashSet_native0_Nova_reverse)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*);
...
typedef nova_Nova_String* (*nova_datastruct_Nova_HashSet_native0_Nova_toString)(nova_datastruct_Nova_HashSet*, nova_exception_Nova_ExceptionData*);
...
{
nova_datastruct_Nova_HashSet_native0_Nova_toArray toArray;
...
nova_datastruct_Nova_HashSet_native0_Nova_join join__nova_String;
nova_datastruct_Nova_HashSet_native0_Nova_skip skip__nova_primitive_number_Int;
nova_datastruct_Nova_HashSet_native0_Nova_take take__nova_primitive_number_Int;
nova_datastruct_Nova_HashSet_native0_Nova_reverse reverse;
...
nova_datastruct_Nova_HashSet_native0_Nova_toString toString;
...
typedef nova_datastruct_Nova_Node* (*nova_datastruct_Nova_Node_native0_Nova_construct)(nova_datastruct_Nova_Node*, nova_exception_Nova_ExceptionData*);
typedef nova_datastruct_Nova_Node* (*nova_datastruct_Nova_Node_native1_Nova_construct)(nova_datastruct_Nova_Node*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*);
typedef nova_datastruct_Nova_Node* (*nova_datastruct_Nova_Node_native2_Nova_construct)(nova_datastruct_Nova_Node*, nova_exception_Nova_ExceptionData*, int);
typedef nova_datastruct_Nova_Node* (*nova_datastruct_Nova_Node_native3_Nova_construct)(nova_datastruct_Nova_Node*, nova_exception_Nova_ExceptionData*, nova_Nova_Object*, int);
...
nova_datastruct_Nova_Node_native0_Nova_construct Node;
nova_datastruct_Nova_Node_native1_Nova_construct Node__nova_Object;
nova_datastruct_Nova_Node_native2_Nova_construct Node__nova_primitive_number_Int;
nova_datastruct_Nova_Node_native3_Nova_construct Node__nova_Object__nova_primitive_number_Int;
...
typedef nova_math_Nova_Matrix* (*nova_math_Nova_Matrix_native_Nova_construct)(nova_math_Nova_Matrix*, nova_exception_Nova_ExceptionData*, int, int);

typedef struct nova_math_native_Matrix
{
nova_math_Nova_Matrix_native_Nova_sum sum;
nova_math_Nova_Matrix_native_Nova_construct Matrix;
...
typedef nova_Nova_String* (*nova_time_Nova_Timer_native0_Nova_toString)(nova_time_Nova_Timer*, nova_exception_Nova_ExceptionData*);
...
nova_time_Nova_Timer_native0_Nova_toString toString;
...
typedef void (*compiler_Nova_Compiler_native_Nova_main)(compiler_Nova_Compiler*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
{
compiler_Nova_Compiler_native_Nova_main main;
...
typedef void (*compiler_tree_node_Nova_Listenable_native0_Nova_onAdded)(compiler_tree_node_Nova_Listenable*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*);

typedef struct compiler_tree_node_native_Listenable
{
compiler_tree_node_Nova_Listenable_native0_Nova_onAdded onAdded__compiler_tree_node_Node;
} compiler_tree_node_native_Listenable;
...
typedef compiler_tree_node_Nova_Scope* (*compiler_tree_node_Nova_Node_native_Nova_getScope)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*);
typedef char (*compiler_tree_node_Nova_Node_native_Nova_containsScope)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*);
...
typedef void (*compiler_tree_node_Nova_Node_native_Nova_setTemporaryParent)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*);
typedef char (*compiler_tree_node_Nova_Node_native_Nova_isDecoding)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*);
...
typedef char (*compiler_tree_node_Nova_Node_native0_Nova_containsChild)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*);
typedef char (*compiler_tree_node_Nova_Node_native1_Nova_containsChild)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, char);
...
typedef compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_Node_native0_Nova_clone)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*);
typedef compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_Node_native1_Nova_clone)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, char);
typedef compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_Node_native_Nova_construct)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*);

typedef struct compiler_tree_node_native_Node
{
compiler_tree_node_Nova_Node_native_Nova_getScope getScope;
compiler_tree_node_Nova_Node_native_Nova_containsScope containsScope;
compiler_tree_node_Nova_Node_native_Nova_addAnnotation addAnnotation;
compiler_tree_node_Nova_Node_native_Nova_setTemporaryParent setTemporaryParent;
compiler_tree_node_Nova_Node_native_Nova_isDecoding isDecoding;
compiler_tree_node_Nova_Node_native0_Nova_detach detach;
compiler_tree_node_Nova_Node_native_Nova_onRemoved onRemoved;
compiler_tree_node_Nova_Node_native0_Nova_containsChild containsChild__compiler_tree_node_Node;
compiler_tree_node_Nova_Node_native1_Nova_containsChild containsChild__compiler_tree_node_Node__nova_primitive_Bool;
compiler_tree_node_Nova_Node_native_Nova_onAdded onAdded;
compiler_tree_node_Nova_Node_native0_Nova_clone clone__compiler_tree_node_Node__compiler_util_Location;
compiler_tree_node_Nova_Node_native1_Nova_clone clone__compiler_tree_node_Node__compiler_util_Location__nova_primitive_Bool;
compiler_tree_node_Nova_Node_native_Nova_construct Node;
} compiler_tree_node_native_Node;

typedef compiler_tree_node_Nova_Scope* (*compiler_tree_node_Nova_Scope_native1_Nova_clone)(compiler_tree_node_Nova_Scope*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, char);
...
{
compiler_tree_node_Nova_Scope_native1_Nova_clone clone__compiler_tree_node_Node__compiler_util_Location__nova_primitive_Bool;
compiler_tree_node_Nova_Scope_native_Nova_construct Scope;
} compiler_tree_node_native_Scope;

typedef void (*compiler_tree_node_annotation_Nova_Annotatable_native0_Nova_addAnnotation)(compiler_tree_node_annotation_Nova_Annotatable*, nova_exception_Nova_ExceptionData*, compiler_tree_node_annotation_Nova_Annotation*);

typedef struct compiler_tree_node_annotation_native_Annotatable
{
compiler_tree_node_annotation_Nova_Annotatable_native0_Nova_addAnnotation addAnnotation__compiler_tree_node_annotation_Annotation;
} compiler_tree_node_annotation_native_Annotatable;

typedef compiler_tree_node_annotation_Nova_Annotation* (*compiler_tree_node_annotation_Nova_Annotation_native1_Nova_clone)(compiler_tree_node_annotation_Nova_Annotation*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, char);
...
{
compiler_tree_node_annotation_Nova_Annotation_native1_Nova_clone clone__compiler_tree_node_Node__compiler_util_Location__nova_primitive_Bool;
...
typedef compiler_tree_node_exceptionhandling_Nova_ExceptionHandler* (*compiler_tree_node_exceptionhandling_Nova_ExceptionHandler_native1_Nova_clone)(compiler_tree_node_exceptionhandling_Nova_ExceptionHandler*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, char);
...
{
compiler_tree_node_exceptionhandling_Nova_ExceptionHandler_native1_Nova_clone clone__compiler_tree_node_Node__compiler_util_Location__nova_primitive_Bool;
...
typedef nova_Nova_String* (*compiler_util_Nova_FileUtils_native_Nova_formatPath)(compiler_util_Nova_FileUtils*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef nova_Nova_String* (*compiler_util_Nova_FileUtils_native_Nova_formAbsolutePath)(compiler_util_Nova_FileUtils*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef nova_Nova_String* (*compiler_util_Nova_FileUtils_native_Nova_escapeSpaces)(compiler_util_Nova_FileUtils*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef nova_Nova_String* (*compiler_util_Nova_FileUtils_native_Nova_getWorkingDirectoryPath)(compiler_util_Nova_FileUtils*, nova_exception_Nova_ExceptionData*);
...
{
compiler_util_Nova_FileUtils_native_Nova_formatPath formatPath;
compiler_util_Nova_FileUtils_native_Nova_formAbsolutePath formAbsolutePath;
compiler_util_Nova_FileUtils_native_Nova_escapeSpaces escapeSpaces;
compiler_util_Nova_FileUtils_native_Nova_getWorkingDirectoryPath getWorkingDirectoryPath;
...
typedef nova_Nova_String* (*compiler_util_Nova_Location_native0_Nova_toString)(compiler_util_Nova_Location*, nova_exception_Nova_ExceptionData*);
...
compiler_util_Nova_Location_native0_Nova_toString toString;
...
typedef char (*compiler_util_Nova_StringUtils_native_Nova_isSurroundedByQuotes)(compiler_util_Nova_StringUtils*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
typedef nova_Nova_String* (*compiler_util_Nova_StringUtils_native_Nova_removeSurroundingQuotes)(compiler_util_Nova_StringUtils*, nova_exception_Nova_ExceptionData*, nova_Nova_String*);
...
{
compiler_util_Nova_StringUtils_native_Nova_isSurroundedByQuotes isSurroundedByQuotes;
compiler_util_Nova_StringUtils_native_Nova_removeSurroundingQuotes removeSurroundingQuotes;
...
typedef void (*example_Nova_HashSetDemo_native_Nova_main)(example_Nova_HashSetDemo*, nova_exception_Nova_ExceptionData*, nova_datastruct_list_Nova_Array*);
...
{
example_Nova_HashSetDemo_native_Nova_main main;
...
compiler_tree_node_native_Listenable compiler_tree_node_Listenable;
