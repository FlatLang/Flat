...
typedef int* (*nova_standard_datastruct_list_Nova_IntRange_native0_Nova_toArray)(nova_standard_datastruct_list_Nova_IntRange*, nova_standard_exception_Nova_ExceptionData*);
