...
void nova_List_add(List* this, ExceptionData* exceptionData, Object* nova_0_data)
{
	...
	if (this->prv->nova_List_start == (ListNode*)nova_null)
	{
...
void nova_List_remove(List* this, ExceptionData* exceptionData, Object* nova_0_data)
{
	...
	while (nova_1_cur != (ListNode*)nova_null)
	{
		Object* nova_3_d;
...
{
	this->prv->nova_List_start = (ListNode*)nova_null;
	this->prv->nova_List_current = (ListNode*)nova_null;
}
