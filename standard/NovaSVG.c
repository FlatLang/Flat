...
{
	this->nova_SVG_root->vtable->nova_virtual_generateOutput((SVGMainComponent*)(this->nova_SVG_root), exceptionData, nova_0_file);
}

void nova_SVG_generateHTMLOutput(SVG* this, ExceptionData* exceptionData, File* nova_0_file)
{
	nova_File_write((File*)(nova_0_file), exceptionData, nova_String_String(exceptionData, "<html>\n"));
