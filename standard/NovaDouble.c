...
int nova_static_Double_numDigits(Double* this, ExceptionData* exceptionData, double nova_0_number)
{
	...
	if (nova_0_number < 0)
	{
		return nova_static_Double_numDigits((Double*)nova_null, exceptionData, -nova_0_number) + 1;
	}
...
String* nova_static_2_Double_toString(Double* this, ExceptionData* exceptionData, double nova_0_value)
{
	...
	nova_1_buffer = nova_static_Double_genBuffer((Double*)nova_null, exceptionData, nova_0_value);
	...
	if (nova_1_c == '0' || nova_1_c == '9')
	{
		...
		{
			nova_1_lastIndex++;
			return nova_static_Double_genString((Double*)nova_null, exceptionData, nova_1_buffer, nova_1_lastIndex);
		}
		else
		{
	...
	else
	{
		...
		nova_9_rep = nova_static_Double_repetition((Double*)nova_null, exceptionData, nova_1_buffer, nova_1_lastIndex);
		if (nova_9_rep > 5)
		{
	...
	nova_1_lastIndex = nova_static_Double_lastSignificantDigit((Double*)nova_null, exceptionData, nova_1_buffer, nova_1_size - 1);
	return nova_static_Double_genString((Double*)nova_null, exceptionData, nova_1_buffer, nova_1_lastIndex);
}
