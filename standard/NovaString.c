...
String* nova_String_String(ExceptionData* exceptionData, char* nova_0_data)
{
	...
	this->prv->nova_String_data = 0;
	{
		...
		nova_1_newData = (char*)NOVA_MALLOC(sizeof(char) * (this->nova_String_length + 1));
		strcpy(nova_1_newData, nova_0_data);
		nova_1_newData[this->nova_String_length] = '\0';
		this->prv->nova_String_data = nova_1_newData;
	}
