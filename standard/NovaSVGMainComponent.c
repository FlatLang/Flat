...
{
	nova_File_write(nova_0_file, exceptionData, nova_String_concat(nova_String_String(exceptionData, "<?xml version = '1.0' standalone = 'no'?>\n"), exceptionData, nova_String_concat(nova_String_String(exceptionData, "<!DOCTYPE svg PUBLIC\"-//W3C//DTD SVG1.1//EN\" \"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd\">"), exceptionData, nova_String_String(exceptionData, "<svg width=\"1400\"px height=\"950\"px version=\"1.1\" preserveAspectRatio=\"none\">\n"))));
