...
void nova_static_TimeStability_test(TimeStability* this, ExceptionData* exceptionData, StabilityTest* nova_0_program)
{
	...
	nova_static_1_Console_write(0, exceptionData, nova_String_String(exceptionData, "Checking Time.nova... "));
	...
	{
		nova_2_StabilityTest_fail(nova_0_program, exceptionData, nova_String_concat(nova_String_String(exceptionData, (char*)("Failed; expected 100ms, found ")), exceptionData, nova_String_concat(nova_2_Long_toString(nova_Long_Long(exceptionData, nova_1_time), exceptionData), exceptionData, nova_String_String(exceptionData, (char*)("ms")))));
	}
}
