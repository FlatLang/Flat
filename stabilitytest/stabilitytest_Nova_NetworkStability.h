...
typedef struct nova_VTable_stabilitytest_Nova_NetworkStability
{
...
} nova_VTable_stabilitytest_Nova_NetworkStability;

extern nova_VTable_stabilitytest_Nova_NetworkStability nova_VTable_stabilitytest_Nova_NetworkStability_val;

CCLASS_CLASS
(
	stabilitytest_Nova_NetworkStability, 
	
	nova_VTable_stabilitytest_Nova_NetworkStability* vtable;
)
