...
stabilitytest_Nova_UnstableException* stabilitytest_Nova_UnstableException_1_Nova_construct(stabilitytest_Nova_UnstableException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* stabilitytest_Nova_UnstableException_Nova_message)
{
	...
	nova_standard_exception_Nova_Exception_1_Nova_this((nova_standard_exception_Nova_Exception*)(this), exceptionData, stabilitytest_Nova_UnstableException_Nova_message);
	stabilitytest_Nova_UnstableException_2_Nova_super(this, exceptionData);
	
	{
		stabilitytest_Nova_UnstableException_1_Nova_this(this, exceptionData, stabilitytest_Nova_UnstableException_Nova_message);
	}
...
void stabilitytest_Nova_UnstableException_1_Nova_this(stabilitytest_Nova_UnstableException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* stabilitytest_Nova_UnstableException_Nova_message)
{
}
