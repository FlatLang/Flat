...
typedef struct nova_VTable_stabilitytest_NovaPolymorphicSuperClass
{
	...
	nova_standard_NovaString* (*stabilitytest_NovaPolymorphicSuperClass_virtual0_NovatoString)(stabilitytest_NovaPolymorphicSuperClass*, nova_standard_exception_NovaExceptionData*);
