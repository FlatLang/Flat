...
stabilitytest_Nova_StabilityTestCase* stabilitytest_Nova_StabilityTestCase_0_Nova_construct(stabilitytest_Nova_StabilityTestCase* this, nova_standard_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_StabilityTest* l0_Nova_program)
{
	...
	{
		stabilitytest_Nova_StabilityTestCase_0_Nova_this(this, exceptionData, l0_Nova_program);
	}
...
{
	this->stabilitytest_Nova_StabilityTestCase_Nova_program = l0_Nova_program;
}
