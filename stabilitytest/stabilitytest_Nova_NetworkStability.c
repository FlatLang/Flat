...
void stabilitytest_Nova_NetworkStability_0_Nova_test(stabilitytest_Nova_NetworkStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Accepting ClientSocket connection... "));
	...
	{
		stabilitytest_Nova_StabilityTest_1_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Failed to accept the client"));
	}
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Sending String to ClientSocket... "));
	if (!nova_standard_io_Nova_OutputStream_virtual1_Nova_write((nova_standard_io_Nova_OutputStream*)(l1_Nova_connection->nova_standard_network_Nova_ConnectionSocket_Nova_out), exceptionData, stabilitytest_Nova_NetworkStability_Nova_received))
	{
		stabilitytest_Nova_StabilityTest_1_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Server unable to send data to client"));
	}
	...
	l1_Nova_s = (nova_standard_Nova_String*)(nova_standard_io_Nova_InputStream_virtual0_Nova_readString((nova_standard_io_Nova_InputStream*)(l1_Nova_connection->nova_standard_network_Nova_ConnectionSocket_Nova_in), exceptionData));
	if (l1_Nova_s->nova_standard_Nova_String_Nova_size != stabilitytest_Nova_NetworkStability_Nova_received->nova_standard_Nova_String_Nova_size || !nova_standard_operators_Nova_Equals_virtual2_Nova_equals((nova_standard_operators_Nova_Equals*)(l1_Nova_s), exceptionData, (nova_standard_Nova_Object*)(stabilitytest_Nova_NetworkStability_Nova_received)))
	{
	...
	nova_standard_io_Nova_Console_0_Nova_write(0, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Attempting to close ServerSocket connection... "));
	if (!nova_standard_network_Nova_ServerSocket_Nova_close(l1_Nova_server, exceptionData))
	{
		stabilitytest_Nova_StabilityTest_1_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Unable to close server"));
	}
...
nova_standard_network_Nova_ServerSocket* stabilitytest_Nova_NetworkStability_Nova_createServer(stabilitytest_Nova_NetworkStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int stabilitytest_Nova_NetworkStability_Nova_port)
{
	...
	nova_standard_io_Nova_Console_0_Nova_write(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Attempting to start ServerSocket on port "), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Int_3_Nova_toString(0, exceptionData, stabilitytest_Nova_NetworkStability_Nova_port)), exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "... "))));
	...
	{
		stabilitytest_Nova_StabilityTest_1_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Unable to start server on port "), exceptionData, nova_standard_primitive_number_Nova_Int_3_Nova_toString(0, exceptionData, stabilitytest_Nova_NetworkStability_Nova_port)));
	}
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "OK"));
