...
nova_standard_network_Nova_ServerSocket* stabilitytest_Nova_NetworkStability_Nova_createServer(stabilitytest_Nova_NetworkStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int l0_Nova_port);
...
stabilitytest_Nova_NetworkStability* stabilitytest_Nova_NetworkStability_0_Nova_construct(stabilitytest_Nova_NetworkStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_StabilityTest* l0_Nova_program)
{
	...
	{
		stabilitytest_Nova_NetworkStability_0_Nova_this(this, exceptionData, l0_Nova_program);
	}
