...
void stabilitytest_Nova_NetworkStability_Nova_test(stabilitytest_Nova_NetworkStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_StabilityTest* l0_Nova_program)
{
	int l1_Nova_port;
	...
	l1_Nova_port = 24243;
	l1_Nova_server = stabilitytest_Nova_NetworkStability_Nova_createServer((stabilitytest_Nova_NetworkStability*)nova_null, exceptionData, l0_Nova_program, l1_Nova_port);
	l1_Nova_thread = stabilitytest_Nova_ClientThread_Nova_construct(0, exceptionData, l0_Nova_program, l1_Nova_port);
	...
	{
		stabilitytest_Nova_StabilityTest_1_Nova_fail(l0_Nova_program, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Failed to accept the client"));
	}
	...
	{
		stabilitytest_Nova_StabilityTest_1_Nova_fail(l0_Nova_program, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Unable to close server"));
	}
...
nova_standard_network_Nova_ServerSocket* stabilitytest_Nova_NetworkStability_Nova_createServer(stabilitytest_Nova_NetworkStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_StabilityTest* l0_Nova_program, int l0_Nova_port)
{
	...
	nova_local_0 = nova_standard_primitive_number_Nova_Int_1_Nova_toString(0, exceptionData, l0_Nova_port);
	...
	if (!nova_standard_network_Nova_ServerSocket_Nova_start(l1_Nova_server, exceptionData, l0_Nova_port))
	{
		stabilitytest_Nova_StabilityTest_1_Nova_fail(l0_Nova_program, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Unable to start server on port "), exceptionData, nova_standard_primitive_number_Nova_Int_1_Nova_toString(0, exceptionData, l0_Nova_port)));
	}
	nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "OK"));
...
void stabilitytest_Nova_NetworkStability_Nova_super(stabilitytest_Nova_NetworkStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
