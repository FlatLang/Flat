...
stabilitytest_Nova_StabilityTestException* stabilitytest_Nova_StabilityTestException_1_Nova_construct(stabilitytest_Nova_StabilityTestException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* stabilitytest_Nova_StabilityTestException_Nova_message)
{
	...
	nova_standard_exception_Nova_Exception_1_Nova_this((nova_standard_exception_Nova_Exception*)(this), exceptionData, stabilitytest_Nova_StabilityTestException_Nova_message);
	stabilitytest_Nova_StabilityTestException_2_Nova_super(this, exceptionData);
	
	{
		stabilitytest_Nova_StabilityTestException_1_Nova_this(this, exceptionData, stabilitytest_Nova_StabilityTestException_Nova_message);
	}
...
void stabilitytest_Nova_StabilityTestException_1_Nova_this(stabilitytest_Nova_StabilityTestException* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* stabilitytest_Nova_StabilityTestException_Nova_message)
{
}
