...
typedef struct nova_VTable_stabilitytest_Nova_FileStability
{
...
} nova_VTable_stabilitytest_Nova_FileStability;

extern nova_VTable_stabilitytest_Nova_FileStability nova_VTable_stabilitytest_Nova_FileStability_val;

CCLASS_CLASS
(
	stabilitytest_Nova_FileStability, 
	
	nova_VTable_stabilitytest_Nova_FileStability* vtable;
)
