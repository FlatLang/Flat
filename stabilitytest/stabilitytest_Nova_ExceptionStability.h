...
typedef struct nova_VTable_stabilitytest_Nova_ExceptionStability
{
...
} nova_VTable_stabilitytest_Nova_ExceptionStability;

extern nova_VTable_stabilitytest_Nova_ExceptionStability nova_VTable_stabilitytest_Nova_ExceptionStability_val;

CCLASS_CLASS
(
	stabilitytest_Nova_ExceptionStability, 
	
	nova_VTable_stabilitytest_Nova_ExceptionStability* vtable;
)
