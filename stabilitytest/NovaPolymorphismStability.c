...
{
	nova_static_1_Console_writeLine(0, exceptionData, nova_String_construct(0, exceptionData, (char*)("Checking Polymorphism stability...")));
...
void nova_static_PolymorphismStability_testCalls(PolymorphismStability* this, ExceptionData* exceptionData, StabilityTest* nova_0_program)
{
	...
	nova_static_1_Console_write(0, exceptionData, nova_String_construct(0, exceptionData, (char*)("Checking polymorphic method calls... ")));
	...
	{
		nova_2_StabilityTest_fail(nova_0_program, exceptionData, nova_String_construct(0, exceptionData, (char*)("Did not call sub class method")));
	}
...
char nova_static_PolymorphismStability_testSubCall(PolymorphismStability* this, ExceptionData* exceptionData, PolymorphicSuperClass* nova_0_obj)
{
	...
	return nova_local_0->vtable->nova_virtual_1_equals(nova_local_0, exceptionData, nova_String_construct(0, exceptionData, (char*)("sub class")));
}
...
void nova_static_PolymorphismStability_testClosure(PolymorphismStability* this, ExceptionData* exceptionData, StabilityTest* nova_0_program)
{
	...
	nova_static_1_Console_write(0, exceptionData, nova_String_construct(0, exceptionData, (char*)("Checking polymorphic closure method calls... ")));
	...
	{
		nova_2_StabilityTest_fail(nova_0_program, exceptionData, nova_String_construct(0, exceptionData, (char*)("Did not call sub class method as closure")));
	}
	nova_PolymorphicSuperClass_giveBirth(nova_1_obj, exceptionData);
	nova_1_child = nova_String_concat(nova_1_obj->nova_PolymorphicSuperClass_child->vtable->nova_virtual_1_toString(nova_1_obj->nova_PolymorphicSuperClass_child, exceptionData), exceptionData, nova_String_construct(0, exceptionData, (char*)("!")));
