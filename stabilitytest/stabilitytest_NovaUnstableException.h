...
typedef struct stabilitytest_NovaUnstableException stabilitytest_NovaUnstableException;
...
CCLASS_CLASS
(
	stabilitytest_NovaUnstableException, 
	
	nova_VTable_stabilitytest_NovaUnstableException* vtable;
