...
typedef int (*stabilitytest_Nova_ClosureStability_closure1_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, int, int, void*);
typedef int (*stabilitytest_Nova_ClosureStability_closure2_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, int, int, void*);
typedef int (*stabilitytest_Nova_ClosureStability_closure3_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, int, int, void*);
typedef double (*stabilitytest_Nova_ClosureStability_closure4_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, double, void*);
typedef double (*stabilitytest_Nova_ClosureStability_closure5_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, double, void*);
typedef double (*stabilitytest_Nova_ClosureStability_closure6_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, double, void*);
typedef void (*stabilitytest_Nova_ClosureStability_closure7_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, void*);
typedef void (*stabilitytest_Nova_ClosureStability_closure8_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, void*);
typedef void (*stabilitytest_Nova_ClosureStability_closure9_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, void*);
...
int stabilitytest_Nova_ClosureStability_Nova_callClosure(stabilitytest_Nova_ClosureStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_ClosureStability_closure3_Nova_closure stabilitytest_Nova_ClosureStability_Nova_closure, void* stabilitytest_Nova_ClosureStability_ref_Nova_closure, void* closure_context, int stabilitytest_Nova_ClosureStability_Nova_a, int stabilitytest_Nova_ClosureStability_Nova_b);
...
void stabilitytest_Nova_ClosureStability_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
...
void stabilitytest_Nova_ClosureStability_Nova_testMathClosures(stabilitytest_Nova_ClosureStability* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	if (stabilitytest_Nova_ClosureStability_Nova_mathClosure(0, exceptionData, (stabilitytest_Nova_ClosureStability_closure6_Nova_closure)&nova_standard_math_Nova_Math_Nova_tan, 0, nova_null, l1_Nova_value) - nova_standard_math_Nova_Math_Nova_tan(0, exceptionData, l1_Nova_value) >= stabilitytest_Nova_ClosureStability_Nova_TOLERANCE)
	{
