...
struct stabilitytest_Extension_VTable_StabilityTestCase
{
	...
	void (*stabilitytest_Nova_StabilityTestCase_virtual0_Nova_test)(stabilitytest_Nova_StabilityTestCase*, nova_exception_Nova_ExceptionData*);
};
...
stabilitytest_Nova_StabilityTestCase* stabilitytest_Nova_StabilityTestCase_Nova_StabilityTestCase(stabilitytest_Nova_StabilityTestCase* this, nova_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_StabilityTest* stabilitytest_Nova_StabilityTestCase_Nova_program);
...
void stabilitytest_Nova_StabilityTestCase_0_Nova_test(stabilitytest_Nova_StabilityTestCase* this, nova_exception_Nova_ExceptionData* exceptionData);void stabilitytest_Nova_StabilityTestCase_Nova_super(stabilitytest_Nova_StabilityTestCase* this, nova_exception_Nova_ExceptionData* exceptionData);
