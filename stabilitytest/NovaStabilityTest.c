...
int nova_StabilityTest_runTests(StabilityTest* this, ExceptionData* exceptionData)
{
		TRY
		{
				...
				
				{
						...
						nova_static_0_Console_writeLine(0, exceptionData, nova_String_construct(0, exceptionData, "All OK"));
						return 0;
				}
		}
		CATCH (2)
...
{
		nova_1_StabilityTest_fail(this, exceptionData, nova_String_construct(0, exceptionData, "Failed"));
}
