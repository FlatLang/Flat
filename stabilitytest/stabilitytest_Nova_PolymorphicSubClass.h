...
struct stabilitytest_Extension_VTable_PolymorphicSubClass
{
	...
	nova_standard_Nova_String* (*nova_standard_Nova_Object_virtual2_Nova_toString)(stabilitytest_Nova_PolymorphicSubClass*, nova_standard_exception_Nova_ExceptionData*);
