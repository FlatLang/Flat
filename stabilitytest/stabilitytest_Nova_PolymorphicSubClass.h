...
struct stabilitytest_Extension_VTable_PolymorphicSubClass
{
	...
	nova_Nova_String* (*nova_Nova_Object_virtual1_Nova_toString)(stabilitytest_Nova_PolymorphicSubClass*, nova_exception_Nova_ExceptionData*);
...
void stabilitytest_Nova_PolymorphicSubClass_0_Nova_super(stabilitytest_Nova_PolymorphicSubClass* this, nova_exception_Nova_ExceptionData* exceptionData);
