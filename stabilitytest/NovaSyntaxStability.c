...
void nova_static_SyntaxStability_checkWhileLoops(SyntaxStability* this, ExceptionData* exceptionData, StabilityTest* nova_0_program)
{
	...
	nova_static_1_Console_write(0, exceptionData, nova_String_construct(0, exceptionData, "Checking inline while loop... "));
	nova_1_num = 0;
	nova_1_num2 = 0;
	nova_1_num3 = 0;
	...
	{
		nova_2_StabilityTest_fail(nova_0_program, exceptionData, nova_String_construct(0, exceptionData, "Inline while loop failed."));
	}
...
void nova_static_SyntaxStability_checkForLoops(SyntaxStability* this, ExceptionData* exceptionData, StabilityTest* nova_0_program)
{
	...
	nova_static_1_Console_write(0, exceptionData, nova_String_construct(0, exceptionData, "Checking inline for loop... "));
	nova_1_num = 0;
	nova_1_num2 = 0;
	nova_1_num3 = 0;
	nova_1_j = 0;
	...
	if (nova_1_num != 100 || nova_1_num2 != 100 || nova_1_num3 != 100)
	{
		nova_2_StabilityTest_fail(nova_0_program, exceptionData, nova_String_construct(0, exceptionData, "Inline for loop failed."));
	}
	nova_static_1_Console_writeLine(0, exceptionData, nova_String_construct(0, exceptionData, "OK"));
}
...
void nova_static_SyntaxStability_checkUntil(SyntaxStability* this, ExceptionData* exceptionData, StabilityTest* nova_0_program)
{
	...
	nova_static_1_Console_write(0, exceptionData, nova_String_construct(0, exceptionData, "Checking until statement... "));
	nova_1_obj = (Object*)0;
	if (!(nova_1_obj != (Object*)0))
	{
		...
		if (!(nova_1_obj != (Object*)0))
		{
			...
			if (!(nova_1_obj != (Object*)0))
			{
				nova_2_StabilityTest_fail(nova_0_program, exceptionData, nova_String_construct(0, exceptionData, "Failed to stop after correct condition"));
			}
		}
	}
	if (nova_1_obj == (Object*)0)
	{
		nova_2_StabilityTest_fail(nova_0_program, exceptionData, nova_String_construct(0, exceptionData, "Failed to reach correct condition"));
	}
	nova_static_1_Console_writeLine(0, exceptionData, nova_String_construct(0, exceptionData, "OK"));
}
