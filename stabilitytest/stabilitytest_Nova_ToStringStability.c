...
void stabilitytest_Nova_ToStringStability_0_Nova_test(stabilitytest_Nova_ToStringStability* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Checking toString implementations... "));
	l1_Nova_d = (double)(5.232);
	stabilitytest_Nova_ToStringStability_Nova_checkToString(this, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Double"), (nova_primitive_number_Nova_Number*)(nova_primitive_number_Nova_Double_Nova_Double(0, exceptionData, l1_Nova_d)), nova_Nova_String_1_Nova_String(0, exceptionData, "5.232"));
	l1_Nova_b = 127;
	stabilitytest_Nova_ToStringStability_Nova_checkToString(this, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Byte"), (nova_primitive_number_Nova_Number*)(nova_primitive_number_Nova_Byte_Nova_Byte(0, exceptionData, l1_Nova_b)), nova_Nova_String_1_Nova_String(0, exceptionData, "127"));
	l1_Nova_i = 2147483647;
	stabilitytest_Nova_ToStringStability_Nova_checkToString(this, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Int"), (nova_primitive_number_Nova_Number*)(nova_primitive_number_Nova_Int_Nova_Int(0, exceptionData, l1_Nova_i)), nova_Nova_String_1_Nova_String(0, exceptionData, "2147483647"));
	l1_Nova_l = (-9223372036854775807LL - 1);
	stabilitytest_Nova_ToStringStability_Nova_checkToString(this, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Long"), (nova_primitive_number_Nova_Number*)(nova_primitive_number_Nova_Long_Nova_Long(0, exceptionData, l1_Nova_l)), nova_Nova_String_1_Nova_String(0, exceptionData, "-9223372036854775808"));
...
void stabilitytest_Nova_ToStringStability_Nova_checkToString(stabilitytest_Nova_ToStringStability* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* stabilitytest_Nova_ToStringStability_Nova_type, nova_primitive_number_Nova_Number* stabilitytest_Nova_ToStringStability_Nova_number, nova_Nova_String* stabilitytest_Nova_ToStringStability_Nova_expected)
{
	...
	{
		stabilitytest_Nova_StabilityTest_1_Nova_fail(this->stabilitytest_Nova_StabilityTestCase_Nova_program, exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(stabilitytest_Nova_ToStringStability_Nova_type), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, ".toString failed. expected "), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(stabilitytest_Nova_ToStringStability_Nova_expected), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, " but received "), exceptionData, nova_Nova_Object_virtual1_Nova_toString((nova_Nova_Object*)(stabilitytest_Nova_ToStringStability_Nova_number), exceptionData))))));
	}
}
