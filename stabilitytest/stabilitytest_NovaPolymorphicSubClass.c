...
CCLASS_PRIVATE
(
	int stabilitytest_NovaPolymorphicSubClass_Novai;
...
{
	return nova_standard_NovaString_Novaconstruct(0, exceptionData, "sub class");
}
...
{
	this->prv->stabilitytest_NovaPolymorphicSubClass_Novai = 0;
}
