...
struct stabilitytest_Extension_VTable_PolymorphicSuperClass
{
	...
	int (*stabilitytest_Nova_PolymorphicSuperClass_Accessor_Nova_myProperty)(stabilitytest_Nova_PolymorphicSuperClass*, nova_standard_exception_Nova_ExceptionData*);
};
