...
typedef struct stabilitytest_Extension_VTable_StabilityTest stabilitytest_Extension_VTable_StabilityTest;
struct stabilitytest_Extension_VTable_StabilityTest
{
	...
	void (*stabilitytest_Nova_StabilityTestCase_virtual0_Nova_test)(stabilitytest_Nova_StabilityTest*, nova_exception_Nova_ExceptionData*);
};

extern stabilitytest_Extension_VTable_StabilityTest stabilitytest_Extension_VTable_StabilityTest_val;
...
(
	...
	stabilitytest_Extension_VTable_StabilityTest* vtable;
...
stabilitytest_Nova_StabilityTest* stabilitytest_Nova_StabilityTest_Nova_StabilityTest(stabilitytest_Nova_StabilityTest* this, nova_exception_Nova_ExceptionData* exceptionData, stabilitytest_Nova_StabilityTest* stabilitytest_Nova_StabilityTest_Nova_program);
