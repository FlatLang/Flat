...
typedef struct nova_VTable_stabilitytest_Nova_ThreadImplementation
{
	...
	void (*stabilitytest_Nova_ThreadImplementation_virtual0_Nova_run)(stabilitytest_Nova_ThreadImplementation*, nova_standard_exception_Nova_ExceptionData*);
} nova_VTable_stabilitytest_Nova_ThreadImplementation;

extern nova_VTable_stabilitytest_Nova_ThreadImplementation nova_VTable_stabilitytest_Nova_ThreadImplementation_val;

CCLASS_CLASS
(
	stabilitytest_Nova_ThreadImplementation, 
	
	nova_VTable_stabilitytest_Nova_ThreadImplementation* vtable;
	struct Private* prv;
)
...
void stabilitytest_Nova_ThreadImplementation_Nova_super(stabilitytest_Nova_ThreadImplementation* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
