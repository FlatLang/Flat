...
typedef struct nova_VTable_stabilitytest_NovaPolymorphicSubClass
{
	...
	nova_standard_NovaString* (*stabilitytest_NovaPolymorphicSubClass_virtual0_NovatoString)(stabilitytest_NovaPolymorphicSubClass*, nova_standard_exception_NovaExceptionData*);
