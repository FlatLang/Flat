...
typedef struct nova_VTable_stabilitytest_Nova_TimeStability
{
...
} nova_VTable_stabilitytest_Nova_TimeStability;

extern nova_VTable_stabilitytest_Nova_TimeStability nova_VTable_stabilitytest_Nova_TimeStability_val;

CCLASS_CLASS
(
	stabilitytest_Nova_TimeStability, 
	
	nova_VTable_stabilitytest_Nova_TimeStability* vtable;
)
