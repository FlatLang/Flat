...
void stabilitytest_Nova_PolymorphicSuperClass_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}

stabilitytest_Nova_PolymorphicSuperClass* stabilitytest_Nova_PolymorphicSuperClass_Nova_PolymorphicSuperClass(stabilitytest_Nova_PolymorphicSuperClass* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
{
	this->stabilitytest_Nova_PolymorphicSuperClass_Nova_child = stabilitytest_Nova_PolymorphicSubClass_Nova_PolymorphicSubClass(0, exceptionData);
}
...
{
	return nova_standard_Nova_String_1_Nova_String(0, exceptionData, "super class");
}
