#pragma once
#ifndef FILE_stabilitytest_Nova_ToStringStability_NOVA
#define FILE_stabilitytest_Nova_ToStringStability_NOVA
...
typedef struct stabilitytest_Extension_VTable_ToStringStability stabilitytest_Extension_VTable_ToStringStability;
struct stabilitytest_Extension_VTable_ToStringStability
{
	...
	void (*stabilitytest_Nova_StabilityTestCase_virtual0_Nova_test)(stabilitytest_Nova_ToStringStability*, nova_standard_exception_Nova_ExceptionData*);
};

extern stabilitytest_Extension_VTable_ToStringStability stabilitytest_Extension_VTable_ToStringStability_val;
...
(
	...
	stabilitytest_Extension_VTable_ToStringStability* vtable;
