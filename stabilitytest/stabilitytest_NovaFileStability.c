...
{
	nova_standard_io_NovaConsole_static_Nova0_writeLine(0, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "Checking File IO..."));
	stabilitytest_NovaFileStability_static_NovainputString = nova_standard_NovaString_Nova1_construct(0, exceptionData, "This is test input...");
	...
	CATCH (1)
	{
		...
		stabilitytest_NovaStabilityTest_Nova1_fail(l0_Novaprogram, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "Failed; Exception thrown"));
	}
	FINALLY
	{
	}
...
void stabilitytest_NovaFileStability_static_NovacreateFile(stabilitytest_NovaFileStability* this, nova_standard_exception_NovaExceptionData* exceptionData, stabilitytest_NovaStabilityTest* l0_Novaprogram, nova_standard_io_NovaFile* l0_Novaf)
{
	nova_standard_io_NovaConsole_static_Nova0_write(0, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "Creating file... "));
...
void stabilitytest_NovaFileStability_static_NovareadFromFile(stabilitytest_NovaFileStability* this, nova_standard_exception_NovaExceptionData* exceptionData, stabilitytest_NovaStabilityTest* l0_Novaprogram, nova_standard_io_NovaFile* l0_Novaf)
{
	...
	nova_standard_io_NovaConsole_static_Nova0_write(0, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "Reading lines from file... "));
	...
	{
		if (!l1_Novaline->vtable->nova_standard_NovaString_Novavirtual_equals(l1_Novaline, exceptionData, stabilitytest_NovaFileStability_static_NovainputString))
		{
			stabilitytest_NovaStabilityTest_Nova0_fail(l0_Novaprogram, exceptionData);
		}
		l1_Novaline = nova_standard_io_NovaFile_NovareadLine(l0_Novaf, exceptionData);
...
void stabilitytest_NovaFileStability_static_NovadeleteFile(stabilitytest_NovaFileStability* this, nova_standard_exception_NovaExceptionData* exceptionData, stabilitytest_NovaStabilityTest* l0_Novaprogram, nova_standard_io_NovaFile* l0_Novaf)
{
	nova_standard_io_NovaConsole_static_Nova0_write(0, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "Deleting file... "));
	if (!nova_standard_io_NovaFile_Novadelete(l0_Novaf, exceptionData))
	{
		stabilitytest_NovaStabilityTest_Nova1_fail(l0_Novaprogram, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "Failed to delete file"));
	}
	nova_standard_io_NovaConsole_static_Nova0_writeLine(0, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "OK"));
}
