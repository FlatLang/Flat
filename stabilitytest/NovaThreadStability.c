...
void nova_static_ThreadStability_test(ThreadStability* this, ExceptionData* exceptionData, StabilityTest* nova_0_program)
{
	...
	nova_static_1_Console_writeLine(0, exceptionData, nova_String_construct(0, exceptionData, (char*)("Checking Thread.nova with 20 Threads... ")));
...
void nova_static_ThreadStability_checkMemoryAccess(ThreadStability* this, ExceptionData* exceptionData)
{
	...
	nova_static_1_Console_write(0, exceptionData, nova_String_construct(0, exceptionData, (char*)("Checking memory access with multi-threading... ")));
	nova_1_i = 0;
