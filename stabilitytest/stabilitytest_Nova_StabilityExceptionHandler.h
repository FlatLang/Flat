...
struct stabilitytest_Extension_VTable_StabilityExceptionHandler
{
	...
	void (*nova_standard_thread_Nova_UncaughtExceptionHandler_virtual1_Nova_uncaughtException)(stabilitytest_Nova_StabilityExceptionHandler*, nova_standard_exception_Nova_ExceptionData*, nova_standard_thread_Nova_Thread*, nova_standard_exception_Nova_Exception*);
};
