...
typedef struct nova_VTable_stabilitytest_Nova_SyntaxStability
{
...
} nova_VTable_stabilitytest_Nova_SyntaxStability;

extern nova_VTable_stabilitytest_Nova_SyntaxStability nova_VTable_stabilitytest_Nova_SyntaxStability_val;

CCLASS_CLASS
(
	stabilitytest_Nova_SyntaxStability, 
	
	nova_VTable_stabilitytest_Nova_SyntaxStability* vtable;
)
