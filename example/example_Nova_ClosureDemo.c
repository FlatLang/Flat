...
typedef int (*example_Nova_ClosureDemo_closure1_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, int, int, void*);
typedef int (*example_Nova_ClosureDemo_closure2_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, int, int, void*);
typedef int (*example_Nova_ClosureDemo_closure3_Nova_closure)(void*, nova_standard_exception_Nova_ExceptionData*, int, int, void*);
...
void example_Nova_ClosureDemo_Nova_callClosure(example_Nova_ClosureDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData, example_Nova_ClosureDemo_closure3_Nova_closure example_Nova_ClosureDemo_Nova_closure, void* example_Nova_ClosureDemo_ref_Nova_closure, void* closure_context);
...
void example_Nova_ClosureDemo_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	{
	}
}
