...
typedef struct example_Extension_VTable_NonWholeDivisionException example_Extension_VTable_NonWholeDivisionException;
struct example_Extension_VTable_NonWholeDivisionException
{
...
extern example_Extension_VTable_NonWholeDivisionException example_Extension_VTable_NonWholeDivisionException_val;
...
(
	...
	example_Extension_VTable_NonWholeDivisionException* vtable;
	nova_standard_Nova_String* nova_standard_exception_Nova_Exception_Nova_message;
)

void example_Nova_NonWholeDivisionException_Nova_init_static(nova_standard_exception_Nova_ExceptionData* exceptionData);
example_Nova_NonWholeDivisionException* example_Nova_NonWholeDivisionException_Nova_NonWholeDivisionException(example_Nova_NonWholeDivisionException* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
