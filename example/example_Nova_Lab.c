...
char example_Nova_Lab_Nova_testLambda7(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* example_Nova_Lab_Nova_x);
nova_standard_Nova_Object* example_Nova_Lab_Nova_testLambda8(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* example_Nova_Lab_Nova_x, int example_Nova_Lab_Nova_i);
nova_standard_Nova_Object* example_Nova_Lab_Nova_testLambda9(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int example_Nova_Lab_Nova_x);
...
void example_Nova_Lab_Nova_main(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_Lab_Nova_args)
{
	...
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Mapped: "), exceptionData, nova_standard_datastruct_list_Nova_Array_Nova_join(nova_standard_datastruct_list_Nova_Array_Nova_map(l1_Nova_list->nova_standard_datastruct_list_Nova_Array_Nova_filter(l1_Nova_list, exceptionData, (nova_standard_datastruct_list_Nova_Array_closure15_Nova_filterFunc)&example_Nova_Lab_Nova_testLambda7, (example_Nova_Lab*)nova_null), exceptionData, (nova_standard_datastruct_list_Nova_Array_closure3_Nova_mapFunc)&example_Nova_Lab_Nova_testLambda8, (example_Nova_Lab*)nova_null), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, ", "))));
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Mapped2: "), exceptionData, nova_standard_datastruct_list_Nova_Array_Nova_join(l1_Nova_list2->nova_standard_datastruct_list_Nova_Array_Nova_map(l1_Nova_list2, exceptionData, (nova_standard_datastruct_list_Nova_Array_closure3_Nova_mapFunc)&example_Nova_Lab_Nova_testLambda9, (example_Nova_Lab*)nova_null), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, ", "))));
	...
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Linked list backwards: "), exceptionData, nova_standard_datastruct_list_Nova_LinkedList_0_Nova_join(l1_Nova_linked->nova_standard_datastruct_list_Nova_LinkedList_0_Nova_reverse(l1_Nova_linked, exceptionData), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, ", "))));
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Linked list forwards: "), exceptionData, nova_standard_datastruct_list_Nova_LinkedList_0_Nova_join(l1_Nova_linked, exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, ", "))));
	nova_standard_io_Nova_Console_Nova_waitForEnter(0, exceptionData);
}

double example_Nova_Lab_Nova_getArea(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, example_Nova_Polygon* example_Nova_Lab_Nova_p)
{
	return example_Nova_Polygon_0_Nova_calculateArea(example_Nova_Lab_Nova_p, exceptionData);
}
...
nova_standard_Nova_Object* example_Nova_Lab_Nova_testLambda8(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* example_Nova_Lab_Nova_x, int example_Nova_Lab_Nova_i)
{
	return (nova_standard_Nova_Object*)nova_standard_Nova_String_0_Nova_concat(nova_standard_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, example_Nova_Lab_Nova_i), exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, ": "), exceptionData, nova_standard_Nova_String_0_Nova_concat(example_Nova_Lab_Nova_x, exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "?"))));
}

nova_standard_Nova_Object* example_Nova_Lab_Nova_testLambda9(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, int example_Nova_Lab_Nova_x)
{
	return (nova_standard_Nova_Object*)nova_standard_Nova_String_0_Nova_concat(nova_standard_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, example_Nova_Lab_Nova_x), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "!"));
}
