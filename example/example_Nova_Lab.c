...
nova_Nova_Object* example_Nova_Lab_Nova_testLambda53(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_Nova_String* example_Nova_Lab_Nova_x, int example_Nova_Lab_Nova__2, nova_datastruct_list_Nova_Array* example_Nova_Lab_Nova__3, Context2* context);
...
void example_Nova_Lab_Nova_main(example_Nova_Lab* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_Nova_Lab_Nova_args)
{
	...
	Context3 contextArg58 = 
	{
	};
	Context4 contextArg59 = 
	{
	};
	Context5 contextArg60 = 
	{
	};
	Context6 contextArg61 = 
	{
	};
	Context7 contextArg62 = 
	{
	};
