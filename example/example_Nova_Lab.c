...
void example_Nova_Lab_Nova_main(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_Lab_Nova_args)
{
		...
		nova_standard_datastruct_list_Nova_Array* l1_Nova_test = (nova_standard_datastruct_list_Nova_Array*)nova_null;
		...
		nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_datastruct_list_Nova_IntRange_0_Nova_join((nova_standard_datastruct_list_Nova_IntRange_1_Nova_IntRange(0, exceptionData, (int)2, (int)8)), exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, ", ")));
		...
		l1_Nova_test = nova_standard_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
		nova_standard_datastruct_list_Nova_Array_0_Nova_add(l1_Nova_test, exceptionData, (nova_standard_Nova_Object*)(nova_standard_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData)));
		nova_standard_datastruct_list_Nova_Array_0_Nova_add((nova_standard_datastruct_list_Nova_Array*)(nova_standard_datastruct_list_Nova_Array_Nova_get(l1_Nova_test, exceptionData, 0)), exceptionData, (nova_standard_Nova_Object*)(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "hey")));
		nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "multi-dimensional array: "), exceptionData, nova_standard_Nova_Object_virtual1_Nova_toString((nova_standard_Nova_Object*)((l1_Nova_test)), exceptionData)));
