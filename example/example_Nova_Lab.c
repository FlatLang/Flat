...
example_VTable_Lab example_VTable_Lab_val =
{
...
example_Nova_Lab* example_Nova_Lab_2_Nova_construct(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
		...
		this->vtable = &example_VTable_Lab_val;
...
int main(int argc, char** argvs)
{
		...
		novaEnv.nova_standard_String.concat__nova_standard_String = nova_standard_VTable_String_val.nova_standard_Nova_String_virtual0_Nova_concat;
		novaEnv.nova_standard_String.toString = nova_standard_VTable_String_val.nova_standard_Nova_String_virtual0_Nova_toString;
		novaEnv.nova_standard_Object.getHashCodeLong = nova_standard_VTable_Object_val.nova_standard_Nova_Object_virtual1_Nova_getHashCodeLong;
		novaEnv.nova_standard_Object.toString = nova_standard_VTable_Object_val.nova_standard_Nova_Object_virtual0_Nova_toString;
		novaEnv.nova_standard_Object.equals__nova_standard_Object = nova_standard_VTable_Object_val.nova_standard_Nova_Object_virtual0_Nova_equals;
		novaEnv.nova_standard_math_NumericOperand.toString = nova_standard_math_VTable_NumericOperand_val.nova_standard_math_Nova_NumericOperand_virtual0_Nova_toString;
		novaEnv.nova_standard_primitive_number_Number.numDigits__nova_standard_primitive_number_Number = nova_standard_primitive_number_VTable_Number_val.nova_standard_primitive_number_Nova_Number_virtual0_Nova_numDigits;
		novaEnv.nova_standard_thread_Thread.run = nova_standard_thread_VTable_Thread_val.nova_standard_thread_Nova_Thread_virtual0_Nova_run;
		novaEnv.nova_standard_io_InputStream.readString = nova_standard_io_VTable_InputStream_val.nova_standard_io_Nova_InputStream_virtual0_Nova_readString;
		novaEnv.nova_standard_io_InputStream.readBytes = nova_standard_io_VTable_InputStream_val.nova_standard_io_Nova_InputStream_virtual0_Nova_readBytes;
		novaEnv.nova_standard_io_OutputStream.write__nova_standard_String = nova_standard_io_VTable_OutputStream_val.nova_standard_io_Nova_OutputStream_virtual1_Nova_write;
		novaEnv.nova_standard_io_OutputStream.write__nova_standard_Object = nova_standard_io_VTable_OutputStream_val.nova_standard_io_Nova_OutputStream_virtual2_Nova_write;
		novaEnv.nova_standard_svg_SVGComponent.generateOutput__nova_standard_io_File = nova_standard_svg_VTable_SVGComponent_val.nova_standard_svg_Nova_SVGComponent_virtual0_Nova_generateOutput;
		novaEnv.nova_standard_datastruct_Node.preorder = nova_standard_datastruct_VTable_Node_val.nova_standard_datastruct_Nova_Node_virtual0_Nova_preorder;
		novaEnv.nova_standard_datastruct_Node.inorder = nova_standard_datastruct_VTable_Node_val.nova_standard_datastruct_Nova_Node_virtual0_Nova_inorder;
		novaEnv.nova_standard_datastruct_Node.postorder = nova_standard_datastruct_VTable_Node_val.nova_standard_datastruct_Nova_Node_virtual0_Nova_postorder;
		novaEnv.nova_standard_datastruct_Comparable.compareTo__nova_standard_Object = nova_standard_datastruct_VTable_Comparable_val.nova_standard_datastruct_Nova_Comparable_virtual0_Nova_compareTo;
		novaEnv.example_Polygon.numberSides = example_VTable_Polygon_val.example_Nova_Polygon_virtual0_Nova_numberSides;
		novaEnv.example_Polygon.calculateArea = example_VTable_Polygon_val.example_Nova_Polygon_virtual0_Nova_calculateArea;
