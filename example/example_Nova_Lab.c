...
nova_standard_Nova_Object* example_Nova_Lab_Nova_testLambda13(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* example_Nova_Lab_Nova_x);
...
nova_standard_Nova_Object* example_Nova_Lab_Nova_testLambda13(example_Nova_Lab* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_Object* example_Nova_Lab_Nova_x)
{
		return (nova_standard_Nova_Object*)nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_Nova_Object_virtual1_Nova_toString((nova_standard_Nova_Object*)(example_Nova_Lab_Nova_x), exceptionData)), exceptionData, nova_standard_Nova_String_1_Nova_String(0, exceptionData, "!!!"));
}
...
int main(int argc, char** argvs)
{
		...
		novaEnv.nova_standard_datastruct_list_Array.first = nova_standard_datastruct_list_Extension_VTable_Array_val.nova_standard_datastruct_list_Nova_List_virtual0_Nova_first;
		novaEnv.nova_standard_datastruct_list_Array.last = nova_standard_datastruct_list_Extension_VTable_Array_val.nova_standard_datastruct_list_Nova_List_virtual0_Nova_last;
