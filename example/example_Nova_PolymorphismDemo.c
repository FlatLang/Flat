...
void example_Nova_PolymorphismDemo_Nova_main(example_Nova_PolymorphismDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_Nova_PolymorphismDemo_Nova_args)
{
	...
	nova_datastruct_list_Nova_Array_Nova_set(l1_Nova_animals, exceptionData, 0, (nova_Nova_Object*)(l1_Nova_dog));
	nova_datastruct_list_Nova_Array_Nova_set(l1_Nova_animals, exceptionData, 1, (nova_Nova_Object*)(l1_Nova_spider));
	...
	nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "Searched for animal with 8 legs and found: "), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)((l1_Nova_description)), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, ""))));
...
nova_Nova_String* example_Nova_PolymorphismDemo_Nova_getDescriptionOfAnimalWithNumberOfLegs(example_Nova_PolymorphismDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_Nova_PolymorphismDemo_Nova_animals, int example_Nova_PolymorphismDemo_Nova_numLegs)
{
	...
	return nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "Could not find animal with "), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, (example_Nova_PolymorphismDemo_Nova_numLegs))), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, " legs")));
}
