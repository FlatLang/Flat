...
struct example_Extension_VTable_Square
{
	...
	int (*example_Nova_Polygon_virtual1_Nova_numberSides)(example_Nova_Square*, nova_exception_Nova_ExceptionData*);
	double (*example_Nova_Polygon_virtual1_Nova_calculateArea)(example_Nova_Square*, nova_exception_Nova_ExceptionData*);
};
