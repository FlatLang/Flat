...
void example_Nova_ThreadDemo_Nova_main(example_Nova_ThreadDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_Nova_ThreadDemo_Nova_args)
{
	...
	while (l1_Nova_c == 'y' || l1_Nova_c == 'Y')
	{
		...
		l1_Nova_thread = (nova_thread_Nova_Thread*)(example_Nova_ThreadDemoImplementation_Nova_ThreadDemoImplementation(0, exceptionData, 100, nova_Nova_String_1_Nova_String(0, exceptionData, (char*)("Thread1"))));
		l1_Nova_thread2 = (nova_thread_Nova_Thread*)(example_Nova_ThreadDemoImplementation_Nova_ThreadDemoImplementation(0, exceptionData, 100, nova_Nova_String_1_Nova_String(0, exceptionData, (char*)("Thread2"))));
