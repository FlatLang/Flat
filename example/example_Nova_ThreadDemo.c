...
void example_Nova_ThreadDemo_Nova_main(example_Nova_ThreadDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_ThreadDemo_Nova_args)
{
	...
	while (l1_Nova_c == 'y' || l1_Nova_c == 'Y')
	{
		...
		l1_Nova_thread = (nova_standard_thread_Nova_Thread*)(example_Nova_ThreadDemoImplementation_Nova_construct(0, exceptionData, (long)(100), nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Thread1")));
		l1_Nova_thread2 = (nova_standard_thread_Nova_Thread*)(example_Nova_ThreadDemoImplementation_Nova_construct(0, exceptionData, (long)(100), nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Thread2")));
