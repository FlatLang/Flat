...
example_Nova_ThreadDemo* example_Nova_ThreadDemo_2_Nova_construct(example_Nova_ThreadDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		example_Nova_ThreadDemo_2_Nova_this(this, exceptionData);
	}
...
void example_Nova_ThreadDemo_Nova_main(example_Nova_ThreadDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_ThreadDemo_Nova_args)
{
	...
	while (l1_Nova_c == 'y' || l1_Nova_c == 'Y')
	{
		...
		l1_Nova_thread = (nova_standard_thread_Nova_Thread*)(example_Nova_ThreadDemoImplementation_Nova_construct(0, exceptionData, (long)(100), nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Thread1")));
		l1_Nova_thread2 = (nova_standard_thread_Nova_Thread*)(example_Nova_ThreadDemoImplementation_Nova_construct(0, exceptionData, (long)(100), nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Thread2")));
		...
		nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Time taken: "), exceptionData, nova_local_0->vtable->nova_standard_Nova_String_virtual0_Nova_concat(nova_local_0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "ms"))));
