...
example_Nova_ThreadDemo* example_Nova_ThreadDemo_0_Nova_construct(example_Nova_ThreadDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
void example_Nova_ThreadDemo_Nova_main(example_Nova_ThreadDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_ThreadDemo_Nova_args)
{
	...
	while (l1_Nova_c == 'y' || l1_Nova_c == 'Y')
	{
		...
		l1_Nova_thread = (nova_standard_thread_Nova_Thread*)(example_Nova_ThreadDemoImplementation_Nova_construct(0, exceptionData, 100, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Thread1")));
		l1_Nova_thread2 = (nova_standard_thread_Nova_Thread*)(example_Nova_ThreadDemoImplementation_Nova_construct(0, exceptionData, 100, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Thread2")));
		...
		nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Time taken: "), exceptionData, nova_standard_Nova_String_virtual0_Nova_concat((nova_standard_Nova_String*)(nova_standard_primitive_number_Nova_Long_2_Nova_toString(0, exceptionData, nova_standard_time_Nova_Timer_Accessor_Nova_duration(l1_Nova_timer, exceptionData))), exceptionData, nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "ms"))));
