...
struct example_Extension_VTable_ThreadDemoImplementation
{
	...
	void (*nova_thread_Nova_Thread_virtual0_Nova_run)(example_Nova_ThreadDemoImplementation*, nova_exception_Nova_ExceptionData*);
};
