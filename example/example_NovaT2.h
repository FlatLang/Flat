...
typedef struct example_NovaT2 example_NovaT2;
...
typedef struct nova_VTable_example_NovaT2
{
	...
	int (*example_NovaT2_static_Accessor_Novaind)(example_NovaT2*, nova_standard_exception_NovaExceptionData*);
} nova_VTable_example_NovaT2;

CCLASS_CLASS
(
	example_NovaT2, 
	
	nova_VTable_example_NovaT2* vtable;
)
