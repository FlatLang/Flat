...
example_ackermann_Nova_Ackermann* example_ackermann_Nova_Ackermann_2_Nova_construct(example_ackermann_Nova_Ackermann* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		example_ackermann_Nova_Ackermann_2_Nova_this(this, exceptionData);
	}
...
{
	nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Ackermann: "), exceptionData, nova_standard_primitive_number_Nova_Int_1_Nova_toString(0, exceptionData, example_ackermann_Nova_Ackermann_Nova_run((example_ackermann_Nova_Ackermann*)nova_null, exceptionData, 4, 1))));
...
void example_ackermann_Nova_Ackermann_2_Nova_this(example_ackermann_Nova_Ackermann* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
