#pragma once
#ifndef FILE_QueueDemo_NOVA
#define FILE_QueueDemo_NOVA

typedef struct example_NovaQueueDemo example_NovaQueueDemo;
...
typedef struct nova_VTable_example_NovaQueueDemo
{
...
} nova_VTable_example_NovaQueueDemo;

CCLASS_CLASS
(
	example_NovaQueueDemo, 
	
	nova_VTable_example_NovaQueueDemo* vtable;
)
