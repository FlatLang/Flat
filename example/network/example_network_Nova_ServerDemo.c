...
void example_network_Nova_ServerDemo_Nova_main(example_network_Nova_ServerDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_network_Nova_ServerDemo_Nova_args)
{
	...
	l1_Nova_connections = nova_datastruct_list_Nova_Array_0_Nova_Array(0, exceptionData);
	l1_Nova_socket = nova_network_Nova_ServerSocket_Nova_ServerSocket(0, exceptionData);
	l1_Nova_port = (int)(25560);
	if (!nova_network_Nova_ServerSocket_Nova_start(l1_Nova_socket, exceptionData, l1_Nova_port))
	{
		nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Failed to start server"));
	}
	else
	{
		nova_network_Nova_ConnectionSocket* l2_Nova_request = (nova_network_Nova_ConnectionSocket*)nova_null;
		
		nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "Started server on port "), exceptionData, nova_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, l1_Nova_port)));
		nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Waiting on client..."));
		...
		{
			nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Failed to accept client"));
		}
		while (l2_Nova_request != (nova_network_Nova_ConnectionSocket*)nova_null)
		{
			...
			nova_datastruct_list_Nova_Array_0_Nova_add(l1_Nova_connections, exceptionData, (nova_Nova_Object*)(l2_Nova_request));
			...
			nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Waiting on anoter"));
			l2_Nova_request = nova_network_Nova_ServerSocket_Nova_acceptClient(l1_Nova_socket, exceptionData);
		}
		nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Exiting"));
	}
