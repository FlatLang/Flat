#pragma once
#ifndef FILE_ServerDemo_NOVA
#define FILE_ServerDemo_NOVA

typedef struct example_network_NovaServerDemo example_network_NovaServerDemo;
...
} nova_VTable_example_network_NovaServerDemo;

CCLASS_CLASS
(
	example_network_NovaServerDemo, 
	
	nova_VTable_example_network_NovaServerDemo* vtable;
)
