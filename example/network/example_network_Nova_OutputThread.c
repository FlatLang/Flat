...
void example_network_Nova_OutputThread_0_Nova_run(example_network_Nova_OutputThread* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	while (this->prv->example_network_Nova_OutputThread_Nova_socket->nova_standard_network_Nova_ConnectionSocket_Nova_connected)
	{
		...
		if (nova_standard_operators_Nova_Equals_virtual2_Nova_equals((nova_standard_operators_Nova_Equals*)(l1_Nova_message), exceptionData, (nova_standard_Nova_Object*)(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "q"))))
		{
		...
		nova_standard_io_Nova_OutputStream_virtual1_Nova_write((nova_standard_io_Nova_OutputStream*)(this->prv->example_network_Nova_OutputThread_Nova_socket->nova_standard_network_Nova_ConnectionSocket_Nova_out), exceptionData, l1_Nova_message);
	}
}

void example_network_Nova_OutputThread_0_Nova_super(example_network_Nova_OutputThread* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
