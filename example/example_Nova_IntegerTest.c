...
example_Nova_IntegerTest* example_Nova_IntegerTest_2_Nova_construct(example_Nova_IntegerTest* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		example_Nova_IntegerTest_2_Nova_this(this, exceptionData);
	}
...
void example_Nova_IntegerTest_Nova_main(example_Nova_IntegerTest* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_IntegerTest_Nova_args)
{
	...
	while (l1_Nova_c == 'y' || l1_Nova_c == 'Y')
	{
		...
		{
			nova_standard_primitive_number_Nova_Long_1_Nova_toString(0, exceptionData, (long)(l3_Nova_i));
		}
...
void example_Nova_IntegerTest_2_Nova_this(example_Nova_IntegerTest* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
