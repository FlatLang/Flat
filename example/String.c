...
String* nova_String_String(ExceptionData* exceptionData, char* nova_String_data_11)
{
	...
	{
		this->prv->nova_String_data = nova_String_data_11;
...
{
	char* nova_String_newData_27;
	String* nova_String_newStr_27;
	
	nova_String_newData_27 = (char*)malloc(sizeof(char) * (nova_String_str_27->nova_String_length + this->nova_String_length + 1));
	strcpy(nova_String_newData_27, this->prv->nova_String_data);
	strcat(nova_String_newData_27, nova_String_toCharArray(nova_String_str_27, exceptionData));
	nova_String_newStr_27 = nova_String_String(exceptionData, nova_String_newData_27);
	return nova_String_newStr_27;
}
