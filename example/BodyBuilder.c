...
BodyBuilder* nova_BodyBuilder_BodyBuilder(ExceptionData* exceptionData, int nova_BodyBuilder_weightClass_109, String* nova_BodyBuilder_name_109)
{
	...
	this->nova_BodyBuilder_weightClass = 0;
	{
		...
		this->nova_BodyBuilder_weightClass = nova_BodyBuilder_weightClass_109;
		this->nova_Person_name = nova_BodyBuilder_name_109;
	}
