...
example_Nova_SVGTest* example_Nova_SVGTest_2_Nova_construct(example_Nova_SVGTest* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		example_Nova_SVGTest_2_Nova_this(this, exceptionData);
	}
...
void example_Nova_SVGTest_Nova_main(example_Nova_SVGTest* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_SVGTest_Nova_args)
{
	...
	l1_Nova_s = nova_standard_svg_Nova_SVG_2_Nova_construct(0, exceptionData);
	l1_Nova_pi2 = (double)(nova_standard_math_Nova_Math_Nova_PI * 2);
	nova_standard_io_Nova_Console_0_Nova_write(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Enter the number of vertices: "));
	l1_Nova_numVerts = nova_standard_io_Nova_Console_Nova_readInt(0, exceptionData);
	nova_standard_io_Nova_Console_0_Nova_write(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Enter the coefficient: "));
	l1_Nova_coefficient = nova_standard_io_Nova_Console_Nova_readDouble(0, exceptionData);
	nova_standard_io_Nova_Console_0_Nova_write(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Enter the number of poInts: "));
	...
	for (; l6_Nova_i < l1_Nova_numVerts; l6_Nova_i++)
	{
		...
		l6_Nova_circle2 = nova_standard_svg_Nova_SVGCircle_Nova_construct(0, exceptionData, l6_Nova_x, l6_Nova_y, 3);
	...
	for (; l8_Nova_i < l1_Nova_numPoInts; l8_Nova_i++)
	{
		...
		if (l8_Nova_i > 15)
		{
			...
			if (l8_Nova_i % 1000 == 0)
			{
				nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, (nova_standard_Nova_Object*)(nova_standard_primitive_number_Nova_Int_Nova_construct(0, exceptionData, l8_Nova_i)));
			}
			l9_Nova_circle = nova_standard_svg_Nova_SVGCircle_Nova_construct(0, exceptionData, l1_Nova_cx, l1_Nova_cy, 1);
	...
	l1_Nova_f = nova_standard_io_Nova_File_3_Nova_construct(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "C:/Users/Braden/svgoutput.html"));
