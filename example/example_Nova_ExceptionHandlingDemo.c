...
example_Nova_ExceptionHandlingDemo* example_Nova_ExceptionHandlingDemo_2_Nova_construct(example_Nova_ExceptionHandlingDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		example_Nova_ExceptionHandlingDemo_2_Nova_this(this, exceptionData);
	}
...
void example_Nova_ExceptionHandlingDemo_Nova_main(example_Nova_ExceptionHandlingDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_ExceptionHandlingDemo_Nova_args)
{
	TRY
	{
		...
		
		{
			...
			nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "After working example: "), exceptionData, nova_standard_primitive_number_Nova_Int_1_Nova_toString(0, exceptionData, l1_Nova_result)));
			...
			nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "this output will not show."));
		}
	}
	CATCH (6)
	{
		...
		nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "You used the divide() method incorrectly."));
	}
	FINALLY
	{
		nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Exiting the try block."));
	}
	END_TRY;
	nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "After the try block."));
...
void example_Nova_ExceptionHandlingDemo_2_Nova_this(example_Nova_ExceptionHandlingDemo* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
