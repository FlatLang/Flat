...
example_Nova_Spider* example_Nova_Spider_2_Nova_construct(example_Nova_Spider* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	example_Nova_Spider_2_Nova_super(this, exceptionData);
	
	{
		example_Nova_Spider_2_Nova_this(this, exceptionData);
	}
...
{
	return nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "A disgusting thing (Spider)");
}
