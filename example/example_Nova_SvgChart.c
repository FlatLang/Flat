...
int main(int argc, char** argvs)
{
		...
		novaEnv.nova_Object.getHashCodeLong = nova_Extension_VTable_Object_val.nova_Nova_Object_virtual1_Nova_getHashCodeLong;
		...
		TRY
		{
				example_Nova_SvgChart_Nova_main(0, exceptionData, argsArray);
		}
		CATCH (1)
		{
