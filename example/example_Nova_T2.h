...
struct example_Extension_VTable_T2
{
	...
	int (*example_Nova_T2_Accessor_Nova_ind)(example_Nova_T2*, nova_standard_exception_Nova_ExceptionData*);
};
...
example_Nova_T2* example_Nova_T2_2_Nova_construct(example_Nova_T2* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
void example_Nova_T2_Nova_destroy(example_Nova_T2** this, nova_standard_exception_Nova_ExceptionData* exceptionData);
void example_Nova_T2_2_Nova_this(example_Nova_T2* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
int example_Nova_T2_Accessor_Nova_ind(example_Nova_T2* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
void example_Nova_T2_2_Nova_super(example_Nova_T2* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
