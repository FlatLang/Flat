...
example_Nova_T1* example_Nova_T1_2_Nova_construct(example_Nova_T1* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
	...
	{
		example_Nova_T1_2_Nova_this(this, exceptionData);
	}
...
void example_Nova_T1_2_Nova_this(example_Nova_T1* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
}
