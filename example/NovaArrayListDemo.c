...
void nova_static_ArrayListDemo_main(ArrayListDemo* this, ExceptionData* exceptionData, String** nova_0_args)
{
	...
	while (nova_1_c == 'y' || nova_1_c == 'Y')
	{
		...
		{
			nova_static_Console_writeLine(0, exceptionData, nova_String_concat(nova_String_String(exceptionData, "Contains: "), exceptionData, nova_Integer_toString(nova_Integer_Integer(exceptionData, nova_ArrayList_get(nova_2_list, exceptionData, nova_2_i)), exceptionData)));
		}
