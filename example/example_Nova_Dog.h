...
struct example_Extension_VTable_Dog
{
	...
	int (*example_Nova_Dog_virtual_Nova_getNumLegs)(example_Nova_Dog*, nova_standard_exception_Nova_ExceptionData*);
	int (*example_Nova_Dog_virtual_Nova_getNumEyes)(example_Nova_Dog*, nova_standard_exception_Nova_ExceptionData*);
	nova_standard_Nova_String* (*example_Nova_Dog_virtual_Nova_getDescription)(example_Nova_Dog*, nova_standard_exception_Nova_ExceptionData*);
};
...
example_Nova_Dog* example_Nova_Dog_2_Nova_construct(example_Nova_Dog* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
void example_Nova_Dog_Nova_destroy(example_Nova_Dog** this, nova_standard_exception_Nova_ExceptionData* exceptionData);
void example_Nova_Dog_2_Nova_this(example_Nova_Dog* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
...
void example_Nova_Dog_2_Nova_super(example_Nova_Dog* this, nova_standard_exception_Nova_ExceptionData* exceptionData);
