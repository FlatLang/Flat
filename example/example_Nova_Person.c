...
example_Nova_Person* example_Nova_Person_5_Nova_construct(example_Nova_Person* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String* example_Nova_Person_Nova_name, int example_Nova_Person_Nova_age)
{
	...
	{
		example_Nova_Person_5_Nova_this(this, exceptionData, example_Nova_Person_Nova_name, example_Nova_Person_Nova_age);
	}
...
{
	nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Hello from "), exceptionData, this->example_Nova_Person_Nova_name->vtable->nova_standard_Nova_String_virtual0_Nova_concat(this->example_Nova_Person_Nova_name, exceptionData, nova_standard_Nova_String_1_Nova_construct(0, exceptionData, " the Person"))));
}
