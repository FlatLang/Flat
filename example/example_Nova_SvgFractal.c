...
{
	nova_svg_Nova_Svg* l1_Nova_s = (nova_svg_Nova_Svg*)nova_null;
	...
	l1_Nova_s = nova_svg_Nova_Svg_Nova_Svg(0, exceptionData);
	l1_Nova_pi2 = (double)(nova_math_Nova_Math_Nova_PI * 2);
	...
	for (; l6_Nova_n < (int)l1_Nova_numVerts; l6_Nova_n++)
	{
		double l6_Nova_x = 0;
		double l6_Nova_y = 0;
		nova_svg_Nova_SvgCircle* l6_Nova_circle2 = (nova_svg_Nova_SvgCircle*)nova_null;
		...
		l6_Nova_circle2 = nova_svg_Nova_SvgCircle_Nova_SvgCircle(0, exceptionData, l6_Nova_x, l6_Nova_y, 3);
		nova_svg_Nova_SvgComponentList_Nova_addChild(l1_Nova_s->nova_svg_Nova_Svg_Nova_root->nova_svg_Nova_SvgComponent_Nova_children, exceptionData, (nova_svg_Nova_SvgComponent*)(l6_Nova_circle2));
	}
	...
	for (; l8_Nova_p < (int)l1_Nova_numPoints; l8_Nova_p++)
	{
		...
		if (l8_Nova_p > 15)
		{
			nova_svg_Nova_SvgCircle* l9_Nova_circle = (nova_svg_Nova_SvgCircle*)nova_null;
			...
			l9_Nova_circle = nova_svg_Nova_SvgCircle_Nova_SvgCircle(0, exceptionData, l1_Nova_cx, l1_Nova_cy, 1);
			nova_svg_Nova_SvgComponentList_Nova_addChild(l1_Nova_s->nova_svg_Nova_Svg_Nova_root->nova_svg_Nova_SvgComponent_Nova_children, exceptionData, (nova_svg_Nova_SvgComponent*)(l9_Nova_circle));
		}
	}
	...
	nova_svg_Nova_Svg_Nova_generateHTMLOutput(l1_Nova_s, exceptionData, l1_Nova_f);
