...
typedef struct example_NovaArrayListDemo example_NovaArrayListDemo;
...
typedef struct nova_VTable_example_NovaArrayListDemo
{
...
} nova_VTable_example_NovaArrayListDemo;

CCLASS_CLASS
(
	example_NovaArrayListDemo, 
	
	nova_VTable_example_NovaArrayListDemo* vtable;
)
