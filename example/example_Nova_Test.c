...
void example_Nova_Test_Nova_main(example_Nova_Test* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_Test_Nova_args)
{
	...
	l1_Nova_d = (int)(5);
	nova_standard_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_String(0, exceptionData, "Comparison: "), exceptionData, nova_standard_primitive_number_Nova_Int_3_Nova_toString(0, exceptionData, nova_standard_primitive_number_Nova_Int_0_Nova_compareTo(nova_standard_primitive_number_Nova_Int_Nova_Int(0, exceptionData, l1_Nova_d), exceptionData, 3))));
