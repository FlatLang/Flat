...
example_Nova_Test* example_Nova_Test_0_Nova_construct(example_Nova_Test* this, nova_standard_exception_Nova_ExceptionData* exceptionData)
{
...
void example_Nova_Test_Nova_main(example_Nova_Test* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_Test_Nova_args)
{
	...
	l1_Nova_s = nova_standard_datastruct_list_Nova_Stack_0_Nova_construct(0, exceptionData);
	nova_standard_datastruct_list_Nova_Stack_Nova_push(l1_Nova_s, exceptionData, (nova_standard_Nova_Object*)(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "How are you?")));
	nova_standard_datastruct_list_Nova_Stack_Nova_push(l1_Nova_s, exceptionData, (nova_standard_Nova_Object*)(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Larry")));
	nova_standard_datastruct_list_Nova_Stack_Nova_push(l1_Nova_s, exceptionData, (nova_standard_Nova_Object*)(nova_standard_Nova_String_2_Nova_construct(0, exceptionData, "Hello")));
