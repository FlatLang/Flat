...
void example_Nova_Test_Nova_main(example_Nova_Test* this, nova_standard_exception_Nova_ExceptionData* exceptionData, nova_standard_Nova_String** example_Nova_Test_Nova_args)
{
	...
	l1_Nova_s = nova_standard_datastruct_list_Nova_Stack_2_Nova_construct(0, exceptionData);
	nova_standard_datastruct_list_Nova_Stack_Nova_push(l1_Nova_s, exceptionData, (nova_standard_Nova_Object*)(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "How are you?")));
	nova_standard_datastruct_list_Nova_Stack_Nova_push(l1_Nova_s, exceptionData, (nova_standard_Nova_Object*)(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Larry")));
	nova_standard_datastruct_list_Nova_Stack_Nova_push(l1_Nova_s, exceptionData, (nova_standard_Nova_Object*)(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Hello")));
	while (!nova_standard_datastruct_list_Nova_Stack_Accessor_Nova_empty(l1_Nova_s, exceptionData))
	{
		nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, (nova_standard_Nova_String*)(nova_standard_datastruct_list_Nova_Stack_Nova_pop(l1_Nova_s, exceptionData)));
	}
	l1_Nova_d = 5;
	nova_standard_io_Nova_Console_0_Nova_writeLine(0, exceptionData, nova_standard_Nova_String_0_Nova_concat(nova_standard_Nova_String_1_Nova_construct(0, exceptionData, "Comparison: "), exceptionData, nova_standard_primitive_number_Nova_Int_1_Nova_toString(0, exceptionData, nova_standard_primitive_number_Nova_Int_0_Nova_compareTo(nova_standard_primitive_number_Nova_Int_Nova_construct(0, exceptionData, l1_Nova_d), exceptionData, nova_standard_primitive_number_Nova_Int_Nova_construct(0, exceptionData, 3)))));
