#pragma once
#ifndef FILE_DatabaseDemo_NOVA
#define FILE_DatabaseDemo_NOVA

typedef struct example_database_NovaDatabaseDemo example_database_NovaDatabaseDemo;
...
typedef struct nova_VTable_example_database_NovaDatabaseDemo
{
	nova_standard_NovaString* (*nova_standard_NovaObject_Novavirtual0_toString)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*);
	char (*nova_standard_NovaObject_Novavirtual0_equals)(nova_standard_NovaObject*, nova_standard_exception_NovaExceptionData*, nova_standard_NovaObject*);
} nova_VTable_example_database_NovaDatabaseDemo;

CCLASS_CLASS
(
	example_database_NovaDatabaseDemo, 
	
	nova_VTable_example_database_NovaDatabaseDemo* vtable;
)
