...
example_database_Nova_DatabaseDemo* example_database_Nova_DatabaseDemo_Nova_DatabaseDemo(example_database_Nova_DatabaseDemo* this, nova_exception_Nova_ExceptionData* exceptionData)
{
...
void example_database_Nova_DatabaseDemo_Nova_main(example_database_Nova_DatabaseDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_database_Nova_DatabaseDemo_Nova_args)
{
	...
	l1_Nova_result = nova_database_Nova_DBConnector_Nova_query(l1_Nova_connection, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "select * from market"));
	l2_Nova_row = (int)0;
	for (; l2_Nova_row < (int)nova_database_Nova_ResultSet_Accessor_Nova_numRows(l1_Nova_result, exceptionData); l2_Nova_row++)
	{
		int l4_Nova_col = 0;
		
		nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "Found ("), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, (l2_Nova_row))), exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "): "), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_Nova_Object_virtual1_Nova_toString((nova_Nova_Object*)((nova_datastruct_list_Nova_Array_virtual1_Nova_get((nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_Array_virtual1_Nova_get((nova_datastruct_list_Nova_Array*)(l1_Nova_result->nova_database_Nova_ResultSet_Nova_rows), exceptionData, l2_Nova_row)), exceptionData, 0))), exceptionData)), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, ""))))));
		l4_Nova_col = (int)1;
		for (; l4_Nova_col < (int)l1_Nova_result->nova_database_Nova_ResultSet_Nova_numCols; l4_Nova_col++)
		{
			nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, ", "), exceptionData, nova_Nova_Object_virtual1_Nova_toString((nova_Nova_Object*)(nova_datastruct_list_Nova_Array_virtual1_Nova_get((nova_datastruct_list_Nova_Array*)(nova_datastruct_list_Nova_Array_virtual1_Nova_get((nova_datastruct_list_Nova_Array*)(l1_Nova_result->nova_database_Nova_ResultSet_Nova_rows), exceptionData, l2_Nova_row)), exceptionData, l4_Nova_col)), exceptionData)));
		}
	...
	nova_database_Nova_DBConnector_Nova_query(l1_Nova_connection, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "insert into market values("), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_primitive_number_Nova_Int_2_Nova_toString(0, exceptionData, (l1_Nova_id))), exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, ", 6, 634, 3);"))));
...
nova_database_Nova_DBConnector* example_database_Nova_DatabaseDemo_Nova_connect(example_database_Nova_DatabaseDemo* this, nova_exception_Nova_ExceptionData* exceptionData)
{
	...
	nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Connecting..."));
	l1_Nova_connection = nova_database_Nova_DBConnector_Nova_DBConnector(0, exceptionData);
	nova_database_Nova_DBConnector_1_Nova_connect(l1_Nova_connection, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "localhost"), nova_Nova_String_1_Nova_String(0, exceptionData, "root"), nova_Nova_String_1_Nova_String(0, exceptionData, "server"), nova_Nova_String_1_Nova_String(0, exceptionData, "test"));
	l1_Nova_error = l1_Nova_connection->nova_database_Nova_DBConnector_Nova_error;
	if (l1_Nova_error->nova_Nova_String_Nova_count > 0)
	{
		nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_String(0, exceptionData, "Error: "), exceptionData, l1_Nova_error));
	}
	else
	{
...
void example_database_Nova_DatabaseDemo_Nova_close(example_database_Nova_DatabaseDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_database_Nova_DBConnector* example_database_Nova_DatabaseDemo_Nova_connection)
{
	nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Closing..."));
	nova_database_Nova_DBConnector_Nova_close(example_database_Nova_DatabaseDemo_Nova_connection, exceptionData);
	nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_1_Nova_String(0, exceptionData, "Closed"));
}
