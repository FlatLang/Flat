...
(
	...
	nova_standard_network_NovaConnectionSocket* bank_NovaConnectionThread_Novasocket;
...
void bank_NovaConnectionThread_Novarun(bank_NovaConnectionThread* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	nova_standard_network_NovaConnectionSocket_Novaclose(this->prv->bank_NovaConnectionThread_Novasocket, exceptionData);
}
...
{
	this->prv->bank_NovaConnectionThread_Novasocket = (nova_standard_network_NovaConnectionSocket*)nova_null;
