...
(
	...
	nova_standard_network_NovaServerSocket* bank_NovaServerOutputThread_Novasocket;
...
void bank_NovaServerOutputThread_Nova0_run(bank_NovaServerOutputThread* this, nova_standard_exception_NovaExceptionData* exceptionData)
{
	...
	l1_Novarequest = nova_standard_network_NovaServerSocket_NovaacceptClient(this->prv->bank_NovaServerOutputThread_Novasocket, exceptionData);
	if (l1_Novarequest == (nova_standard_network_NovaConnectionSocket*)nova_null)
	{
	...
	while (l1_Novarequest != (nova_standard_network_NovaConnectionSocket*)nova_null && this->prv->bank_NovaServerOutputThread_Novasocket->nova_standard_network_NovaServerSocket_Novaopen)
	{
		bank_NovaBank* l3_Novabank;
		bank_NovaConnectionThread* l3_Novathread;
		
		nova_standard_io_NovaConsole_static_Nova0_writeLine(0, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "Accepted new client"));
	...
	nova_standard_io_NovaConsole_static_Nova0_writeLine(0, exceptionData, nova_standard_NovaString_Nova1_construct(0, exceptionData, "Done"));
}
...
{
	this->prv->bank_NovaServerOutputThread_Novasocket = (nova_standard_network_NovaServerSocket*)nova_null;
}
