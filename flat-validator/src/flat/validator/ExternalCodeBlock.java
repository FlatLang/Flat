...
public class ExternalCodeBlock extends NodeValidator implements ScopeAncestor
{
	 ...
	 */
	public ExternalCodeBlock(NodeValidator temporaryParent, Location locationIn)
	{
	...
	public void setContents(String contents)
	{
		...
		while (index >= 0)
		{
			...
			NodeValidator content = SyntaxTree.decodeScopeContents(getParent(), value.trim(), getLocationIn());
	...
	public String joinContents(BiFunction<NodeValidator, Boolean, String> func)
	{
		String output = "";
	 ...
	 */
	public static ExternalCodeBlock decodeStatement(NodeValidator parent, String statement, Location location, boolean require)
	{
	 ...
	 */
	@Override
	public ExternalCodeBlock clone(NodeValidator temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
