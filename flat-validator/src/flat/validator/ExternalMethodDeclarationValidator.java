...
public class ExternalMethodDeclarationValidator extends MethodDeclarationValidator
{
	public String	alias;
	 ...
	 */
	public ExternalMethodDeclarationValidator(NodeValidator temporaryParent, Location locationIn)
	{
		super(temporaryParent, locationIn);
	}
	
	/**
	 * @see MethodDeclarationValidator#isVirtual()
	 */
	@Override
	...
	/**
	 * @see MethodDeclarationValidator#isExternal()
	 */
	@Override
	...
	/**
	 * @see MethodDeclarationValidator#containsBody()
	 */
	@Override
	 ...
	 * 		into a Method.
	 */
	public static ExternalMethodDeclarationValidator decodeStatement(NodeValidator parent, String statement, Location location, boolean require)
	{
		Bounds bounds = StringUtils.findWordBounds(statement, ExternalMethodDeclarationValidator.PREFIX);
		...
		if (bounds.isValid() && bounds.getStart() < statement.indexOf('('))
		{
			...
			{
				ExternalMethodDeclarationValidator n = new ExternalMethodDeclarationValidator(parent, location);
				...
				MethodDeclarationValidator method = FlatMethodDeclarationValidator.decodeStatement(n, methodSignature, location.asNew(), require);
	...
	public ValidationResult validate(int phase)
	{
		...
		MethodDeclarationValidator methods[] = getParentClass().getMethods(getName());
	 ...
	 */
	@Override
	public ExternalMethodDeclarationValidator clone(NodeValidator temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
		ExternalMethodDeclarationValidator node = new ExternalMethodDeclarationValidator(temporaryParent, locationIn);
	 ...
	 */
	public ExternalMethodDeclarationValidator cloneTo(ExternalMethodDeclarationValidator node)
	{
		return cloneTo(node, true, true);
	}
	
	/**
	 * Fill the given {@link ExternalMethodDeclarationValidator} with the data that is in
	 * the specified node.
	 * 
	 * @param node The node to copy the data into.
	 * @return The cloned node.
	 */
	public ExternalMethodDeclarationValidator cloneTo(ExternalMethodDeclarationValidator node, boolean cloneChildren, boolean cloneAnnotations)
	{
	...
	/**
	 * Test the {@link ExternalMethodDeclarationValidator} class type to make sure everything
	 * is working properly.
	 * 
