...
public class Package extends NodeValidator
{
	 ...
	 */
	public Package(NodeValidator temporaryParent, Location locationIn)
	{
	 ...
	 * 		into a {@link Package}.
	 */
	public static Package decodeStatement(NodeValidator parent, String statement, Location location, boolean require)
	{
	...
	public static Package generateDefaultPackage(NodeValidator parent, Location location)
	{
	 ...
	 */
	@Override
	public Package clone(NodeValidator temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
