...
public class VariableDeclarationValidator extends IIdentifier
{
	...
	public ArrayList<VariableValidator> references = new ArrayList<>();

	/**
	 * @see NodeValidator#NodeValidator(NodeValidator, Location)
	 */
	public VariableDeclarationValidator(NodeValidator temporaryParent, Location locationIn)
	{
	...
	{
		if (replacement instanceof VariableDeclarationValidator)
		{
			references.forEach(x -> {
				x.declaration = (VariableDeclarationValidator)replacement;
			});
		}
	...
	public VariableDeclarationValidator getOriginalDeclaration()
	{
		return this;
	}
	...
	/**
	 * @see ValueValidator#getGenericReturnType()
	 */
	@Override
	...
	/**
	 * @see IdentifierValidator#isDeclaration()
	 */
	@Override
	...
	{
		if (getParent() instanceof FieldDeclarationValidator)
		{
			FieldDeclarationValidator field = (FieldDeclarationValidator)getParent();
	...
	/**
	 * @see NodeValidator#isWithinExternalContext()
	 */
	@Override
	 ...
	 *
	 * @see IdentifierValidator#setName(String)
	 *
	 ...
	 */
	public VariableValidator generateUsableVariable(NodeValidator parent, Location location)
	{
		VariableValidator var = new VariableValidator(parent, location);
	 ...
	 */
	public VariableValidator generateUsableVariable(VariableValidator toVar)
	{
...
//					args.getVisibleChild(i).setType(refArgs.getVisibleChild(index));
	 ...
	 */
	@Override
	public VariableDeclarationValidator clone(NodeValidator temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
		VariableDeclarationValidator node = new VariableDeclarationValidator(temporaryParent, locationIn);
	 ...
	 */
	public VariableDeclarationValidator cloneTo(VariableDeclarationValidator node)
	{
		return cloneTo(node, true, true);
	}

	/**
	 * Fill the given {@link VariableDeclarationValidator} with the data that is in the
	 * specified node.
	 *
	 * @param node The node to copy the data into.
	 * @return The cloned node.
	 */
	public VariableDeclarationValidator cloneTo(VariableDeclarationValidator node, boolean cloneChildren, boolean cloneAnnotations)
	{
