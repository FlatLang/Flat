...
public class OverrideAnnotationValidator extends AnnotationValidator
{
	 ...
	 */
	public OverrideAnnotationValidator(Node temporaryParent, Location locationIn)
	{
		super(temporaryParent, locationIn);
	}
	
	/**
	 * Decode the given statement into a {@link OverrideAnnotationValidator} instance, if
	 ...
	 * 		{@link OverrideAnnotationValidator} instance.
	 * @param location The location of the statement in the source code.
	 * @param require Whether or not to throw an error if anything goes wrong.
	 * @return The generated node, if it was possible to translated it
	 * 		into a {@link OverrideAnnotationValidator}.
	 */
	public static OverrideAnnotationValidator decodeStatement(Node parent, String name, String parameters, Location location, boolean require)
	{
		if (name.equals("Override"))
		{
			OverrideAnnotationValidator n = new OverrideAnnotationValidator(parent, location);
	 ...
	 */
	@Override
	public OverrideAnnotationValidator clone(Node temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
		OverrideAnnotationValidator node = new OverrideAnnotationValidator(temporaryParent, locationIn);
	 ...
	 */
	public OverrideAnnotationValidator cloneTo(OverrideAnnotationValidator node)
	{
		return cloneTo(node, true, true);
	}
	
	/**
	 * Fill the given {@link OverrideAnnotationValidator} with the data that is in the
	 * specified node.
	 *
	 * @param node The node to copy the data into.
	 * @return The cloned node.
	 */
	public OverrideAnnotationValidator cloneTo(OverrideAnnotationValidator node, boolean cloneChildren, boolean cloneAnnotations)
	{
	...
	/**
	 * Test the {@link OverrideAnnotationValidator} class type to make sure everything
	 * is working properly.
	 *
