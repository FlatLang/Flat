...
public class RequireGenericTypeAnnotationValidator extends AnnotationValidator
{
	/**
	 * @see Node#Node(Node, Location)
	 */
	public RequireGenericTypeAnnotationValidator(Node temporaryParent, Location locationIn)
	{
	...
	/**
	 * Decode the given statement into a {@link RequireGenericTypeAnnotationValidator} instance, if
	 ...
	 * 		{@link RequireGenericTypeAnnotationValidator} instance.
	 * @param location The location of the statement in the source code.
	 * @param require Whether or not to throw an error if anything goes wrong.
	 * @return The generated node, if it was possible to translated it
	 * 		into a {@link RequireGenericTypeAnnotationValidator}.
	 */
	public static RequireGenericTypeAnnotationValidator decodeStatement(Node parent, String name, String parameters, Location location, boolean require)
	{
		if (name.equals("RequireGenericType"))
		{
			RequireGenericTypeAnnotationValidator n = new RequireGenericTypeAnnotationValidator(parent, location);
	 ...
	 */
	@Override
	public RequireGenericTypeAnnotationValidator clone(Node temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
		RequireGenericTypeAnnotationValidator node = new RequireGenericTypeAnnotationValidator(temporaryParent, locationIn);
	 ...
	 */
	public RequireGenericTypeAnnotationValidator cloneTo(RequireGenericTypeAnnotationValidator node)
	{
		return cloneTo(node, true, true);
	}
	
	/**
	 * Fill the given {@link RequireGenericTypeAnnotationValidator} with the data that is in the
	 * specified node.
	 * 
	 * @param node The node to copy the data into.
	 * @return The cloned node.
	 */
	public RequireGenericTypeAnnotationValidator cloneTo(RequireGenericTypeAnnotationValidator node, boolean cloneChildren, boolean cloneAnnotations)
	{
	...
	/**
	 * Test the {@link RequireGenericTypeAnnotationValidator} class type to make sure everything
	 * is working properly.
	 * 
