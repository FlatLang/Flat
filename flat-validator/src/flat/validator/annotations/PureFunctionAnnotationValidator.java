...
public class PureFunctionAnnotationValidator extends AnnotationValidator
{
	...
	public PureFunctionAnnotationValidator(Node temporaryParent, Location locationIn)
	{
		this(temporaryParent, locationIn, false);
	}
	
	public PureFunctionAnnotationValidator(Node temporaryParent, Location locationIn, boolean validated)
	{
	...
	public static PureFunctionAnnotationValidator decodeStatement(Node parent, String name, String parameters, Location location, boolean require)
	{
		if (name.equals("Pure"))
		{
			PureFunctionAnnotationValidator n = new PureFunctionAnnotationValidator(parent, location);
	...
	{
		return validatePure(x->{}, method, allowInstanceModification);
	}
	...
	{
		return validatePure(x->{}, closure, allowInstanceModification);
	}
	...
	public boolean validatePure(Consumer<Variable> onImpure, ClosureDeclaration closure, boolean allowInstanceModification)
	{
		...
		final PureFunctionAnnotationValidator self = this;
...
//				result.errorOccurred = true;
	...
	@Override
	public PureFunctionAnnotationValidator clone(Node temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
		PureFunctionAnnotationValidator node = new PureFunctionAnnotationValidator(temporaryParent, locationIn);
		
		return cloneTo(node, cloneChildren, cloneAnnotations);
	}
	
	public PureFunctionAnnotationValidator cloneTo(PureFunctionAnnotationValidator node)
	{
		return cloneTo(node, true, true);
	}
	
	public PureFunctionAnnotationValidator cloneTo(PureFunctionAnnotationValidator node, boolean cloneChildren, boolean cloneAnnotations)
	{
