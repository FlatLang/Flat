...
public class ImmutableAnnotationValidator extends AnnotationValidator
{
	...
	public ImmutableAnnotationValidator(Node temporaryParent, Location locationIn)
	{
		super(temporaryParent, locationIn);
	}
	
	public static ImmutableAnnotationValidator decodeStatement(Node parent, String name, String parameters, Location location, boolean require)
	{
		if (name.equals("Immutable"))
		{
			ImmutableAnnotationValidator n = new ImmutableAnnotationValidator(parent, location);
	...
	public ClassDeclaration getImmutableClass()
	{
		if (getParent() instanceof VariableDeclaration)
		{
			...
			ImmutableAnnotationValidator reference = (ImmutableAnnotationValidator)mutableClass.getAnnotationOfType(ImmutableAnnotationValidator.class, false);
	...
	@Override
	public ImmutableAnnotationValidator clone(Node temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
		ImmutableAnnotationValidator node = new ImmutableAnnotationValidator(temporaryParent, locationIn);
		
		return cloneTo(node, cloneChildren, cloneAnnotations);
	}
	
	public ImmutableAnnotationValidator cloneTo(ImmutableAnnotationValidator node)
	{
		return cloneTo(node, true, true);
	}
	
	public ImmutableAnnotationValidator cloneTo(ImmutableAnnotationValidator node, boolean cloneChildren, boolean cloneAnnotations)
	{
