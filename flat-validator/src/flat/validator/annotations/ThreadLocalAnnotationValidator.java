...
public class ThreadLocalAnnotationValidator extends AnnotationValidator
{
	...
	public ThreadLocalAnnotationValidator(Node temporaryParent, Location locationIn)
	{
		super(temporaryParent, locationIn);
	}
	
	public static ThreadLocalAnnotationValidator decodeStatement(Node parent, String name, String parameters, Location location, boolean require)
	{
		if (name.equals("ThreadLocal"))
		{
			ThreadLocalAnnotationValidator n = new ThreadLocalAnnotationValidator(parent, location);
	...
	@Override
	public ThreadLocalAnnotationValidator clone(Node temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
		ThreadLocalAnnotationValidator node = new ThreadLocalAnnotationValidator(temporaryParent, locationIn);
		
		return cloneTo(node, cloneChildren, cloneAnnotations);
	}
	
	public ThreadLocalAnnotationValidator cloneTo(ThreadLocalAnnotationValidator node)
	{
		return cloneTo(node, true, true);
	}
	
	public ThreadLocalAnnotationValidator cloneTo(ThreadLocalAnnotationValidator node, boolean cloneChildren, boolean cloneAnnotations)
	{
