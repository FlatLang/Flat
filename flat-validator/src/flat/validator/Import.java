...
public class Import extends NodeValidator
{
	 ...
	 */
	public Import(NodeValidator temporaryParent, Location locationIn)
	{
	 ...
	 * 		into a Import.
	 */
	public static Import decodeStatement(NodeValidator parent, String statement, Location location, boolean require)
	{
...
//				SyntaxMessage.error("Import location ends with unknown extension", this);
	...
	private ValidationResult validateLocation(ValidationResult result)
	{
		if (!isExternal())
		{
			ClassDeclarationValidator clazz = getProgram().getClassDeclaration(location);
	 ...
	 */
	@Override
	public Import clone(NodeValidator temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
