...
import flat.validator.BodyMethodDeclarationValidator;
import flat.validator.NodeValidator;

public class LambdaMethodDeclarationValidator extends BodyMethodDeclarationValidator
{
	 ...
	 */
	public LambdaMethodDeclarationValidator(NodeValidator temporaryParent, Location locationIn, Scope scope)
	{
...
//			detach();
	 ...
	 */
	@Override
	public LambdaMethodDeclarationValidator clone(NodeValidator temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
		LambdaMethodDeclarationValidator node = new LambdaMethodDeclarationValidator(temporaryParent, locationIn, scope);
	 ...
	 */
	public LambdaMethodDeclarationValidator cloneTo(LambdaMethodDeclarationValidator node)
	{
		return cloneTo(node, true, true);
	}
	
	/**
	 * Fill the given {@link LambdaMethodDeclarationValidator} with the data that is in the
	 * specified node.
	 *
	 * @param node The node to copy the data into.
	 * @return The cloned node.
	 */
	public LambdaMethodDeclarationValidator cloneTo(LambdaMethodDeclarationValidator node, boolean cloneChildren, boolean cloneAnnotations)
	{
	...
	/**
	 * Test the {@link LambdaMethodDeclarationValidator} class type to make sure everything
	 * is working properly.
	 *
