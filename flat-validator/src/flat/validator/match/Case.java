...
public class Case extends MatchCase
{
	 ...
	 */
	public Case(NodeValidator temporaryParent, Location locationIn)
	{
	...
	public boolean pendingScopeFragment(NodeValidator nodeValidator)
	{
		...
		{
			return returningCase.pendingScopeFragment(nodeValidator);
		}
	...
	{
		if (nodeValidator instanceof Case)
		{
//			getAncestorOfType(Match.class).addChild(node);
	 ...
	 * 		into a {@link Case}.
	 */
	public static Case decodeStatement(NodeValidator parent, String statement, Location location, boolean require)
	{
	...
	{
		ValueValidator control = getParentMatch().getControlValue();
		
		ValueValidator value = (ValueValidator)getParentMatch().getControlValue().clone(control.getParent(), control.getLocationIn(), true);
		ValueValidator clone = (ValueValidator)getValue().clone(getValue().getParent(), getValue().getLocationIn(), true);
	 ...
	 */
	@Override
	public Case clone(NodeValidator temporaryParent, Location locationIn, boolean cloneChildren, boolean cloneAnnotations)
	{
