...
{
	public NodeValidator returnedNodeValidator, originalNodeValidator;
	 ...
	 * the given Node.
	 * 
	 * @param returnedNodeValidator The Node that the validation method can expect
	 * 		to return.
	 */
	public ValidationResult(NodeValidator returnedNodeValidator)
	{
		this.returnedNodeValidator = returnedNodeValidator;
		this.originalNodeValidator = returnedNodeValidator;
	...
	{
		return errorOccurred || skipCycle || !continueValidation || returnedNodeValidator != originalNodeValidator;
	}
	 ...
	 */
	public ValidationResult errorOccurred(NodeValidator remove)
	{
//		remove.detach();
