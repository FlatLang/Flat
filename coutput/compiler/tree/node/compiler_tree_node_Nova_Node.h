#pragma once
#ifndef FILE_compiler_tree_node_Nova_Node_NOVA
#define FILE_compiler_tree_node_Nova_Node_NOVA

typedef struct compiler_tree_node_Nova_Node compiler_tree_node_Nova_Node;
...
typedef struct compiler_tree_node_Extension_VTable_Node compiler_tree_node_Extension_VTable_Node;
struct compiler_tree_node_Extension_VTable_Node
{
	...
	compiler_tree_node_Nova_Node* (*compiler_tree_node_Nova_Node_virtual1_Nova_clone)(compiler_tree_node_Nova_Node*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, char);
};

extern compiler_tree_node_Extension_VTable_Node compiler_tree_node_Extension_VTable_Node_val;
...
(
	...
	compiler_tree_node_Extension_VTable_Node* vtable;
	struct Private* prv;
)
...
compiler_tree_node_Nova_Node* compiler_tree_node_Nova_Node_1_Nova_clone(compiler_tree_node_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_node_Nova_Node* compiler_tree_node_Nova_Node_Nova_temporaryParent, compiler_util_Nova_Location* compiler_tree_node_Nova_Node_Nova_locationIn, char compiler_tree_node_Nova_Node_Nova_cloneChildren);void compiler_tree_node_Nova_Node_0_Nova_this(compiler_tree_node_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData);
