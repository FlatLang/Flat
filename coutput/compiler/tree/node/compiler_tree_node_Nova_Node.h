...
compiler_tree_node_Nova_Node* compiler_tree_node_Nova_Node_1_Nova_clone(compiler_tree_node_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData, compiler_tree_node_Nova_Node* compiler_tree_node_Nova_Node_Nova_temporaryParent, compiler_util_Nova_Location* compiler_tree_node_Nova_Node_Nova_locationIn, char compiler_tree_node_Nova_Node_Nova_cloneChildren);compiler_tree_node_Nova_Node* compiler_tree_node_Nova_Node_Accessor_Nova_parent(compiler_tree_node_Nova_Node* this, nova_exception_Nova_ExceptionData* exceptionData);
