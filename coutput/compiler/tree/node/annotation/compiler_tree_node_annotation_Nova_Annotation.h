#pragma once
#ifndef FILE_compiler_tree_node_annotation_Nova_Annotation_NOVA
#define FILE_compiler_tree_node_annotation_Nova_Annotation_NOVA
...
typedef struct compiler_tree_node_annotation_Extension_VTable_Annotation compiler_tree_node_annotation_Extension_VTable_Annotation;
struct compiler_tree_node_annotation_Extension_VTable_Annotation
{
	...
	compiler_tree_node_annotation_Nova_Annotation* (*compiler_tree_node_Nova_Node_virtual1_Nova_clone)(compiler_tree_node_annotation_Nova_Annotation*, nova_exception_Nova_ExceptionData*, compiler_tree_node_Nova_Node*, compiler_util_Nova_Location*, char);
};

extern compiler_tree_node_annotation_Extension_VTable_Annotation compiler_tree_node_annotation_Extension_VTable_Annotation_val;
...
(
	...
	compiler_tree_node_annotation_Extension_VTable_Annotation* vtable;
	struct Private* prv;
)
