...
nova_datastruct_list_Nova_Array* generated10(compiler_Nova_Compiler* this, nova_exception_Nova_ExceptionData* exceptionData);
...
void compiler_Nova_Compiler_Nova_compile(compiler_Nova_Compiler* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* compiler_Nova_Compiler_Nova_args)
{
		...
		if (compiler_Nova_Compiler_Nova_DEBUG)
		{
				...
				compiler_Nova_Compiler_Nova_args = generated10(this, exceptionData);
				nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Args: ")), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_Nova_Object_virtual1_Nova_toString((nova_Nova_Object*)((compiler_Nova_Compiler_Nova_args)), exceptionData)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("")))));
		}
}
...
nova_datastruct_list_Nova_Array* generated10(compiler_Nova_Compiler* this, nova_exception_Nova_ExceptionData* exceptionData)
{
		...
		l1_Nova_temp = (nova_Nova_String**)NOVA_MALLOC(sizeof(nova_Nova_String) * 10);
		l1_Nova_temp[0] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("../Compiler"));
		l1_Nova_temp[1] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("example"));
		l1_Nova_temp[2] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("stabilitytest"));
		l1_Nova_temp[3] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("-formatc"));
		l1_Nova_temp[4] = (nova_Nova_Object*)nova_null ? nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("-v")) : nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(""));
		l1_Nova_temp[5] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("-keepc"));
		l1_Nova_temp[6] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("-single-thread"));
		l1_Nova_temp[7] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("-main"));
		l1_Nova_temp[8] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("compiler/Compiler"));
		l1_Nova_temp[9] = nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("-no-optimize"));
		return nova_datastruct_list_Nova_Array_2_Nova_construct(0, exceptionData, (nova_Nova_Object**)(l1_Nova_temp), 10);
}
