#pragma once
#ifndef FILE_nova_svg_Nova_SvgComponent_NOVA
#define FILE_nova_svg_Nova_SvgComponent_NOVA

typedef struct nova_svg_Nova_SvgComponent nova_svg_Nova_SvgComponent;
