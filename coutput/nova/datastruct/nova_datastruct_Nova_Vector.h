#pragma once
#ifndef FILE_nova_datastruct_Nova_Vector_NOVA
#define FILE_nova_datastruct_Nova_Vector_NOVA

typedef struct nova_datastruct_Nova_Vector nova_datastruct_Nova_Vector;
...
typedef struct nova_datastruct_Extension_VTable_Vector nova_datastruct_Extension_VTable_Vector;
struct nova_datastruct_Extension_VTable_Vector
{
...
extern nova_datastruct_Extension_VTable_Vector nova_datastruct_Extension_VTable_Vector_val;


CCLASS_CLASS
(
	nova_datastruct_Nova_Vector, 
	
	nova_datastruct_Extension_VTable_Vector* vtable;
)
