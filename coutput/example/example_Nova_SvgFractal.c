...
void example_Nova_SvgFractal_Nova_main(example_Nova_SvgFractal* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_Nova_SvgFractal_Nova_args)
{
	...
	nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Enter the number of vertices: ")));
	l1_Nova_numVerts = nova_io_Nova_Console_Nova_readInt(0, exceptionData);
	nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Enter the coefficient: ")));
	l1_Nova_coefficient = nova_io_Nova_Console_Nova_readDouble(0, exceptionData);
	nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Enter the number of points: ")));
	...
	l1_Nova_points = nova_datastruct_list_Nova_DoubleArray_1_Nova_construct(0, exceptionData, l1_Nova_numVerts * 2);
	...
	for (; l8_Nova_p < (int)l1_Nova_numPoints; l8_Nova_p++)
	{
		...
		if (l8_Nova_p > 15)
		{
			...
			{
				nova_io_Nova_Console_2_Nova_writeLine(0, exceptionData, (nova_Nova_Object*)(nova_primitive_number_Nova_Int_Nova_construct(0, exceptionData, l8_Nova_p + 1)));
			}
	...
	nova_io_Nova_Console_0_Nova_write(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("Done generating ")), exceptionData, nova_primitive_number_Nova_Long_2_Nova_toString(0, exceptionData, nova_time_Nova_Timer_Accessor_Nova_duration(l1_Nova_timer, exceptionData))));
