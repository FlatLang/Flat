...
void example_Nova_HashMapDemo_Nova_testLambda55(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context1* context);
void example_Nova_HashMapDemo_Nova_testLambda56(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context2* context);
char example_Nova_HashMapDemo_Nova_testLambda57(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context3* context);
nova_Nova_Object* example_Nova_HashMapDemo_Nova_testLambda58(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_list_Nova_Array* example_Nova_HashMapDemo_Nova__3, Context4* context);
void example_Nova_HashMapDemo_Nova_testLambda59(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_Nova_Pair* example_Nova_HashMapDemo_Nova__1, int example_Nova_HashMapDemo_Nova__2, nova_datastruct_Nova_HashMap* example_Nova_HashMapDemo_Nova__3, Context5* context);
...
void example_Nova_HashMapDemo_Nova_main(example_Nova_HashMapDemo* this, nova_exception_Nova_ExceptionData* exceptionData, nova_datastruct_list_Nova_Array* example_Nova_HashMapDemo_Nova_args)
{
	...
	Context2 contextArg59 = 
	{
	};
	Context3 contextArg60 = 
	{
	};
	Context4 contextArg61 = 
	{
	};
	Context5 contextArg62 = 
	{
	};
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_words), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&example_Nova_HashMapDemo_Nova_testLambda55, nova_null, &contextArg58);
	...
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_words), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&example_Nova_HashMapDemo_Nova_testLambda56, nova_null, &contextArg59);
	nova_io_Nova_Console_1_Nova_writeLine(0, exceptionData, nova_Nova_String_0_Nova_concat(nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\n")), exceptionData, nova_Nova_String_virtual1_Nova_concat((nova_Nova_String*)(nova_datastruct_list_Nova_List_virtual0_Nova_join((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_map((nova_datastruct_list_Nova_List*)(nova_datastruct_list_Nova_List_virtual0_Nova_filter((nova_datastruct_list_Nova_List*)(l1_Nova_words), exceptionData, (nova_datastruct_list_Nova_List_closure15_Nova_filterFunc)&example_Nova_HashMapDemo_Nova_testLambda57, nova_null, &contextArg60)), exceptionData, (nova_datastruct_list_Nova_List_closure6_Nova_mapFunc)&example_Nova_HashMapDemo_Nova_testLambda58, nova_null, &contextArg61)), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)(", ")))), exceptionData, nova_Nova_String_1_Nova_construct(0, exceptionData, (char*)("\n")))));
	nova_datastruct_list_Nova_List_virtual0_Nova_forEach((nova_datastruct_list_Nova_List*)(l1_Nova_words), exceptionData, (nova_datastruct_list_Nova_List_closure3_Nova_func)&example_Nova_HashMapDemo_Nova_testLambda59, nova_null, &contextArg62);
