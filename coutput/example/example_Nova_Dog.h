...
struct example_Extension_VTable_Dog
{
	...
	int (*example_Nova_Animal_virtual1_Nova_getNumLegs)(example_Nova_Dog*, nova_exception_Nova_ExceptionData*);
	int (*example_Nova_Animal_virtual1_Nova_getNumEyes)(example_Nova_Dog*, nova_exception_Nova_ExceptionData*);
	nova_Nova_String* (*example_Nova_Animal_virtual1_Nova_getDescription)(example_Nova_Dog*, nova_exception_Nova_ExceptionData*);
};
